...
| Datei | Problem | Fix |
|-------|---------|-----|
| `PAP-camerer2004neuroeconomics.yaml` | `\citet{}` in context mit Double-Quotes → YAML Parse Error | Single-Quotes mit escaped Backslashes |
...
| 2026-02-01 | Paper DB | YAML Backslash-Escape Fix | `PAP-camerer2004neuroeconomics.yaml` |
...
| Metrik | Wert |
|--------|------|
| Lessons dokumentiert | **16** |
| Verbesserungen implementiert | **62** |
