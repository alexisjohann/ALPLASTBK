...
%          presents the four core concepts (C, Ψ, C*, K) plus the 9C CORE preview.
%
...
% Leads to: Chapter 1b (9C CORE Architecture), Chapter 2 (Rationality)
%
...
AU, AV, AW (CORE) & 9C Behavioral Pipeline & \ref{sec:intro-8c} \\
...
\begin{itemize}
    ...
    \item Section \ref{sec:intro-8c}: Preview of the 9C CORE Framework
...
\begin{enumerate}
    ...
    \item \textbf{1953:} Milton Friedman's ``as if'' methodology defended \emph{unrealistic assumptions} if they yielded good predictions \citep{friedman1953}.
    ...
    \item \textbf{1970s:} The Chicago School institutionalized this methodology \citep{stigler1982,becker1976}, treating the framework as an empirically validated model.
    ...
    \item \textbf{2010s:} The credibility revolution \citep{angrist2010,leamer2010} brought data-driven methods, yet theoretical fragmentation persisted.
...
Each finding generated its own literature---behavioral economics \citep{camloewrabin}, identity economics, institutional economics. These literatures developed independently because \emph{no integration was technologically feasible}---and because scientific incentives favor specialization over synthesis \citep{smaldino2016,kuhn1962}. Without computation, context-dependent models with $C_{ij} \neq 0$ could not be operationalized.
...
\begin{itemize}
    \item \textbf{Psychology} developed rich experimental insights into individual cognition \citep{kahneman2011,stanovich2011}, but Freudians, behaviorists, cognitive psychologists, and neuroscientists use incompatible frameworks. No common language exists for integration \citep{mischel2008}.
    \item \textbf{Sociology} mapped social structures and cultural dynamics \citep{merton1968,giddens1984}, but explicitly rejected formalization. Functionalism, conflict theory, and symbolic interactionism coexist without any integration mechanism \citep{collins1994}.
    \item \textbf{Political science} analyzed institutional design and collective action \citep{ostrom1990,olson1965}, but only partially formalized. Rational choice exists alongside historical institutionalism without synthesis \citep{hall1996}.
    \item \textbf{Management science} accumulated practical knowledge about organizational change \citep{lewin1947,kotter1996}, but exhibits fashion cycles rather than cumulation \citep{abrahamson1996}. Each decade's framework replaces rather than builds on the previous.
    \item \textbf{Economics} developed all three: a common mathematical language (utility, equilibrium, optimization) \citep{mascolell1995}, cumulative development (each generation builds on predecessors), and methodological flexibility (absorbed experiments, RCTs, machine learning while maintaining coherence) \citep{angristpischke2009}.
\end{itemize}
...
Heterodox economics---Post-Keynesian \citep{lavoie2014}, Institutionalist \citep{hodgson2004}, Austrian \citep{hayek1945knowledge}, and other traditions---identified crucial phenomena that separable models could not capture: institutional path dependence, fundamental uncertainty, the social construction of preferences \citep{lawson2006nature,davis2008heterodox}. These insights were correct and important.
...
\begin{itemize}
  ...
  \item \textbf{$\Psi_I$ (Institutional):} Institutional economics \citep{north1990},
  ...
  \item \textbf{$\Psi_E$ (Economic):} Resource constraints, budget effects,
        capital markets \citep{fama1970}. See Appendix~Y.
...
The \textbf{9C CORE Framework} completes this architecture by addressing these gaps. Each CORE question has a dedicated appendix with 80--150 axioms, complete formalization, and empirical grounding.

%==============================================================================
% 9C CORE PREVIEW BOX
%==============================================================================
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=\textbf{The 9C CORE Framework}]
...
\textbf{Key Insight:} The four concepts above (Complementarity, Context, Reference, Coherence) answer questions 3--4 (HOW and WHEN). The 9C Framework extends this to the complete behavioral prediction pipeline---from potential utility through sustained behavioral change.

\textit{See Chapter~1b for the complete 9C CORE architecture.}
...
\begin{itemize}
    \item \textbf{Chapter 1b} introduces the complete \textbf{9C CORE Framework}---the eight fundamental questions that structure behavioral prediction.
...
\begin{itemize}
    \item \textbf{CORE (9C Framework):} AAA (WHO---Level Hierarchy), B (HOW---Complementarity), C (WHAT---FEPSDE Matrix), V (WHEN---Context $\Psi$), BBB (WHERE---Parameter Estimation), AU (AWARE---Awareness Function), AV (READY---Willingness Function), AW (STAGE---Behavioral Change Journey)
...
\begin{itemize}[nosep]
    \item \textbf{Chapter 1b:} Complete 9C CORE architecture---the eight fundamental questions
...
\begin{itemize}[nosep]
    \item \textbf{Why integration now?} Appendix LIT-META (Metascience Integration)
    \item \textbf{Arrow-Debreu as limiting case:} Appendix A (FORMAL-DERIVE)
    \item \textbf{Behavioral pipeline:} Appendices AU, AV, AW (Awareness, Willingness, Stage)
    \item \textbf{All terminology:} Appendix G (REF-GLOSSARY)
    \item \textbf{Worked examples:} Appendix F (REF-EXAMPLES)
\end{itemize}
