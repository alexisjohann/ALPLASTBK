...
\textbf{Formal Specification:} See Appendix REA (CORE-READY), Section 2 ``Tau Decomposition
...
\begin{cross-reference}
\textbf{Formal Specification:} See Appendix REA (CORE-READY), Section 3 ``The WAX Master
...
\begin{cross-reference}
\textbf{Formal Specification:} See Appendix REA (CORE-READY), Axiom WAX-A103
...
\begin{cross-reference}
\textbf{Formal Specification:} See Appendix REA (CORE-READY), Section 5 ``The Critical
...
\end{itemize}
See Chapter 11 and Appendix AWA (CORE-AWARE) for the awareness specification.
\end{cross-reference}
...
Appendix REA provides the complete formal specification of all 99+ Willingness axioms.
...
\begin{cross-reference}
\textbf{Complete Formal Specification:} See Appendix REA (CORE-READY) for all axioms
...
\begin{enumerate}
    ...
    \item \textbf{99 Axioms:} Complete formal specification in Appendix REA
...
\textbf{Reading Path:}
\begin{itemize}
    \item For complete axiom specification: Appendix REA (CORE-READY)
    \item For $\tau$ estimation: Appendix REA, Section 2
    \item For threshold dynamics: Appendix REA, Section 4
    \item For awareness mechanics: Chapter 11 + Appendix AWA (CORE-AWARE)
    \item For BCJ (next): Chapter 13 + Appendix STA (CORE-STAGE)
