...
\textbf{Primär:}
\begin{itemize}[nosep]
\item Appendix HHH (METHOD-TOOLKIT) --- F10 (Complementarity), Axiom HHH-A4, Theorem HHH-T7
\item Appendix PAP (FORMAL-EQUILIBRIA) --- Portfolio-Equilibria, Tipping Points
\end{itemize}

\textbf{Unterstützend:}
\begin{itemize}[nosep]
\item Appendix THL1 (METHOD-EVAL): Evaluations-Protokolle, Attribution-Methoden
\item Appendix WEN (CORE-WHEN): Kontext-Level für Implementation
\item Appendix SUN (PREDICT-MASTER): Testbare Portfolio-Vorhersagen
\item Appendix REG (METHOD-REGISTRY): $\gamma$-Repository, Organizational Learning
...
\vspace{0.2cm}
\textit{Siehe: Chapter 11, Section 11.20 (EMERGE Algorithm), Appendix IE (EMERGE-SPEC)}
\end{tcolorbox}
...
\textbf{Derivation from Ch17 and Appendix C:}
...
\vspace{0.2cm}
\footnotesize
\textit{Quelle: Chapter 11, §11.20.3 (EIT-EMP-3 Scope Level Emergence); Appendix IE (EMERGE-SPEC)}
\end{table}
...
\end{itemize}
\textit{Begründung: Appendix FRM, Axiom EXC-3 (Hybrid Formulation).}
...
\begin{equation}
\gamma(\Psi_{\text{workplace}}) = \text{(aus Appendix V, CORE-WHEN)}
\end{equation}
...
\item \textbf{Input-Spezifikation:}
   ...
   \item $\gamma_{ij}$-Schätzungen aus Appendix REG
...
\item \textbf{Repository-Update (Appendix REG):}
\begin{equation}
...
Die zentrale Frage ist nicht ``Pfad A oder B?'', sondern: \textbf{Was lassen wir emergieren vs.\ was setzen wir vorab?} (Siehe Appendix HHH, Section~\ref{sec:hhh-emergence-modes} für vollständige Theorie.)
...
\textbf{Referenz:} Kapitel 17, Section~\ref{sec:17-diagnosis}; Appendix AAA-HI (CORE)
...
\textbf{Referenz:} Kapitel 17, Section~\ref{sec:17-continuous-space}; Appendix HHH (METHOD-TOOLKIT)
...
\textbf{Referenz:} Section~\ref{sec:20-complementarity}; Appendix HHH (F1--F9)
...
\textbf{Referenz:} Section~\ref{sec:20-complementarity}; Appendix HHH (F10)
...
\midrule
\textbf{Appendix HHH} & Portfolio formula & Deployed throughout & Is Appendix HHH & ☐ \\
...
\begin{itemize}[nosep]
\item Appendix HHH (METHOD-TOOLKIT) --- F10 (Complementarity), Axiom HHH-A4, Theorem HHH-T7
\item Appendix PAP (FORMAL-EQUILIBRIA) --- Portfolio-Equilibria, Tipping-Point-Analysis
\item Appendix THL1 (METHOD-EVAL) --- Evaluations-Protokolle, Attribution-Methoden
\item Appendix REG (METHOD-REGISTRY) --- $\gamma$-Repository, Organizational Learning
\end{itemize}
