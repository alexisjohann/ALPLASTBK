...
\textbf{Essential:}
\begin{itemize}[nosep]
\item Appendix HHH (METHOD-TOOLKIT) --- Complementarity matrix, coherence criteria
\item Appendix KKK (METHOD-DYNAMIC) --- Formal models for dynamic adjustment
\item Appendix LLL (METHOD-POLICY-DOMAINS) --- Domain-specific portfolio templates
\item Appendix MMM (METHOD-POLICY-COHERENCE) --- Cross-domain spillover analysis
\end{itemize}

\textbf{Supporting:}
\begin{itemize}[nosep]
\item Appendix JJJ (METHOD-PSG) --- Parameter sourcing for policy contexts
...
\item \textbf{Appendix RB (LIT-BENABOU)} --- Narrative-aware policy design ($I_{\text{AWARE}}$ + framing)
\end{itemize}
...
\vspace{0.2cm}
\textit{Siehe: Chapter 11 §11.20 (EMERGE), Chapter 20 §20.7 (Constraints), Appendix IE (EMERGE-SPEC)}
\end{tcolorbox}
...
\item Copy-paste templates for your domain → Appendix LLL (templates + matrices)
\item To understand domain interactions → Section 5 (Cross-Domain Coherence)
\item To analyze spillovers & optimize coherence → Appendix MMM (spillover framework)
...
\item Formal mathematics behind portfolio dynamics → Appendix KKK
\item Parameter sourcing discipline for your domain → Appendix JJJ
\item Case studies of policy successes/failures → Case studies in Appendix MMM
\end{itemize}
