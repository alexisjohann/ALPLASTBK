...
\midrule
B (CORE-HOW) & Complete $\Gamma$-matrix (15 parameters), CMP-11, CMP-12 & All sections \\
...
Appendix HOW contains the complete mathematical specification with all 163 parameters.
\end{tcolorbox}
...
%------------------------------------------------------------------------------
% NARRATIVE MODULATION (CMP-11)
%------------------------------------------------------------------------------
\begin{tcolorbox}[
    colback=green!5!white,
    colframe=green!60!black,
    title={\textbf{Advanced: Narrative Modulation of $\gamma$ (Axiom CMP-11)}},
    fonttitle=\bfseries
]
...
\medskip
\textit{Full formalization: Appendix B (CORE-HOW), Axiom CMP-11. Narrative theory: Appendix RB (LIT-BENABOU).}
\end{tcolorbox}

%------------------------------------------------------------------------------
% ASKING-OFFERING COMPLEMENTARITY (CMP-12)
%------------------------------------------------------------------------------
\begin{tcolorbox}[
    colback=blue!5!white,
    colframe=blue!60!black,
    title={\textbf{Advanced: Asking-Offering Complementarity (Axiom CMP-12)}},
    fonttitle=\bfseries
]
...
\medskip
\textit{Full formalization: Appendix B (CORE-HOW), Axiom CMP-12. Fear of Asking: Appendix RB (LIT-BENABOU), Axiom RB-10. Theory: MS-IB-018.}
\end{tcolorbox}
...
\textbf{Appendix HOW} provides the complete mathematical treatment of supermodularity,
including proofs of equilibrium existence, lattice structure, and comparative statics.
\textbf{Appendix FND} details the Milgrom-Roberts contributions that established these foundations.
\end{cross-reference}
...
\begin{cross-reference}
\textbf{Appendix EST} (CORE-WHERE) provides the complete calibration framework,
...
\begin{cross-reference}
\textbf{Appendix HRC} provides a detailed account of how computational capabilities
...
The complete formal treatment appears in Appendix B (CORE-HOW). Key results:
\begin{itemize}[nosep]
...
\textbf{For Theorists:}
$\rightarrow$ Appendix HOW (complete $\Gamma$-matrix) $\rightarrow$ Appendix FND (Milgrom-Roberts)

\textbf{For Scientists:}
$\rightarrow$ Appendix MS (134 theories with $C_{ij}$ restrictions) $\rightarrow$ Appendix DER (formal proofs)

\textbf{For Practitioners:}
$\rightarrow$ Chapter 6 (reference structures) $\rightarrow$ Chapter 9 (context)

\textbf{For Empiricists:}
$\rightarrow$ Appendix EST (calibration) $\rightarrow$ Appendix LLM1 (LLM-MC estimation)
