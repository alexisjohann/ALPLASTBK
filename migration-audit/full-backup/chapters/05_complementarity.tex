...
\begin{tcolorbox}[
    ...
    title={\textbf{9C CORE Connection: HOW (Question 3)}},
    fonttitle=\bfseries
]
...
\midrule
B (CORE-HOW) & Complete $\Gamma$-matrix (15 parameters) & All sections \\
...
Appendix B contains the complete mathematical specification with all 163 parameters.
\end{tcolorbox}
...
\begin{itemize}
    ...
    \item Section \ref{sec:comp-integration}: Integration with 9C framework
...
\textbf{Appendix B} provides the complete mathematical treatment of supermodularity,
including proofs of equilibrium existence, lattice structure, and comparative statics.
\textbf{Appendix X} details the Milgrom-Roberts contributions that established these foundations.
\end{cross-reference}
...
\begin{cross-reference}
\textbf{Appendix BBB} (CORE-WHERE) provides the complete calibration framework,
...
\begin{cross-reference}
\textbf{Appendix H} provides a detailed account of how computational capabilities
evolved from chalk-and-blackboard analysis in the 1960s to today's LLM-assisted frameworks.
\end{cross-reference}


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                    PART X: 9C INTEGRATION
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\section{Integration with 9C Framework}
...
\begin{table}[htbp]
\centering
\caption{Chapter 5 Integration with 9C CORE Structure}
\label{tab:ch5-8c-integration}
\small
...
\textbf{For Theorists:}
$\rightarrow$ Appendix B (complete $\Gamma$-matrix) $\rightarrow$ Appendix X (Milgrom-Roberts)

\textbf{For Practitioners:}
$\rightarrow$ Chapter 6 (reference structures) $\rightarrow$ Chapter 9 (context)

\textbf{For Empiricists:}
$\rightarrow$ Appendix BBB (calibration) $\rightarrow$ Appendix AN (LLM-MC estimation)

\textbf{For Full 9C Understanding:}
