...
\begin{tcolorbox}[
    ...
    title={\textbf{9C CORE Connection: WHAT (Question 3) + WHO (Question 1)}},
    fonttitle=\bfseries
]
...
Appendix C provides the complete 144-component formal specification.
\end{tcolorbox}
...
See Appendix C (CORE-WHAT), Section C.2 for the complete axiomatization of
...
\begin{cross-reference}
See Appendix C (CORE-WHAT) for the complete specification of all six dimensions
...
\begin{cross-reference}
See Appendix AAA (CORE-WHO) for the complete specification of the level hierarchy
...
\begin{cross-reference}
See Appendix AJ (Social Preferences) for the formal foundations of
...
\begin{cross-reference}
See Appendix C (CORE-WHAT) for the complete axiom system (144 axioms)
...
\end{itemize}
See Chapter 5 and Appendix B (CORE-HOW) for the complete complementarity specification.
\end{cross-reference}
...
\end{itemize}
See Chapter 9 and Appendix V (CORE-WHEN) for the 8-dimensional context specification.
\end{cross-reference}
...
See Appendix AAA (CORE-WHO) for the complete specification.
\end{cross-reference}
...
\bottomrule
\end{tabular}
\caption{Integration of WHAT (FEPSDE) with the 9C framework}
\label{tab:8c-fepsde-integration}
\end{table}
...
\textbf{Reading Path:}
\begin{itemize}
    \item For complete FEPSDE specification: Appendix C (CORE-WHAT)
    \item For level aggregation: Appendix AAA (CORE-WHO)
    \item For complementarity mechanics: Chapter 5 + Appendix B (CORE-HOW)
    \item For context modulation: Chapter 9 + Appendix V (CORE-WHEN)
    \item For awareness (next): Chapter 11 + Appendix AU (CORE-AWARE)
\end{itemize}
\end{cross-reference}
