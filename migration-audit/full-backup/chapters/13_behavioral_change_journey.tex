...
\begin{tcolorbox}[
    ...
    title={\textbf{9C CORE Connection: STAGE (Question 5)}},
    fonttitle=\bfseries
]
...
\medskip
\textit{This chapter extends 7C to 9C by adding STAGE as the temporal dimension of behavioral change.}
\end{tcolorbox}
...
\begin{itemize}
    ...
    \item Section \ref{sec:bcj-integration}: Connects BCJ to the 9C CORE framework
...
See Appendix AU (CORE-AWARE) for the formal Awareness function $A(\cdot)$
...
\begin{cross-reference}
See Appendix AV (CORE-READY) for the formal specification of $\theta$
...
\begin{cross-reference}
Appendix AW (CORE-STAGE) contains 152 boundary conditions specifying
exact conditions for forward and backward transitions across 29 model categories.
\end{cross-reference}


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                     PART V: INTEGRATION WITH 7C/9C
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
The BCJ extends the 7C framework to 9C by adding \textbf{STAGE} as the
...
\end{itemize}
See Chapter 11 and Appendix AU for full specification.
\end{cross-reference}
...
\end{itemize}
See Chapter 12 and Appendix AV for full specification.
\end{cross-reference}
...
\end{itemize}
See Appendix V (CORE-WHEN) for the 8-dimensional context specification.
\end{cross-reference}
...
\bottomrule
\end{tabular}
\caption{Integration of STAGE (8th CORE) with the complete 9C framework}
...
\begin{cross-reference}
Appendix AW contains boundary conditions for multi-level BCJ from
...
\begin{enumerate}
    \item \textbf{BCJ as 8th CORE:} Stage (STAGE) extends 7C to 9C, answering
    ...
    \item \textbf{9C Integration:} BCJ connects to all other CORE dimensions,
...
\textbf{Reading Path:}
\begin{itemize}
    \item For formal BCJ specification: Appendix AW (CORE-STAGE)
    \item For awareness mechanics: Chapter 11 + Appendix AU
    \item For willingness mechanics: Chapter 12 + Appendix AV
