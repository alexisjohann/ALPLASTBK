%------------------------------------------------------------------------------
% Chapter 1b: The 9C CORE Architecture
%------------------------------------------------------------------------------
% Version: 2.0 (January 2026)
%
% Purpose: Introduces the complete 9C CORE Framework---the eight fundamental
...
\section{The 9C CORE Architecture}
\label{sec:8c-core}
...
\textbf{9C CORE} & Die acht fundamentalen Fragen: WHO, WHAT, HOW, WHEN, WHERE, AWARE, READY, STAGE \\[3pt]
...
\midrule
AAA (CORE-WHO) & Level hierarchy (9 levels, 41 axioms) & \ref{sec:8c-who} \\
C (CORE-WHAT) & FEPSDE dimensions (144 components) & \ref{sec:8c-what} \\
B (CORE-HOW) & Complementarity framework & \ref{sec:8c-how} \\
V (CORE-WHEN) & Context $\Psi$ (8 dimensions) & \ref{sec:8c-when} \\
BBB (CORE-WHERE) & Calibration methodology & \ref{sec:8c-where} \\
AU (CORE-AWARE) & Awareness filter (104 axioms) & \ref{sec:8c-aware} \\
AV (CORE-READY) & Willingness threshold (99 axioms) & \ref{sec:8c-ready} \\
AW (CORE-STAGE) & Behavioral change journey & \ref{sec:8c-stage} \\
...
\textbf{The 9C Framework} explains:
\begin{itemize}[nosep]
...
\textit{This chapter shows how the 9C Framework predicts exactly WHEN and WHY behavior change occurs---or fails.}
\end{tcolorbox}
...
\noindent Thomas's Fitness Journey (above) illustrates what Anna's Dilemma could not: why \emph{knowing} the right answer and \emph{doing} the right thing are separated by an entire behavioral pipeline. This chapter develops that pipeline---the \textbf{9C CORE Framework}.

%------------------------------------------------------------------------------
% CHAPTER OVERVIEW
%------------------------------------------------------------------------------
\paragraph{Chapter Overview.}
\label{sec:8c-overview}
This chapter proceeds as follows:
\begin{itemize}
    \item Section \ref{sec:8c-questions}: The eight fundamental questions (overview)
    \item Section \ref{sec:8c-pipeline}: The four-stage pipeline from utility to action
    \item Section \ref{sec:8c-who}: CORE-WHO---The level hierarchy
    \item Section \ref{sec:8c-what}: CORE-WHAT---The FEPSDE dimensions
    \item Section \ref{sec:8c-how}: CORE-HOW---Complementarity
    \item Section \ref{sec:8c-when}: CORE-WHEN---The $\Psi$ context dimensions
    \item Section \ref{sec:8c-where}: CORE-WHERE---Calibration
    \item Section \ref{sec:8c-aware}: CORE-AWARE---The awareness filter
    \item Section \ref{sec:8c-ready}: CORE-READY---The willingness threshold
    \item Section \ref{sec:8c-stage}: CORE-STAGE---The behavioral change journey
    \item Section \ref{sec:8c-integration}: Integration---How the 9C connect
    \item Section \ref{sec:8c-summary}: Summary---The complete architecture
\end{itemize}

%==============================================================================
\subsection{The Eight Fundamental Questions}
\label{sec:8c-questions}
%==============================================================================
...
\textbf{9C CORE Framework}.

%==============================================================================
\subsection{The Eight Fundamental Questions}
%==============================================================================

\begin{definition}[The 9C CORE Framework]
\label{def:8c-core}
...
\label{sec:8c-pipeline}
%==============================================================================

The 9C questions organize into a \textbf{four-stage pipeline} from potential
...
%==============================================================================
\subsection{Integration: How the 9C Connect}
\label{sec:8c-integration}
%==============================================================================

The eight COREs are not independent---they form an integrated architecture:

\begin{tcolorbox}[colback=green!5!white, colframe=green!75!black,
    title=\textbf{The 9C Integration Structure}]
...
\label{sec:8c-connect}
%==============================================================================

The 9C CORE Framework \emph{extends} the four concepts introduced in
...
\begin{tabular}{@{}lll@{}}
\toprule
\textbf{Original Concept} & \textbf{9C Connection} & \textbf{What 9C Adds} \\
\midrule
Complementarity $C_{ij}$ & CORE-HOW ($\gamma$) & Level-specific $\gamma^L$ \\
Context $\Psi$ & CORE-WHEN & Systematic 8-dimension structure \\
Reference $C^*(\Psi)$ & All 9C & $C^*$ now includes WHO, WHAT \\
Coherence $K$ & All 9C & $K$ measures fit across all 8 \\
Change dynamics & CORE-STAGE & Temporal $S(t)$ trajectory \\
\bottomrule
\end{tabular}
\end{center}

The 9C Framework answers the question: \textbf{What determines $C^*$?}
...
\label{sec:8c-summary}
%==============================================================================

\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=\textbf{EBF: The 9C CORE Framework}]
...
\begin{itemize}[nosep]
    \item \textbf{WHO:} Appendix AAA (CORE-WHO) + Chapter 10.8
    \item \textbf{WHAT:} Appendix C (CORE-WHAT) + Chapter 10.2
    \item \textbf{HOW:} Appendix B (CORE-HOW) + Chapter 5
    \item \textbf{WHEN:} Appendix V (CORE-WHEN) + Chapter 9
    \item \textbf{WHERE:} Appendix BBB (CORE-WHERE) + Chapter 4x
    \item \textbf{AWARE:} Appendix AU (CORE-AWARE) + Chapter 11
    \item \textbf{READY:} Appendix AV (CORE-READY) + Chapter 12
    \item \textbf{STAGE:} Appendix AW (CORE-STAGE) + Chapter 13
\end{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% END OF CHAPTER 1b: THE 9C CORE ARCHITECTURE
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
