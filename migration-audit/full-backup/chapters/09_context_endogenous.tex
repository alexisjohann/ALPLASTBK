...
\begin{tcolorbox}[
    ...
    title={\textbf{9C CORE Connection: WHEN (Question 4)}},
    fonttitle=\bfseries
]
...
Appendix V provides measurement protocols and calibration values.
\end{tcolorbox}
...
\begin{itemize}
    ...
    \item Section \ref{sec:context-integration}: Integration with 9C framework
...
See Appendix V (CORE-WHEN) for the complete specification of all 8 Ψ-dimensions
...
\begin{cross-reference}
See Appendix AH (CONTEXT-TEMPORAL) for detailed temporal dynamics
and Appendix V (CORE-WHEN) for the complete speed hierarchy.
\end{cross-reference}
...
\begin{cross-reference}
See Appendix AI (CONTEXT-SPATIAL) for detailed spatial dynamics
...
\begin{cross-reference}
See Appendix AG (DOMAIN-COMPLEXITY) for detailed complexity economics integration
...
\begin{cross-reference}
See Appendix AAA (CORE-WHO) for the complete level hierarchy
...
\begin{cross-reference}
See Appendix V (CORE-WHEN), Section 8 for complete measurement protocols
and LLM-MC estimation methodology.
\end{cross-reference}


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                     PART XI: 9C INTEGRATION
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\end{itemize}
See Appendix AAA (CORE-WHO) for the complete level specification.
\end{cross-reference}
...
\end{equation}
See Chapter 5 and Appendix B (CORE-HOW) for the complementarity specification.
\end{cross-reference}
...
\end{itemize}
See Chapter 13 and Appendix AW (CORE-STAGE).
\end{cross-reference}
...
\bottomrule
\end{tabular}
\caption{Integration of WHEN (Context) with the 9C framework}
\label{tab:8c-context-integration}
\end{table}
...
\textbf{Reading Path:}
\begin{itemize}
    \item For complete Ψ-dimension specification: Appendix V (CORE-WHEN)
    \item For temporal context: Appendix AH (CONTEXT-TEMPORAL)
    \item For spatial context: Appendix AI (CONTEXT-SPATIAL)
    \item For complexity economics: Appendix AG (DOMAIN-COMPLEXITY)
    \item For welfare (next): Chapter 10 + Appendix C (CORE-WHAT)
\end{itemize}
\end{cross-reference}
