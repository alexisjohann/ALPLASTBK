...
\item[\textbf{Part II: HI CORE-HIERARCHY Formalization (Sections \ref{sec:ch15-part2a}--\ref{sec:ch15-part2d})}]
    Complete axiomatization (A1-A12), key theorems (T1-T15), and universal L2 formula. \textbf{Reference: Appendix HIE.}
...
\begin{itemize}[nosep]
    ...
    \item \textit{Theory first:} Read Part II (HI CORE-HIERARCHY) with Appendix HIE open
    \item \textit{By worked example:} Section \ref{sec:ch15-part4a} (Examples start here)
    \item \textit{Full understanding:} Read Part I → Part II (with Appendix HIE) → Part III → Part IV → Part V
\end{itemize}
...
From Appendix HIE, the Van den Steen (2017) framework defines a universal hierarchy. Each level is characterized by strategic interaction strength:
...
\begin{itemize}[nosep]
    \item \textbf{$\gamma_{avg}$ (complementarity):} How tightly are your decisions coupled? Use Appendix HOW complementarity matrix methodology. Range [0, 1].
...
→ patient accepts,'' removing the psychological cost of asking. See Appendix RB
...
Using Appendix HIE methodology, estimate:
...
\textbf{Monthly Checks (Tool C8---Appendix HIE):}
...
See **Appendix HIE (CORE-HIERARCHY)** for full axiomatization, proofs, and boundary conditions.
...
\begin{itemize}[nosep]
    \item \textbf{Appendix HIE (CORE-HIERARCHY):} Complete axiomatization (A1-A12), theorems (T1-T15), and formula derivation
    \item \textbf{Appendix PAP (FORMAL-INTERVENTION-EQUILIBRIA):} Equilibrium theory and stability diagnostics
    \item \textbf{Appendix REA (Willingness):} Full W11-W13 formalization
    \item \textbf{Appendix STA (BCJ):} Behavioral change journey phases and context modulation
    \item \textbf{Appendix HOW (CORE-HOW, Complementarity Levels):} Complementarity matrix methodology
