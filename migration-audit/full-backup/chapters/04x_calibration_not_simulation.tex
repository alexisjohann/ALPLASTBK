...
\textbf{Primary Appendix:} Appendix BBB (CORE-WHERE: Parameter Estimation)
\begin{itemize}[nosep]
...
\begin{itemize}[nosep]
    \item Appendix AN (LLM Monte Carlo): Simulation methodology
    \item Appendix E (Operationalization): Measurement protocols
    \item Appendix R (Evaluation): Validation framework
\end{itemize}

\textbf{Reading Guide:} This chapter explains \textit{why} calibration differs from simulation;
Appendix BBB provides the complete \textit{how} of parameter estimation.
...
\subsubsection{The EBF Alternative: Calibration on Behavioral Data}
...
\subsubsection{Why Experimental Replication Is Guaranteed}
