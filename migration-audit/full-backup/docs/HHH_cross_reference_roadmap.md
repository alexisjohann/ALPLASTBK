...
where $\gamma_{ij}$ is the complementarity coefficient from Appendix HOW (CORE-HOW, Definition B.3)
```
...
See Appendix HOW Table B.7 for calibrated values.
```
...
Appendix HHH Axiom HHH-A3 formalizes the critical alignment between
...
See also Appendix HHH Axiom HHH-A3 (Journey Phase Alignment):
