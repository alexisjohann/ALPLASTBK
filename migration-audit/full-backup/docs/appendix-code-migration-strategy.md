...
```latex
% Before
See Appendix AA for labor market applications
...
```
Appendix AA → Appendix LAB
[Appendix AA](../appendices/AA_labor.tex) → [Appendix LAB](../appendices/LAB_labor.tex)
```
...
# Expected: ~20 (only CORE/FORMAL like "Appendix C", "Appendix B" which are intentional)
...
**Q: What about existing cross-project references to "Appendix AA"?**
