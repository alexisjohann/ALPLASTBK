...
## Part 6: Connection to Appendix BB (Equilibria Framework)

### How Van den Steen + BB Create a Complete Framework

**Appendix BB provides:**
...
4. **Implementation (Appendix AV):** How do we ensure willingness at each layer?
...
- Appendix AW (BCJ-T36): Van den Steen as special case of BCJ
- Appendix B: Complementarity theory foundations
- Appendix BB: Equilibrium operationalization
