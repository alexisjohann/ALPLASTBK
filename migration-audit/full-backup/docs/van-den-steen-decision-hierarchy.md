...
## Part 6: Connection to Appendix PAP (Equilibria Framework)

### How Van den Steen + BB Create a Complete Framework

**Appendix PAP provides:**
...
4. **Implementation (Appendix REA):** How do we ensure willingness at each layer?
...
- Appendix STA (BCJ-T36): Van den Steen as special case of BCJ
- Appendix HOW: Complementarity theory foundations
- Appendix PAP: Equilibrium operationalization
