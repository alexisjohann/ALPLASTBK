...
|-------------|------------------------|
| Complementarity (Appendix HOW) | IS the mechanism that creates hierarchy |
| Decision layers (Ch15) | Are the L2 sub-decisions emanating from L1 roots |
| Coherence (Ch15) | Requires all L2 to reinforce L1 |
| Equilibrium (Appendix PAP) | Assumes L1-L2-L3 coherence; if incoherent, equilibrium degrades |
| Willingness (Appendix REA) | More likely when decision hierarchy is coherent |
