...
│ (Papers → 10C Context → Intervention Mix)                        │
├─────────────────────────────────────────────────────────────────┤
│ FOUNDATION: Papers + Cases + 10C Linking (Phases 1-4)            │
└─────────────────────────────────────────────────────────────────┘
```
...
Process: Theory-Driven Design
  ...
  │  ├─ Filter by mechanism relevance (10C match)
...
**Key Functions**:
- `find_similar_cases()` - Query case-registry by 10C match
...
```
Phase 1-2: Papers + 10C Annotation
    ↓
