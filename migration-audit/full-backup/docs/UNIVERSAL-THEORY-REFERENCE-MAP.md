...
└── Commits:
    ├── 9a11eec: Initial PSF 2.0 + Appendix PAP
...
#### **Appendix PAP: Cardinal Appointments as Structural Determinants**
```
...
**Key Insight**: Appendix PAP explains **HOW** appointments create the universal dimensions, not just **THAT** they do.
...
│   └── @misc{prevost2026psf}
│       └── Documents: Appendix PAP & gamma matrix
...
│   │   ├── Appendix PAP (Cardinal Appointments)
│   │   ├── Appendix PAP3 (Main Model)
│   │   ├── Appendix PAP2 (Historical Validation)
...
│   ├── Appendix PAP: Cardinal Appointments Theory
│   ├── GENERALIZATION-CHINESE-SUCCESSION.md
...
- [x] Appendix PAP provides theoretical foundation (cardinal appointments)
