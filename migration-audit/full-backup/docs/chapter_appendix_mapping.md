...
| Appendix | Name | Relevanz |
|----------|------|----------|
| **NC** | **FORMAL-NC: Non-Concavity, Fit, Coherence** | **Primärer Appendix** - Axiome NC-1 bis NC-4, K vs Q |
...
\begin{itemize}
    \item Appendix WAT (CORE-WHAT): Dimensionen pro Ebene
    \item Appendix HOW (CORE-HOW): Cross-Level Interaktionen
\end{itemize}

% In Appendix WAT (entsprechend):
\textbf{Cross-References:}
\begin{itemize}
    \item Appendix WHO (CORE-WHO): Level-spezifische Dimensionen
\end{itemize}
```
...
\begin{itemize}[nosep]
    \item Appendix FND: Grund
    \item Appendix CIA: Grund
\end{itemize}
