...
\title{\textbf{Appendix BNK: DOMAIN-BANK-STRATEGIC-DECISIONS} \\ Strategic Bank Decision-Making System (SBDMS) 1.0 \\ Evidence-Based Framework for Global Bank Leadership}
...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=Quick Reference: Appendix BNK]
...
\begin{tcolorbox}[colback=yellow!5!white,colframe=yellow!75!black,title=Axiom BNK-1: Fundamental Principle]
\textbf{Axiom BNK-1 (Core Assumption):}
...
\begin{tcolorbox}[colback=yellow!5!white,colframe=yellow!75!black,title=Axiom BNK-2: Complementarity]
\textbf{Axiom BNK-2 (Complementarity):}
...
\begin{table}[htbp]
\centering
\caption{Key Symbols in Appendix BNK}
\begin{tabular}{lll}
\toprule
