...
\title{Appendix PAP: Formal Framework for Intervention Equilibria and Tipping Points}
...
Following Appendix FRM (LIT-FEHR-METHOD), we note:
...
\begin{itemize}[nosep]
    \item LIT-FEHR-METHOD $\rightarrow$ Appendix FRM
    \item METHOD-TOOLKIT $\rightarrow$ Appendix HHH
    \item FORMAL-NC $\rightarrow$ Appendix NC
    \item Willingness $\rightarrow$ Appendix AV
\end{itemize}
...
This Appendix PAP provides the \textbf{diagnostic and strategic foundation}:

\begin{enumerate}
    \item \textbf{Phase 1 – Characterize Your Context (Appendix PAP):}
    \begin{itemize}
    ...
    \item \textbf{Phase 3 – Understand Journey Dynamics (Chapter 13 / Appendix STA):}
    \begin{itemize}
...
See \textbf{Appendix GLS} (\textit{Glossary and Notation}) for comprehensive definitions.
...
\begin{itemize}[nosep]
    ...
    \item W11, W12, W13 --- Dynamic Modulation Axioms (from Appendix REA)
\end{itemize}
...
\begin{itemize}
    \item Appendix REA: Willingness Formalization (W11-W13)
    \item Appendix STA: Behavioral Change Journey (5-stage model)
