...
\textbf{In-Scope:}
\begin{itemize}[nosep]
    \item Appendix EST: The Epistemics of Parameter Estimation
    \item Theory
    \item Results
\end{itemize}
...
\begin{itemize}[nosep]
    \item CORE-HOW: $\Gamma$ structure $\rightarrow$ Appendix HOW
    \item CORE-WHEN: $\Psi$ dimensions $\rightarrow$ Appendix CTW
    \item Empirical Operationalization $\rightarrow$ Appendix OPS
...
\section{Appendix EST: The Epistemics of Parameter Estimation}
...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=\textbf{Appendix EST: CORE-WHERE}]
...
\textbf{Dependencies:} & Appendix HOW (CORE-HOW: $\Gamma$ structure) \\
...
connecting Appendix LLM1 (LLM Monte Carlo), Appendix OPS (Empirical Operationalization),
...
\midrule
\textbf{Tier 1} & Hard Empirical & Direct measurement, RCTs, natural experiments & Highest & Appendix OPS \\
...
\subsubsection{Axiom Index for Appendix EST}
...
\bottomrule
\end{tabular}
\caption{Axiom index for Appendix EST}
...
\begin{table}[htbp]
\centering
\caption{Summary of Key Results in Appendix EST}
...
\midrule
$\gamma_{dd'}$ & Utility-utility complementarity & Appendix HOW \\
...
\textbf{See also:} Appendix GLS (Central Glossary and Notation) for complete symbol definitions; Appendix XX (METHOD-EVIDENCE) for evidence tier classification criteria.
...
The Level-$k$ distribution provides the following constraints for Appendix AWA parameters:
...
\begin{itemize}[nosep]
    \item \textbf{Appendix AWA:} Uses Level-$k$ $\leftrightarrow$ $A(\cdot)$ mapping for AWX axioms
    \item \textbf{Appendix EXP:} Beauty Contest experiments in Paradigm 8 (Beliefs)
    \item \textbf{Appendix MSC:} Full treatment of Mauersberger \& Nagel (2018), Section 11
\end{itemize}
...
\subsection{References for Appendix EST}
...
\textbf{Depends on:}
\begin{itemize}[nosep]
    \item Appendix HOW (CORE-HOW): $\Gamma$ complementarity structure
    \item Appendix WAT (CORE-WHAT): FEPSDE dimensions for $\gamma_{dd'}$
...
\begin{itemize}[nosep]
    ...
    \item Appendix SUN (PREDICT): Parameters for falsifiable predictions
    \item Appendix VC (METHOD-VALIDATE): Parameter consistency validation (DCV-3, DCV-4)
\end{itemize}

\textbf{Reading Path:}
$\rightarrow$ Chapter 4 (overview) $\rightarrow$ This Appendix (methodology)
$\rightarrow$ Appendix LLM1 (LLM-MC details) $\rightarrow$ Appendix OPS (data sources)
