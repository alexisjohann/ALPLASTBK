...
\chapter*{Appendix MM: Michel Maréchal Research Integration}
\addcontentsline{toc}{chapter}{Appendix MM: LIT-MARECHAL - Honesty \& Corporate Culture}
\label{app:marechal}
...
\begin{itemize}
    ...
    \item Appendix FI (LIT-FISCHBACHER): Experimental methodology
    \item Appendix V (CORE-WHEN): Context dependence $\Psi$
...
\begin{itemize}
    ...
    \item Appendix AN (METHOD-LLMMC): Cross-cultural estimation
\end{itemize}
\end{tcolorbox}
...
\begin{itemize}[nosep]
    ...
    \item LIT-FISCHBACHER $\rightarrow$ Appendix FI
...
\begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=Axiom MM-1: Corporate Culture Effect]
...
\begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=Axiom MM-2: Identity Priming Effect]
...
\begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=Axiom MM-3: Civic Honesty Universality with Variation]
...
\begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=Axiom MM-4: Neural Basis of Honesty]
...
\begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=Axiom MM-5: Lab-Field Predictive Validity]
...
\begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=Axiom MM-6: Honesty-Cognition Link]
