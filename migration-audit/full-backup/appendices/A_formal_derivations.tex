...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=\textbf{Appendix A: FORMAL-LIMITS}]
...
\begin{table}[htbp]
\centering
\caption{Summary of Formal Results in Appendix A}
\label{tab:A-results}
\renewcommand{\arraystretch}{1.2}
...
$\rightarrow$ Appendix B (complementarity details) $\rightarrow$ Appendix D (proofs)
