...
% - Appendix GLS (REF-GLOSSARY): Standard terminology
%
% DEPENDENTS (what REQUIRES this appendix):
% - Quality management system: Document style validation
% - Appendix DTE (REF-DOCTYPE): Computational complement to theory
%
% =============================================================================
...
\begin{itemize}[nosep]
    ...
    \item REF-DOCTYPE $\rightarrow$ Appendix DTE
    \item Central Glossary $\rightarrow$ Appendix GLS
    \item CORE-WHEN $\rightarrow$ Appendix CTW
    \item REF-DOCTYPE --- theoretical foundations $\rightarrow$ Appendix DTE
\end{itemize}
...
generate the required structural elements (see Appendix DTE, Axioms DT-5 and DT-6).
...
class DocumentStructure:
    ...
    DT-6 (Structural Element Rules) from Appendix DTE.
    """
...
Given a document type vector $\mathcal{D} = (D_1, ..., D_8)$, we can deterministically
generate appropriate style parameters (see Appendix DTE, Axioms DT-7 and DT-8).
...
class DocumentStyle:
    ...
    DT-8 (Style Parameter Rules) from Appendix DTE.
    """
...
word class constraints (see Appendix DTE, Axiom DT-9).
...
class DocumentVocabulary:
    ...
    Implements Axiom DT-9 (Vocabulary Emergence) from Appendix DTE.
    """
...
\textbf{Rule AUT-1 (Format Selection):}
\begin{equation}
...
\begin{tcolorbox}[colback=green!5!white, colframe=green!75!black,
    title=Axiom AUT-1: Output Completeness]
...
\item Output format is determined by Rules AUT-1, AUT-2
...
\begin{tcolorbox}[colback=green!10!white, colframe=green!75!black,
    title=\textbf{Appendix DTC: Summary}]
...
\begin{table}[htbp]
\centering
\caption{Symbols Introduced in Appendix DTC}
...
Appendix DTE (REF-DOCTYPE --- theoretical foundations).
