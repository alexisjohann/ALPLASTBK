...
% - Appendix BF (DOMAIN-SOCIALDEMOCRACY): 10 normative principles as baseline
% - Appendix CJ (FORMAL-BELIEFARCHITECTURE): Sabatier ACF hierarchy
% - Appendix CK (FORMAL-BELIEFOPPOSITIONS): Coalition Possibility Frontier
% - Appendix A (LIT-FEHR): Ernst Fehr fairness research
%
% DEPENDENTS (what REQUIRES this appendix):
% - Chapter 11+: Voter behavior under incoherence
% - Appendix AW (CORE-STAGE): Behavioral change journey stages
...
\item For Sabatier architecture: See Appendix CJ before reading Section \ref{sec:cm-integration}
\end{itemize}
...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=Quick Reference: Appendix CM]
...
\textit{stated} Policy Core (Appendix CJ: Sabatier layer 2) and \textit{actual} Secondary
...
Appendix BF (10 principles), CJ (belief hierarchy), CK (CPF), A (Fehr), AW (stages)
...
The existing framework (Appendix CJ: Sabatier ACF) explains \textit{how} belief systems are organized
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom CM-1: Fairness Archetypes are Universal]
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom CM-2: Childhood Fairness Violations Have 2× Amplification]
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom CM-3: Incoherence Detection Threshold}
...
\textbf{Cross-reference:} Axiom CJ-8 (Sabatier: Secondary Belief adaptivity), Axiom CK-5 (CPF constraints).
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom CM-4: Media Amplification Mechanism]
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom CM-5: Intergenerational Fairness Constraint}
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom CM-9: Intra-Archetype Conflicts Under Design Lock]
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom CM-10: Institutional Lag and Media Gatekeeping Collapse]
...
We now apply Axioms CM-1 through CM-5 (and CM-7c, CM-7d, CM-9, CM-10) to construct the Austrian fairness alignment matrix.
...
\item Media regulation promises made but \textbf{not implemented} (Axiom CM-3 violation: $\Delta = 0.60$)
\end{itemize}
...
\textbf{The Four Fairness-Violation Frames (Axiom CM-9 activation):}
...
\textbf{Mathematical Formulation of Design Lock (Axiom CM-9):}
...
\textbf{SPÖ's Communication Trap (Axiom CM-9 Political Consequence):}
...
\textbf{FPÖ's Exploitation (Axiom CM-7c + CM-9 Combined):}
...
\subsection{Connection to Appendix BF: DOMAIN-SOCIALDEMOCRACY}
...
\begin{tcolorbox}[colback=yellow!5!white, colframe=yellow!75!black,
    title=Integration: Appendix CM $\leftrightarrow$ Appendix BF]
...
\subsection{Connection to Appendix CJ: FORMAL-BELIEFARCHITECTURE (Sabatier ACF)}
...
\begin{tcolorbox}[colback=yellow!5!white, colframe=yellow!75!black,
    title=Integration: Appendix CM $\leftrightarrow$ Appendix CJ (Sabatier)]
...
\subsection{Connection to Appendix CK: FORMAL-BELIEFOPPOSITIONS (Coalition Possibility Frontier)}
...
\begin{tcolorbox}[colback=yellow!5!white, colframe=yellow!75!black,
    title=Integration: Appendix CM $\leftrightarrow$ Appendix CK (CPF)}
...
\begin{enumerate}
\item \textbf{Incoherence does not destabilize immediately.} Violations of Axiom CM-3 ($\Delta \geq 0.25$)
...
\begin{tcolorbox}[colback=green!10!white, colframe=green!75!black,
    title=\textbf{Appendix CM: Summary}]
...
This appendix connects Appendix BF (normative principles operationalized as fairness metrics),
...
See Appendix AW (Behavioral Change Journey) for how fairness salience drives stage transitions
in voter decision-making. See Appendix BH (Context-SPÖ Paradox) for detailed Austrian media
...
\begin{table}[htbp]
\centering
\caption{Symbols in Appendix CM}
...
Axiom CM-3 claims threshold $\Delta^* \approx 0.25$ but provides no principled derivation.
...
\subsection{CM's Integration: How Axioms CM-1 through CM-11 Connect the Five Streams}

\subsubsection{Integration Mechanism 1: Fairness as Voter Detection System}

Axioms CM-1 through CM-5 translate Fehr's fairness archetypes into a \textit{voter coherence detection mechanism}.
...
Axioms CM-3 through CM-4 integrate ACF's belief hierarchy with Fehr's fairness archetypes.
...
Axioms CM-9 and CM-10 integrate path dependency with fairness dynamics.
...
Axiom CM-10 integrates institutional rigidity with media technology change.
...
\subsection{Axiom CM-11: System-Level Design Lock --- Multiple Policies Simultaneously Incoherent}

\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom CM-11: System-Level Design Lock and Political Inescapability]
...
\begin{table}[htbp]
\centering
\caption{Research Roadmap for Appendix CM: Developmental Fairness}
...
Appendix BF (DOMAIN-SOCIALDEMOCRACY: 10 principles),
Appendix CJ (FORMAL-BELIEFARCHITECTURE: Sabatier ACF),
Appendix CK (FORMAL-BELIEFOPPOSITIONS: Coalition Possibility Frontier),
Appendix A (LIT-FEHR: Ernst Fehr research),
Appendix AW (CORE-STAGE: Behavioral journey stages),
Appendix BH (CONTEXT-SPÖ PARADOX: Austrian media timeline),
