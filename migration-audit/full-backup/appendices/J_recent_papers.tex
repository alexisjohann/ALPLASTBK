...
% - Appendix I (LIT-NOBEL): Retrospective Nobel integration
%
...
\item For retrospective analysis: See Appendix I (LIT-NOBEL)
...
(Appendix I), these papers were published \emph{after} the framework was
...
\textbf{Cross-References:} Appendix I (LIT-NOBEL), Appendix B (CORE-HOW),
Appendix V (CORE-WHEN), Appendix C (CORE-WHAT)
\end{tcolorbox}
...
but future research as well. While retrospective integration (Appendix I)
...
which equilibrium ($C^*$) is selected. Links directly to Appendix Y
...
Links to FEPSDE dimension structure in Appendix C.
\end{tcolorbox}
...
\begin{tcolorbox}[colback=green!10!white, colframe=green!75!black,
    title=\textbf{Appendix J: Summary}]
...
\textbf{Integration:} This appendix connects to Appendix I (LIT-NOBEL) as
...
\begin{table}[htbp]
\centering
\caption{Symbols Introduced in Appendix J}
\label{tab:J-symbols}
\renewcommand{\arraystretch}{1.3}
...
Appendix I (LIT-NOBEL: Retrospective Integration),
Appendix B (CORE-HOW: Complementarity),
Appendix V (CORE-WHEN: Context),
Appendix C (CORE-WHAT: Welfare Dimensions).
