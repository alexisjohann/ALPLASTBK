...
% - Appendix MS (REF-MODELSPACE): Theory catalog
...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=Quick Reference: Appendix VB]
...
\begin{itemize}[nosep]
    ...
    \item Theory definitions $\rightarrow$ Appendix MS (REF-MODELSPACE)
...
\begin{itemize}[nosep]
\item Case CAS-903 in Case Registry
\item Axiom RB-11 in LIT-BENABOU appendix
...
\begin{tcolorbox}[colback=green!10!white, colframe=green!75!black,
    title=\textbf{Appendix VB: Summary}]
...
\begin{table}[htbp]
\centering
\caption{Symbols Introduced in Appendix VB}
...
Appendix MS (Theory Catalog),
Appendix RB (LIT-BENABOU).
