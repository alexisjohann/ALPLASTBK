...
\begin{tcolorbox}[colback=yellow!5!white, colframe=yellow!75!black,
    title=Axiom P02-1: Spillover Dynamics]
\textbf{Axiom P02-1 (Spillover Principle):}
...
\begin{tcolorbox}[colback=yellow!5!white, colframe=yellow!75!black,
    title=Axiom P02-2: Asymmetric Timing]
\textbf{Axiom P02-2 (Timing Asymmetry):}
...
\begin{table}[htbp]
\centering
\caption{Key Symbols in Appendix P02}
\begin{tabular}{lll}
\toprule
