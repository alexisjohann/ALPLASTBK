...
%
% Cross-References:
%   - Appendix CIA (LIT-Fehr): Ernst Fehr's foundational work (co-author with Gächter)
%   - Appendix DUF (LIT-Cialdini): Social influence and norms
%   - Appendix HOW (CORE-HOW): Complementarity mechanisms (Gächter's work on γ)
...
\title{Appendix GCR: LIT-GAECHTER \\
...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=Quick Reference: Appendix GCR]
...
\begin{itemize}
    \item Appendix CIA (LIT-Fehr): Complementary work on strong reciprocity
    \item Appendix DUF (LIT-Cialdini): Social norms and influence
    \item Appendix HOW (CORE-HOW): Complementarity mechanisms (γ values)
    \item Appendix WAT (CORE-WHAT): Multidimensional utility (social preferences)
\end{itemize}
...
\begin{table}[htbp]
\centering
\caption{Key Symbols in Appendix GCR}
\begin{tabular}{lll}
\toprule
