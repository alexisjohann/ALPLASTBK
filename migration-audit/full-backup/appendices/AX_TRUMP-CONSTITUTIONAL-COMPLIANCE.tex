...
\title{\textbf{Appendix AX: DOMAIN-TRUMP} \\ Trump Constitutional Compliance Decision Model \\ Two-Stage Behavioral Analysis 2025--2030}
...
\subsection{1.3 9C CORE Mapping}

\begin{table}[h]
\centering
\begin{tabular}{|c|c|c|}
\hline
\textbf{9C Dimension} & \textbf{Trump Context} & \textbf{Appendix Reference} \\
\hline
...
\subsection{7.1 Connection to Appendix AAA (WHO: Welfare Hierarchy)}
...
\subsection{7.2 Connection to Appendix C (WHAT: Complementarity)}
...
\subsection{7.3 Connection to Appendix V (WHEN: Context Modulation)}
...
\subsection{7.4 Connection to Appendix AU (AWARE: Consciousness)}
