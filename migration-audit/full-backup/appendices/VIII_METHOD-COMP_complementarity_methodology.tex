...
% HEADER BLOCK
% ----------------------------------------------------------------------------
\begin{tcolorbox}[colback=orange!5!white,colframe=orange!75!black,title=\textbf{Appendix VIII: METHOD-COMP}]
...
\textbf{Theoretical Foundation:} Appendix VII (FORMAL-GTC) establishes \textit{what} complementarities are and \textit{why} they must be consistent. This appendix establishes \textit{how} to measure them.
...
\begin{itemize}[noitemsep]
    ...
    \item Appendix D: Mathematical Formalization
\end{itemize}

\textbf{Application Domains:}
\begin{itemize}[noitemsep]
    \item Appendix V (MEP): Portfolio optimization using $\gamma$
    \item Appendix VI (MEQ): Equilibrium analysis using $\gamma$
    \item Appendix HHH: Intervention Toolkit
\end{itemize}

\textbf{Estimation Infrastructure:}
\begin{itemize}[noitemsep]
    \item Appendix BBB: Parameter Repository
    \item Appendix AN: LLM Monte Carlo Methods
    \item Appendix E: Empirical Validation
\end{itemize}
\end{tcolorbox}
...
Appendix AN introduces \textbf{LLM Monte Carlo} for estimating $\gamma$ via language models:
...
Following Appendix VII (GTC), we have six complementarity types requiring distinct measurement approaches:
...
Segment & $\gamma^S$ & Clustering methods & Appendix BA \\
...
\begin{itemize}[noitemsep]
    \item Search Appendix BBB (Parameter Repository)
...
From Appendix BBB and meta-analyses:
\begin{itemize}
