...
\begin{itemize}[nosep]
\item Appendix HHH (METHOD-TOOLKIT): Operationalizes EIH through 20-field schema
\item Appendix BC (FORMAL-PROBABILITY): EIH modifies $P(i \to j)$
\item Appendix AW (CORE-STAGE): Journey alignment condition
\item Appendix BA (FORMAL-SEGMENT): Segment efficiency condition
\item Appendix B (CORE-HOW): Complementarity condition
\end{itemize}
...
\textbf{Cross-References:} HHH (Axioms HHH-3, HHH-4, HHH-5), BC (Axiom P11), B ($\gamma$-matrix)
\end{tcolorbox}
...
is the context adjustment factor from Appendix V.
\end{definition}
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=EIH Condition 1: Journey Alignment (from HHH Axiom HHH-3)]
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=EIH Condition 2: Segment Fit (from HHH Axiom HHH-5)]
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=EIH Condition 3: Portfolio Complementarity (from HHH Axiom HHH-4)]
...
\begin{itemize}[nosep]
\item Use Appendix AW diagnostic tools
...
\begin{itemize}[nosep]
\item Use Appendix BA segmentation
...
\item Check $\gamma_{ij}$ for each pair (Appendix B, HHH Table)
...
\begin{tcolorbox}[colback=green!10!white, colframe=green!75!black,
    title=\textbf{Appendix III Summary: The Efficient Intervention Hypothesis}]
...
\begin{table}[htbp]
\centering
\caption{Symbols Introduced in Appendix III}
