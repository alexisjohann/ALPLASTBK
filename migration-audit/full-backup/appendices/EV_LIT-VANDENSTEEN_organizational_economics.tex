...
\subsection{Axiom EV-1: Culture as Shared Beliefs}

\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black]
\textbf{Axiom EV-1 (Culture Definition):}
...
\subsection{Axiom EV-2: Vision and Leadership}

\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black]
\textbf{Axiom EV-2 (Vision Effect):}
...
\subsection{Axiom EV-3: Sorting and Homogeneity}

\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black]
\textbf{Axiom EV-3 (Sorting Mechanism):}
...
\subsection{Axiom EV-4: Strategy as Complementarity}

\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black]
\textbf{Axiom EV-4 (Strategy Coherence):}
...
\subsection{Axiom EV-5: Rational Overoptimism}

\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black]
\textbf{Axiom EV-5 (Belief Bias):}
...
\subsection{Axiom EV-6: Authority and Delegation}

\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black]
\textbf{Axiom EV-6 (Authority Allocation):}
...
\begin{enumerate}
    \item \textbf{EV-1 (Culture as Beliefs):} Current culture = shared beliefs
    about ``how we work here.'' Must change beliefs, not just practices.

    \item \textbf{EV-3 (Sorting):} New hires will self-select based on perceived
    culture. To change culture, must signal new beliefs to attract different people.

    \item \textbf{EV-2 (Vision):} Leaders must articulate clear vision of new
    culture to coordinate expectations.

    \item \textbf{EV-6 (Authority):} Agile requires different authority allocation---
    more delegation, less hierarchy.
\end{enumerate}

\textbf{EBF Prediction:}
\begin{equation}
P(culture\_change) = f(\underbrace{Vision_{clarity}}_{\text{EV-2}},
\underbrace{Turnover_{rate}}_{\text{EV-3}},
\underbrace{Authority_{reallocation}}_{\text{EV-6}})
\end{equation}
