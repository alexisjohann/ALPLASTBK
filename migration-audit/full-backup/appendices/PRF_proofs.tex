...
\begin{itemize}[nosep]
    \item CORE-HOW: $\Gamma$-matrix $\rightarrow$ Appendix HOW
...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=\textbf{Appendix PRF: FORMAL-CSTAR}]
...
\textbf{Dependencies:} & Appendix HOW (CORE-HOW: $\Gamma$-matrix) \\
...
\begin{itemize}[nosep]
    ...
    \item For $\Gamma$-matrix foundations: See Appendix HOW (CORE-HOW)
\end{itemize}
...
\subsubsection{Connection to Appendix HOW}

Appendix HOW (CORE-HOW) defines the complementarity matrix $\Gamma = [\gamma_{dd'}]$
...
\begin{table}[htbp]
\centering
\caption{Summary of Formal Results in Appendix PRF}
\label{tab:D-results}
...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=\textbf{Appendix PRF Summary: FORMAL-CSTAR}]
...
on learning supports such convergence \citep{PAP-camerer2003behavioral}.
...
\subsection{References for Appendix PRF}
...
\textbf{Depends on:}
\begin{itemize}[nosep]
    \item Appendix HOW (CORE-HOW): $\Gamma$-matrix foundations
...
\begin{itemize}[nosep]
    ...
    \item Chapter 7: Coherence Dynamics (applies $K$ measure)
    \item Appendix EST: Calibration of $C^*(\Psi)$
\end{itemize}

\textbf{Reading Path:}
$\rightarrow$ Chapter 6 (intuition) $\rightarrow$ This Appendix (formal)
$\rightarrow$ Appendix HOW (complementarity) $\rightarrow$ Appendix EST (calibration)
