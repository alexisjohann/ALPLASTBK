...
\begin{itemize}[nosep]
    ...
    \item Behavioral Game Theory $\rightarrow$ Appendix SPC
\end{itemize}
...
\begin{itemize}[nosep]
    \item Appendix WAT (CORE-WHAT): Social dimension in FEPSDE
    \item Appendix CTW (CORE-WHEN): $\Psi_S$ modulation
    \item Appendix FEH (Fehr Papers): Primary literature
\end{itemize}
...
\textbf{Cross-Reference:} Appendix MSC Section 11 (full BC treatment),
Appendix SPC (Behavioral Game Theory), Appendix HOW (Complementarity).
...
\begin{itemize}[nosep]
    \item Appendix FEH (Fehr Papers): Complete Fehr research integration
    \item Appendix SPC (Behavioral GT): Social preferences in games
    \item Appendix CTW (CORE-WHEN): $\Psi_S$ as context dimension
    \item Appendix MSC Section 11: BC-isomorphism of social games
\end{itemize}
