...
% - Appendix AN (METHOD-LLMMC): LLM-based measurement methodology
% - Appendix G (REF-GLOSSARY): Standard terminology
%
% DEPENDENTS (what REQUIRES this appendix):
% - Quality management system: Document style validation
% - Appendix DDD (REF-DOCTYPE): Computational complement to theory
%
% =============================================================================
...
Following the methodology in Appendix AN (METHOD-LLMMC), we can use LLMs
...
generate the required structural elements (see Appendix DDD, Axioms DT-5 and DT-6).
...
class DocumentStructure:
    ...
    DT-6 (Structural Element Rules) from Appendix DDD.
    """
...
Given a document type vector $\mathcal{D} = (D_1, ..., D_8)$, we can deterministically
generate appropriate style parameters (see Appendix DDD, Axioms DT-7 and DT-8).
...
class DocumentStyle:
    ...
    DT-8 (Style Parameter Rules) from Appendix DDD.
    """
...
word class constraints (see Appendix DDD, Axiom DT-9).
...
class DocumentVocabulary:
    ...
    Implements Axiom DT-9 (Vocabulary Emergence) from Appendix DDD.
    """
...
\textbf{Rule O-1 (Format Selection):}
\begin{equation}
...
\begin{tcolorbox}[colback=green!5!white, colframe=green!75!black,
    title=Axiom O-1: Output Completeness]
...
\item Output format is determined by Rules O-1, O-2
...
applies the Monte Carlo methodology from Appendix AN. Key adaptations:
...
\begin{tcolorbox}[colback=green!10!white, colframe=green!75!black,
    title=\textbf{Appendix CCC: Summary}]
...
\begin{table}[htbp]
\centering
\caption{Symbols Introduced in Appendix CCC}
...
Appendix DDD (REF-DOCTYPE --- theoretical foundations).
