...
\begin{itemize}[nosep]
\item Appendix BI (SDM-1.0): Implementation of chosen strategy
\item Appendix B (Complementarities): Theoretical foundation for γ-matrix
\item Appendix BBB (Parameter Repository): Parameter values and calibration
\end{itemize}
...
\item For implementation after choice: See SDM-1.0 (Appendix BI)
\end{itemize}
...
\textbf{Cross-References:} Appendix B (Complementarities), Appendix BI (SDM-1.0 Implementation), Appendix BBB (Parameter Repository)
...
\begin{tcolorbox}[colback=yellow!5!white, colframe=yellow!75!black,
    title=Integration: SOCM $\leftrightarrow$ Appendix B (Complementarities)]
...
\begin{tcolorbox}[colback=green!10!white, colframe=green!75!black,
    title=Appendix BJ: Strategy Option Comparison Model v1.0 --- Summary]
...
\begin{table}[htbp]
\centering
\caption{Symbols Introduced in Appendix BJ (SOCM)}
...
Appendix BI (SDM-1.0: Implementation),
