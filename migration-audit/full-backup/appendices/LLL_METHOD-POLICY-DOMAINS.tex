...
\newpage
\section*{Appendix LLL: METHOD-POLICY-DOMAINS}
\label{app:method-policy-domains}
\addcontentsline{toc}{section}{Appendix LLL: METHOD-POLICY-DOMAINS}
...
\midrule
6 & Ignoring spillovers; designing domain-by-domain & Use Appendix MMM to check coherence \\
...
\item Appendix HHH (METHOD-TOOLKIT): Coherence criteria and quickstart
\item Appendix MMM (METHOD-POLICY-COHERENCE): Cross-domain spillover analysis
\end{itemize}

\textbf{For Theory:}
\begin{itemize}[nosep]
\item Appendix KKK (METHOD-DYNAMIC): Formal models for phase progression, Bayesian learning
\item Appendix JJJ (METHOD-PSG): Parameter sourcing discipline for your domain
\item Appendix BBB (CORE-WHERE): Parameter repository with literature values
\end{itemize}
...
\begin{table}[htbp]
\centering
\caption{Key Symbols in Appendix LLL}
\begin{tabular}{lll}
\toprule
...
\vspace{2cm}
\begin{center}
{\large \textbf{End of Appendix LLL: METHOD-POLICY-DOMAINS}} \\
\vspace{0.5cm}
{\small \textit{For cross-domain coherence analysis, see Appendix MMM}}
\end{center}
