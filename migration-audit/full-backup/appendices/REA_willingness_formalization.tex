...
%------------------------------------------------------------------------------
\begin{tcolorbox}[
  title={\textbf{Die 9 Fragen des EBF — Appendix REA Formalisierung}},
  colback=green!3,
...
\begin{tabular}{@{}p{0.75\textwidth}r@{}}
$\circ$~0. Kontext und Zielverhalten & [Chapter 6, Appendix AWA] \\
$\circ$~2. Welchen Nutzen? & [Chapter 10] \\
$\circ$~3. Wie nimmt er/sie wahr? & [Chapter 11, Appendix AWA] \\
...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=\textbf{Appendix REA: CORE-READY}]
...
\textbf{Dependencies:} & Appendix AWA (CORE-AWARE: Awareness function) \\
                       & Appendix WAT (CORE-WHAT: Dimension-specific willingness) \\
                       & Appendix HOW (CORE-HOW: Complementarity) \\
                       & Appendix CTW (CORE-WHEN: Context $\Psi$) \\
                       & Appendix EST (CORE-WHERE: Threshold calibration) \\
\textbf{Feeds into:}   & Appendix STA (CORE-STAGE: Phase transitions) \\
...
\section*{Appendix REA: CORE-READY — The Willingness Function}
\addcontentsline{toc}{section}{Appendix REA: CORE-READY — The Willingness Function}
...
\begin{itemize}[nosep]
    \item CORE-AWARE: Awareness function $\rightarrow$ Appendix AWA
    \item CORE-WHAT: Dimension-specific willingness $\rightarrow$ Appendix WAT
    \item CORE-HOW: Complementarity $\rightarrow$ Appendix HOW
    \item CORE-WHEN: Context $\Psi$ $\rightarrow$ Appendix CTW
    \item CORE-WHERE: Threshold calibration $\rightarrow$ Appendix EST
\end{itemize}
...
axioms, following the 8-factor structure established in Appendix AWA for Awareness axioms.
...
\begin{itemize}
\item \textbf{North (1990)}: Nobel laureate's foundational work establishing that institutions fundamentally shape economic behavior and cooperation \cite{PAP-north1990institutions}.
...
\begin{table}[htbp]
\centering
\caption{Summary of Key Results in Appendix REA}
...
$AWX$ & Awareness function & Appendix AWA \\
...
\textbf{See also:} Appendix GLS (Central Glossary and Notation) for complete symbol definitions across all EBF appendices.
...
\section{References for Appendix REA}
\label{sec:av-references}
...
\begin{itemize}[nosep]
    ...
    \item Appendix AWA (CORE-AWARE): Awareness function $A(\cdot)$
\end{itemize}
...
\textbf{Reading Path:}
$\rightarrow$ Appendix AWA (awareness) $\rightarrow$ This Appendix (willingness)
