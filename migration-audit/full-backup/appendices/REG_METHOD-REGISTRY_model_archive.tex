...
% - Appendix DSN (METHOD-DESIGN): Defines model structure and workflow
% - Appendix EST (CORE-WHERE): Parameter source documentation
% - All DOMAIN- appendices: Domain-specific model attributes
%
% DEPENDENTS (what REQUIRES this appendix):
% - Appendix DSN (METHOD-DESIGN): Draws 3+1 options from Registry
...
\textbf{Reading Guide:}
\begin{itemize}[nosep]
\item For model design process: Read Appendix DSN first
\item For storage structure: This appendix provides complete specification
\item For parameter sources: See Appendix EST (CORE-WHERE)
\end{itemize}
...
Choice Architecture (Axiom MD-2 in Appendix DSN).
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom REG-1: Similarity Computation]
...
\begin{tcolorbox}[colback=yellow!5!white, colframe=yellow!75!black,
    title=Axiom REG-2: Cold Start Handling]
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom REG-3: Mandatory Validation Review]
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom REG-4: Complete Traceability]
...
\begin{tcolorbox}[colback=white, colframe=black,
    title=Example Registry Entry: SHL-2026-001]
\begin{verbatim}
identification:
  model_id: SHL-2026-001
...
\addlinespace
SEED-P06-01 & L=0 & 🇦🇹 & Gesundheit & Decision & Vorsorgeuntersuchung \\
SEED-P06-02 & L=0 & 🇦🇹 & Public & Decision & Steuer Compliance \\
\addlinespace
...
% ---------------------------------------------------------------------------
\subsection{Austria: SEED-P06-01 -- Preventive Health Screening}
% ---------------------------------------------------------------------------

\begin{tcolorbox}[colback=white, colframe=blue!50!black,
    title=SEED-P06-01: Vorsorgeuntersuchung Participation (Austria)]
\begin{verbatim}
identification:
  model_id: SEED-P06-01
  designer: "FehrAdvice Reference Team"
  created: 2026-01-01
  client: "Reference Model"
  project: "DACH Seed Repository"
...
% ---------------------------------------------------------------------------
\subsection{Austria: SEED-P06-02 -- Tax Compliance}
% ---------------------------------------------------------------------------

\begin{tcolorbox}[colback=white, colframe=blue!50!black,
    title=SEED-P06-02: Tax Declaration Timeliness (Austria)]
\begin{verbatim}
identification:
  model_id: SEED-P06-02
  designer: "FehrAdvice Reference Team"
  created: 2026-01-01
  client: "Reference Model"
  project: "DACH Seed Repository"
...
\begin{tcolorbox}[colback=green!10!white, colframe=green!75!black,
    title=\textbf{Appendix REG: Summary}]
...
\textbf{Key Axioms:}
\begin{itemize}[nosep]
    \item REG-1: Similarity Computation
    \item REG-2: Cold Start Handling
    \item REG-3: Mandatory Validation Review
    \item REG-4: Complete Traceability
\end{itemize}
...
\begin{table}[htbp]
\centering
\caption{Symbols Introduced in Appendix REG}
