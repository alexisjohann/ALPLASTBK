...
\title{\textbf{Appendix PAP: DOMAIN-PAPAL-APPOINTMENTS} \\ Cardinal Appointments as Structural Determinants of Papal Succession \\ Integration with PSF 2.0 Complementarity Parameters}
...
See Appendix GLS (Central Glossary) for full symbol definitions. \href{https://github.com/FehrAdvice-Partners-AG/complementarity-context-framework/appendices/G_glossary.tex}{Link to Appendix GLS}.
...
\begin{itemize}
\item Appendix PAP3: DOMAIN-PAPAL-SUCCESSION (PSF 2.0 framework)
\item Appendix PAP2: DOMAIN-PAPAL-HISTORICAL (validation across 7 conclaves)
...
$\Rightarrow$ Appendix PAP3 (PSF 2.0 Main Model) | Appendix PAP2 (Historical Validation) | Appendix PAP1 (Extended History) \\
