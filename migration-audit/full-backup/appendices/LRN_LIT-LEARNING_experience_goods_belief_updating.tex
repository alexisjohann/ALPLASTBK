...
\begin{itemize}[nosep]
    ...
    \item \textbf{Appendix PBB (FORMAL-PROBABILITY):} Empirical grounding for Axiom P7 (Learning Feedback)
    \item \textbf{Appendix AU (CORE-AWARE):} Literature on awareness and belief updating
...
\begin{itemize}[nosep]
    ...
    \item \textbf{Appendix BBB (CORE-WHERE):} Parameter estimates from learning studies
\end{itemize}
\end{tcolorbox}
...
\begin{itemize}[nosep]
    ...
    \item FORMAL-PROBABILITY $\rightarrow$ Appendix PBB
...
This is \textbf{Axiom AU-3} in CORE-AWARE: ``First experience dominates subsequent information.''
...
The learning literature provides empirical estimates for EBF parameter repository (Appendix BBB):
...
\textbf{Axiom AU-3 (First Experience Dominance):}
\begin{equation}
...
\begin{itemize}[nosep]
    \item Grounds CORE-AWARE (AU): Axiom AU-3 (First Experience Dominance)
...
\begin{itemize}[nosep]
    ...
    \item \texttt{PAP-BeckerMurphy1988}: Rational addiction benchmark
    \item \texttt{PAP-Ackerberg2003}: Advertising and experience goods
    \item \texttt{PAP-Dupas2014}: Subsidies and learning
    \item \texttt{JonesMolitorReif2025}: Key habit formation identification
    \item \texttt{PAP-BanerjeeEtAl2021}: Preference discovery
    \item \texttt{HussamEtAl2022}: Frequency moderation
    \item \texttt{AllcottRogers2014}: Persistence estimation
\end{itemize}
...
Appendix PBB (FORMAL-PROBABILITY),
