...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=Quick Reference: Appendix BN]
...
\begin{itemize}[nosep]
    ...
    \item Behavioral scoring models $\rightarrow$ Appendix HHH (METHOD-TOOLKIT)
...
\begin{tcolorbox}[colback=green!10!white, colframe=green!75!black,
    title=\textbf{Appendix BN: Summary}]
...
\begin{table}[htbp]
\centering
\caption{Terms Introduced in Appendix BN}
...
\begin{itemize}[nosep]
    \item Manual workflow documented in Appendix BN and LEAD-ID-SYSTEM.md
