...
%
% =============================================================================
% CROSS-REFERENCE STRUCTURE: Appendix AU ↔ Chapter 11
% =============================================================================
%
...
%   Chapter 11 → Appendix AU: "See Appendix AU, Section X"
%   Appendix AU → Chapter 11: "See Chapter 11, Section 11.Y"
%
% CROSS-REFERENCE MAP:
% ┌────────────────────────────────────────────────────────────────────────────┐
...
% --- Cross-Reference Map (9C CORE Integration) ---
\begin{tcolorbox}[colback=purple!5!white, colframe=purple!50!black, title=Cross-Reference Map: 9C CORE Integration]
...
\begin{itemize}[nosep]
    \item Appendix AV (CORE-READY): Willingness formalization (WAX) depends on AWX outputs
    \item Appendix U (Kahneman-Tversky): Cognitive foundations for attention/salience
    \item \textbf{XVIII (LIT-FEHR-METHOD):} Exclusion Principle --- $\gamma = 0$ as null hypothesis
\end{itemize}
\textbf{Referenziert von:}
\begin{itemize}[nosep]
    \item Appendix AV: $W(\cdot) = f(A(\cdot))$ transformation
...
\textbf{Sources} & \citet{PAP-fehr1999fairness}; \citet{PAP-fehr2004social}; \citet{PAP-akerlof2000identity} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Sources} & \citet{PAP-fehr2003nature}; \citet{fehr2002altruistic} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Dependencies} & None (foundational axiom) \\
\textbf{Sources} & \citet{PAP-kahneman1979prospect}; \citet{PAP-tversky1981framing} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Sources} & \citet{PAP-tversky1981framing}; \citet{PAP-thaler1980toward} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Sources} & \citet{loewenstein2003projection}; \citet{loewenstein2001risk} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Dependencies} & AWX-A9 \\
\textbf{Sources} & \citet{PAP-tversky1973availability}; \citet{PAP-kahneman1979prospect} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Sources} & \citet{cialdini2004social}; \citet{fehr2002altruistic} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Dependencies} & AWX-A7 \\
\textbf{Sources} & \citet{acemoglu2012nations}; \citet{PAP-north1990institutions} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Dependencies} & AWX-A22 \\
\textbf{Sources} & \citet{PAP-north1990institutions}; \citet{ostrom1990governing} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Parameters} & None (structural equation) \\
\textbf{Dependencies} & AWX-A1 \\
\textbf{Sources} & \citet{PAP-kahneman1979prospect}; \citet{PAP-thaler1980toward} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Parameters} & None (structural equation) \\
\textbf{Dependencies} & AWX-A1 \\
\textbf{Sources} & \citet{PAP-fehr1999fairness}; \citet{PAP-fehr2004social} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Sources} & \citet{PAP-fehr1999fairness}; \citet{PAP-akerlof2000identity}; \citet{PAP-henrich2001search} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Sources} & \citet{PAP-fehr1999fairness}; \citet{charness2002understanding} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Sources} & \citet{PAP-fehr1999fairness}; \citet{PAP-kahneman2003maps} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Dependencies} & AWX-A34 \\
\textbf{Sources} & \citet{PAP-kahneman1979prospect}; \citet{PAP-fehr1999fairness} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Sources} & \citet{PAP-tversky1981framing}; \citet{PAP-kahneman1979prospect} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Sources} & \citet{PAP-north1990institutions}; \citet{acemoglu2005institutions} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Sources} & \citet{PAP-thaler2008nudge}; \citet{PAP-sunstein2014nudge}; \citet{benartzi2004save} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Sources} & \citet{PAP-fehr1999fairness}; \citet{PAP-henrich2001search}; \citet{heckman2006effects} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Sources} & \citet{fischbacher2001people}; \citet{kurzban2005experiments}; \citet{PAP-fehr1999fairness} \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{table}[htbp]
\centering
\caption{Summary of Key Results in Appendix AU}
...
See Appendix EV (Paradigm 8: Beliefs) and Appendix LIT-META (Section 11) for full treatment.
...
\section{References for Appendix AU}
...
\textbf{Required by:}
\begin{itemize}[nosep]
    \item Appendix AV (CORE-READY): $WAX = f(A(\cdot))$ transformation
...
$\rightarrow$ Appendix AV (willingness) $\rightarrow$ Chapter 12 (integration)
