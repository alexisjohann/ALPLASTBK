...
\item Appendix LET (THEORY-LET): Provides portfolio emergence $\mathcal{E}_{\mathcal{P}}$
\item Appendix HHH (METHOD-TOOLKIT): Provides intervention specification
\item Appendix PBB (FORMAL-PROBABILITY): Provides $P(i \to j | \mathcal{P})$
\item Appendix HIE (CORE-HIERARCHY): Provides decision level structure $L_0$--$L_3$
\end{itemize}
...
From Chapter 15 and Appendix PBB:
\begin{equation}
...
Integrating with Appendix HIE (CORE-HIERARCHY), we can specify interventions by
decision level:
...
\begin{tcolorbox}[colback=yellow!5!white,colframe=yellow!75!black,title=Axiom MES-1: Fundamental Principle]
\textbf{Axiom MES-1 (Core Assumption):}
...
\begin{tcolorbox}[colback=yellow!5!white,colframe=yellow!75!black,title=Axiom MES-2: Complementarity]
\textbf{Axiom MES-2 (Complementarity):}
