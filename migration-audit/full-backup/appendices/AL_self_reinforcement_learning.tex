...
Appendix AK established that deviations from $C^*(\Psi)$ are informative signals, 
...
$\Delta = C - C^*$ & Provides feedback signal & Appendix AK \\
Diagnostic Protocol & Classifies feedback & Appendix AK \\
...
type to corrective action (Appendix AK) already specifies how the model should 
change.
...
\\
\textbf{4. DIAGNOSE} \\
\> Apply diagnostic protocol (Appendix AK) \\
...
The diagnostic protocol (Appendix AK) classifies deviations. This section 
...
to expensive human data collection. The diagnostic protocol (Appendix AK) 
...
Diagnostic protocol & Rule-based classifier per Appendix AK \\
...
\begin{itemize}
    ...
    \item Systematic diagnosis (Appendix AK)
...
\hrule
\vspace{0.5em}
\noindent\textit{Cross-references: Appendix AK (Diagnostic Protocol), 
Appendix H (Computational History), Chapter 4 (Empirical Foundations)}
