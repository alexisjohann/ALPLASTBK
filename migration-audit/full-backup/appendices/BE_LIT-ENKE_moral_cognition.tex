...
\chapter*{Appendix BE: Benjamin Enke Research Integration}
\addcontentsline{toc}{chapter}{Appendix BE: LIT-ENKE - Moral Universalism \& Cognitive Uncertainty}
\label{app:enke}
...
\begin{axiom}[BE-1: Kinship-Morality Link]
\label{ax:be1}
...
\begin{axiom}[BE-2: Cognitive Uncertainty]
\label{ax:be2}
...
\begin{axiom}[BE-3: Correlation Neglect]
\label{ax:be3}
...
\begin{axiom}[BE-4: Noise-Rationality Tradeoff]
\label{ax:be4}
...
\begin{axiom}[BE-5: Complexity-Time Link]
\label{ax:be5}
...
\begin{axiom}[BE-6: Market Reference Points]
\label{ax:be6}
