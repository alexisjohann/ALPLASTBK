...
\subsection{Axiom RN-1: Bounded Depth of Reasoning}

\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black]
\textbf{Axiom RN-1 (Bounded Reasoning):}
...
\subsection{Axiom RN-2: Level-0 Anchoring}

\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black]
\textbf{Axiom RN-2 (Level-0 Behavior):}
...
\subsection{Axiom RN-3: Poisson Cognitive Hierarchy}

\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black]
\textbf{Axiom RN-3 (Poisson-CH):}
...
\subsection{Axiom RN-4: Neural Correlates of Strategic Depth}

\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black]
\textbf{Axiom RN-4 (Neural Basis):}
...
\subsection{Axiom RN-5: External Validity via Large-Scale Experiments}

\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black]
\textbf{Axiom RN-5 (Population Generalization):}
...
\subsection{Axiom RN-6: Strategic Sophistication is Context-Dependent}

\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black]
\textbf{Axiom RN-6 (Context Modulation):}
...
\begin{tcolorbox}[colback=green!10!white, colframe=green!75!black,
    title=\textbf{Appendix RN: Summary}]
