...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=\textbf{Appendix AY: LIT-PARADIGMS}]
...
\textbf{Dependencies:} & Appendix D (FORMAL-CSTAR) \\
                       & Appendix T (REF-META) \\
...
\begin{itemize}[nosep]
    ...
    \item \citet{thaler1980}: Mental Accounting
    \item \citet{camerer2003}: Behavioral Game Theory
\end{itemize}
...
\textbf{Key Works:}
\begin{itemize}[nosep]
    \item \citet{north1990}: Institutions as rules of the game
...
Appendix D proves that $C^*$ is an ESS for complementarity beliefs.
...
\paragraph{Connection to Appendix D (FORMAL-CSTAR).}
AY provides the intellectual context for why $C^*$ is derived as a fixed point
rather than assumed. Appendix D provides the formal mathematics that AY surveys
across paradigms.

\paragraph{Connection to Appendix T (REF-META).}
AY's taxonomy of reference point types (exogenous, endogenous, optimization,
normative) builds on the metatheoretical foundations in Appendix T.
...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=\textbf{Appendix AY Summary: LIT-PARADIGMS}]
...
\textbf{Appendix G} (\textit{REF-GLOSSARY}).
...
\begin{table}[htbp]
\centering
\caption{Symbols in Appendix AY}
...
\begin{table}[htbp]
\centering
\caption{Research Roadmap for Appendix AY}
...
\subsection{References for Appendix AY}
...
\begin{itemize}[nosep]
    ...
    \item \citet{north1990}: Institutions, Institutional Change
\end{itemize}
...
\textbf{Depends on:}
\begin{itemize}[nosep]
    \item Appendix D (FORMAL-CSTAR): $C^*$ derivation
    \item Appendix G (REF-GLOSSARY): Symbol definitions
    \item Appendix T (REF-META): Metatheoretical foundations
\end{itemize}
...
$\rightarrow$ Appendix D (formal $C^*$) $\rightarrow$ Chapter 6 (application)
