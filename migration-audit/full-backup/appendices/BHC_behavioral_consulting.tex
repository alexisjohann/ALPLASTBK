...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=\textbf{Appendix BHC: Application Domain}]
...
\textbf{Dependencies:} & Appendix MSC (Framework vs Model theory) \\
...
\begin{itemize}[nosep]
    \item Appendix MSC: Framework vs Model epistemology (Section~\ref{sec:meta-framework-model})
...
\begin{itemize}[nosep]
\item Appendix MSC: Theoretical foundation for Framework vs Model
...
\begin{itemize}[nosep]
    \item Framework vs Model theory $\rightarrow$ Appendix MSC
...
\textit{Cross-Reference:} For the full epistemological treatment, see Appendix MSC,
...
\begin{enumerate}[nosep]
    \item \textbf{Appendix MSC:} Framework vs.\ Model epistemology
    \item \textbf{Appendix CTW:} Context ($\Psi$) dimensions and SwissHealth case
    \item \textbf{Appendix HOW:} Complementarity theory (10C CORE-HOW)
