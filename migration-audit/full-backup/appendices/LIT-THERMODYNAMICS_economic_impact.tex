...
% - Appendix B (CORE-HOW): γ definition
...
% - Appendix XVI (LIT-CRITIQUE): Uses historical analogy for defense
...
\item For formal γ-theory: See Appendix B (CORE-HOW)
\item For scientific history: See Appendix XV (LIT-HISTORY)
\end{itemize}
...
\textbf{Cross-References:} Appendix B (CORE-HOW), XV (LIT-HISTORY), VII (FORMAL-GTC)
\end{tcolorbox}
...
$\gamma$ & Complementarity parameter & See Appendix B (CORE-HOW) & \checkmark \\
\bottomrule
\end{tabular}
\end{table}
...
Appendix B (CORE-HOW: $\gamma$ definition),
Appendix XV (LIT-HISTORY: Scientific history),
Appendix VII (FORMAL-GTC: General Theory of Complementarity).
