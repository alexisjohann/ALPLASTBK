...
%   - Appendix DFN (DOMAIN-FOUND): Domain foundations
%   - Appendix HOW (CORE-HOW): Interaction structure
...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=Quick Reference: Appendix EBF]
...
From CORE-WHAT (Appendix WAT), utility decomposes into six dimensions:
\begin{itemize}[noitemsep]
...
From CORE-STAGE (Appendix STA), the BCJ has five phases:
\begin{enumerate}[noitemsep]
...
\begin{tcolorbox}[colback=yellow!5!white,colframe=yellow!75!black,title=Axiom EBF-1: Fundamental Principle]
\textbf{Axiom EBF-1 (Core Assumption):}
...
\begin{tcolorbox}[colback=yellow!5!white,colframe=yellow!75!black,title=Axiom EBF-2: Complementarity]
\textbf{Axiom EBF-2 (Complementarity):}
