...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=Quick Reference: Appendix FM]
...
\textbf{Key Concepts:}
\begin{itemize}[nosep]
\item \textbf{Reusability Principle (FM-1)}: Assets that can be applied to $N$ problems have $N \times$ value
\item \textbf{Cumulative Knowledge (FM-2)}: Each application improves the framework
\item \textbf{Falsifiability Requirement (FM-3)}: Predictions must be testable
\end{itemize}
...
\textbf{In-Scope:}
\begin{itemize}[nosep]
    \item The five principles of Framework methodology (FM-1 to FM-5)
...
\begin{itemize}[nosep]
    ...
    \item Parameter estimation techniques $\rightarrow$ Appendix AN (METHOD-LLMMC)
...
\begin{itemize}[nosep]
    \item Five axioms of Framework methodology (FM-1 to FM-5)
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom FM-1: Reusability Principle]
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom FM-2: Transparency Principle]
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom FM-3: Cumulative Growth Principle]
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom FM-4: Falsifiability Requirement]
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom FM-5: Transferability Principle]
...
\midrule
FM-1: Reusability & 10C Framework & Same 10 questions apply to ANY behavioral problem \\
FM-2: Transparency & Model Registry & Every model documents $\mathcal{M}, \mathcal{A}, \Theta, \mathcal{B}$ \\
FM-3: Cumulative & Session Database & Each engagement updates parameter estimates \\
FM-4: Falsifiability & Monte Carlo + CI & Predictions have 90\% confidence intervals \\
FM-5: Transferability & Skills \& Templates & \texttt{/design-model} usable by any trained analyst \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{itemize}[nosep]
    \item Five principles distinguishing Framework from Consulting (FM-1 to FM-5)
...
\begin{table}[htbp]
\centering
\caption{Symbols Introduced in Appendix FM}
...
\begin{itemize}[nosep]
    ...
    \item \textbf{Behavioral Economics Foundations:} \citet{PAP-kahneman1979prospectprospect}, \citet{thaler2008nudge}
