...
% - Appendix DTC (METHOD-DOCTYPE): Computational implementation
% - Appendix SW (METHOD-SWSM): Scientific Writing Structure Model (supersedes 8D for academic texts)
...
\item For computational implementation: See Appendix DTC
\end{itemize}
...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=Quick Reference: Appendix DTE]
...
\begin{itemize}[nosep]
    ...
    \item METHOD-DOCTYPE $\rightarrow$ Appendix DTC
    \item METHOD-DOCTYPE $\rightarrow$ Appendix DTC
...
Appendix DTC (METHOD-DOCTYPE) provides the \textit{how}:
...
\begin{tcolorbox}[colback=green!10!white, colframe=green!75!black,
    title=\textbf{Appendix DTE: Summary}]
...
\begin{table}[htbp]
\centering
\caption{Symbols Introduced in Appendix DTE}
...
Appendix DTC (METHOD-DOCTYPE),
Appendix CTW (CORE-WHEN),
Appendix WHO (CORE-WHO),
Appendix SW (METHOD-SWSM) --- supersedes 8D for scientific writing.
