...
%
% DEPENDENCIES:
% - Appendix AAA (CORE-WHO): Level structure for cross-level complementarity
% - Appendix C (CORE-WHAT): Dimension structure for cross-dimension complementarity
%
% DEPENDENTS:
% - Appendix V (CORE-WHEN): Context-dependent γ values
% - Appendix IE (CORE-EIT): Intervention complementarity/crowding
% - Appendix CAL (METHOD-LLMMC): γ calibration methods
%
% =============================================================================
...
\begin{itemize}[nosep]
\item Appendix AAA (CORE-WHO): Provides levels whose interactions HOW describes
\item Appendix C (CORE-WHAT): Provides dimensions whose interactions HOW describes
\item Appendix V (CORE-WHEN): Provides context that modulates γ values
\end{itemize}
...
\textbf{In-Scope:}
\begin{itemize}[nosep]
    \item Definition and properties of γ (axioms CMP-1 through CMP-10)
...
\textbf{Out-of-Scope:}
\begin{itemize}[nosep]
    \item What the dimensions are $\rightarrow$ Appendix C (CORE-WHAT)
    \item What the levels are $\rightarrow$ Appendix AAA (CORE-WHO)
    \item When γ varies with context $\rightarrow$ Appendix V (CORE-WHEN)
    \item How to estimate γ empirically $\rightarrow$ Appendix BBB (CORE-WHERE)
\end{itemize}
...
\begin{itemize}[nosep]
    ...
    \item Axiom System CMP-1 through CMP-10
...
levels. The axiom system CMP-1 through CMP-10 provides the formal foundations.
...
% CMP-1
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom CMP-1: Existence of Interaction]
\textbf{Statement:}
\begin{equation}
...
% CMP-3
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom CMP-3: Default Symmetry]
\textbf{Statement:}
\begin{equation}
...
% CMP-4
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom CMP-4: Context Dependence]
\textbf{Statement:}
\begin{equation}
...
% CMP-5
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom CMP-5: Crowding-Out Theorem]
\textbf{Statement:}
\begin{equation}
...
\textbf{Boundary Conditions:} See CMP-4 --- the sign can flip in specific contexts.
\end{tcolorbox}

% CMP-6
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom CMP-6: Social-Financial Tension]
\textbf{Statement:}
\begin{equation}
...
% CMP-7
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom CMP-7: Positive Definiteness Requirement]
\textbf{Statement:}
\begin{equation}
...
% CMP-8
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom CMP-8: Emergence from Complementarity]
\textbf{Statement:}
\begin{equation}
...
% CMP-9
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom CMP-9: Level-Level Complementarity]
\textbf{Statement:}
\begin{equation}
...
% CMP-10
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom CMP-10: Intervention Complementarity]
\textbf{Statement:}
\begin{equation}
...
% CMP-11
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom CMP-11: Narrative Modulation of Complementarity]
\textbf{Statement:}
\begin{equation}
...
This is stronger than CMP-4 (context dependence): narratives don't just modulate magnitude,
...
\textbf{Cross-Reference:} Full formalization in Appendix RB (LIT-BENABOU), Axiom RB-7.
\end{tcolorbox}
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Appendix B Summary: CORE-HOW]
...
\textbf{Next Steps:}
See Appendix C (CORE-WHAT) for the dimensions that interact.
See Appendix V (CORE-WHEN) for context-dependent γ values.
...
\begin{table}[htbp]
\centering
\caption{Symbols Introduced in Appendix B}
...
\textbf{Response:}
Not all γ values need separate estimation. Theoretical constraints (CMP-5, CMP-6)
...
Appendix IE (CORE-EIT),
Appendix CAL (METHOD-LLMMC),
Appendix RB (LIT-BENABOU) --- Axiom CMP-11 narrative modulation.
