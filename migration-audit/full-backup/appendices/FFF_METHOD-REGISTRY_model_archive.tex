...
% - Appendix EEE (METHOD-DESIGN): Defines model structure and workflow
% - Appendix BBB (CORE-WHERE): Parameter source documentation
% - All DOMAIN- appendices: Domain-specific model attributes
%
% DEPENDENTS (what REQUIRES this appendix):
% - Appendix EEE (METHOD-DESIGN): Draws 3+1 options from Registry
...
\textbf{Reading Guide:}
\begin{itemize}[nosep]
\item For model design process: Read Appendix EEE first
\item For storage structure: This appendix provides complete specification
\item For parameter sources: See Appendix BBB (CORE-WHERE)
\end{itemize}
...
Choice Architecture (Axiom MD-2 in Appendix EEE).
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom FFF-1: Similarity Computation]
...
\begin{tcolorbox}[colback=yellow!5!white, colframe=yellow!75!black,
    title=Axiom FFF-2: Cold Start Handling]
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom FFF-3: Mandatory Validation Review]
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom FFF-4: Complete Traceability]
...
\begin{tcolorbox}[colback=white, colframe=black,
    title=Example Registry Entry: M-2026-001]
\begin{verbatim}
identification:
  model_id: M-2026-001
...
\addlinespace
SEED-AT-01 & L=0 & 🇦🇹 & Gesundheit & Decision & Vorsorgeuntersuchung \\
SEED-AT-02 & L=0 & 🇦🇹 & Public & Decision & Steuer Compliance \\
\addlinespace
...
% ---------------------------------------------------------------------------
\subsection{Austria: SEED-AT-01 -- Preventive Health Screening}
% ---------------------------------------------------------------------------

\begin{tcolorbox}[colback=white, colframe=blue!50!black,
    title=SEED-AT-01: Vorsorgeuntersuchung Participation (Austria)]
\begin{verbatim}
identification:
  model_id: SEED-AT-01
  designer: "FehrAdvice Reference Team"
...
% ---------------------------------------------------------------------------
\subsection{Austria: SEED-AT-02 -- Tax Compliance}
% ---------------------------------------------------------------------------

\begin{tcolorbox}[colback=white, colframe=blue!50!black,
    title=SEED-AT-02: Tax Declaration Timeliness (Austria)]
\begin{verbatim}
identification:
  model_id: SEED-AT-02
  designer: "FehrAdvice Reference Team"
...
\begin{tcolorbox}[colback=green!10!white, colframe=green!75!black,
    title=\textbf{Appendix FFF: Summary}]
...
\textbf{Key Axioms:}
\begin{itemize}[nosep]
    \item FFF-1: Similarity Computation
    \item FFF-2: Cold Start Handling
    \item FFF-3: Mandatory Validation Review
    \item FFF-4: Complete Traceability
\end{itemize}
...
\begin{table}[htbp]
\centering
\caption{Symbols Introduced in Appendix FFF}
