...
%
% Cross-Reference Map:
%   - Appendix V (MEP): Portfolio optimization foundation
%   - Appendix BB (EQUILIBRIA): Tipping points and stability
%   - Appendix HI (HIERARCHY): Decision level structure
%   - Appendix III (EIH): Intervention efficiency
%   - Appendix IV (LET): Level emergence
...
\begin{abstract}
The MEP optimization problem (Appendix V) is non-convex when complementarities
...
\textbf{Key Insight:} The MEP (Appendix V) finds the cost-minimizing portfolio
...
\subsection{Connection to Appendix V (MEP)}
...
\subsection{Connection to Appendix BB (Equilibria)}

Appendix BB formalizes tipping points and stability. MEQ operationalizes these
...
\subsection{Connection to Appendix HI (Hierarchy)}
...
\begin{itemize}[nosep]
    \item \textbf{Appendix V (FORMAL-MEP):} Portfolio optimization foundation
    \item \textbf{Appendix BB (FORMAL-EQUILIBRIA):} Stability and tipping points
    \item \textbf{Appendix III (FORMAL-EIH):} Intervention efficiency conditions
    \item \textbf{Appendix IV (FORMAL-LET):} Level emergence mechanics
    \item \textbf{Appendix HI (CORE-HIERARCHY):} Decision level structure
    \item \textbf{Appendix HHH (METHOD-TOOLKIT):} Intervention design toolkit
    \item \textbf{Appendix AW (CORE-STAGE):} BCJ phase dynamics
...
See Appendix G (REF-GLOSSARY) for complete terminology.
