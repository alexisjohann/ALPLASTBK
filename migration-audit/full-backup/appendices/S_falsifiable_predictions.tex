...
% - Appendix B (CORE-HOW): Complementarity structure $C$
% - Appendix V (CORE-WHEN): Context dimensions $\Psi$
% - Appendix C (CORE-WHAT): Utility dimensions (FEPSDE)
% - Appendix T (Metatheory): Framework philosophy
%
% DEPENDENTS (what REQUIRES this appendix):
% - Appendix R (Evaluation Protocol): Uses predictions as test cases
% - Appendix AK (Epistemics of Deviation): Uses failed predictions for learning
...
\item For testing methodology: See Appendix R (Evaluation Protocol)
\item For learning from failures: See Appendix AK (Epistemics of Deviation)
\end{itemize}
...
\textbf{Cross-References:} Appendix R (Evaluation Protocol), Appendix T (Metatheory), Appendix AK (Epistemics of Deviation), Appendix XVIII (Philosophy of Science Foundation---Fehr Compatibility)
\end{tcolorbox}
...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=\textbf{Connection to Appendix XVIII: The Exclusion Principle}]
This appendix implements the \textbf{Exclusion Principle} established in Appendix XVIII
...
\subsection{Connection to Evaluation Protocol (Appendix R)}

\begin{tcolorbox}[colback=yellow!5!white, colframe=yellow!75!black,
    title=Integration: Appendix S $\leftrightarrow$ Appendix R]
...
\begin{itemize}[nosep]
\item Appendix R: Evaluation methodology and data collection protocols
\item Appendix AK: Protocol for learning from failed predictions
\end{itemize}
\end{tcolorbox}

\subsection{Connection to Epistemics of Deviation (Appendix AK)}

When predictions fail, Appendix AK provides the diagnostic protocol for systematic learning from those failures. This creates a feedback loop: failed predictions become inputs for framework refinement.
...
\begin{tcolorbox}[colback=green!10!white, colframe=green!75!black,
    title=\textbf{Appendix S: Summary}]
...
\textbf{Integration:} This appendix connects to Appendix R (testing methodology), Appendix T (metatheory), and Appendix AK (learning from failures).
...
Appendix AK (Epistemics of Deviation---when predictions fail, Appendix AK provides the diagnostic protocol for systematic learning from those failures),
Appendix B (CORE-HOW),
