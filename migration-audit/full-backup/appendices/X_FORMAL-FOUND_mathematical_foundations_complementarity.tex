...
% HEADER BLOCK
% ----------------------------------------------------------------------------
\begin{tcolorbox}[colback=blue!5!white,colframe=blue!75!black,title=\textbf{Appendix X: FORMAL-FOUND}]
...
\begin{itemize}[noitemsep]
    ...
    \item Economics (to be applied in Appendix XIII)
