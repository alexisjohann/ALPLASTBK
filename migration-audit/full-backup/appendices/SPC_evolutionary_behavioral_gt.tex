...
\begin{itemize}[nosep]
    ...
    \item Social Preferences $\rightarrow$ Appendix SCP
    \item complementarity $\gamma$ $\rightarrow$ Appendix HOW
\end{itemize}
...
\begin{itemize}[nosep]
    \item Appendix AWA (CORE-AWARE): Level-$k$ $\leftrightarrow$ Awareness $A(\cdot)$
    \item Appendix HOW (CORE-HOW): Strategic complementarity $\gamma$
    \item Appendix MSC Section 11: M\&N (2018) generative framework
    \item Appendix SCP (Social Preferences): Fairness in games
\end{itemize}
...
\textbf{Cross-Reference:} Appendix MSC Section 11 (full treatment),
Appendix HOW (complementarity $\gamma$), Appendix AWA (awareness $A(\cdot)$).
...
Behavioral game theory intersects with social preferences (Appendix KTH):
\begin{equation}
...
\textbf{Cross-Reference.} Appendix MSC Section 11 (full integration).
...
\begin{itemize}[nosep]
    \item Appendix AWA (CORE-AWARE): Awareness $A(\cdot)$ formalization
    \item Appendix HOW (CORE-HOW): Complementarity $\gamma$ structure
    \item Appendix MSC Section 11: M\&N generative framework
    \item Appendix SCP: Social preferences in games
    \item Appendix SHA: Complexity economics and heterogeneity
\end{itemize}
