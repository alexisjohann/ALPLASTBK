...
\chapter*{Appendix XG: Xavier Gabaix Research Integration}
\addcontentsline{toc}{chapter}{Appendix XG: LIT-GABAIX - Behavioral Inattention \& Sparsity}
\label{app:gabaix}
...
\begin{axiom}[XG-1: Sparse Attention]
\label{ax:xg1}
...
\begin{axiom}[XG-2: Default Anchoring]
\label{ax:xg2}
...
\begin{axiom}[XG-3: Endogenous Salience]
\label{ax:xg3}
...
\begin{axiom}[XG-4: Power Law Returns]
\label{ax:xg4}
...
\begin{axiom}[XG-5: Behavioral Macro Dynamics]
\label{ax:xg5}
With $M < 1$:
\begin{enumerate}
...
\begin{axiom}[XG-6: Micro-Macro Bridge]
\label{ax:xg6}
