...
\citet{guth1982} (original); \citet{PAP-camerer2003behavioral} (meta-analysis);
...
\paragraph{Gneezy (2005) Deception Game \citep{PAP-gneezy2005deception}.}
...
\paragraph{Meta-Analytic Findings \citep{PAP-enke2021ancestral_env}.}
...
\paragraph{Key Citations.}
\citet{PAP-gneezy2005deception} (deception game); \citet{fischbacher2013} (die roll);
\citet{PAP-enke2021ancestral_env} (meta-analysis); \citet{kajackas2009} (replication);
...
\paragraph{Double Auction Experiments \citep{PAP-smith1962experimental}.}
...
\paragraph{Induced Value Theory \citep{PAP-smith1976experimental}.}
...
\paragraph{Constructivist vs.\ Ecological Rationality \citep{PAP-smith2003constructivist}.}
...
\paragraph{Key Citations.}
\citet{PAP-smith1962experimental} (double auction); \citet{PAP-smith1976experimental} (induced value);
\citet{smith1982microeconomic} (institutions); \citet{smith1988bubbles} (bubbles);
\citet{PAP-smith2003constructivist} (ecological rationality); \citet{plottsmith2008} (handbook).
...
\paragraph{Schelling Focal Points \citep{PAP-schelling1960strategy}.}
...
\paragraph{Key Citations.}
\citet{PAP-schelling1960strategy} (focal points); \citet{vanhuyck1990,vanhuyck1991} (minimum effort);
\citet{cooper1992communication} (communication); \citet{mehta1994focal} (focal point experiments);
\citet{PAP-camerer2003behavioral} (behavioral game theory synthesis).
...
(predicting behavior); \citet{camererho1999} (EWA); \citet{fudenberg1998learning}
(theory); \citet{PAP-camerer2003behavioral} (behavioral game theory synthesis).
...
\paragraph{Key Citations.}
\citet{axelrod1984evolution} (tournaments); \citet{fudenbergmaskin1986} (folk theorem);
...
\paragraph{Cognitive Hierarchy \citep{PAP-PAP-camerer2004neuroeconomicscognitive}.}
...
\paragraph{Intentions and Belief-Dependent Preferences \citep{PAP-falk2006theory}.}
...
\begin{itemize}[nosep]
    ...
    \item \textbf{Experimental finding:} Subjects struggle with higher-order reasoning;
          typically stop at 2nd order \citep{PAP-PAP-camerer2004neuroeconomicscognitive}
\end{itemize}
\begin{equation}
...
\paragraph{Field Evidence for Beliefs \citep{PAP-dellavigna2009psychology, levitt2007laboratory}.}
...
\begin{itemize}[nosep]
    ...
    \item \textbf{Voting:} Beliefs about others' turnout affect own turnout \citep{PAP-dellavigna2009psychology}
...
\paragraph{Replication and Robustness \citep{camerer2016, camerer2018evaluating}.}
...
\paragraph{Key Citations.}
\citet{nagel1995unraveling} (beauty contest); \citet{PAP-PAP-camerer2004neuroeconomicscognitive} (cognitive hierarchy);
\citet{costagomes2006} (belief elicitation); \citet{PAP-falk2006theory} (intentions);
...
\begin{itemize}[nosep]
    ...
    \item \citet{PAP-camerer2003behavioral}: Behavioral game theory synthesis
...
\textbf{Honesty:}
\begin{itemize}[nosep]
    \item \citet{PAP-gneezy2005deception}: Deception games (foundational)
    \item \citet{fischbacher2013}: Die-roll paradigm
    \item \citet{PAP-enke2021ancestral_env}: Meta-analysis of lying experiments
    \item \citet{mazar2008}: Self-concept maintenance theory
\end{itemize}

\textbf{Market Experiments (Smith):}
\begin{itemize}[nosep]
    \item \citet{PAP-smith1962experimental}: Double auction experiments (foundational)
    \item \citet{PAP-smith1976experimental}: Induced value theory
    \item \citet{smith1988bubbles}: Asset bubble experiments
    \item \citet{PAP-smith2003constructivist}: Ecological rationality (Nobel lecture)
...
\textbf{Coordination:}
\begin{itemize}[nosep]
    \item \citet{PAP-schelling1960strategy}: Strategy of Conflict (focal points)
...
\begin{itemize}[nosep]
    ...
    \item \citet{PAP-PAP-camerer2004neuroeconomicscognitive}: Cognitive hierarchy model
    \item \citet{costagomes2006}: Belief elicitation experiments
    \item \citet{PAP-falk2006theory}: Intentions and belief-dependent preferences
...
\begin{itemize}[nosep]
    \item \citet{PAP-dellavigna2009psychology}: Psychology and economics (field evidence)
