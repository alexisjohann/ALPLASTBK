...
\begin{tcolorbox}[colback=orange!5!white, colframe=orange!75!black,
    title=\textbf{Appendix MSC: Literature Integration}]
...
\textbf{Dependencies:} & Appendix GLS (Glossary), Appendix EXP (Experimental Evidence) \\
...
\begin{itemize}[nosep]
    \item Appendix GLS: Central notation and definitions
    \item Appendix EXP: 8 paradigms of experimental evidence (integrated by EBF)
    \item Appendix STA: CORE-STAGE Section 12 (Meta-Scientific Foundation)
...
\begin{itemize}[nosep]
    ...
    \item Experimental Evidence $\rightarrow$ Appendix EXP
    \item CORE-STAGE $\rightarrow$ Appendix STA
    \item Document Type Theory $\rightarrow$ Appendix DTE
    \item Fehr Papers $\rightarrow$ Appendix FEH
\end{itemize}
...
\item 8 paradigms of experimental evidence integrated (Appendix EXP)
...
\begin{itemize}[nosep]
    ...
    \item \textbf{Parametrics} = Calibrated values ($\Theta$) from Appendix EST
...
economics. Following the 8D document type framework (Appendix DTE), we derive
...
type space (see Appendix DTE for definitions):
...
\begin{enumerate}
\item \textbf{Appendix DTE (Document Type Theory):} The 8D coordinates
      derive from the axiomatic system established there.

\item \textbf{Appendix FEH (Fehr Papers):} The vocabulary and patterns
      are extracted from the 20 papers analyzed there.

\item \textbf{Appendix QLY (Quality Assessment):} The TERAN quality
      dimensions (Theory, Evidence, Rigor, Applicability, Novelty)
      map directly to style requirements.

\item \textbf{Appendix GLS (Glossary):} All technical terms follow the
...
Key terms used in this appendix (see Appendix GLS for complete glossary):
...
\begin{itemize}[nosep]
    \item Appendix GLS: All EBF notation
    \item Appendix EXP: Experimental evidence integrated by EBF
...
Appendix APL (The EBF Workflow Reference). This section provides
...
\textbf{Note:} The 8th CORE question is STAGE (Behavioral Change Journey, Appendix STA).
The EBF workflow methodology is documented in Appendix APL (reference document).
...
Appendix STA (CORE-STAGE) Section 12,
Appendix GLS (Central Glossary),
Appendix EXP (Experimental Evidence),
