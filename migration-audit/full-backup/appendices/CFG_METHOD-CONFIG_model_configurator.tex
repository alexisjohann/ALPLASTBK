...
% - Appendix DSN (METHOD-DESIGN): Workflow that uses configurator
% - Appendix REG (METHOD-REGISTRY): Stores generated models
% - Appendix WHO (CORE-WHO): Level definitions
% - Appendix HOW (CORE-HOW): Complementarity
% - Appendix WAT (CORE-WHAT): Utility dimensions
% - Appendix CTW (CORE-WHEN): Context dimensions
% - Appendix AWA (CORE-AWARE): Awareness function [NEW]
% - Appendix REA (CORE-READY): Willingness function [NEW]
% - Appendix STA (CORE-STAGE): Behavioral change journey [NEW]
%
% DEPENDENTS (what REQUIRES this appendix):
% - Appendix DSN (METHOD-DESIGN): Uses configurator for model generation
...
\textbf{Reading Guide:}
\begin{itemize}[nosep]
\item For workflow context: Read Appendix DSN first
...
The welfare hierarchy level from CORE-WHO (Appendix WHO).
...
Derived from Appendix AWA (CORE-AWARE) and Chapter 11.
...
Derived from Appendix REA (CORE-READY) and Chapter 12.
...
\item Reducing $\theta$ often more effective than increasing $WAX$ (cf. Appendix REA, WAX-A15)
\end{itemize}


\subsection{Mapping 7: Domain × Complexity → Stage Defaults}

Derived from Appendix STA (CORE-STAGE) and Chapter 13.
...
\textbf{10C Coverage:}
\begin{itemize}[nosep]
\item WHO: $L$ (input) $\rightarrow$ Appendix WHO
\item WHAT: $C$ (Mapping 2) $\rightarrow$ Appendix WAT
\item HOW: $\gamma$ (Mapping 3) $\rightarrow$ Appendix HOW
\item WHEN: $\Psi$ (Mapping 1) $\rightarrow$ Appendix CTW
\item WHERE: All tables $\rightarrow$ Appendix EST
\item AWARE: $A$ (Mapping 5) $\rightarrow$ Appendix AWA
\item READY: $WAX$, $\theta$ (Mapping 6) $\rightarrow$ Appendix REA
\item STAGE: $\tau$, $\rho$, $\kappa$ (Mapping 7) $\rightarrow$ Appendix STA
\end{itemize}
...
\begin{tcolorbox}[colback=yellow!5!white,colframe=yellow!75!black,title=Axiom CFG-1: Fundamental Principle]
\textbf{Axiom CFG-1 (Core Assumption):}
...
\begin{tcolorbox}[colback=yellow!5!white,colframe=yellow!75!black,title=Axiom CFG-2: Complementarity]
\textbf{Axiom CFG-2 (Complementarity):}
...
\begin{tcolorbox}[colback=green!10!white, colframe=green!75!black,
    title=\textbf{Appendix CFG: Summary}]
...
\begin{table}[htbp]
\centering
\caption{Symbols Introduced in Appendix CFG}
