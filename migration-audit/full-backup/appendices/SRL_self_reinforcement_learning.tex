...
Appendix EPS established that deviations from $C^*(\Psi)$ are informative signals, 
...
$\Delta = C - C^*$ & Provides feedback signal & Appendix EPS \\
Diagnostic Protocol & Classifies feedback & Appendix EPS \\
...
type to corrective action (Appendix EPS) already specifies how the model should 
change.
...
\\
\textbf{4. DIAGNOSE} \\
\> Apply diagnostic protocol (Appendix EPS) \\
...
The diagnostic protocol (Appendix EPS) classifies deviations. This section 
...
to expensive human data collection. The diagnostic protocol (Appendix EPS) 
...
Diagnostic protocol & Rule-based classifier per Appendix EPS \\
...
\begin{itemize}
    ...
    \item Systematic diagnosis (Appendix EPS)
...
\hrule
\vspace{0.5em}
\noindent\textit{Cross-references: Appendix EPS (Diagnostic Protocol), 
Appendix HRC (Computational History), Chapter 4 (Empirical Foundations)}
...
\begin{table}[htbp]
\centering
\caption{Key Symbols in Appendix SRL}
\begin{tabular}{lll}
\toprule
