...
% - Appendix B (CORE-HOW): Complementarity framework
% - Appendix AAA (CORE-WHO): Welfare hierarchy
...
\textbf{Cross-References:} Appendix B (CORE-HOW), K (LIT-FEHR), AAA (CORE-WHO), V (CORE-WHEN)
\end{tcolorbox}
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom SU-1: Group Rationality Premium]
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom SU-2: Group Selfishness Premium]
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom SU-3: Trust Development]
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom SU-4: Preference Heritability]
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom SU-5: Conditional Cooperation Universality]
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom SU-6: Lab-Field Validity]
...
\midrule
SU-1 & Groups are less behavioral & $+0.30$ rationality & 1 \\
SU-2 & Groups trust less than individuals & $-0.20$ trust & 1 \\
SU-3 & Trust increases with age & $+0.15$ per stage & 1 \\
SU-4 & Time preferences predict health & $r = 0.35$ & 1 \\
SU-5 & Preferences transmitted in families & $\rho = 0.35$--$0.40$ & 1 \\
SU-6 & Conditional cooperation is universal & $\approx 50\%$ & 1 \\
SU-7 & Workplace training improves climate & $d = 0.25$ & 1 \\
SU-8 & Psychological pressure affects performance & $d = 0.21$ & 1 \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{tcolorbox}[colback=green!5!white, colframe=green!75!black,
    title=Key Result SU-1: Groups are Less Behavioral]
...
\begin{tcolorbox}[colback=green!5!white, colframe=green!75!black,
    title=Key Result SU-2: Age-Trust Gradient]
...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=Key Result SU-3: Lab-Field Validity]
...
\begin{tcolorbox}[colback=green!5!white, colframe=green!75!black,
    title=Key Result SU-4: Preference Heritability]
...
\begin{tcolorbox}[colback=green!5!white, colframe=green!75!black,
    title=Key Result SU-5: Universal Conditional Cooperation]
...
\begin{tcolorbox}[colback=green!5!white, colframe=green!75!black,
    title=Key Result SU-6: Scalable Workplace Interventions]
...
\textbf{Connection to CORE-HOW (Appendix B):}
\begin{itemize}[nosep]
...
\textbf{Connection to CORE-WHO (Appendix AAA):}
\begin{itemize}[nosep]
...
\textbf{Connection to CORE-WHEN (Appendix V):}
\begin{itemize}[nosep]
...
\textbf{Connection to CORE-WHERE (Appendix BBB):}
\begin{itemize}[nosep]
...
\begin{tcolorbox}[colback=green!10!white, colframe=green!75!black,
    title=\textbf{Appendix SU: Summary}]
...
\begin{table}[htbp]
\centering
\caption{Symbols Introduced in Appendix SU}
