...
\begin{itemize}[nosep]
    \item Appendix AD (Behavioral GT): Level-$k$ heterogeneity
    \item Appendix LIT-META Section 11: M\&N structured heterogeneity
    \item Appendix B (CORE-HOW): Complementarity creates feedback loops
\end{itemize}
...
\begin{equation}
\boxed{
C^*_T = f(C_0, C_1, \ldots, C_{T-1}, \text{random events})
}
...
\textbf{Cross-Reference:} Appendix LIT-META Section 11, Appendix AD (Behavioral GT),
...
\hline
Path dependence & $C^*_T = f(C_0, \ldots, C_{T-1})$ & History matters \\
\hline
...
\begin{itemize}[nosep]
    ...
    \item Appendix B (CORE-HOW): Complementarity and increasing returns
    \item Appendix AJ (Social Preferences): Heterogeneous preferences
\end{itemize}
