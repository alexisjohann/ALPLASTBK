% =============================================================================
% APPENDIX HTY: LIT-AUTHOR: Unknown Researcher Research Integration
% =============================================================================
% Category: LIT
% Language: English
...
\textbf{Primary Chapter:} Chapter 2: Historical Foundations
\begin{itemize}[nosep]
\item Section 2.1: Pre-Scientific Origins $\leftrightarrow$ HTY Phase I
\item Section 2.2: Scientific Development $\leftrightarrow$ HTY Phases II-V
\item Section 2.3: Modern Synthesis $\leftrightarrow$ HTY Phase VI
\end{itemize}

\textbf{Secondary Chapters:}
\begin{itemize}[nosep]
\item Chapter 4: Critical Assessment --- historical objections
\item Chapter 7: Mathematical Foundations --- formal emergence
\end{itemize}
...
See Appendix DFN (DOMAIN-FOUND) for complete translation.
...
\label{sec:hty-axioms}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\begin{tcolorbox}[colback=yellow!5!white,colframe=yellow!75!black,title=Axiom HTY-1: Fundamental Principle]
\textbf{Axiom HTY-1 (Core Assumption):}
...
\begin{tcolorbox}[colback=yellow!5!white,colframe=yellow!75!black,title=Axiom HTY-2: Complementarity]
\textbf{Axiom HTY-2 (Complementarity):}
...
The 68 references documented in this appendix span 2,500 years of intellectual history,
from ancient philosophy through modern behavioral economics.
