...
\textbf{Cross-References:} Appendix B (HOW: Complementarities), Appendix V (WHEN: Context), Appendix BBB (Parameters), Appendix EEE (EEE Workflow used in SDM design)
...
SDM adapts the EBF FEPSDE framework (Appendix C) to five core strategic dimensions with organizational weights:
...
\subsection{Connection to Appendix B: Complementarities (HOW)}

SDM applies the general complementarity theory from Appendix B to the organizational strategy domain. The $\gamma$ matrix in Table \ref{tab:sdm-gamma} is an instance of the general EBF complementarity framework:

\begin{tcolorbox}[colback=yellow!5!white, colframe=yellow!75!black,
    title=Integration: SDM $\leftrightarrow$ Appendix B (HOW)]
...
SDM's utility function (Eq. \ref{eq:sdm-utility}) is an application of EBF Appendix B's general form:

\begin{equation}
U(C) = \beta_0 + \sum_i \beta_i C_i + \underbrace{\sum_{i<j} \gamma_{ij} C_i C_j}_{\text{Appendix B}} + \lambda \Psi
\end{equation}

\end{tcolorbox}

\subsection{Connection to Appendix V: Context (WHEN)}

SDM operationalizes the general context framework from Appendix V specifically for organizational strategy. The five context factors ($\Psi_1$ through $\Psi_5$) are domain-specific instantiations of the general EBF context concept:

\begin{tcolorbox}[colback=yellow!5!white, colframe=yellow!75!black,
    title=Integration: SDM $\leftrightarrow$ Appendix V (WHEN)]
...
\subsection{Connection to Appendix C: Strategic Dimensions (WHAT)}

SDM adapts the FEPSDE framework from Appendix C to the organizational strategy domain. The five strategic dimensions in Table \ref{tab:sdm-dimensions} map to EBF's core utility dimensions:
...
\begin{tcolorbox}[colback=green!10!white, colframe=green!75!black,
    title=Appendix BI: Strategy Design Model v1.0 --- Summary]
...
\begin{table}[htbp]
\centering
\caption{Symbols Introduced in Appendix BI (SDM)}
...
\begin{itemize}
    \item EBF Appendix BBB (Parameter Repository) literature review
...
Appendix B (HOW: Complementarities),
Appendix C (WHAT: Utility Dimensions),
Appendix V (WHEN: Context),
Appendix BBB (Parameter Repository),
Appendix EEE (EEE Workflow).

\noindent\textit{Master Bibliography:} \texttt{bcm\_master\_references.bib}

\noindent\textit{Related Domain Appendices:} Appendix BE (SBDMS: Bank Strategic Decisions), Appendix AA (Personal Financial Planning)
