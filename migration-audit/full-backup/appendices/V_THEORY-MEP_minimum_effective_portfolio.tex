...
\begin{itemize}[nosep]
\item Appendix III (THEORY-EIH): Provides efficiency $\eta$ for each intervention
\item Appendix IV (THEORY-LET): Provides portfolio emergence $\mathcal{E}_{\mathcal{P}}$
\item Appendix HHH (METHOD-TOOLKIT): Provides intervention specification
\item Appendix BC (FORMAL-PROBABILITY): Provides $P(i \to j | \mathcal{P})$
\item Appendix HI (CORE-HIERARCHY): Provides decision level structure $L_0$--$L_3$
\end{itemize}
...
\end{equation}
where $\eta_i$ is the efficiency from EIH (Appendix III).
\end{definition}
...
From Chapter 15 and Appendix BC:
\begin{equation}
...
Integrating with Appendix HI (CORE-HIERARCHY), we can specify interventions by
decision level:
...
\begin{tcolorbox}[colback=green!10!white, colframe=green!75!black,
    title=\textbf{Appendix V Summary: The Minimum Effective Portfolio}]
