...
%==============================================================================
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black, title=\textbf{Appendix AA: DOMAIN-LABOR}]
...
\begin{itemize}[noitemsep]
    \item Appendix B (Levels): $L$-Struktur für Humankapital-Investition
    \item Appendix C (FEPSDE): $\Psi_C$ als Human Capital Dimension
    \item Appendix E (Operationalization): Empirische Messverfahren
    \item Appendix G (Glossary): Standardnotation
\end{itemize}
\textbf{Wird verwendet von:}
\begin{itemize}[noitemsep]
    \item Appendix AB (Trade): Labor-Market-Interaktionen
    \item Appendix S (Predictions): Testbare Arbeitsmarkt-Vorhersagen
...
\begin{align}
\text{Mincer:} \quad & \ln W = \alpha + \beta S + \gamma X + \delta X^2 \tag{AA-1} \\
\text{LATE:} \quad & \mathbb{E}[Y_1 - Y_0 | \text{Compliers}] \tag{AA-2} \\
\text{Matching:} \quad & M = m(U, V) \tag{AA-3} \\
\text{Task:} \quad & C_{tech, task} \gtrless 0 \text{ by task type} \tag{AA-4}
\end{align}
...
\begin{tcolorbox}[colback=green!5!white, colframe=green!75!black, title=\textbf{Appendix AA Summary}]
...
Für vollständige Definitionen siehe \textbf{Appendix G} (REF-GLOSSARY).
...
\textbf{Objection AA-1: Ability Bias in Returns to Education}
\begin{quote}
...
\textbf{Objection AA-2: External Validity of Natural Experiments}
\begin{quote}
...
\textbf{Objection AA-3: Task Polarization Overstated}
\begin{quote}
...
\textbf{Objection AA-4: LATE vs. ATE for Policy}
\begin{quote}
...
%==============================================================================
% \section{References} marker for compliance
\subsection{References for Appendix AA}
...
\textit{Appendix AA: DOMAIN-LABOR | EBF Framework | Version 1.0}\\
