...
\textbf{Source:} \citet{PAP-PAP-camerer2004neuroeconomicscognitive}
\end{tcolorbox}
...
\textbf{Source:} \citet{PAP-PAP-camerer2004neuroeconomicsneuroeconomics}, \citet{camerer2007brain}
\end{tcolorbox}
...
Camerer's magnum opus \textit{Behavioral Game Theory} \citep{PAP-PAP-camerer2003behavioralbehavioral} establishes that people systematically deviate from Nash equilibrium in predictable ways. The key insight is that these deviations are \textit{structured}---not random noise, but systematic patterns that can be modeled.
...
The cognitive hierarchy (CH) model \citep{PAP-PAP-camerer2004neuroeconomicscognitive} provides a tractable alternative to Nash equilibrium:
...
Camerer's foundational paper ``Neuroeconomics: Why Economics Needs Brains'' \citep{PAP-PAP-camerer2004neuroeconomicsneuroeconomics} established the field. Key claims:
...
\begin{itemize}[nosep]
    \item \textbf{Behavioral Game Theory:} \citet{PAP-PAP-camerer2003behavioralbehavioral}
    \item \textbf{Cognitive Hierarchy:} \citet{PAP-PAP-camerer2004neuroeconomicscognitive}
    \item \textbf{Neuroeconomics:} \citet{PAP-PAP-camerer2004neuroeconomicsneuroeconomics}, \citet{fehr2007neurobiology}
