...
\begin{tcolorbox}[colback=yellow!5!white,colframe=yellow!75!black,title=Axiom TRK-1: Fundamental Principle]
\textbf{Axiom TRK-1 (Core Assumption):}
...
\begin{tcolorbox}[colback=yellow!5!white,colframe=yellow!75!black,title=Axiom TRK-2: Complementarity]
\textbf{Axiom TRK-2 (Complementarity):}
...
\begin{table}[htbp]
\centering
\caption{Key Symbols in Appendix TRK}
\begin{tabular}{lll}
\toprule
