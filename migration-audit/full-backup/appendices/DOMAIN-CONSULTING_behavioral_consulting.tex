...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=\textbf{Appendix DOMAIN-CONSULTING: Application Domain}]
...
\textbf{Dependencies:} & Appendix LIT-META (Framework vs Model theory) \\
 & Appendix V (Context dimensions, SwissHealth case) \\
 & Appendix G (Glossary) \\
...
\begin{itemize}[nosep]
    \item Appendix LIT-META: Framework vs Model epistemology (Section~\ref{sec:meta-framework-model})
    \item Appendix V: SwissHealth worked example (Section~\ref{sec:V-example-org})
    \item Appendix G: Central notation and definitions
    \item Appendix AN: Beatrix technical architecture
...
\begin{itemize}[nosep]
\item Appendix LIT-META: Theoretical foundation for Framework vs Model
\item Appendix V: Practical application (SwissHealth case)
\end{itemize}
...
\textbf{Example} & EBF's 9C $\times$ 8$\Psi$ & ``Weekly rewards increase participation by 12\%'' \\
\bottomrule
\end{tabular}
\end{center}
...
\textit{Cross-Reference:} For the full epistemological treatment, see Appendix LIT-META,
...
\textbf{Classical:} & \textbf{EBF:} \\
\midrule
Five Forces: 5 fields & 9C $\times$ 8$\Psi$ $\times$ 6 FEPSDE = 384 dimensions \\
...
\textit{Cross-Reference:} Full case in Appendix V, Section~\ref{sec:V-example-org}.
...
\begin{equation}
\text{Analysis Space} = 8 \text{ (9C)} \times 8 \text{ (8$\Psi$)} \times 6 \text{ (FEPSDE)} = 384 \text{ dimensions}
\end{equation}
...
\begin{itemize}[nosep]
    ...
    \item \textbf{9C CORE:} Eight fundamental questions (WHO, WHAT, HOW, WHEN, WHERE, AWARE, READY, STAGE)
...
\begin{enumerate}[nosep]
    \item \textbf{Appendix LIT-META:} Framework vs.\ Model epistemology
    \item \textbf{Appendix V:} Context ($\Psi$) dimensions and SwissHealth case
    \item \textbf{Appendix B:} Complementarity theory (9C CORE-HOW)
    \item \textbf{Appendix AN:} Beatrix technical methodology
\end{enumerate}
