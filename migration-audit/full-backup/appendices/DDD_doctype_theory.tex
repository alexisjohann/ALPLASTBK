...
% - Appendix V (CORE-WHEN): Context framework parallels
%
% DEPENDENTS (what REQUIRES this appendix):
% - Appendix CCC (METHOD-DOCTYPE): Computational implementation
...
\item For computational implementation: See Appendix CCC
\end{itemize}
...
Appendix CCC (METHOD-DOCTYPE) provides the \textit{how}:
...
\begin{tcolorbox}[colback=green!10!white, colframe=green!75!black,
    title=\textbf{Appendix DDD: Summary}]
...
\begin{table}[htbp]
\centering
\caption{Symbols Introduced in Appendix DDD}
