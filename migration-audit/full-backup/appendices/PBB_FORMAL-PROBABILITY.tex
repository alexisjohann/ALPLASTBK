...
\end{itemize}
Institutional change is typically slow but can exhibit punctuated equilibrium \citep{PAP-PAP-north1990institutionsinstitutions}.
...
\item Loss aversion amplifies inertia: $\lambda \approx 2$ \citep{PAP-kahneman1979prospectprospect, tversky1991loss}
\end{itemize}
...
\item Identity-based preferences become stable \citep{PAP-akerlof2000identity}
