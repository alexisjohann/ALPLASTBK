...
\chapter*{Appendix SA: Sandro Ambühl Research Integration}
\addcontentsline{toc}{chapter}{Appendix SA: LIT-AMBÜHL - Beliefs, Organ Markets \& Informed Consent}
\label{app:ambuhl}
...
\textbf{Builds On:}
\begin{itemize}
    \item Appendix RO (LIT-ROTH): Market design and repugnance
    \item Appendix AU (CORE-AWARE): Awareness and comprehension
    \item Appendix GN (LIT-GNEEZY): Crowding out of intrinsic motivation
...
\begin{itemize}
    ...
    \item Appendix V (CORE-WHEN): Contextual effects on beliefs
...
\begin{itemize}
    ...
    \item Appendix AN (METHOD-LLMMC): Belief elicitation
\end{itemize}
\end{tcolorbox}
...
\begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=Axiom SA-1: Price-Risk Inference]
...
\begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=Axiom SA-2: Repugnance as Belief Channel]
...
\begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=Axiom SA-3: Comprehension Deficit]
...
\begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=Axiom SA-4: Informed Consent Paradox]
...
\begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=Axiom SA-5: Justified Paternalism Conditions]
...
\begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=Axiom SA-6: Incentive-Belief Interaction]
