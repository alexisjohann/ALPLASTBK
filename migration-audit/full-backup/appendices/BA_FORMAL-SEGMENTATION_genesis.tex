...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Appendix BA: Header Block]
...
\subsection{WHO (Appendix AAA): Levels and Segment Distributions}
...
\subsection{WHAT (Appendix C): Utility Dimensions Drive Clustering}
...
\subsection{HOW (Appendix B): Complementarities Shape Preference Prototypes}
...
\subsection{WHEN (Appendix V): Context Determines Cluster Structure}
...
\subsection{WHERE (Appendix BBB): Parameters Estimated Per Cluster}
...
\subsection{AWARE (Appendix AU): Awareness Creates Cluster Visibility}
...
\subsection{READY (Appendix AV): Willingness Operates Within and Across Clusters}
...
\subsection{STAGE (Appendix AW): Behavioral Change Journey Differs By Cluster}
...
Appendix HHH Axiom HHH-5 (Segment Specificity) formalizes what BA establishes empirically:
the same intervention has dramatically different effects on different segments.

\textbf{Segment Multipliers $\sigma_s$ (from HHH Axiom HHH-5):}
\begin{equation}
...
\textbf{Cross-Reference:} See Appendix HHH Section 4 (Axiom HHH-5) for formal specification.
...
\cite{nosek2018registered, osc2015}
...
\cite{button2013power, bland1995multiple, camerer2018evaluatingevaluating}
...
\cite{camerer2018evaluatingevaluating, osc2015, PAP-nosek2015}
...
\begin{tcolorbox}[colback=green!10!white, colframe=green!75!black,
    title=\textbf{Appendix BA: Summary}]
...
\begin{table}[htbp]
\centering
\caption{Symbols in Appendix BA (Segmentation Genesis)}
...
\textbf{This Appendix BA references:}
\begin{itemize}[nosep]
\item \textbf{Appendix AW} (CORE-STAGE): BCJ dynamics differ by cluster
\item \textbf{Appendix AV} (CORE-READY): Willingness thresholds differ by cluster
\item \textbf{Appendix AU} (CORE-AWARE): Awareness distributions shape clustering
\item \textbf{Appendix C} (CORE-WHAT): Utility dimensions define clustering space
\item \textbf{Appendix V} (CORE-WHEN): Context modulates cluster structure
