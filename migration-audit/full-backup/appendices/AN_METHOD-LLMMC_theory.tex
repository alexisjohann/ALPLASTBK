...
\hrule
\vspace{0.5em}
\noindent\textit{Cross-references: Appendix CTW ($\Psi$-Dimensions validation), Appendix EPS (Epistemics of Deviation), Appendix THL1 (Evaluation Protocol)}
...
$\rightarrow$ Appendix CTW (validation) $\rightarrow$ Appendix EST (parameters)
