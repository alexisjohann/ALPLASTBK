...
See \textbf{Appendix GLS: Glossary of Terms} for comprehensive notation and concepts. Key terms used in this appendix:
...
For ongoing research, practitioners should document results systematically in the FFF (Framework Falsification \& Feedback) registry (see Appendix GLS).
...
\item Appendix GLS: Glossary (notation and terminology)
\end{itemize}
