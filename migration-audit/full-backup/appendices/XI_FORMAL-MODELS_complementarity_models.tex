...
% HEADER BLOCK
% ----------------------------------------------------------------------------
\begin{tcolorbox}[colback=blue!5!white,colframe=blue!75!black,title=\textbf{Appendix XI: FORMAL-MODELS}]
...
\textbf{Prerequisite:} Appendix X (FORMAL-FOUND) establishes WHAT complementarity is. This appendix shows HOW to model it mathematically.
...
% REFERENCES
% ============================================================================
\section{Key References by Model}
