...
\begin{itemize}[nosep]
    \item Appendix AU (CORE-AWARE): Level-$k$ $\leftrightarrow$ Awareness $A(\cdot)$
    \item Appendix B (CORE-HOW): Strategic complementarity $\gamma$
    \item Appendix LIT-META Section 11: M\&N (2018) generative framework
    \item Appendix AJ (Social Preferences): Fairness in games
\end{itemize}
...
\textbf{Cross-Reference:} Appendix LIT-META Section 11 (full treatment),
Appendix B (complementarity $\gamma$), Appendix AU (awareness $A(\cdot)$).
...
Behavioral game theory intersects with social preferences (Appendix U):
\begin{equation}
...
\textbf{Cross-Reference.} Appendix LIT-META Section 11 (full integration).
...
\begin{itemize}[nosep]
    \item Appendix AU (CORE-AWARE): Awareness $A(\cdot)$ formalization
    \item Appendix B (CORE-HOW): Complementarity $\gamma$ structure
    \item Appendix LIT-META Section 11: M\&N generative framework
    \item Appendix AJ: Social preferences in games
    \item Appendix AG: Complexity economics and heterogeneity
\end{itemize}
