...
% - Appendix DER (FORMAL-DERIVE): Mathematical foundations
% - Appendix PRF (FORMAL-PROOF): C* derivations and proofs
% - Appendix CAM (REF-META): Metatheoretical foundations
% - Appendix EST (CORE-WHERE): Parameter estimation framework
%
...
\item For formal C* theory: See Appendix PRF (FORMAL-PROOF)
...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=Quick Reference: Appendix MCD]
...
\textbf{Cross-References:} Appendix DER (FORMAL-DERIVE), Appendix PRF (FORMAL-PROOF),
Appendix CAM (REF-META), Appendix EST (CORE-WHERE), Appendix LLM1 (METHOD-LLMMC)
\end{tcolorbox}
...
\begin{itemize}[nosep]
    \item FORMAL-DERIVE $\rightarrow$ Appendix DER
...
See Appendix PRF, Section D.1 for complete proof.
\end{proof}
...
See Appendix PRF, Section D.2 for complete conditions.
\end{proof}
...
\begin{proof}
Standard linearization argument. See Appendix PRF, Section D.3.
\end{proof}
...
Appendix EST for the complete hierarchy.
...
\item Train on $FEH-1$ folds, predict on held-out fold
...
\begin{tcolorbox}[colback=green!10!white, colframe=green!75!black,
    title=\textbf{Appendix PAP2: Summary}]
...
\begin{table}[htbp]
\centering
\caption{Symbols Introduced in Appendix PAP2}
...
with behavioral learning theories \citep{PAP-PAP-camerer2004neuroeconomicscognitive}.
...
\begin{table}[htbp]
\centering
\caption{Research Roadmap for Appendix PAP2}
...
\begin{itemize}[nosep]
    ...
    \citet{PAP-PAP-camerer2004neuroeconomicscognitive}
...
\bibitem{PAP-PAP-camerer2004neuroeconomicscognitive} Camerer, C.F., Ho, T.H., \& Chong, J.K. (2004).
...
Appendix DER (FORMAL-DERIVE: Mathematical Foundations),
Appendix PRF (FORMAL-PROOF: Theorem Demonstrations),
Appendix CAM (REF-META: Metatheory),
