...
\textbf{Dependencies:} & Appendix AAA (Aggregation Levels) \\
 & Appendix C (FEPSDE Utility Structure) \\
 & Appendix V (8Ψ Context Dimensions) \\
...
\begin{itemize}[nosep]
    ...
    \item For empirical values: See Appendix BBB (Parameter Calibration)
\end{itemize}
...
\textbf{New in 2026:} See also \textbf{Appendix HI (CORE-HIERARCHY)}---Decision Hierarchy \& Strategic Coherence. HI formalizes how the $\Gamma$ complementarity matrix creates stratification into L0-L1-L2-L3 decision levels via Theorem T1 (Universal L2 Complexity Formula). HI Axiom A1 grounds the Complementarity Principle in Milgrom \& Roberts (1995).
...
\textbf{The Exclusion Principle} (see Appendix XVIII: LIT-FEHR-METHOD):
...
\textbf{Cross-Reference:} Appendix XVIII provides the full philosophy of science
...
with context changes (see Appendix V, CORE-WHEN).
...
\citep{roberts2004}. See Appendix X for detailed coverage.
...
\vspace{1cm}
\begin{tcolorbox}[colback=gray!10, colframe=gray!50, title=Appendix B Structure]
...
\begin{itemize}
    \item For formal supermodularity theory: See Appendix X (Milgrom-Roberts)
    \item For FEPSDE dimensions: See Appendix C (CORE-WHAT)
    \item For aggregation levels: See Appendix AAA (CORE-WHO)
    \item For context specification: See Appendix V (CORE-WHEN)
\end{itemize}
\end{tcolorbox}
...
between context and utility. From Appendix C, awareness determines which utility 
...
\citet{PAP-becker1988theory} model habit formation as intertemporal complementarity 
...
context assessment (Appendix C) improves allocation efficiency.
...
treated comprehensively in \textbf{Appendix BBB: The Epistemics of Parameter 
...
\textbf{Key parameters estimated in Appendix BBB:}
\begin{center}
\begin{tabular}{lcl}
\toprule
...
See Appendix BBB for the complete methodological framework and current parameter 
values.
...
\begin{tcolorbox}[colback=green!10!white, colframe=green!75!black, 
    title=\textbf{Appendix B: Complete Summary}]
...
\begin{enumerate}[nosep]
    ...
    \item The three-tier epistemic system (Appendix BBB) explicitly distinguishes 
    empirical estimates from theoretical placeholders.
    \item Symmetry and sparsity reduce effective dimensionality.
    \item LLM-MC methodology (Appendix AN) provides synthetic priors that 
...
\begin{enumerate}[nosep]
    ...
    related to cognitive bounds. See Appendix AU (Awareness).
...
\bottomrule
\end{tabular}
\caption{Notation guide for Appendix B}
\label{tab:notation}
\end{table}
...
%==============================================================================
% GLOSSARY OF SYMBOLS (Required - links to Appendix G)
%==============================================================================
...
framework, see \textbf{Appendix G} (\textit{Glossary and Notation}).
...
\textbf{Note:} \checkmark = Defined in Appendix G; NEW = Introduced in this appendix 
...
\toprule
\textbf{Appendix} & \textbf{CORE Question} & \textbf{Connection to Appendix B} \\
\midrule
