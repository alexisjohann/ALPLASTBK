...
\begin{itemize}[nosep]
    ...
    \item $\lambda = 2.25$: Loss aversion parameter is well-replicated \citep{PAP-tversky1992advances}
\end{itemize}
...
The discovery of \textbf{Nudging} \citep{PAP-sunstein2014nudge} provides a historical parallel for IE-CONJ-1:
...
\begin{itemize}[nosep]
\item \citet{PAP-sunstein2014nudge} --- Nudge theory and choice architecture
...
\begin{itemize}[nosep]
\item \citet{PAP-rogers2003diffusion} --- Diffusion of innovations (segment archetypes)
\item \citet{PAP-fehr1999theory} --- Theory of fairness (heterogeneous preferences)
\item \citet{PAP-gaechter2010socialpreferences} --- Heterogeneity in social preferences
\item \citet{PAP-PAP-camerer2003behavioralbehavioral} --- Behavioral game theory (types)
\end{itemize}
...
\item \citet{PAP-PAP-kahneman1979prospectprospect} --- Prospect theory
...
\begin{itemize}[nosep]
    ...
    \item[$x$] \textbf{$I_{\text{WHO}}$+$I_{\text{WHAT},F}$ ($\gamma = -0.2$):} Identity + Financial. \citet{PAP-tirole_benabou_2003_intrinsic_motivation}: ``Intrinsic and Extrinsic Motivation''; \citet{ariely2009predictably}. \textit{Mechanism:} Payments crowd out identity-based motivation.
...
\begin{itemize}[nosep]
    ...
    \item[$w$] \textbf{$I_{\text{WHO}}$+$I_{\text{WHO},o}$ ($\gamma = +0.4$):} Identity + Social. \citet{PAP-akerlof2000identity}: ``Economics and Identity''. \textit{Mechanism:} Social norms reinforce identity.

    \item[$n$] \textbf{$I_{\text{WHEN}}$+$I_{\text{WHEN},t}$ ($\gamma = +0.3$):} Contextual + Temporal. \citet{PAP-sunstein2014nudge}; \citet{benartzi2007save}. \textit{Mechanism:} Defaults + timing optimize choice architecture.
\end{itemize}
...
\textbf{Sources:} \citet{michie2013behavior} (BCT Taxonomy), \citet{PAP-sunstein2014nudge} (Choice Architecture), \citet{deci2000what} (Motivation Theory)
...
\begin{itemize}[nosep]
    ...
    \item \citet{PAP-gaechter2010socialpreferences} --- Conditional cooperators vs.\ free-riders
    \item \citet{PAP-rogers2003diffusion} --- Innovators, early adopters, laggards
