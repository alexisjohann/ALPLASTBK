...
\begin{itemize}[noitemsep]
    \item Appendix HOW (Levels): $L$-Struktur für Humankapital-Investition
    \item Appendix WAT (FEPSDE): $\Psi_C$ als Human Capital Dimension
    \item Appendix OPS (Operationalization): Empirische Messverfahren
    \item Appendix GLS (Glossary): Standardnotation
\end{itemize}
\textbf{Wird verwendet von:}
\begin{itemize}[noitemsep]
    \item Appendix LIS1 (Trade): Labor-Market-Interaktionen
    \item Appendix SUN (Predictions): Testbare Arbeitsmarkt-Vorhersagen
...
\begin{itemize}[nosep]
    \item Levels $\rightarrow$ Appendix HOW
    \item FEPSDE $\rightarrow$ Appendix WAT
    \item Operationalization $\rightarrow$ Appendix OPS
    \item Glossary $\rightarrow$ Appendix GLS
    \item Predictions $\rightarrow$ Appendix SUN
\end{itemize}
...
\begin{tcolorbox}[colback=yellow!5!white,colframe=yellow!75!black,title=Axiom LAB-1: Fundamental Principle]
\textbf{Axiom LAB-1 (Core Assumption):}
...
\begin{tcolorbox}[colback=yellow!5!white,colframe=yellow!75!black,title=Axiom LAB-2: Complementarity]
\textbf{Axiom LAB-2 (Complementarity):}
...
Für vollständige Definitionen siehe \textbf{Appendix GLS} (REF-GLOSSARY).
