...
\title{\textbf{Appendix QLY: Quality Assessment Framework}\\
...
\begin{table}[htbp]
\centering
\caption{Key Symbols in Appendix QLY}
\begin{tabular}{lll}
\toprule
...
Key terms defined in Appendix GLS (Master Glossary):
\begin{itemize}
...
$\rightarrow$ \textbf{Full Glossary:} See Appendix GLS
