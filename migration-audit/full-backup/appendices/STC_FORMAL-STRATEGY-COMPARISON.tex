...
\begin{itemize}[nosep]
\item Appendix COR (SDM-1.0): Implementation of chosen strategy
\item Appendix HOW (Complementarities): Theoretical foundation for γ-matrix
\item Appendix EST (Parameter Repository): Parameter values and calibration
\end{itemize}
...
\item For implementation after choice: See SDM-1.0 (Appendix COR)
\end{itemize}
...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=Quick Reference: Appendix STC]
...
\textbf{Cross-References:} Appendix HOW (Complementarities), Appendix COR (SDM-1.0 Implementation), Appendix EST (Parameter Repository)
...
\begin{itemize}[nosep]
    \item SDM-1.0 $\rightarrow$ Appendix COR
    \item Complementarities $\rightarrow$ Appendix HOW
    \item Parameter Repository $\rightarrow$ Appendix EST
    \item Complementarities $\rightarrow$ Appendix HOW
    \item SDM-1.0 Implementation $\rightarrow$ Appendix COR
\end{itemize}
...
\begin{tcolorbox}[colback=yellow!5!white, colframe=yellow!75!black,
    title=Integration: SOCM $\leftrightarrow$ Appendix HOW (Complementarities)]
...
\begin{tcolorbox}[colback=green!10!white, colframe=green!75!black,
    title=Appendix STC: Strategy Option Comparison Model v1.0 --- Summary]
...
\begin{table}[htbp]
\centering
\caption{Symbols Introduced in Appendix STC (SOCM)}
...
Appendix COR (SDM-1.0: Implementation),
