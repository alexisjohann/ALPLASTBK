...
\textbf{Hierarchy:} & Tier 1 $\succ$ Tier 2 $\succ$ Tier 3 (EST Axiom BBB-1) \\
\textbf{LLMMC Pipeline:} & Appendix CAL \\
\textbf{Literature Values:} & Appendix EST, WHERE \\
\textbf{Practical Guide:} & Appendix JJJ \\
\textbf{Complementarity $\gamma$:} & Appendix CMP \\
...
\begin{itemize}[nosep]
    \item Complete tier hierarchy theory → Appendix EST
    \item Full LLMMC implementation details → Appendix CAL
    \item Parameter value tables → Appendix WHERE
    \item Complementarity estimation theory → Appendix CMP
\end{itemize}
...
\begin{tcolorbox}[colback=green!5!white, colframe=green!75!black, title=BBB Axiom BBB-1: Evidential Precedence]
...
\begin{itemize}[nosep]
    ...
    \item \textbf{Primary Source:} Appendix EST, \texttt{bcm\_master.bib}
\end{itemize}
...
\begin{itemize}[nosep]
    ...
    \item \textbf{Primary Source:} Appendix EST, WHERE
\end{itemize}
...
\begin{itemize}[nosep]
    ...
    \item \textbf{Primary Source:} Appendix CAL (LLMMC pipeline)
\end{itemize}

\textbf{Full Specification:} Appendix EST provides the complete axiomatic treatment of the three-tier hierarchy.
...
\begin{itemize}[nosep]
    \item \textbf{Primary Reference:} Appendix CMP (METHOD-COMP)
    \item \textbf{Methods:}
        \begin{itemize}[nosep]
...
\textbf{Full Pipeline:} Appendix CAL (METHOD-LLMMC)
...
\textbf{Full derivation and validation:} Appendix CAL, Section 3.
...
Consulting Appendix EST/WHERE tables:
\begin{itemize}[nosep]
...
This appendix integrates with the Developer Pipeline (Appendix DP) at Stage 3 (Calibration):
...
\begin{itemize}
    \item \textbf{BBB-1 (Evidential Precedence):} Tier 1 $\succ$ Tier 2 $\succ$ Tier 3 - Appendix EST
    ...
    \item \textbf{Complementarity Identification:} $\gamma$ requires special methods - Appendix CMP
    \item \textbf{R-Score Threshold:} GO/PILOT/NO-GO at 1.2/0.8 - Appendix CAL
\end{itemize}
...
Appendix PM serves as the \textbf{navigation hub} for EBF's distributed parameterization methodology. Rather than repeating content, it provides:
...
\begin{itemize}[nosep]
    \item \textbf{DellaVigna (2009)} - ``Psychology and Economics: Evidence from the Field'' \citep{PAP-dellavigna2009psychology} - \textit{Comprehensive meta-analysis of behavioral parameters across domains}
    ...
    \item \textbf{DellaVigna (2020)} - ``Structural Behavioral Economics'' \citep{PAP-dellavigna2020structural} - \textit{Handbook chapter on structural estimation}
\end{itemize}

\subsection{Calibration Methodology}

\begin{itemize}[nosep]
    \item \textbf{Rabin (2000)} - ``Risk Aversion and Expected-Utility Theory: A Calibration Theorem'' \citep{PAP-rabin2000risk} - \textit{Foundational calibration methodology}
...
\begin{itemize}[nosep]
    ...
    \begin{itemize}[nosep]
        ...
        \item Ericson \& Laibson (2017) - Intertemporal choice handbook \citep{PAP-ericson2017money}
    \end{itemize}
    \item \textbf{Context Effects:}
    \begin{itemize}[nosep]
        \item Choi et al. (2004) - Default effects \citep{choi2004optimal}
        \item Gabaix \& Laibson (2006) - Shrouded attributes \citep{PAP-gabaix2006shrouded}
    \end{itemize}
\end{itemize}
...
\begin{itemize}[nosep]
    \item \textbf{DellaVigna \& Linos (2022)} - ``RCTs to Scale'' \citep{PAP-dellavigna2022rcts} - \textit{Large-scale nudge validation}
    \item \textbf{DellaVigna \& Pope (2018)} - ``What Motivates Effort?'' \citep{PAP-dellavigna2018motivates} - \textit{Expert forecasts vs. actual effects}
\end{itemize}

\medskip
\textbf{Complete Parameter Bibliography:} See Appendix EST for the full 200+ parameter values with sources.
