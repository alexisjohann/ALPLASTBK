...
\end{equation}
Beispiel: $\lambda \in [1.5, 2.8]$ basierend auf der originalen Prospect Theory \citep{PAP-PAP-kahneman1979prospectprospect,kahneman1991loss} und nachfolgenden Meta-Analysen. Ein Modell, das $\lambda = 5.0$ benötigt, ist falsifiziert, da ausserhalb des empirisch etablierten Intervalls.
...
\end{equation}
Wenn $H_0$ die Daten systematisch besser erklärt (via Likelihood-Ratio, BIC, Cross-Validation), ist EBF falsifiziert. Die Komplementaritäts-These ist direkt aus der empirischen Literatur zu Interaktionseffekten abgeleitet \citep{PAP-gaechter2002altruistic,PAP-gaechter2001conditional}.
...
\begin{itemize}[nosep]
    \item Prospect Theory: \citet{PAP-PAP-kahneman1979prospectprospect}, \citet{kahneman1991loss}
    \item Falsifikationismus: \citet{popper1959logic}
    \item Soziale Präferenzen: \citet{PAP-gaechter2002altruistic}, \citet{PAP-gaechter2001conditional}
...
\begin{enumerate}
    \item \textbf{Struktur-Entscheidungen:} 10C-Dimensionen sind framework-definiert, nicht LLM-generiert. Die Utility-Dimensionen (FEPSDE) folgen \citet{PAP-gaechter2002altruistic}.
    \item \textbf{Parameter-Werte:} Kommen aus BBB (Literatur), nicht aus LLM-``Wissen''. Beispiel: Loss Aversion $\lambda$ aus \citet{PAP-PAP-kahneman1979prospectprospect}.
    \item \textbf{Kausal-Aussagen:} Identifikation erfordert Forschungsdesign \citep{PAP-PAP-camerer2003behavioralbehavioral}, nicht LLM-Korrelationen.
...
\textbf{Schlüsselreferenzen:}
\begin{itemize}[nosep]
    \item Behavioral Economics Framework: \citet{PAP-PAP-camerer2003behavioralbehavioral}, \citet{thaler2015misbehaving}
    ...
    \item Kooperation: \citet{fehr2002cooperation}, \citet{PAP-gaechter2001conditional}
\end{itemize}
...
$\lambda = 2.25$ basiert auf \citet{PAP-PAP-kahneman1979prospectprospect}, repliziert in >100 Studien. Meta-Analyse-Schätzung: $\hat{\lambda} = 2.25$ mit 95\%-CI $[1.93, 2.57]$.
...
\begin{itemize}[nosep]
    \item Originalschätzung: $\lambda \approx 2.25$ \citep{PAP-PAP-kahneman1979prospectprospect}
...
\begin{itemize}[nosep]
    \item Quasi-hyperbolisch: $\beta \in [0.7, 0.9]$ \citep{laibson1997golden,PAP-PAP-odonoghue1999doingdoing}
...
\begin{itemize}[nosep]
    ...
    \item Conditional Cooperation: $\sigma \in [0.10, 0.25]$ \citep{PAP-gaechter2001conditional}
\end{itemize}
...
\begin{itemize}[nosep]
    \item Prospect Theory: \citet{PAP-PAP-kahneman1979prospectprospect}, \citet{kahneman1991loss}
    \item Hyperbolisches Diskontieren: \citet{laibson1997golden}, \citet{PAP-PAP-odonoghue1999doingdoing}
    \item Soziale Präferenzen: \citet{fehr1993reciprocity}, \citet{PAP-gaechter2001conditional}, \citet{PAP-gaechter2002altruistic}
    \item Methodik: \citet{PAP-PAP-camerer2003behavioralbehavioral}, \citet{camerer2018evaluatingevaluating}
\end{itemize}
...
\textbf{Tier 1 (Stark):} Die 2,328 integrierten Papers liefern RCT-Evidenz für einzelne Mechanismen (Loss Aversion \citep{PAP-PAP-kahneman1979prospectprospect}, Social Proof \citep{PAP-cialdini2006influence,PAP-allcott2011social}, Defaults \citep{johnson2003defaults,choi2004better}). Diese Evidenz ist robust.
...
Loss Framing & $+5\%$ bis $+15\%$ & \citet{PAP-PAP-kahneman1979prospectprospect}, \citet{benartzi1995myopic} \\
Commitment & $+10\%$ bis $+20\%$ & \citet{benartzi2007save}, \citet{bryan2010commitment} \\
\end{tabular}
\end{center}

Diese Effekte sind in hunderten von RCTs repliziert und robust über Kontexte \citep{PAP-PAP-camerer2003behavioralbehavioral,thaler2015misbehaving}.
...
\textbf{Schlüsselreferenzen:}
\begin{itemize}[nosep]
    \item Komponenten-Evidenz: \citet{PAP-PAP-kahneman1979prospectprospect}, \citet{johnson2003defaults}, \citet{PAP-allcott2011social}
    \item Defaults in Retirement: \citet{choi2004better}, \citet{benartzi2007save}
    \item Methodologie: \citet{PAP-PAP-camerer2003behavioralbehavioral}, \citet{camerer2018evaluatingevaluating}
