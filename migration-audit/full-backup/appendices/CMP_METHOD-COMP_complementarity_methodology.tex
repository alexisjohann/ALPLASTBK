...
% HEADER BLOCK
% ----------------------------------------------------------------------------
\begin{tcolorbox}[colback=orange!5!white,colframe=orange!75!black,title=\textbf{Appendix CMP: METHOD-COMP}]
...
\textbf{Theoretical Foundation:} Appendix GTC (FORMAL-GTC) establishes \textit{what} complementarities are and \textit{why} they must be consistent. This appendix establishes \textit{how} to measure them.
...
\begin{itemize}[noitemsep]
    ...
    \item Appendix PRF: Mathematical Formalization
\end{itemize}

\textbf{Application Domains:}
\begin{itemize}[noitemsep]
    \item Appendix CTW (MEP): Portfolio optimization using $\gamma$
    \item Appendix MEQ (MEQ): Equilibrium analysis using $\gamma$
    \item Appendix HHH: Intervention Toolkit
\end{itemize}

\textbf{Estimation Infrastructure:}
\begin{itemize}[noitemsep]
    \item Appendix EST: Parameter Repository
    \item Appendix LLM1: LLM Monte Carlo Methods
    \item Appendix OPS: Empirical Validation
\end{itemize}
\end{tcolorbox}
...
\begin{enumerate}[noitemsep]
    ...
    \item \citet{thaler1999} - Mental accounting matters
...
\begin{enumerate}[noitemsep]
    ...
    \item \citet{PAP-dellavigna2009psychology} - Psychology and economics: Evidence from the field
...
\begin{tcolorbox}[colback=yellow!5!white,colframe=yellow!75!black,title=Axiom CMP-1: Fundamental Principle]
\textbf{Axiom CMP-1 (Core Assumption):}
...
\begin{tcolorbox}[colback=yellow!5!white,colframe=yellow!75!black,title=Axiom CMP-2: Complementarity]
\textbf{Axiom CMP-2 (Complementarity):}
...
Following Appendix GTC (GTC), we have six complementarity types requiring distinct measurement approaches:
...
\begin{itemize}[noitemsep]
    \item Search Appendix EST (Parameter Repository)
...
From Appendix EST and meta-analyses:
\begin{itemize}
...
Key terms in this appendix (see also Appendix GLS for complete glossary):
...
\begin{description}
    ...
    \item[Bridge equation] Links structural and operative complementarity (GTC-6)
