...
\chapter*{Appendix RA: Matthew Rabin Research Integration}
\addcontentsline{toc}{chapter}{Appendix RA: LIT-RABIN - Reference-Dependent Preferences \& Behavioral Theory}
\label{app:rabin}
...
\begin{itemize}
    ...
    \item Appendix C (CORE-WHAT): Utility dimensions
    \item Appendix AU (CORE-AWARE): Awareness mechanisms
\end{itemize}

\textbf{Supports:}
\begin{itemize}
    \item Appendix AV (CORE-READY): Willingness and action thresholds
    \item Appendix LO (LIT-LOEWENSTEIN): Visceral influences, projection bias
...
\begin{itemize}
    ...
    \item Appendix CA (LIT-CAMERER): Strategic behavior, game theory
...
% ============================================================================
\begin{abstract}
This appendix integrates Matthew Rabin's foundational contributions to behavioral economics into the Evidence-Based Framework. Rabin's work provides rigorous theoretical foundations for reference-dependent preferences (with Kőszegi), present bias and self-control (with O'Donoghue), belief biases (law of small numbers), and social preferences (with Charness). We formalize six core axioms (RA-1 to RA-6) that connect his theoretical innovations to EBF. Key parameters include the projection bias coefficient ($\alpha_{proj} = 0.4$), present bias ($\beta = 0.7$), and loss aversion in reference-dependent utility ($\lambda = 2.0$). John Bates Clark Medal 2001; MacArthur Fellowship.
\end{abstract}
...
\begin{itemize}[nosep]
    ...
    \item LIT-LOEWENSTEIN $\rightarrow$ Appendix LO
\end{itemize}
...
\subsection{Axiom RA-1: Expectations-Based Reference Points}

\begin{tcolorbox}[colback=blue!5!white,colframe=blue!75!black,title=Axiom RA-1: Expectations-Based Reference Points]
...
\subsection{Axiom RA-2: Present Bias with Varying Awareness}

\begin{tcolorbox}[colback=blue!5!white,colframe=blue!75!black,title=Axiom RA-2: Present Bias and Self-Awareness]
...
\subsection{Axiom RA-3: Projection Bias}

\begin{tcolorbox}[colback=blue!5!white,colframe=blue!75!black,title=Axiom RA-3: Projection Bias]
...
\subsection{Axiom RA-4: Law of Small Numbers}

\begin{tcolorbox}[colback=blue!5!white,colframe=blue!75!black,title=Axiom RA-4: Law of Small Numbers]
...
\subsection{Axiom RA-5: Narrow Bracketing}

\begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=Axiom RA-5: Narrow Bracketing]
...
\subsection{Axiom RA-6: Fairness in Games}

\begin{tcolorbox}[colback=green!5!white,colframe=green!75!black,title=Axiom RA-6: Reciprocal Fairness]
