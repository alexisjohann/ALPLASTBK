...
% - Appendix B (CORE-HOW): Complementarity framework ($\gamma$)
% - Appendix V (CORE-WHEN): Context framework ($\Psi$)
% - Appendix C (CORE-WHAT): Welfare dimensions (FEPSDE)
% - Appendix AAA (CORE-WHO): Welfare hierarchy (Levels)
%
% DEPENDENTS (what REQUIRES this appendix):
% - Appendix Z (DOMAIN-MACRO): Macroeconomics builds on financial market analysis
% - Appendix AA (DOMAIN-LABOR): Labor markets reference asset pricing insights
%
% =============================================================================
...
\textbf{Cross-References:} Appendix B (CORE-HOW), Appendix V (CORE-WHEN),
Appendix Z (DOMAIN-MACRO), Appendix L (LIT-THALER)
\end{tcolorbox}
...
\begin{tcolorbox}[colback=green!10!white, colframe=green!75!black,
    title=\textbf{Appendix Y: Summary}]
...
\textbf{Integration:} This appendix connects to Appendix B (CORE-HOW) via
portfolio complementarities and to Appendix V (CORE-WHEN) via information
context effects.
...
\begin{table}[htbp]
\centering
\caption{Symbols Introduced in Appendix Y}
\label{tab:Y-symbols}
\renewcommand{\arraystretch}{1.3}
...
\bibitem{PAP-fama1970efficient} Fama, E.F. (1970). Efficient Capital Markets: A Review of Theory and Empirical Work. \textit{Journal of Finance}, 25(2), 383-417.
...
Appendix V (CORE-WHEN: Context),
Appendix Z (DOMAIN-MACRO: Macroeconomics),
Appendix L (LIT-THALER: Behavioral Economics).
