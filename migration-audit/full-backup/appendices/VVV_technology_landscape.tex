...
\begin{itemize}[nosep]
    \item Master $\rightarrow$ Appendix VVV
\end{itemize}
...
\begin{itemize}[nosep]
    \item Appendix VVV (Master): Business Model framework
    \item Appendix VVV.1: Technological Roadmap
...
\begin{tcolorbox}[colback=yellow!5!white,colframe=yellow!75!black,title=Axiom VVV-1: Fundamental Principle]
\textbf{Axiom VVV-1 (Core Assumption):}
...
\begin{tcolorbox}[colback=yellow!5!white,colframe=yellow!75!black,title=Axiom VVV-2: Complementarity]
\textbf{Axiom VVV-2 (Complementarity):}
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=\textbf{Summary: Appendix VVV.0 Key Points}]
...
\begin{tcolorbox}[colback=red!5!white, colframe=red!75!black,
    title=\textbf{Critical Foundations for Appendix VVV.0}]
...
\begin{enumerate}
    ...
    \item \textbf{Appendix VVV:} Strategic framework context
\end{enumerate}
...
\begin{itemize}[nosep]
    ...
    \item Appendix VVV7: McKinsey AI 2025 detailed analysis
\end{itemize}
...
\begin{table}[htbp]
\centering
\caption{Key Symbols in Appendix VVV}
\begin{tabular}{lll}
\toprule
