...
% - Appendix HI: CORE-INTELLIGENCE (Menschlichkeit × Mechanik)
% - Appendix BX: CORE-BEATRIX (three-tier hierarchy)
% - Appendix FM: METHOD-FRAMEWORK (scientific reusability)
%
% =============================================================================
...
\item For implementation: Appendix BX (BEATRIX architecture)
\end{itemize}
...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=Quick Reference: Appendix PR]
...
\textbf{Cross-References:} Appendix AAA (WHO), B (HOW), C (WHAT), V (WHEN), HI (INTELLIGENCE), BX (BEATRIX), G (Glossary)
\end{tcolorbox}
...
\begin{itemize}[nosep]
    \item Detailed 10C framework $\rightarrow$ Appendix AAA-HI (CORE appendices)
    \item Technical LLM architecture $\rightarrow$ Appendix BX (CORE-BEATRIX)
    \item Mechanics Thesis details $\rightarrow$ Appendix HI (CORE-INTELLIGENCE)
    \item Parameter estimation $\rightarrow$ Appendix BBB (CORE-WHERE)
\end{itemize}
...
\begin{itemize}[nosep]
    \item 7 formal axioms (PR-1 to PR-7)
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom PR-1: Complementarity]
...
\textbf{Cross-Reference:} Appendix B (CORE-HOW) for full $\gamma$-matrix specification.
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom PR-2: Context Primacy]
...
\textbf{Cross-Reference:} Appendix V (CORE-WHEN) for full context specification.
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom PR-3: Systematic 10C Analysis]
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom PR-4: Evidence Primacy]
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom PR-5: Falsifiable Predictions]
...
\textbf{Cross-Reference:} Appendix AN (METHOD-LLMMC) for Monte Carlo estimation.
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom PR-6: The Autor-Fehr Synthesis]
...
\textbf{Cross-Reference:} Appendix HI (CORE-INTELLIGENCE), Appendix BX (CORE-BEATRIX).
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom PR-7: Knowledge Accumulation]
...
\textbf{Cross-Reference:} Appendix BX (CORE-BEATRIX) for persistence architecture.
...
\begin{tcolorbox}[colback=blue!10!white, colframe=blue!75!black,
    title=\textbf{Theorem PR-1: EBF Completeness}]
...
\begin{tcolorbox}[colback=green!10!white, colframe=green!75!black,
    title=\textbf{Appendix PR: Summary}]
...
\begin{table}[htbp]
\centering
\caption{Symbols Introduced in Appendix PR}
...
\begin{itemize}[nosep]
    ...
    \item \citet{PAP-searle1980minds} --- Chinese Room argument
\end{itemize}
