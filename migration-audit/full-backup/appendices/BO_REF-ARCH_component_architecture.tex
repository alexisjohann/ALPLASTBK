...
\begin{itemize}[nosep]
    ...
    \item Individual skill documentation $\rightarrow$ Appendix SK (REF-SKILLS)
    \item Database schemas in detail $\rightarrow$ Database schemas doc
    \item Validation implementation $\rightarrow$ Appendix VC (METHOD-VALIDATE)
\end{itemize}
...
\textbf{Superkey Specification:} Appendix BN (REF-SUPERKEY)
...
\textbf{SSOT:} Appendix SK (REF-SKILLS)
...
Parameter Values & Appendix BBB (CORE-WHERE) & Behavioral params \\
...
Skills Registry & Appendix SK (REF-SKILLS) & 41 commands \\
...
\textbf{Given:} Appendix HI (CORE-INTELLIGENCE): Machine Mechanics vs Human
