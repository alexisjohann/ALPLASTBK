...
\begin{itemize}
  \item Fits: Appendix AH (Temporal Context) --- already included
...
\hrule
\vspace{0.5em}
\noindent\textit{Cross-references: Appendix S (Falsifiable Predictions), 
Appendix T (Metatheory), Appendix AK (Epistemics of Deviation---diagnostic 
