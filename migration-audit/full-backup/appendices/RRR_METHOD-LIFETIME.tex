...
% - Added 4 formal axioms (RRR-1 to RRR-4) deriving parameters from behavioral theory
...
\begin{table}[htbp]
\centering
\caption{Mathematical Notation for Appendix RRR}
...
From Appendix OOO, each domain evolves according to:
...
\begin{tcolorbox}[colback=red!5!white, colframe=red!75!black, title=Axiom RRR-1: Feedback Clarity]
\textbf{Axiom RRR-1 (Feedback Clarity $\rightarrow$ Learning Rate).}
...
\begin{tcolorbox}[colback=red!5!white, colframe=red!75!black, title=Axiom RRR-2: Maintenance Requirements]
\textbf{Axiom RRR-2 (Maintenance Requirements $\rightarrow$ Decay Rate).}
...
\begin{tcolorbox}[colback=red!5!white, colframe=red!75!black, title=Axiom RRR-3: Identity Relevance]
\textbf{Axiom RRR-3 (Identity Relevance $\rightarrow$ Bayesian Update).}
...
\begin{tcolorbox}[colback=red!5!white, colframe=red!75!black, title=Axiom RRR-4: Context Stability]
\textbf{Axiom RRR-4 (Context Stability $\rightarrow$ Reversion Rate).}
...
\begin{tcolorbox}[colback=green!5!white, colframe=green!75!black, title=Theorem RRR-1: Equilibrium Time Formula]
\textbf{Theorem RRR-1 (Equilibrium Time).}
...
\begin{tcolorbox}[colback=green!5!white, colframe=green!75!black, title=Theorem RRR-2: Domain Equilibrium Ordering]
\textbf{Theorem RRR-2 (Equilibrium Ordering).}
...
\textit{Proof.}
Using Theorem RRR-1 with parameter values from Section 1:
\begin{center}
\small
\begin{tabular}{@{}lccr@{}}
\toprule
...
\begin{tcolorbox}[colback=green!5!white, colframe=green!75!black, title=Theorem RRR-3: Cross-Domain Spillover]
\textbf{Theorem RRR-3 (Cross-Domain Spillover).}
...
\begin{tcolorbox}[colback=green!5!white, colframe=green!75!black, title=Theorem RRR-4: Template Validity Conditions]
\textbf{Theorem RRR-4 (Template Validity).}
...
EBF Framework - Appendix RRR v3.0
"""
...
\begin{table}[htbp]
\centering
\caption{Key Symbols in Appendix RRR}
\begin{tabular}{lll}
\toprule
