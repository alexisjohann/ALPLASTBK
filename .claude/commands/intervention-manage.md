...
5. Projektvolumen (CHF):
   [1] TBD          [2] < CHF 25k      [3] CHF 25-50k
   [4] CHF 50-100k  [5] CHF 100-250k   [6] > CHF 250k
   [7] Exakt: CHF ___

   Abrechnungsmodell:
   [1] FIXED_PRICE  [2] TIME_AND_MATERIALS  [3] RETAINER  [4] BLENDED

6. Projektmitarbeitende:
   FA Project Lead: [GF | EB | MR | AJ | MDL | ___] | Auslastung: ___ %
   FA Team:
