...
Appendix UNMAPPED_WAT provides the complete 144-component formal specification.
\end{tcolorbox}
...
See Appendix UNMAPPED_WAT (CORE-WHAT), Section C.2 for the complete axiomatization of
...
\begin{cross-reference}
See Appendix UNMAPPED_WAT (CORE-WHAT) for the complete specification of all six dimensions
...
\begin{cross-reference}
See Appendix UNMAPPED_WHO (CORE-WHO) for the complete specification of the level hierarchy
...
\begin{cross-reference}
See Appendix UNMAPPED_SCP (Social Preferences) for the formal foundations of
...
\begin{cross-reference}
See Appendix UNMAPPED_WAT (CORE-WHAT) for the complete axiom system (144 axioms)
...
\end{itemize}
See Chapter 5 and Appendix UNMAPPED_HOW (CORE-HOW) for the complete complementarity specification.
\end{cross-reference}
...
\end{itemize}
See Chapter 9 and Appendix UNMAPPED_WEN (CORE-WHEN) for the 8-dimensional context specification.
\end{cross-reference}
...
See Appendix UNMAPPED_WHO (CORE-WHO) for the complete specification.
\end{cross-reference}
...
\textbf{Reading Path:}
\begin{itemize}
    \item For complete FEPSDE specification: Appendix UNMAPPED_WAT (CORE-WHAT)
    \item For level aggregation: Appendix UNMAPPED_WHO (CORE-WHO)
    \item For complementarity mechanics: Chapter 5 + Appendix UNMAPPED_HOW (CORE-HOW)
    \item For context modulation: Chapter 9 + Appendix UNMAPPED_WEN (CORE-WHEN)
    \item For awareness (next): Chapter 11 + Appendix UNMAPPED_AWA (CORE-AWARE)
