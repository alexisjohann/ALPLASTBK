...
% Narrative overview - Formal specifications in Appendix UNMAPPED_AWA Corollaries
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
The 59 formally derived corollaries (UNMAPPED_COR-01 to UNMAPPED_COR-59) are organized into eight categories:
...
\midrule
System-Level & UNMAPPED_COR-01--07 & A4, A35, A58 & Present Bias, Akrasia \\
Self-Community & UNMAPPED_COR-08--15 & A1a, A1b, A34 & Egocentric Bias, Bystander Effect \\
Utility-Type & UNMAPPED_COR-16--23 & A34--A37 & Tragedy of Commons, Free Rider \\
Belief-Based & UNMAPPED_COR-24--33 & A81--A90 & Confirmation Bias, Overconfidence \\
Cognitive & UNMAPPED_COR-34--41 & A9, A14, A27 & Availability, Anchoring \\
Emotional & UNMAPPED_COR-42--47 & A15--A17 & Loss Aversion, Negativity Bias \\
Social & UNMAPPED_COR-48--53 & A19--A21, A70 & Conformity, Groupthink \\
Temporal & UNMAPPED_COR-54--59 & A58--A60, A63 & Recency, Status Quo Bias \\
\midrule
...
\begin{itemize}
\item UNMAPPED_COR-05 (Temptation): $A_{INU}^{instant} = 1 \land A_{KNU}^{instant} = 0$
\item UNMAPPED_COR-14 (Empathy Gap): $A^{comm}$ requires deliberate effort
\item UNMAPPED_COR-16 (Tragedy of Commons): Individual benefits instant; collective costs not
\item UNMAPPED_COR-17 (Free Rider): $A_{INU} > A_{KNU}$ structurally
\item UNMAPPED_COR-18 (Social Dilemmas): INU crowds out KNU
\item UNMAPPED_COR-19 (NIMBY): Self-INU instant; Community-KNU not
\end{itemize}
...
\begin{equation}
\text{UNMAPPED_COR-24 to UNMAPPED_COR-33} \Leftarrow \{A81, A82, A84, A85, A89\}
\end{equation}
...
UNMAPPED_COR-43 (Loss Aversion) derives from A16 (Fear) and A8 (Asymmetry):
\begin{equation}
...
\begin{itemize}
\item \textbf{Dunning-Kruger}: UNMAPPED_COR-30 $\land$ A51 $\land$ A74
\item \textbf{Planning Fallacy}: UNMAPPED_COR-31 $\land$ UNMAPPED_COR-06 $\land$ A46
\item \textbf{Sunk Cost}: UNMAPPED_COR-28 $\land$ A85 $\land$ UNMAPPED_COR-43
\end{itemize}
