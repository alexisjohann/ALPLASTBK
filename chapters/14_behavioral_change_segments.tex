...
\textbf{Formal Mechanism (Appendix RB, Axiom RB-9):}
\begin{itemize}[nosep]
...
\textbf{Cross-Reference:} See Appendix RB §\ref{subsec:rb-fear-asking} for full formalization
of fear of asking dynamics; Appendix B (CMP-12) for asking-offering complementarity.
...
\item \textbf{Accumulate} results in a registry (Appendix REG: Framework Falsification \& Feedback Registry) with success/failure patterns by context
