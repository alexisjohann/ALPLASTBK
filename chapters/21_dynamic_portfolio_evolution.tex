...
\textbf{Essential:}
\begin{itemize}[nosep]
\item Appendix UNMAPPED_KKK (METHOD-DYNAMIC) --- Formal ODE/Markov models, Bayesian learning, convergence proofs
\item Appendix TKT (METHOD-TOOLKIT) --- Portfolio complementarity, coherence criteria
\end{itemize}

\textbf{Supporting:}
\begin{itemize}[nosep]
\item Appendix UNMAPPED_JJJ (METHOD-PSG) --- Parameter sourcing (where do Θ values come from?)
\item Appendix UNMAPPED_BBB (CORE-WHERE) --- Parameter repository (literature values)
\end{itemize}
...
\vspace{0.2cm}
\textit{Siehe: Chapter 11 §11.20 (EMERGE), Chapter 20 §20.7 (Constraint C7), Appendix UNMAPPED_IE}
\end{tcolorbox}
...
where $v_0, v_A, v_W$ are empirically calibrated parameters (see Appendix UNMAPPED_KKK for full formalization).
...
\section{Section 5: Synthesis and Bridge to Appendix UNMAPPED_KKK}
...
\subsection{For Researchers: Formal Mathematical Models in Appendix UNMAPPED_KKK}

Appendix UNMAPPED_KKK provides rigorous mathematical treatment:
...
\item Formal mathematics → Appendix UNMAPPED_KKK (METHOD-DYNAMIC)
\item Parameter sourcing discipline → Appendix UNMAPPED_JJJ (METHOD-PSG)
...
The complete formal treatment appears in Appendix UNMAPPED_KKK (METHOD-DYNAMIC). Key results:
...
\begin{enumerate}
    ...
    \item \textbf{Appendix UNMAPPED_KKK:} Full mathematical treatment of all dynamic models
\end{enumerate}
