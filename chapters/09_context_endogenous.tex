...
Appendix UNMAPPED_WEN provides measurement protocols and calibration values.
\end{tcolorbox}
...
See Appendix UNMAPPED_WEN (CORE-WHEN) for the complete specification of all 8 Ψ-dimensions
...
\begin{cross-reference}
See Appendix UNMAPPED_CTM (CONTEXT-TEMPORAL) for detailed temporal dynamics
and Appendix UNMAPPED_WEN (CORE-WHEN) for the complete speed hierarchy.
\end{cross-reference}
...
\begin{cross-reference}
See Appendix UNMAPPED_CTS (CONTEXT-SPATIAL) for detailed spatial dynamics
...
\begin{cross-reference}
See Appendix UNMAPPED_SHA (DOMAIN-COMPLEXITY) for detailed complexity economics integration
...
\begin{cross-reference}
See Appendix UNMAPPED_WHO (CORE-WHO) for the complete level hierarchy
...
\begin{cross-reference}
See Appendix UNMAPPED_WEN (CORE-WHEN), Section 8 for complete measurement protocols
...
\end{itemize}
See Appendix UNMAPPED_WHO (CORE-WHO) for the complete level specification.
\end{cross-reference}
...
\end{equation}
See Chapter 5 and Appendix UNMAPPED_HOW (CORE-HOW) for the complementarity specification.
\end{cross-reference}
...
\end{itemize}
See Chapter 13 and Appendix UNMAPPED_STA (CORE-STAGE).
\end{cross-reference}
...
\textbf{Reading Path:}
\begin{itemize}
    \item For complete Ψ-dimension specification: Appendix UNMAPPED_WEN (CORE-WHEN)
    \item For temporal context: Appendix UNMAPPED_CTM (CONTEXT-TEMPORAL)
    \item For spatial context: Appendix UNMAPPED_CTS (CONTEXT-SPATIAL)
    \item For complexity economics: Appendix UNMAPPED_SHA (DOMAIN-COMPLEXITY)
    \item For welfare (next): Chapter 10 + Appendix UNMAPPED_WAT (CORE-WHAT)
    \item \textbf{For intervention optimization: Chapter 11 (EMERGE Algorithm) + Appendix UNMAPPED_IE (EIT-EMP)}
\end{itemize}
\end{cross-reference}
