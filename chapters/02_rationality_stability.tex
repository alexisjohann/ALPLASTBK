% =============================================================================
% Chapter 2: Rationality as Stability
% =============================================================================
%
% Version: 1.0 (January 2026)
%
% Purpose: Redefining rationality
%
...
Establish why classical rationality is necessary but insufficient, motivating the extension to $(C, \Psi)$ framework.

\vspace{0.3cm}
\textbf{In-Scope:}
\begin{itemize}[nosep]
    \item Classical rationality concepts and their achievements
    \item Arrow-Debreu framework and its assumptions
    \item Why extensions became necessary (behavioral anomalies)
    \item Stability as an alternative rationality criterion
\end{itemize}

\vspace{0.3cm}
\textbf{Out-of-Scope (delegiert an Appendices):}
\begin{itemize}[nosep]
    \item Formal proofs of limiting cases $\rightarrow$ Appendix UNMAPPED_DER (FORMAL-DERIVE)
    \item Detailed behavioral anomalies $\rightarrow$ Chapter 3
    \item Empirical calibration methods $\rightarrow$ Appendix UNMAPPED_LLM (METHOD-LLMMC)
\end{itemize}
...
\midrule
DER (FORMAL-DERIVE) & Arrow-Debreu as limiting case of $(C, \Psi)$ \\
...
\midrule
Redefining rationality & See Section \ref{sec:ch2-intro} \\
\end{tabular}
\end{tcolorbox}
...
Consider \textbf{Anna}, a professional facing a decision that involves redefining rationality.
...
redefining rationality interact with broader welfare considerations.
...
\Large
\centering
\textit{How does redefining rationality contribute to understanding human welfare and decision-making?}
\end{tcolorbox}
...
\begin{itemize}
\item \textbf{Section \ref{sec:ch2-intro}}: Introduction and motivation
\item \textbf{Section \ref{sec:ch2-theory}}: Theoretical foundations
\item \textbf{Section \ref{sec:ch2-applications}}: Applications and examples
\item \textbf{Section \ref{sec:ch2-summary}}: Summary and conclusions
\end{itemize}
...
\textbf{Ziel (Objective):}
Develop the conceptual understanding of redefining rationality as a foundation for the EBF framework.

\vspace{0.3cm}
\textbf{In-Scope:}
\begin{itemize}[nosep]
    \item Conceptual introduction to redefining rationality
...
\begin{itemize}
  ...
  \item \textbf{Reciprocity:} Conditional cooperation in repeated games \citep{axelrod1984evolution,nowak2006}
...
\textbf{Numerical Illustration:} Consider a standard choice between options A (\$100 certain) and B (\$200 with 50\% probability). Classical theory predicts risk-neutral agents are indifferent (EV = \$100 both). Behavioral data shows 65\% choose A, implying $\lambda \approx 2.25$ loss aversion and $\alpha \approx 0.88$ probability weighting---deviations that classical rationality cannot accommodate.

\subsection{What Comes Next}
\label{sec:ch2-next}

With the classical foundations and their limitations established, subsequent chapters build:

\begin{enumerate}[nosep]
    \item \textbf{Chapter 3:} Examines specific limits of utility maximization that motivated the behavioral revolution
    \item \textbf{Chapter 4:} Develops empirical foundations for measuring context and calibrating the framework
...
\begin{tabular}{@{}ll@{}}
\textbf{Previous:} & Chapter 1 \\
\textbf{Next:} & Chapter 3 \\
