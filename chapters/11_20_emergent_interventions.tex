...
\textbf{Formal Specification:} The complete mathematical framework is documented in Appendix UNMAPPED_IE (CORE-EIT), Sections EIT-EMP-1 (Gamma Emergence) and EIT-EMP-2 (EMERGE Algorithm).
\end{cross-reference}
...
\textbf{Full Specification:} See Appendix UNMAPPED_IE (CORE-EIT):
\begin{itemize}[nosep]
