...
\begin{itemize}[nosep]
    \item \textbf{WHO:} Appendix UNMAPPED_WHO (CORE-WHO) + Chapter 10.8
    \item \textbf{WHAT:} Appendix UNMAPPED_WAT (CORE-WHAT) + Chapter 10.2
    \item \textbf{HOW:} Appendix UNMAPPED_HOW (CORE-HOW) + Chapter 5
    \item \textbf{WHEN:} Appendix UNMAPPED_WEN (CORE-WHEN) + Chapter 9
    \item \textbf{WHERE:} Appendix UNMAPPED_EST (CORE-WHERE) + Chapter 4x
    \item \textbf{AWARE:} Appendix UNMAPPED_AWA (CORE-AWARE) + Chapter 11
    \item \textbf{READY:} Appendix UNMAPPED_REA (CORE-READY) + Chapter 12
    \item \textbf{STAGE:} Appendix UNMAPPED_STA (CORE-STAGE) + Chapter 13
\end{itemize}
