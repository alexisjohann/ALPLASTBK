...
\textbf{Primär:} Appendix TKT (METHOD-TOOLKIT) --- Theoreme HHH-T1 bis T8, 20-Field Schema, Feasibility-Reduktion
...
\textbf{Der Learning Loop:} Gemessene $\Delta\vec{S}$ fließen zurück in Appendix UNMAPPED_BBB (WHERE) und verbessern zukünftige Vorhersagen.
\end{tcolorbox}
...
Analog zu den Parameter-Level Epistemic Tags (Appendix UNMAPPED_EST) klassifizieren wir Archetypen:
...
Diese Felder sind Design-Parameter (Forschungsfragen RQ-1 bis RQ-4 in Appendix TKT prüfen Emergenz-Potenzial):
...
F10 & Complementarity & Appendix UNMAPPED_HOW & $\gamma$-Werte zu anderen Interventionen \\
\bottomrule
\end{tabular}
\end{center}
...
\item Aktuelle Journey-Phase (aus Appendix UNMAPPED_STA)
\item Awareness-Level (aus Appendix UNMAPPED_AWA)
\end{itemize}
...
\textbf{Für Forscher:}
\begin{enumerate}[nosep]
\item Appendix TKT (vollständige Theoreme)
...
\item \textbf{Für Forscher:} Die offenen Forschungsfragen RQ-1 bis RQ-4 (Appendix TKT) bieten Ansatzpunkte für Tier-2 Emergence-Formalisierung.
\end{enumerate}
