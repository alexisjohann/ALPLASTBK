...
\textbf{Essential:}
\begin{itemize}[nosep]
\item Appendix NNN (METHOD-MULTI-LEVEL) --- Templates and parameter tables for all 5 levels
\item Appendix MMM (METHOD-POLICY-COHERENCE) --- Cross-level spillover analysis
\end{itemize}

\textbf{Primary Appendix:} Appendix NNN

\textbf{Supporting:}
\begin{itemize}[nosep]
\item Appendix HHH (METHOD-TOOLKIT) --- Coherence criteria at all levels
\item Appendix KKK (METHOD-DYNAMIC) --- Formal dynamics (apply to each level)
\item Appendix LLL (METHOD-POLICY-DOMAINS) --- Domain-specific templates
\item \textbf{Appendix V (CORE-WHEN)} --- Network structure parameter $\rho$ for narrative transmission
\item \textbf{Appendix RB (LIT-BENABOU)} --- Moral narratives, network segregation effects
\end{itemize}
...
\vspace{0.2cm}
\textit{Siehe: Chapter 11 §11.20 (EMERGE), Chapter 20 (Scope Levels L0-L4), Appendix IE}
\end{tcolorbox}
...
\textbf{Example:} Energy efficiency program (from Appendix LLL)
...
\begin{itemize}[nosep]
\item Appendix RRR (METHOD-LIFETIME) - 30-year templates per domain
\item Appendix OOO (FORMAL-SYSTEM-DYNAMICS) - Complete ODE analysis
\item Appendix PPP (METHOD-AGENT-BASED) - Agent-based simulation code
\end{itemize}
...
The complete formal treatment appears in Appendix NNN (METHOD-MULTI-LEVEL). Key results:
...
\begin{enumerate}
    ...
    \item \textbf{Appendix NNN:} Full mathematical treatment of multi-level coordination
    \item \textbf{Appendix IE (EMERGE-SPEC):} Scope-Level vs. Org-Level Unterscheidung
\end{enumerate}
