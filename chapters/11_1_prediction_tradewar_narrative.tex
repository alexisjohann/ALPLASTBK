...
% Intuitive, accessible, with key data - references Appendix UNMAPPED_AWA for technicals
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
experienced. (The full technical analysis is in Appendix UNMAPPED_AWA, Section~\ref{subsec:pred-01-calc}.)
...
\vspace{0.5em}
\noindent\textit{Technical details: See Appendix UNMAPPED_AWA, Section~\ref{subsec:pred-01-calc} for the full formal model, derivation of $\beta$ coefficients, empirical validation methodology, and dynamic simulation results.}
