...
\begin{itemize}[nosep]
   ...
   \item \textbf{Theory focus:} Read Introduction + Appendix UNMAPPED_PBB (axioms P1-P10) + Appendix UNMAPPED_UN (UNTCM dynamics)
\end{itemize}
...
\begin{itemize}[nosep]
\item \textbf{Appendix UNMAPPED_PBB (FORMAL-PROBABILITY):} 10 axioms (P1-P10) formalizing how all BCM components integrate into transition probabilities; NTM basics (A1-A4, T1-T5)
\item \textbf{Appendix UNMAPPED_UN (FORMAL-UNTCM):} Unified NTM-Context Model with 29 elements---coupled ODE system, three regimes, tipping points, optimal timing, maintenance cost analysis, portfolio archetypes
\end{itemize}
...
The \textbf{Natural Trajectory Model (NTM)} from Appendix UNMAPPED_PBB formalizes basic decay dynamics, while the \textbf{Unified NTM-Context Model (UNTCM)} in \textbf{Appendix UNMAPPED_UN (FORMAL-UNTCM)} provides the complete coupled ODE system:
...
The \textbf{Unified NTM-Context Model (UNTCM)} extends basic NTM with context modulation and social feedback. The complete formalization is in \textbf{Appendix UNMAPPED_UN (FORMAL-UNTCM)}.
...
UNTCM identifies three dynamically distinct regimes (see Appendix UNMAPPED_UN, Section UNTCM-T7):
...
UNTCM-M5 (Appendix UNMAPPED_UN) formalizes the \textbf{Maintenance Paradox}: Status quo preservation is NOT free and becomes MORE expensive over time due to the X5 loss aversion premium.
...
\end{enumerate}
\textbf{Full formalization:} Appendix UNMAPPED_UN (FORMAL-UNTCM) with 29 elements (A5, T6-T8, M1-M5, M5-D1/D2, M5-T2/T3, I1-I4, E1-E3, X1-X5).
\end{tcolorbox}
...
\end{itemize}
See \textbf{Appendix UNMAPPED_UN} for formal UNTCM specification and \textbf{Appendix UNMAPPED_PBB} for probability axioms P1-P10.
\end{tcolorbox}
...
The complete probabilistic architecture is specified in **Axioms P1-P10** (Appendix UNMAPPED_PBB), which provide:
\begin{enumerate}[nosep]
...
\begin{itemize}[nosep]
    \item \textbf{Appendix UNMAPPED_PBB (FORMAL-PROBABILITY):} 10-axiom probabilistic foundation (P1-P10), NTM basics (A1-A4, T1-T5)
    \item \textbf{Appendix UNMAPPED_UN (FORMAL-UNTCM):} Unified NTM-Context Model --- complete coupled ODE system (A5, T6-T8), methodology (M1-M5 including Maintenance Cost Analysis), framework integration (I1-I4), empirical applications (E1-E3), theoretical extensions (X1-X5 including Loss Aversion Lock-in)
\end{itemize}
...
\begin{itemize}[nosep]
    ...
    \item \textbf{Appendix UNMAPPED_REA (CORE-READY):} Willingness dynamics
    \item \textbf{Appendix UNMAPPED_STA (CORE-STAGE):} Behavioral change journey
    \item \textbf{Appendix UNMAPPED_WAT (FEPSDE):} Utility dimensionality
\end{itemize}
