...
%    │  □ Chapter Scope Box (Ziel/In-Scope/Out-of-Scope/Lieferobjekte)     │
%    ├─────────────────────────────────────────────────────────────────────┤
%    │  OPENING                                                            │
%    ├─────────────────────────────────────────────────────────────────────┤
...
\begin{tcolorbox}[
    ...
    title={\textbf{10C CORE Connection: [CORE-NAME] (Question [N])}},
    fonttitle=\bfseries
]
...
\medskip
\textit{[Brief statement of chapter's role in 10C framework]}
\end{tcolorbox}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% SECTION 6: CHAPTER SCOPE BOX (NEW - January 2026)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% REQUIRED for all chapters. Defines clear boundaries for the chapter.
% Helps readers understand what is covered vs. delegated to appendices.
%
% This box answers four questions:
%   1. ZIEL (Goal): What is the chapter trying to achieve?
%   2. IN-SCOPE: What topics are covered in this chapter?
%   3. OUT-OF-SCOPE: What is delegated to appendices?
%   4. LIEFEROBJEKTE: What concrete outputs does this chapter deliver?
%
%==============================================================================
% CHAPTER SCOPE BOX
%==============================================================================
...
\textbf{Ziel (Goal):}
[One sentence stating what this chapter aims to achieve. Be specific.]

\vspace{0.3cm}
\textbf{In-Scope:}
\begin{itemize}[nosep]
\item [Topic 1 covered in this chapter]
\item [Topic 2 covered in this chapter]
\item [Topic 3 covered in this chapter]
\item [Topic 4 covered in this chapter]
\end{itemize}

\vspace{0.3cm}
\textbf{Out-of-Scope (delegiert an Appendices):}
\begin{itemize}[nosep]
\item [Formal proofs / detailed derivations] $\to$ \textbf{Appendix [CODE]}
\item [Complete parameter tables] $\to$ \textbf{Appendix [CODE]}
\item [Exhaustive literature review] $\to$ \textbf{Appendix [CODE]}
\item [Implementation code] $\to$ \textbf{Appendix [CODE]}
\end{itemize}

\vspace{0.3cm}
\textbf{Lieferobjekte ([N] konkrete Outputs):}
...
\midrule
1 & [Deliverable 1] & \S[N].1 & [Format] \\
2 & [Deliverable 2] & \S[N].2 & [Format] \\
3 & [Deliverable 3] & \S[N].3 & [Format] \\
4 & [Deliverable 4] & \S[N].4 & [Format] \\
\bottomrule
\end{tabular}
\end{center}
...
\bottomrule
\end{tabular}
\caption{Integration of [this CORE] with the 10C framework}
...
% - Use consistent notation (see Appendix UNMAPPED_GLS: Glossary)
...
% =============================================================================
%
% - Always specify appendix by BOTH code AND name: "Appendix UNMAPPED_WAT (CORE-WHAT)"
...
%
% REFERENCE PATTERN:
% In chapter: "The utility function has six dimensions (see Appendix UNMAPPED_WAT for
...
% [ ] Chapter Scope Box with Ziel/In-Scope/Out-of-Scope/Lieferobjekte (NEW)
%
% OPENING:
...
%
% STYLE:
% [ ] Consistent notation (checked against Appendix UNMAPPED_GLS)
