...
to punish unfairness \citep{guth1982experimental}
\item \textbf{Public Goods:} People contribute more than Nash equilibrium predicts, 
even without enforcement \citep{fehr2000cooperation}
...
\begin{itemize}
\item \textbf{Inequity Aversion:} \citet{fehr1999theory} showed that people 
dislike both advantageous and disadvantageous inequality, and will sacrifice 
personal payoffs to reduce it.

\item \textbf{Reciprocity:} \citet{falk2006theory} demonstrated that people 
...
\paragraph{Implication for the 10C Framework.}
This level-indexing reveals a deep integration within the 10C CORE architecture:
