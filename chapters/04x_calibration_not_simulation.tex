...
\begin{itemize}[nosep]
    \item Complete estimation methodology $\rightarrow$ Appendix UNMAPPED_EST
    \item LLM Monte Carlo implementation $\rightarrow$ Appendix UNMAPPED_LLM
...
\textbf{Primary Appendix:} Appendix UNMAPPED_EST (CORE-WHERE: Parameter Estimation)
\begin{itemize}[nosep]
...
\begin{itemize}[nosep]
    ...
    \item Appendix UNMAPPED_OPS (Operationalization): Measurement protocols
...
Appendix UNMAPPED_EST provides the complete \textit{how} of parameter estimation.
...
\textbf{Formal Details:} Complete estimation methodology, epistemic status tags (EMP/THR/LLM/ILL/HYP), and validation protocols are provided in Appendix UNMAPPED_BBB (CORE-WHERE).
...
\textbf{Deep Dive:} & See Appendix UNMAPPED_BBB (Parameter Repository) for complete estimation methodology \\
\end{tabular}
