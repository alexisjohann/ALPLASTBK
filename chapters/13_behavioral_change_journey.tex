...
See Appendix UNMAPPED_AWA (CORE-AWARE) for the formal Awareness function $A(\cdot)$
...
\begin{cross-reference}
See Appendix UNMAPPED_REA (CORE-READY) for the formal specification of $\theta$
...
\begin{cross-reference}
Appendix UNMAPPED_STA (CORE-STAGE) contains 152 boundary conditions specifying
...
\end{itemize}
See Chapter 11 and Appendix UNMAPPED_AWA for full specification.
\end{cross-reference}
...
\end{itemize}
See Chapter 12 and Appendix UNMAPPED_REA for full specification.
\end{cross-reference}
...
\end{itemize}
See Appendix UNMAPPED_WEN (CORE-WHEN) for the 8-dimensional context specification.
\end{cross-reference}
...
\begin{cross-reference}
Appendix UNMAPPED_STA contains boundary conditions for multi-level BCJ from
...
\textbf{Reading Path:}
\begin{itemize}
    \item For formal BCJ specification: Appendix UNMAPPED_STA (CORE-STAGE)
    \item For awareness mechanics: Chapter 11 + Appendix UNMAPPED_AWA
    \item For willingness mechanics: Chapter 12 + Appendix UNMAPPED_REA
