...
details are in Appendix UNMAPPED_AWA, Section~\ref{subsec:pred-02-calc}.)
...
\vspace{0.5em}
\noindent\textit{Technical details: See Appendix UNMAPPED_AWA, Section~\ref{subsec:pred-02-calc} for the 
