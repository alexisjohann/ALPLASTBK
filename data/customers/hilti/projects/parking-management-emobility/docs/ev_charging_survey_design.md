...
*→ Varianten-Mapping: Anna=V3 (PPU), Ben=V2 (Flatrate), Clara=V4 (Time/Blocking), David=V1 (Volume)*
...
*→ Option 1: Direct Notification (Awareness — personalisiert)*
*→ Option 2: Public Dashboard (Awareness — Salienz/Sichtbarkeit)*
*→ Option 3: Social Comparison Email (Awareness — Opower-Modell)*
...
| B4 (Pricing-Variante) | 0.20 | 1 - %David (David = «no fee» = niedrigste Akzeptanz) |
...
| B5 | Awareness-Kanal | — | Haeufigkeit: Notification / Dashboard / Email / Guidelines |
...
| SP-5 | B5: Notification hat Mehrheit ueber Dashboard/Email | Direct > Salience > Social | Personalisierter Push = praeferierter Kanal |
| SP-6 | C2: >50% finden Blockieren unfair | σ > 0.50 | Sozialer Hebel ist aktivierbar |

---

*Version 3.0 — Streamlined: 12 Fragen, 4 Optionen, Awareness-Fokus*
