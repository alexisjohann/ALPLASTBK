...
Usage:
  ...
  python scripts/migrate_paper_sources.py --paper PAP-kahneman1979prospect  # Specific paper
"""
...
def main():
    ...
    parser.add_argument('--paper', type=str, help="Process specific paper ID (e.g. PAP-kahneman1979prospect)")
