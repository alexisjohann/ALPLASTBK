...
from bibtex_key_generator import generate_canonical_key
...
def generate_bibtex_key(author: str, year: str, title: str) -> str:
    """Generate a BibTeX key. Delegates to bibtex_key_generator.py (SSOT)."""
    return generate_canonical_key(author, year, title)
