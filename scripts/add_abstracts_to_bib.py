...
PAPER_MAPPING = {
    ...
    "Thaler": {
        "key_pattern": r"PAP-thaler1980toward",
        "title_contains": "Consumer Choice"
    },
    "Kahneman": {
        "key_pattern": r"PAP-kahneman1979prospect",
        "title_contains": "Prospect Theory"
    },
    "Camerer": {
        "key_pattern": r"PAP-camerer2004neuroeconomics",
    ...
    "Sunstein": {
        "key_pattern": r"PAP-sunstein2014nudge|PAP-thaler2008nudge",
    ...
    "Shiller": {
        "key_pattern": r"shiller2000irrational",
