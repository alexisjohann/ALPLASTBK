...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=\textbf{Appendix E: METHOD-OPERATIONAL}]
...
\begin{table}[htbp]
\centering
\caption{Summary of Results in Appendix E}
\label{tab:E-results}
\renewcommand{\arraystretch}{1.2}
...
$C_{ij}$ & Complementarity between $i$ and $j$ & Appendix B \\
\bottomrule
\end{tabular}
\end{center}
...
\subsection{References for Appendix E}
...
$\rightarrow$ Appendix AN (estimation) $\rightarrow$ Appendix BBB (parameters)
