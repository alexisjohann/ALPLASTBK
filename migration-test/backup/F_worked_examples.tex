...
\begin{itemize}[nosep]
    \item Appendix AAA (CORE-WHO): Aggregation levels $L \in \{1,...,6\}$
    \item Appendix B (CORE-HOW): Complementarity structure $C$
    \item Appendix V (CORE-WHEN): Context dimensions $\Psi$
    \item Appendix D (FORMAL-PROOF): $C^*$, $K$, $Q$ definitions
\end{itemize}
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=\textbf{Summary: Appendix F Key Points}]
...
\begin{tcolorbox}[colback=red!5!white, colframe=red!75!black,
    title=\textbf{Critical Foundations for Appendix F}]

This appendix's worked examples depend on:

\begin{enumerate}
    \item \textbf{Appendix AAA (CORE-WHO):} Definition of aggregation levels $L$
    \item \textbf{Appendix B (CORE-HOW):} Complementarity structure creating $K$
    \item \textbf{Appendix D (FORMAL-PROOF):} Formal definitions of $K$, $Q$, $C^*$
