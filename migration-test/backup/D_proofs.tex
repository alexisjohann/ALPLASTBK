...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=\textbf{Appendix D: FORMAL-CSTAR}]
...
\textbf{Dependencies:} & Appendix B (CORE-HOW: $\Gamma$-matrix) \\
...
\begin{itemize}[nosep]
    ...
    \item For $\Gamma$-matrix foundations: See Appendix B (CORE-HOW)
\end{itemize}
...
\subsubsection{Connection to Appendix B}

Appendix B (CORE-HOW) defines the complementarity matrix $\Gamma = [\gamma_{dd'}]$
...
\begin{table}[htbp]
\centering
\caption{Summary of Formal Results in Appendix D}
\label{tab:D-results}
...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=\textbf{Appendix D Summary: FORMAL-CSTAR}]
...
\subsection{References for Appendix D}
...
\textbf{Depends on:}
\begin{itemize}[nosep]
    \item Appendix B (CORE-HOW): $\Gamma$-matrix foundations
...
\begin{itemize}[nosep]
    ...
    \item Chapter 7: Coherence Dynamics (applies $K$ measure)
    \item Appendix BBB: Calibration of $C^*(\Psi)$
\end{itemize}

\textbf{Reading Path:}
$\rightarrow$ Chapter 6 (intuition) $\rightarrow$ This Appendix (formal)
$\rightarrow$ Appendix B (complementarity) $\rightarrow$ Appendix BBB (calibration)
