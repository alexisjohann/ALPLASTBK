...
\begin{tcolorbox}[colback=yellow!5!white,colframe=yellow!75!black,title=Axiom CAS-1: Fundamental Principle]
\textbf{Axiom CAS-1 (Core Assumption):}
...
\begin{tcolorbox}[colback=yellow!5!white,colframe=yellow!75!black,title=Axiom CAS-2: Complementarity]
\textbf{Axiom CAS-2 (Complementarity):}
...
\begin{table}[htbp]
\centering
\caption{Key Symbols in Appendix CAS}
\begin{tabular}{lll}
\toprule
