...
% - Appendix TKT (METHOD-TOOLKIT): Emergent 10C intervention vectors
% - Appendix UNMAPPED_AV (CORE-READY): Willingness heterogeneity
...
% - Appendix UNMAPPED_LLL (METHOD-POLICY-DOMAINS): Domain-specific multipliers
%
% =============================================================================
...
\item For intervention types: See Appendix TKT (METHOD-TOOLKIT)
\end{itemize}
...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=Quick Reference: Appendix UNMAPPED_QQ]
...
\begin{itemize}[nosep]
    ...
    \item 5 Axiome für Multiplier-Verhalten (UNMAPPED_QQ-1 bis UNMAPPED_QQ-5)
...
\begin{itemize}[nosep]
    ...
    \item Emergente 10C Interventionsvektoren $\rightarrow$ Appendix TKT (METHOD-TOOLKIT)
    \item Willingness-Heterogenität $\rightarrow$ Appendix UNMAPPED_AV (CORE-READY)
...
\begin{itemize}[nosep]
    ...
    \item 5 Axiome (UNMAPPED_QQ-1 bis UNMAPPED_QQ-5) mit Implikationen
...
Following Appendix TKT, interventions \textit{emerge} from the continuous 10C space $[0,1]^9$.\footnote{Note: The 10C dimensions are the primitives. Interventions emerge from the continuous 10C space based on context analysis (Axiom EIT-3, Appendix TKT). The ``types'' shown below are shorthand for interventions with high intensity on that 10C dimension---they are not discrete categories.} For communication purposes, we use shorthand labels for interventions emphasizing each dimension:
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom UNMAPPED_QQ-1: Multiplier Bounds]
\textbf{Statement:}
\begin{equation}
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom UNMAPPED_QQ-2: Segment-Type Affinity]
\textbf{Statement:}
\begin{equation}
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom UNMAPPED_QQ-3: Reactance Threshold]
\textbf{Statement:}
\begin{equation}
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom UNMAPPED_QQ-4: Weighted Average Consistency]
\textbf{Statement:}
\begin{equation}
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom UNMAPPED_QQ-5: Monotonicity in Segment Characteristic]
...
\begin{tcolorbox}[colback=green!10!white, colframe=green!75!black,
    title=\textbf{Appendix UNMAPPED_QQ: Summary}]
...
\begin{table}[htbp]
\centering
\caption{Symbols Introduced in Appendix UNMAPPED_QQ}
...
\textbf{Response:} We acknowledge domain-specificity (see Axiom UNMAPPED_QQ-5) but note that
...
\begin{table}[htbp]
\centering
\caption{Research Roadmap for Appendix UNMAPPED_QQ}
