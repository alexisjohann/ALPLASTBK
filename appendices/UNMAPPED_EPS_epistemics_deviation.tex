% =============================================================================
% APPENDIX EPS: LIT-AUTHOR: Unknown Researcher Research Integration
% =============================================================================
% Category: LIT
% Language: English
...
Appendix UNMAPPED_SUN (Falsifiable Predictions), Appendix UNMAPPED_CAM (Metatheory), 
Appendix CTW ($\Psi$ Dimensions), Appendix UNMAPPED_SRL (Self-Reinforcement Learning)}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Summary}
\label{sec:eps-summary}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Appendix eps Summary]
...
\begin{table}[htbp]
\centering
\caption{Key Symbols in Appendix UNMAPPED_EPS}
\begin{tabular}{lll}
\toprule
