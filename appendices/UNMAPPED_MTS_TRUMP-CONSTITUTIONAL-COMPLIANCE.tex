...
\title{\textbf{Appendix UNMAPPED_MTS: DOMAIN-TRUMP} \\ Trump Constitutional Compliance Decision Model \\ Two-Stage Behavioral Analysis 2025--2030}
...
\subsection{7.1 Connection to Appendix UNMAPPED_WHO (WHO: Welfare Hierarchy)}
...
\subsection{7.2 Connection to Appendix UNMAPPED_WAT (WHAT: Complementarity)}
...
\subsection{7.4 Connection to Appendix UNMAPPED_AWA (AWARE: Consciousness)}
...
\begin{table}[htbp]
\centering
\caption{Key Symbols in Appendix UNMAPPED_MTS}
\begin{tabular}{lll}
\toprule
