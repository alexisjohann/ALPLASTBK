...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=\textbf{Appendix GLS: REF-GLOSSARY}]
...
This appendix provides a comprehensive reference for all symbols, terms, and concepts used throughout the framework. Updated 2026-01-06 (v52.1: corrected FEPSDE 144-component structure to match Appendix WAT).
...
FFF & Framework Falsification \& Feedback Registry (Appendix REG: METHOD-REGISTRY) \\
GGG & Goal Guidance \& Generalization Tables (Appendix CFG: METHOD-CONFIG) \\
EEE & Externalization Experimentation \& Enhancement Workflow (Appendix DSN: METHOD-DESIGN) \\
UG & Ultimatum Game \\
...
\multicolumn{3}{l}{\textbf{Methodological Principles (see Appendix FRM)}} \\
\midrule
...
%------------------------------------------------------------------------------
\subsection{Epistemic Status Framework (from Appendix EST)}
...
%------------------------------------------------------------------------------
\subsection{Estimation Methods (from Appendix EST)}
...
\subsubsection{Estimation Axioms (from Appendix EST)}
...
Epistemic Status & $E(\theta) = \frac{\sum_s w_s q_s r_s}{\sum_s w_s}$ & Appendix EST \\
Bayesian Update & $\theta' = \frac{n\bar{x} + \kappa\mu_0}{n + \kappa}$ & Appendix EST \\
Total Parameters & $|\Theta| = 15 + 28 + 120 = 163$ & Appendix EST \\
\bottomrule
\end{tabular}
\end{center}
...
\hline
Complementarity theory & Chapter 5 & Appendix HOW \\
Reference structure & Chapter 6 & Appendix DER \\
Mathematical proofs & Chapter 8 & Appendix PRF \\
Context dimensions ($\Psi$) & Chapter 9 & Appendix CTW \\
FEPSDE welfare & Chapter 10 & Appendix WAT \\
Awareness module & Chapter 11 & Appendix AWA \\
Willingness module & Chapter 12 & Appendix REA \\
Empirical validation & Chapter 4, 4.X & Appendix LLM1 \\
Deviation epistemics & --- & Appendix EPS \\
Self-reinforcement & --- & Appendix SRL \\
Nobel integration & --- & Appendix NOB \\
Falsifiable predictions & --- & Appendix SUN \\
Metatheory & --- & Appendix CAM \\
\hline
\end{tabular}
\end{center}
...
\begin{table}[htbp]
\centering
\caption{Summary of Notation Standards in Appendix GLS}
\label{tab:g-results}
\renewcommand{\arraystretch}{1.2}
...
\begin{itemize}[nosep]
    \item $K$ derivation: See Appendix PRF (FORMAL-CSTAR)
    \item $C^*$ definition: See Appendix HOW (CORE-HOW)
    \item Empirical estimation: See Appendix EST (CORE-WHERE)
\end{itemize}
...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=\textbf{Appendix GLS Summary: REF-GLOSSARY}]
...
\subsection{References for Appendix GLS}
\label{sec:glossary-references}

\begin{itemize}[nosep]
    \item EBF Master Document: Primary source for all definitions
    \item Appendix HOW (CORE-HOW): Complementarity matrix $\Gamma$ notation
    \item Appendix WAT (CORE-WHAT): FEPSDE welfare dimensions
    \item Appendix CTW (CORE-WHEN): Context $\Psi$ dimension definitions
    \item Appendix EST (CORE-WHERE): Estimation method notation
    \item Appendix AWA (CORE-AWARE): Awareness function notation
    \item Appendix REA (CORE-READY): Willingness function notation
\end{itemize}
