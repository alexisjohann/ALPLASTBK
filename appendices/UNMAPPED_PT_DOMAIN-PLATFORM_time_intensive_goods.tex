...
% - Appendix UNMAPPED_V (CORE-WHEN): Temporal context and Ψ_T dimension
% - Appendix UNMAPPED_AAA (CORE-WHO): Consumer segments and levels
% - Appendix UNMAPPED_C (CORE-WHAT): Utility dimensions (FEPSDE)
% - Appendix UNMAPPED_BBB (CORE-WHERE): Parameter values
% - Appendix UNMAPPED_MS (REF-MODELSPACE): Theory catalog UNMAPPED_CAT-17
%
% DEPENDENTS (what REQUIRES this appendix):
% - Appendix UNMAPPED_DER (FORMAL-LIMITS): Proofs for §7.1, §7.2
...
\item For proofs: See Appendix UNMAPPED_DER §7.1, §7.2
\end{itemize}
...
\textit{Theory Catalog Reference: UNMAPPED_CAT-17 (MS-TA-001, MS-TA-002, MS-TA-003)}
\end{abstract}
...
Following \citet{becker1965theory}, consumers do not derive utility directly from market goods $X$ but from \textit{commodities} $Z$ produced using goods and time:
...
\citet{goodman2026timeintensive} conducted two field experiments on Facebook and Instagram users, finding:
...
Following \citet{simon1971designing}, attention is bounded:
\[
...
This appendix implements theories from UNMAPPED_CAT-17 (Household Economics \& Time Allocation):
...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=Case Study: UNMAPPED_CAS-853]
...
\item \textbf{EBF Integration:} The temporal context dimension $\Psi_T$ (Appendix UNMAPPED_V) captures time scarcity effects. Platform economics is a domain application.
...
\begin{itemize}[nosep]
\item \citet{becker1965theory}: Foundational time allocation theory
\item \citet{goodman2026timeintensive}: Digital platform application (NBER WP 34743)
\item \citet{simon1971designing}: Attention scarcity insight
\end{itemize}
...
\item Appendix UNMAPPED_AAA (CORE-WHO): Consumer segmentation by shadow wage
\item Appendix UNMAPPED_BBB (CORE-WHERE): Parameter values PAR-TA-001 to PAR-TA-005
\item Appendix UNMAPPED_MS (REF-MODELSPACE): Theory catalog UNMAPPED_CAT-17
\item Appendix UNMAPPED_DER (FORMAL-LIMITS): Formal proofs §7.1, §7.2
\end{itemize}
...
\textbf{Related Cases:}
\begin{itemize}[nosep]
\item UNMAPPED_CAS-853: Facebook-Instagram Zeit-Substitution
\end{itemize}
