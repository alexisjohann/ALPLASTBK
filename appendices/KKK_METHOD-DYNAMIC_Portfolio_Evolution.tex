...
\textbf{Prerequisites:} Chapter 20 (Static Portfolio Analysis), Appendix HHH (Portfolio Complementarity), Appendix BBB (Parameter Repository)
...
\begin{itemize}[nosep]
    ...
    \item Emergent 10C intervention vectors $\rightarrow$ Appendix HHH
    \item Parameter sources $\rightarrow$ Appendix BBB
\end{itemize}
...
$\Theta_0 \sim$ Distribution of parameters published in literature (see Appendix BBB for sourced values)
...
\begin{tcolorbox}[colback=green!5!white, colframe=green!75!black, title=Appendix KKK Summary]
...
\item \textbf{Appendix HHH:} Complementarity Foundations ($\gamma_{ij}$ interpretation)
\item \textbf{Appendix BBB:} Parameter Repository (Sourced $\Theta_0$ priors)
\item \textbf{Appendix JJJ:} Parameter Sourcing Discipline
\end{itemize}
...
\textit{Appendix KKK (METHOD-DYNAMIC) is linked from:}
\begin{itemize}[nosep]
\item \textbf{Chapter 21:} Dynamic Portfolio Evolution
\item \textbf{Appendix HHH:} METHOD-TOOLKIT (complementarities)
\item \textbf{Appendix BBB:} Parameter Repository
\item \textbf{Appendix JJJ:} Parameter Sourcing Guide
\end{itemize}
...
\begin{tcolorbox}[colback=yellow!5!white,colframe=yellow!75!black,title=Axiom KKK-1: Fundamental Principle]
\textbf{Axiom KKK-1 (Core Assumption):}
...
\begin{tcolorbox}[colback=yellow!5!white,colframe=yellow!75!black,title=Axiom KKK-2: Complementarity]
\textbf{Axiom KKK-2 (Complementarity):}
...
\begin{table}[htbp]
\centering
\caption{Key Symbols in Appendix KKK}
\begin{tabular}{lll}
\toprule
