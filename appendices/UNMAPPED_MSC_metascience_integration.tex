...
\begin{tcolorbox}[colback=orange!5!white, colframe=orange!75!black,
    title=\textbf{Appendix UNMAPPED_MSC: Literature Integration}]
...
\textbf{Dependencies:} & Appendix UNMAPPED_GLS (Glossary), Appendix UNMAPPED_EXP (Experimental Evidence) \\
...
\begin{itemize}[nosep]
    ...
    \item Appendix UNMAPPED_EXP: 8 paradigms of experimental evidence (integrated by EBF)
    \item Appendix UNMAPPED_STA: CORE-STAGE Section 12 (Meta-Scientific Foundation)
...
\begin{itemize}[nosep]
    \item Why has behavioral science fragmented into 40+ competing models, and why
has no one integrated them before?
\end{itemize}

\textbf{In-Scope:}
\begin{itemize}[nosep]
    \item Introduction: The Integration Puzzle
    \item Sociology of Scientific Knowledge
    \item Academic Incentive Structures
    \item Disciplinary Silos
    \item Peer Review Bias Against Integration
\end{itemize}

\textbf{Out-of-Scope (delegiert an andere Appendices):}
\begin{itemize}[nosep]
    \item Glossary $\rightarrow$ Appendix UNMAPPED_GLS
    \item Experimental Evidence $\rightarrow$ Appendix UNMAPPED_EXP
    \item CORE-STAGE $\rightarrow$ Appendix UNMAPPED_STA
    \item Document Type Theory $\rightarrow$ Appendix UNMAPPED_DTE
    \item Fehr Papers $\rightarrow$ Appendix UNMAPPED_FEH
\end{itemize}
...
\item 8 paradigms of experimental evidence integrated (Appendix UNMAPPED_EXP)
...
\begin{itemize}[nosep]
    \item 10C $\times$ 8$\Psi$ $\times$ 6 FEPSDE = 384 potential interaction points
...
Positive Economics} \citep{friedman1953essays} is, according to Daniel Hausman, ``the most
...
assumptions (including $C_{ij} = 0$) from empirical scrutiny \citep{samuelson1963problems}.

\paragraph{Becker (1976): Economic Imperialism.}
Gary Becker's \textit{The Economic Approach to Human Behavior} \citep{becker1976economic}
...
Robert Lucas's ``Econometric Policy Evaluation: A Critique'' \citep{lucas1976econometric} established
...
\begin{itemize}[nosep]
    \item \textbf{Van Horn \& Mirowski (2009):} ``The Rise of the Chicago School of Economics
        ...
        \citep{vanhorn2009rise}. Documents the institutional origins and Mont P\`{e}lerin
        Society connections.
    \item \textbf{Van Horn et al.\ (2011):} \textit{Building Chicago Economics}
        \citep{vanhorn2011building}. First collective historiography; Kimberly Phillips-Fein (NYU):
        ``The deeply researched essays in this collection do a tremendous service.''
    \item \textbf{Burgin (2012):} \textit{The Great Persuasion} \citep{burgin2012great}.
...
\begin{itemize}[nosep]
    \item \textbf{Blaug (1980/1992):} \textit{The Methodology of Economics}
        \citep{blaug1992methodology}. Definitive critique; documents how Friedman's essay
        ``shielded assumptions from the requirement of realism.''
    \item \textbf{Hands (2001):} \textit{Reflection Without Rules} \citep{hands2001reflection}.
    ...
    \item \textbf{Hausman (1992):} \textit{The Inexact and Separate Science of Economics}
        \citep{hausman1992inexact}. Philosophical analysis of economics' epistemological status.
    \item \textbf{Caldwell (1980):} ``A Critique of Friedman's Methodological
        Instrumentalism'' \citep{caldwell1980critique}. Early systematic critique in
...
\begin{itemize}[nosep]
    \item \textbf{Yonay (1998):} \textit{The Struggle over the Soul of Economics}
        \citep{yonay1998struggle}. Documents how neoclassical economics displaced institutionalism
        between the wars; uses actor-network theory.
    \item \textbf{Backhouse \& Cherrier (2017):} ``The Age of the Applied Economist''
        \citep{backhouse2017age}. Transformation of economics after 1970.
    \item \textbf{Fourcade (2009):} \textit{Economists and Societies} \citep{fourcade2009economists}.
...
American Economic Association \citep{debreu1984economic,debreu1991mathematization}, articulated the core benefits:
...
to words from intruding upon the reasoning process}.'' \citep{koopmans1957three}
\end{quote}
...
the assumptions and structure of a model.'' \citep{romer2015mathiness}
\end{quote}
...
devastating replication crisis \citep{collaboration2015estimating}:
...
and France \citep{fourcade2009economists} documents how American economics achieved global
...
Lazear \citep{lazear2000economic} articulated the imperialist claim explicitly:
...
\begin{itemize}[nosep]
    ...
    \item \textbf{Parametrics} = Calibrated values ($\Theta$) from Appendix UNMAPPED_EST
...
economics. Following the 8D document type framework (Appendix UNMAPPED_DTE), we derive
...
type space (see Appendix UNMAPPED_DTE for definitions):
...
\begin{enumerate}
\item \textbf{Appendix UNMAPPED_DTE (Document Type Theory):} The 8D coordinates
      derive from the axiomatic system established there.

\item \textbf{Appendix UNMAPPED_FEH (Fehr Papers):} The vocabulary and patterns
      are extracted from the 20 papers analyzed there.

\item \textbf{Appendix UNMAPPED_QLY (Quality Assessment):} The TERAN quality
      dimensions (Theory, Evidence, Rigor, Applicability, Novelty)
      map directly to style requirements.

\item \textbf{Appendix UNMAPPED_GLS (Glossary):} All technical terms follow the
...
\subsection{Behavioral Intervention Meta-Analyses}
\textit{Added 2026-01-19: Supporting Portfolio Archetypes \& FEPSDE-KPI Framework (Chapter 20, HHH)}
\begin{itemize}[nosep]
\item \textbf{Hummel, D. \& Maedche, A.} (2019). How effective is nudging? A quantitative review on the effect sizes and limits of empirical nudging studies. \textit{Journal of Behavioral and Experimental Economics}, 80, 47--58. \textbf{[k=100, mean $d$=0.43, E(P) benchmarks]}
\item \textbf{Mertens, S. et al.} (2022). Choice architecture interventions to change physical activity and sedentary behavior: A systematic review and meta-analysis. \textit{Int.\ J.\ Behavioral Nutrition and Physical Activity}, 19(1), 1--26. \textbf{[Type-specific: defaults $d$=0.68, feedback $d$=0.41, salience $d$=0.29, social $d$=0.38]}
\item \textbf{Szaszi, B. et al.} (2018). A systematic scoping review of the choice architecture movement: Toward understanding when and why nudges work. \textit{Journal of Behavioral Decision Making}, 31(3), 355--366. \textbf{[k=156, context-dependency, domain-heterogeneity]}
\end{itemize}
...
Key terms used in this appendix (see Appendix UNMAPPED_GLS for complete glossary):
...
\begin{itemize}[nosep]
    \item Appendix UNMAPPED_GLS: All EBF notation
    \item Appendix UNMAPPED_EXP: Experimental evidence integrated by EBF
...
\begin{enumerate}
    ...
    Appendix UNMAPPED_EXP simultaneously?
...
Appendix UNMAPPED_APL (The EBF Workflow Reference). This section provides
...
\textbf{Note:} The 8th CORE question is STAGE (Behavioral Change Journey, Appendix UNMAPPED_STA).
The EBF workflow methodology is documented in Appendix UNMAPPED_APL (reference document).
...
Appendix UNMAPPED_STA (CORE-STAGE) Section 12,
Appendix UNMAPPED_GLS (Central Glossary),
Appendix UNMAPPED_EXP (Experimental Evidence),
