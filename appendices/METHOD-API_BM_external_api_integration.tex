...
\begin{itemize}[noitemsep]
    \item Appendix BL (REF-DOI) -- DOI system and journal database
    \item Appendix BBB (CORE-WHERE) -- Parameter sources requiring API validation
    \item Appendix MS (REF-MODELSPACE) -- Theory-paper linkages via DOI
\end{itemize}
...
\textbf{Used By:}
\begin{itemize}[noitemsep]
    \item DOI lookup workflows (Appendix BL)
    \item Parameter validation workflows (Appendix BBB)
...
========================================
[1/50] kahneman1979prospect... ✓ 10.2307/1914185
...
\begin{description}
    ...
    \item[DOI (Digital Object Identifier)] A persistent identifier for digital objects, standardized in ISO 26324. See Appendix BL for details.
