...
\begin{enumerate}
    ...
    \item \textbf{Generates} novel predictions (Appendix UNMAPPED_SUN lists 10 testable hypotheses)
...
\begin{enumerate}
    ...
    \item Ten novel predictions in Appendix UNMAPPED_SUN
...
\begin{itemize}
    ...
    \item Generates predictions (Appendix UNMAPPED_SUN)
...
\begin{tcolorbox}[colback=yellow!5!white,colframe=yellow!75!black,title=Axiom UNMAPPED_CAM-1: Fundamental Principle]
\textbf{Axiom UNMAPPED_CAM-1 (Core Assumption):}
...
\begin{tcolorbox}[colback=yellow!5!white,colframe=yellow!75!black,title=Axiom UNMAPPED_CAM-2: Complementarity]
\textbf{Axiom UNMAPPED_CAM-2 (Complementarity):}
