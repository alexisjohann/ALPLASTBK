...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=Quick Reference: Appendix UNMAPPED_IOO]
\textbf{Appendix:} IOO (LIT)
...
\begin{table}[htbp]
\centering
\caption{Key Symbols in Appendix UNMAPPED_IOO}
\begin{tabular}{lll}
\toprule
