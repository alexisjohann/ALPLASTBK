...
%
% Cross-References:
%   - Appendix UNMAPPED_CIA (LIT-Fehr): Ernst Fehr's foundational work (co-author with Gächter)
%   - Appendix UNMAPPED_DUF (LIT-Cialdini): Social influence and norms
%   - Appendix UNMAPPED_HOW (CORE-HOW): Complementarity mechanisms (Gächter's work on γ)
...
\title{Appendix UNMAPPED_GCR: LIT-GAECHTER \\
...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=Quick Reference: Appendix UNMAPPED_GCR]
\textbf{Appendix:} GCR (LIT)
...
\subsection*{10C CORE Connection: Gächter's Experimental Evidence}

\begin{tabular}{|l|l|l|}
\hline
\textbf{10C Dimension} & \textbf{Gächter's Finding} & \textbf{EBF Integration} \\
\hline
...
\begin{itemize}
    \item Appendix UNMAPPED_CIA (LIT-Fehr): Complementary work on strong reciprocity
    \item Appendix UNMAPPED_DUF (LIT-Cialdini): Social norms and influence
    \item Appendix UNMAPPED_HOW (CORE-HOW): Complementarity mechanisms (γ values)
    \item Appendix UNMAPPED_WAT (CORE-WHAT): Multidimensional utility (social preferences)
\end{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{1997: Reciprocity as a Contract Enforcement Device: Experimental E...}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Gächter, Simon and Falk, Armin (1997). ``Reciprocity as a Contract Enforcement Device: Experimental Evidence.'' \textit{Econometrica}, 65, 833-860.

\paragraph{10C Integration.}
\begin{itemize}[nosep]
  \item \textbf{Domain}: [To be specified]
  \item \textbf{use\_for}: LIT-GAECHTER, LIT-O
\end{itemize}


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{1998: Reciprocity and Economics: The Economic Implications of Homo...}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Gächter, Simon (1998). ``Reciprocity and Economics: The Economic Implications of Homo Reciprocans.'' \textit{European Economic Review}, 42, 845-859.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2002: Reputation and Reciprocity: Consequences for the Labour Rela...}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Gächter, Simon and Falk, Armin (2002). ``Reputation and Reciprocity: Consequences for the Labour Relation.'' \textit{Scandinavian Journal of Economics}, 104, 1-26.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2002: Strong Reciprocity, Human Cooperation, and the Enforcement o...}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Gächter, Simon and Fehr, Ernst (2002). ``Strong Reciprocity, Human Cooperation, and the Enforcement of Social Norms.'' \textit{Human Nature}, 13, 1-25.

\paragraph{10C Integration.}
\begin{itemize}[nosep]
  \item \textbf{Domain}: [To be specified]
  \item \textbf{use\_for}: LIT-FEH, LIT-GAECHTER, LIT-O
\end{itemize}


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2004: Trust, Voluntary Cooperation, and Socio-Economic Background:...}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Gächter, Simon and Herrmann, Benedikt (2004). ``Trust, Voluntary Cooperation, and Socio-Economic Background: Survey \& Experimental Evidence.'' \textit{Journal of Economic Behavior \& Organization}, 55, 505-528.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2010: Social Preferences, Beliefs, and the Dynamics of Free Riding...}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Gächter, Simon (2010). ``Social Preferences, Beliefs, and the Dynamics of Free Riding in Public Goods Experiments.'' \textit{American Economic Review}, 100, 541-556.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2011: The Framing of Games and the Psychology of Play}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Gächter, Simon and Johnson, Eric J. (2011). ``The Framing of Games and the Psychology of Play.'' \textit{Games and Economic Behavior}, 73, 459-478.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2018: Conducting Interactive Experiments Online}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Gächter, Simon (2018). ``Conducting Interactive Experiments Online.'' \textit{Experimental Economics}, 21, 99-131.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2022: Preferences and Perceptions in Provision \& Maintenance of P...}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Gächter, Simon and Kölle, Felix (2022). ``Preferences and Perceptions in Provision \& Maintenance of Public Goods.'' \textit{Games and Economic Behavior}, 131, 240-265.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2025: Incentives Crowd Out Voluntary Cooperation: Evidence from Gi...}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Gächter, Simon (2025). ``Incentives Crowd Out Voluntary Cooperation: Evidence from Gift-Exchange Experiments.'' \textit{Experimental Economics}, 28, 1-25.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2025: Why People Follow Rules}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Gächter, Simon and Molleman, Lucas and Nosenzo, Daniele (2025). ``Why People Follow Rules.'' \textit{Nature Human Behaviour}.

\paragraph{Key Parameters.}
\texttt{baseline_compliance = 0.55-0.70, unconditional_followers = 0.23, peer_effect = 0.19}

\paragraph{10C Integration.}
\begin{itemize}[nosep]
  \item \textbf{Domain}: [To be specified]
  \item \textbf{use\_for}: LIT-GAECHTER, LIT-FEH, CORE-WHO, CORE-WHAT, METHOD-EXP
\end{itemize}

% === END AUTO-GENERATED ENTRIES ===
\section{Summary}
\label{sec:gcr-summary}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{table}[htbp]
\centering
\caption{Key Symbols in Appendix UNMAPPED_GCR}
\begin{tabular}{lll}
\toprule
