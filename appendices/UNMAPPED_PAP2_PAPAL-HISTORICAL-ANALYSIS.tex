...
\title{\textbf{Appendix UNMAPPED_PAP2: DOMAIN-PAPAL-HISTORICAL} \\ Complete Analysis of Papal Conclaves 1958-2025 \\ Historical Validation and Trend Analysis of PSF 2.0}
...
\begin{tcolorbox}[colback=yellow!5!white,colframe=yellow!75!black,title=Axiom UNMAPPED_PAP2-1: Fundamental Principle]
\textbf{Axiom UNMAPPED_PAP2-1 (Core Assumption):}
...
\begin{tcolorbox}[colback=yellow!5!white,colframe=yellow!75!black,title=Axiom UNMAPPED_PAP2-2: Complementarity]
\textbf{Axiom UNMAPPED_PAP2-2 (Complementarity):}
...
\textbf{See Appendix UNMAPPED_PAP3 for full analysis. Summary:}
...
\begin{table}[htbp]
\centering
\caption{Key Symbols in Appendix UNMAPPED_PAP2}
\begin{tabular}{lll}
\toprule
