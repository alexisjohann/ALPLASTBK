...
% - Appendix UNMAPPED_HOW (CORE-HOW): γ definition
% - Appendix UNMAPPED_HTY (LIT-HISTORY): Scientific history of complementarity
% - Appendix UNMAPPED_GTC (FORMAL-GTC): General Theory of Complementarity
%
% DEPENDENTS (what REQUIRES this appendix):
% - Appendix UNMAPPED_CRT (LIT-CRITIQUE): Uses historical analogy for defense
...
\item For formal γ-theory: See Appendix UNMAPPED_HOW (CORE-HOW)
\item For scientific history: See Appendix UNMAPPED_HTY (LIT-HISTORY)
\end{itemize}
...
\textbf{Cross-References:} Appendix UNMAPPED_HOW (CORE-HOW), XV (LIT-HISTORY), VII (FORMAL-GTC)
\end{tcolorbox}
...
% =============================================================================
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=Quick Reference: Appendix UNMAPPED_THM]
...
$\gamma$ & Complementarity parameter & See Appendix UNMAPPED_HOW (CORE-HOW) & \checkmark \\
\bottomrule
\end{tabular}
\end{table}
...
Appendix UNMAPPED_HOW (CORE-HOW: $\gamma$ definition),
Appendix UNMAPPED_HTY (LIT-HISTORY: Scientific history),
Appendix UNMAPPED_GTC (FORMAL-GTC: General Theory of Complementarity).
