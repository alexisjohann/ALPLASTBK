...
\begin{itemize}[nosep]
    ...
    \item Defense axioms (UNMAPPED_DA-1 to UNMAPPED_DA-20)
...
\textbf{Our Response (Axiom UNMAPPED_DA-0):}
...
\begin{axiom}[UNMAPPED_DA-0: Framework Falsifiability]
...
\begin{axiom}[UNMAPPED_DA-1: Structural Precedence]
...
\textbf{Cross-Reference:} Appendix UNMAPPED_HI (CORE-HIERARCHY), Section on Human-Machine complementarity
...
\begin{axiom}[UNMAPPED_DA-2: Evidence Aggregation]
...
\textbf{Cross-Reference:} Appendix UNMAPPED_BBB (CORE-WHERE), Appendix R (METHOD-EVAL)
...
\begin{axiom}[UNMAPPED_DA-3: Universal Structure, Local Parameters]
...
\textbf{Cross-Reference:} Appendix UNMAPPED_V (CORE-WHEN), BCM2 Context Database
...
\begin{axiom}[UNMAPPED_DA-4: Complexity Is Optional]
...
\begin{axiom}[UNMAPPED_DA-5: Cumulative Knowledge (P7)]
...
\textbf{Cross-Reference:} Appendix UNMAPPED_PR (CORE-PRINCIPLES), P7 Cumulation
...
\begin{axiom}[UNMAPPED_DA-6: Epistemic Transparency]
...
\textbf{Cross-Reference:} Appendix UNMAPPED_BBB (CORE-WHERE), Appendix UNMAPPED_LLM (METHOD-LLMMC)
...
\begin{axiom}[UNMAPPED_DA-7: Analysis vs. Answer]
...
\textbf{Cross-Reference:} Appendix UNMAPPED_HI (CORE-HIERARCHY), Appendix UNMAPPED_BX (BEATRIX)
...
\begin{axiom}[UNMAPPED_DA-8: Empirical Grounding]
...
\begin{axiom}[UNMAPPED_DA-9: Total Cost of Intuition]
...
\begin{axiom}[UNMAPPED_DA-10: Analysis vs. Communication]
...
\begin{axiom}[UNMAPPED_DA-11: Falsifiability by Design (P5)]
...
\begin{axiom}[UNMAPPED_DA-12: Descriptive vs. Causal $\gamma$]
Distinction:
...
\textbf{Cross-Reference:} Appendix VIII (METHOD-COMP), Appendix UNMAPPED_B (CORE-HOW)
...
\begin{axiom}[UNMAPPED_DA-13: Framework vs. Intervention Testing]
Two responses:
...
\begin{axiom}[UNMAPPED_DA-14: Framework as Enabler]
...
\begin{itemize}[nosep]
    ...
    \item Human-Machine complementarity (Appendix UNMAPPED_HI)
    \item Emergent intervention theory (Appendix UNMAPPED_IE)
\end{itemize}
...
\textbf{Cross-Reference:} Appendix UNMAPPED_PR (CORE-PRINCIPLES), Appendix UNMAPPED_FM (METHOD-FRAMEWORK)
...
\begin{axiom}[UNMAPPED_DA-15: LLMMC as Prior, Not Posterior]
...
Appendix UNMAPPED_LLM documents: calibration, uncertainty propagation, out-of-sample validation.
\end{axiom}

\textbf{Cross-Reference:} Appendix UNMAPPED_LLM (METHOD-LLMMC), Appendix UNMAPPED_BBB (CORE-WHERE)
...
\begin{axiom}[UNMAPPED_DA-16: Multi-Channel Validation]
Status:
...
\begin{axiom}[UNMAPPED_DA-17: Positive-Normative Separation]
...
\begin{axiom}[UNMAPPED_DA-18: Operational Completeness vs. Mathematical Minimality]
...
\textbf{Cross-Reference:} Appendix UNMAPPED_PR (CORE-PRINCIPLES)
...
\begin{axiom}[UNMAPPED_DA-19: BCM2 Proves Operationalizability]
...
\textbf{Example:} $\Psi_I$ (Institutional) $\rightarrow$ CH-UNMAPPED_REG-01 (State Trust)
$\rightarrow$ BFS Statistics, annually updated.

This is not ``not operationalizable.'' This is ``operationalized in data/dr-datareq/.''
\end{axiom}

\textbf{Cross-Reference:} Appendix UNMAPPED_V (CORE-WHEN), BCM2 Database
...
\begin{axiom}[UNMAPPED_DA-20: Bias Acknowledgment and Mitigation]
