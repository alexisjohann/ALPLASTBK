...
\chapter*{Appendix UNMAPPED_MN: Muriel Niederle Research Integration}
\addcontentsline{toc}{chapter}{Appendix UNMAPPED_MN: LIT-NIEDERLE - Gender, Competition \& Market Design}
\label{app:niederle}
...
\textbf{Builds On:}
\begin{itemize}
    \item Appendix UNMAPPED_GN (LIT-GNEEZY): Gender and competition foundations
    \item Appendix UNMAPPED_RO (LIT-ROTH): Market design principles
    \item Appendix UNMAPPED_SA (LIT-AMBÜHL): Organ market research collaboration
...
\begin{itemize}[nosep]
    ...
    \item LIT-AMBÜHL $\rightarrow$ Appendix UNMAPPED_SA
...
\begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=Axiom UNMAPPED_MN-1: Gender Competition Gap]
...
\begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=Axiom UNMAPPED_MN-2: Overconfidence Channel]
...
\begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=Axiom UNMAPPED_MN-3: Affirmative Action Efficacy]
...
\begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=Axiom UNMAPPED_MN-4: Competition Aversion Independence]
...
\begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=Axiom UNMAPPED_MN-5: Market Unraveling]
...
\begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=Axiom UNMAPPED_MN-6: Institutional Malleability]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2003: Unraveling Reduces the Scope of an Entry Level Labor Market:...}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Niederle, Muriel and Roth, Alvin E (2003). ``Unraveling Reduces the Scope of an Entry Level Labor Market: Gastroenterology with and without a Centralized Match.'' \textit{Journal of Political Economy}, 111, 1342--1352.

\paragraph{10C Integration.}
\begin{itemize}[nosep]
  \item \textbf{Domain}: [To be specified]
  \item \textbf{use\_for}: LIT-NIEDERLE
\end{itemize}


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2009: Market Culture: How Rules Governing Exploding Offers Affect ...}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Niederle, Muriel and Roth, Alvin E (2009). ``Market Culture: How Rules Governing Exploding Offers Affect Market Performance.'' \textit{American Economic Journal: Microeconomics}, 1, 199--219.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2006: The Effects of Centralized Clearinghouses on Market Design}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Niederle, Muriel and Roth, Alvin (2006). ``The Effects of Centralized Clearinghouses on Market Design.'' \textit{Games and Economic Behavior}, 55.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2014: Do Women Expect to Earn Less? The Role of Gender Expectation...}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Niederle, Muriel and Vesterlund, Lise (2014). ``Do Women Expect to Earn Less? The Role of Gender Expectations in Compensation Negotiations.'' \textit{Working Paper}.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2021: Matching Markets and Market Design}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Niederle, Muriel and Roth, Alvin (2021). ``Matching Markets and Market Design.'' \textit{Handbook of Industrial Organization}, 5.
