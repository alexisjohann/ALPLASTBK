...
% - Appendix UNMAPPED_B (CORE-HOW): Complementarity parameters
...
% - Appendix UNMAPPED_LLM (METHOD-LLMMC): Estimation procedures
%
% =============================================================================
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom UNMAPPED_CA-1: Bounded Strategic Depth]
...
\textbf{Source:} \citet{camerer2004neuroeconomicscognitive}
\end{tcolorbox}

\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom UNMAPPED_CA-2: Neural Value Representation]
...
\textbf{Source:} \citet{camerer2004neuroeconomicsneuroeconomics}, \citet{camerer2007brain}
\end{tcolorbox}

\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom UNMAPPED_CA-3: Experience-Weighted Attraction]
...
\textbf{Source:} \citet{camerer2005frame}
\end{tcolorbox}

\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom UNMAPPED_CA-4: Overconfidence in Competition]
...
\textbf{Source:} \citet{camerer1999overconfidence}
\end{tcolorbox}

\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom UNMAPPED_CA-5: Theory of Mind Integration]
...
\textbf{Source:} \citet{camerer2010levels}, \citet{camerer2017reading}
\end{tcolorbox}

\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom UNMAPPED_CA-6: Lab-Field Correspondence]
...
\midrule
UNMAPPED_CA-1 & Strategic depth is bounded ($\tau \approx 1.5$) & k-level distribution & 1 \\
UNMAPPED_CA-2 & Value encoded in vmPFC & Neural common currency & 1 \\
UNMAPPED_CA-3 & EWA explains game learning & $\delta \approx 0.5$ & 1 \\
UNMAPPED_CA-4 & Excess entry from overconfidence & 50\% overentry & 1 \\
UNMAPPED_CA-5 & Strategic thinking uses ToM circuits & TPJ/mPFC activation & 1 \\
UNMAPPED_CA-6 & Lab-field correlation exists & $r \in [0.3, 0.6]$ & 1 \\
UNMAPPED_CA-7 & Trust has neural correlates & Striatum/insula & 1 \\
UNMAPPED_CA-8 & Expertise reduces bias partially & Domain-specific & 1 \\
\bottomrule
\end{tabular}
\end{table}
...
Camerer's magnum opus \textit{Behavioral Game Theory} \citep{camerer2003behavioralbehavioral} establishes that people systematically deviate from Nash equilibrium in predictable ways. The key insight is that these deviations are \textit{structured}---not random noise, but systematic patterns that can be modeled.
...
The cognitive hierarchy (CH) model \citep{camerer2004neuroeconomicscognitive} provides a tractable alternative to Nash equilibrium:
...
Camerer's foundational paper ``Neuroeconomics: Why Economics Needs Brains'' \citep{camerer2004neuroeconomicsneuroeconomics} established the field. Key claims:
...
The EWA model \citep{camerer2005frame} unifies reinforcement learning and belief learning:
...
Camerer and Lovallo \citep{camerer1999overconfidence} demonstrate that overconfidence causes excess market entry:
...
\subsection{Connection to Appendix UNMAPPED_B (CORE-HOW)}
...
\begin{tcolorbox}[colback=green!10!white, colframe=green!75!black,
    title=\textbf{Appendix UNMAPPED_CA: Summary}]
...
\begin{table}[htbp]
\centering
\caption{Symbols Introduced in Appendix UNMAPPED_CA}
...
PAP-camerer2003behavioralbehavioral & 2003 & Behavioral Game Theory & 1 \\
PAP-camerer2004neuroeconomicsneuroeconomics & 2004 & Neuroeconomics & 1 \\
PAP-camerer2004neuroeconomicscognitive & 2004 & Cognitive Hierarchy & 2 \\
...
camerer2018evaluatingprospect & 2018 & Prospect Theory & 1 \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{itemize}[nosep]
    \item \textbf{Behavioral Game Theory:} \citet{camerer2003behavioralbehavioral}
    \item \textbf{Cognitive Hierarchy:} \citet{camerer2004neuroeconomicscognitive}
    \item \textbf{Neuroeconomics:} \citet{camerer2004neuroeconomicsneuroeconomics}, \citet{fehr2007neurobiology}
    \item \textbf{EWA Learning:} \citet{camerer2005frame}
    \item \textbf{Overconfidence:} \citet{camerer1999overconfidence}
\end{itemize}
