...
\chapter*{Appendix UNMAPPED_DV: Stefano DellaVigna Research Integration}
\addcontentsline{toc}{chapter}{Appendix UNMAPPED_DV: LIT-DELLAVIGNA - Contracts, Media \& Field Evidence}
...
\textbf{Builds On:}
\begin{itemize}
    \item Appendix UNMAPPED_LA (LIT-LAIBSON): Present bias and $\beta$-$\delta$ model
    ...
    \item Appendix UNMAPPED_V (CORE-WHEN): Temporal context effects
\end{itemize}
...
\begin{itemize}
    ...
    \item Appendix UNMAPPED_LLM (METHOD-LLMMC): Structural estimation
\end{itemize}
\end{tcolorbox}
...
\begin{itemize}[nosep]
    \item LIT-LAIBSON $\rightarrow$ Appendix UNMAPPED_LA
...
\begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=Axiom UNMAPPED_DV-1: Overconfidence in Self-Control]
...
\begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=Axiom UNMAPPED_DV-2: Media Persuasion Effect]
...
\begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=Axiom UNMAPPED_DV-3: Social Pressure Avoidance]
...
\begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=Axiom UNMAPPED_DV-4: Motivation Heterogeneity]
...
\begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=Axiom UNMAPPED_DV-5: Reference-Dependent Job Search]
...
\begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=Axiom UNMAPPED_DV-6: Nudge Attenuation at Scale]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2021: Illusion of Transparency and the Impact of Written Advice}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
DellaVigna, Stefano and Linos, Elizaveta (2021). ``Illusion of Transparency and the Impact of Written Advice.'' \textit{Quarterly Journal of Economics}, 136, 2185--2241.

\paragraph{10C Integration.}
\begin{itemize}[nosep]
  \item \textbf{Domain}: [To be specified]
  \item \textbf{use\_for}: LIT-DELLAVIGNA, CORE-EIT
\end{itemize}


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2020: Forecasting the Results of Experiments: Piloting an Elicitat...}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
DellaVigna, Stefano and Otis, Nicholas and Vivalt, Eva (2020). ``Forecasting the Results of Experiments: Piloting an Elicitation Strategy.'' \textit{AEA Papers and Proceedings}, 110, 75--79.

\paragraph{Core Finding.}
Tests forecast elicitation robustness. Slider bounds affect distribution (anchoring). 15-30 forecasters sufficient. Platform: socialscienceprediction.org

\paragraph{Key Parameters.}
\texttt{E[tau_hat] = 0.16 SD (avg forecast); Delta_bounds = 0.09 SD (anchoring); n*_forecast = 15-30 (optimal sample)}

\paragraph{10C Integration.}
\begin{itemize}[nosep]
  \item \textbf{Domain}: [To be specified]
  \item \textbf{use\_for}: LIT-DELLAVIGNA, METHOD-PARAM, METHOD-LLMMC, CORE-AWARE, PREDICT-FCT, CORE-EIT
\end{itemize}


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2010: Persuasion: Empirical Evidence}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
DellaVigna, Stefano and Gentzkow, Matthew (2010). ``Persuasion: Empirical Evidence.'' \textit{Annual Review of Economics}, 2.

\paragraph{10C Integration.}
\begin{itemize}[nosep]
  \item \textbf{Domain}: [To be specified]
  \item \textbf{use\_for}: LIT-DELLAVIGNA
\end{itemize}
...
\paragraph{Citation.}
DellaVigna, Stefano (2015). ``The Behavioral Economics of Taxation.'' \textit{Journal of Economic Literature}.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2016: Predicting Experimental Results: Who Knows What?}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
DellaVigna, Stefano and Pope, Devin (2016). ``Predicting Experimental Results: Who Knows What?.'' \textit{Journal of Political Economy}, 126.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2016: Voting to Tell Others}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
DellaVigna, Stefano and List, John and Malmendier, Ulrike and Rao, Gautam (2016). ``Voting to Tell Others.'' \textit{Review of Economic Studies}, 84.

\paragraph{10C Integration.}
\begin{itemize}[nosep]
  \item \textbf{Domain}: [To be specified]
  \item \textbf{use\_for}: LIT-DELLAVIGNA, LIT-O
\end{itemize}


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2017: Reference-Dependent Job Search: Evidence from Hungary}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
DellaVigna, Stefano and Lindner, Attila and Reizer, Balázs and Schmieder, Johannes (2017). ``Reference-Dependent Job Search: Evidence from Hungary.'' \textit{Quarterly Journal of Economics}, 132.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2019: Uniform Pricing in US Retail Chains}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
DellaVigna, Stefano and Malmendier, Ulrike (2019). ``Uniform Pricing in US Retail Chains.'' \textit{Quarterly Journal of Economics}, 134.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2022: RCTs to Scale: Comprehensive Evidence from Two Nudge Units}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
DellaVigna, Stefano and Linos, Elizabeth (2022). ``RCTs to Scale: Comprehensive Evidence from Two Nudge Units.'' \textit{Econometrica}, 90.
