...
\begin{itemize}[nosep]
    \item CONTEXT-MEDIA $\rightarrow$ Appendix UNMAPPED_DX
    \item LIT-ALESINA $\rightarrow$ Appendix UNMAPPED_BD
...
%
% DEPENDENCIES:
% - Appendix UNMAPPED_DX (CONTEXT-MEDIA): Media structure as determinant of party viability in democracies
% - Appendix UNMAPPED_BD (LIT-ALESINA): Redistribution preference formation
% - Appendix UNMAPPED_C (CORE-WHAT): Welfare, fairness dimensions
% - Appendix UNMAPPED_V (CORE-WHEN): Institutional context
% - Appendix UNMAPPED_BBB (CORE-WHERE): Parameter estimates
%
% DEPENDENTS:
% - Appendix UNMAPPED_DX: Babler's media reform shown as NECESSARY (not optional) for SPÖ viability
...
\begin{itemize}[nosep]
\item Section 14.2 (Redistribution Politics) $\leftrightarrow$ Appendix GEN, Sections 2-3
\item Section 14.3 (Institutional Models) $\leftrightarrow$ Appendix GEN, Sections 3-4
\item Section 14.4 (Global Variation) $\leftrightarrow$ Appendix GEN, Sections 8-10
\end{itemize}
...
Alesina's research (see Appendix UNMAPPED_BD for full discussion) provides the **foundation for understanding demand for welfare states**. His key insight:
...
\item \textbf{Awareness Function (AWARE - Appendix UNMAPPED_AU):}
...
\subsection{WHO (Appendix UNMAPPED_AAA): Welfare Hierarchy}
...
\subsection{WHAT (Appendix UNMAPPED_C): Utility Dimensions}
...
\subsection{HOW (Appendix UNMAPPED_B): Complementarity}
...
\subsection{WHEN (Appendix UNMAPPED_V): Context Dimensions}
...
\subsection{WHERE (Appendix UNMAPPED_BBB): Parameters}
...
\subsection{AWARE (Appendix UNMAPPED_AU): Awareness Function}
...
\subsection{READY (Appendix UNMAPPED_AV): Willingness Function}
...
\subsection{STAGE (Appendix UNMAPPED_AW): Behavioral Change Journey}
...
\begin{itemize}
\item \hyperref[app:lit-alesina]{Appendix UNMAPPED_BD (LIT-ALESINA)}: Foundation on preference formation
\item \hyperref[app:core-what]{Appendix UNMAPPED_C (CORE-WHAT)}: Welfare as utility dimension
\item \hyperref[app:core-when]{Appendix UNMAPPED_V (CORE-WHEN)}: Institutional context
\item \hyperref[app:core-hierarchy]{Appendix UNMAPPED_HI (CORE-HIERARCHY)}: Multi-level political analysis
\end{itemize}
