...
%
% Dependencies: Chapter 22 (Policy Applications), Appendix UNMAPPED_LLL (domain templates)
%
% Cross-references: Appendix TKT (coherence criteria), KKK (dynamics)
%
% =============================================================================

\newpage
\section*{Appendix UNMAPPED_MMM: METHOD-POLICY-COHERENCE}
\label{app:method-policy-coherence}
\addcontentsline{toc}{section}{Appendix UNMAPPED_MMM: METHOD-POLICY-COHERENCE}
...
\textbf{For Theory:}
\begin{itemize}[nosep]
\item Appendix TKT (METHOD-TOOLKIT): Coherence criteria C1-C4
\item Appendix UNMAPPED_KKK (METHOD-DYNAMIC): Formal spillover dynamics
\end{itemize}
...
\begin{table}[htbp]
\centering
\caption{Key Symbols in Appendix UNMAPPED_MMM}
\begin{tabular}{lll}
\toprule
...
\vspace{2cm}
\begin{center}
{\large \textbf{End of Appendix UNMAPPED_MMM: METHOD-POLICY-COHERENCE}} \\
\vspace{0.5cm}
{\small \textit{For domain-specific design templates, see Appendix UNMAPPED_LLL}}
\end{center}
