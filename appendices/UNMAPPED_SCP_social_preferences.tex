...
\begin{itemize}[nosep]
    ...
    \item Behavioral Game Theory $\rightarrow$ Appendix UNMAPPED_SPC
\end{itemize}
...
\begin{itemize}[nosep]
    \item Appendix UNMAPPED_WAT (CORE-WHAT): Social dimension in FEPSDE
    \item Appendix CTW (CORE-WHEN): $\Psi_S$ modulation
    \item Appendix UNMAPPED_FEH (Fehr Papers): Primary literature
\end{itemize}
...
\textbf{Cross-Reference:} Appendix UNMAPPED_MSC Section 11 (full BC treatment),
Appendix UNMAPPED_SPC (Behavioral Game Theory), Appendix UNMAPPED_HOW (Complementarity).
...
\begin{itemize}[nosep]
    \item Appendix UNMAPPED_FEH (Fehr Papers): Complete Fehr research integration
    \item Appendix UNMAPPED_SPC (Behavioral GT): Social preferences in games
    \item Appendix CTW (CORE-WHEN): $\Psi_S$ as context dimension
    \item Appendix UNMAPPED_MSC Section 11: BC-isomorphism of social games
\end{itemize}
