...
% =============================================================================
% Appendix UNMAPPED_VVV7: McKinsey State of AI 2025 Report
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Implications for EBF Productizing (Appendix UNMAPPED_VVV)}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Appendix UNMAPPED_VVV7 Summary]
...
\begin{table}[htbp]
\centering
\caption{Key Symbols in Appendix UNMAPPED_VVV7}
\begin{tabular}{lll}
\toprule
