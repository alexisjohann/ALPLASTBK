...
\begin{itemize}[nosep]
    ...
    \item Behavioral GT $\rightarrow$ Appendix UNMAPPED_SPC
    \item CORE-HOW $\rightarrow$ Appendix UNMAPPED_HOW
    \item Behavioral GT $\rightarrow$ Appendix UNMAPPED_SPC
    \item Awareness $\rightarrow$ Appendix UNMAPPED_AWA
\end{itemize}
...
\begin{itemize}[nosep]
    \item Appendix UNMAPPED_SPC (Behavioral GT): Level-$k$ heterogeneity
    \item Appendix UNMAPPED_MSC Section 11: M\&N structured heterogeneity
    \item Appendix UNMAPPED_HOW (CORE-HOW): Complementarity creates feedback loops
\end{itemize}
...
\begin{equation}
\boxed{
C^*_T = f(C_0, C_1, \ldots, C_{UNMAPPED_CAM-1}, \text{random events})
}
...
\textbf{Cross-Reference:} Appendix UNMAPPED_MSC Section 11, Appendix UNMAPPED_SPC (Behavioral GT),
Appendix UNMAPPED_AWA (Awareness).
...
\hline
Path dependence & $C^*_T = f(C_0, \ldots, C_{UNMAPPED_CAM-1})$ & History matters \\
\hline
...
\begin{itemize}[nosep]
    ...
    \item Appendix UNMAPPED_HOW (CORE-HOW): Complementarity and increasing returns
    \item Appendix UNMAPPED_SCP (Social Preferences): Heterogeneous preferences
\end{itemize}
