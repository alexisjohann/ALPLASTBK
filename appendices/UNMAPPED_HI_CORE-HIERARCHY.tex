...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom UNMAPPED_HIE-1: Level-Bias Correspondence]
\textbf{Statement:}
\begin{equation}
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom UNMAPPED_HIE-2: Level Shifting]
\textbf{Statement:}
\begin{equation}
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom UNMAPPED_HIE-3: Default Level]
\textbf{Statement:}
\begin{equation}
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom UNMAPPED_HIE-4: Level-Intervention Match]
\textbf{Statement:}
\begin{equation}
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Appendix UNMAPPED_HI Summary: CORE-HIERARCHY]
...
Appendix UNMAPPED_AAA (CORE-WHO), V (CORE-WHEN), AU (CORE-AWARE), IE (CORE-EIT).
