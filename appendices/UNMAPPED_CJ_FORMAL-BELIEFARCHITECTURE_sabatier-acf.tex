...
\begin{itemize}[nosep]
\item Appendix GEN (DOMAIN-SOCIALDEMOCRACY): The ten normative principles
\item Appendix UNMAPPED_CK (FORMAL-BELIEFOPPOSITIONS): Liberal/Conservative alternatives
\item Appendix UNMAPPED_BH (CONTEXT-SPÖ_PARADOX): How incoherence paralyzed SPÖ
\end{itemize}
...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=Quick Reference: Appendix UNMAPPED_CJ]
...
\begin{itemize}[nosep]
    ...
    \item CONTEXT-SPÖ_PARADOX $\rightarrow$ Appendix UNMAPPED_BH
    \item DOMAIN-SOCIALDEMOCRACY $\rightarrow$ Appendix GEN
    \item FORMAL-BELIEFOPPOSITIONS $\rightarrow$ Appendix UNMAPPED_CK
\end{itemize}
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom UNMAPPED_CJ-1: Hierarchical Belief Organization]
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom UNMAPPED_CJ-2: Coherence as Psychological Consistency}
...
\begin{tcolorbox}[colback=green!10!white, colframe=green!75!black,
    title=Appendix UNMAPPED_CJ: Summary]
...
\textbf{Related Appendices:}
\begin{itemize}[nosep]
\item Appendix GEN (DOMAIN-SOCIALDEMOCRACY): The 10 normative principles
\item Appendix UNMAPPED_CK (FORMAL-BELIEFOPPOSITIONS): Liberal/Conservative counterarguments
\item Appendix UNMAPPED_BH (CONTEXT-SPÖ_PARADOX): How incoherence paralyzed SPÖ decision-making
\item Appendix UNMAPPED_DX (CONTEXT-POLITICAL-ECONOMY): Babler's 2025-2029 reform scenarios
\end{itemize}
