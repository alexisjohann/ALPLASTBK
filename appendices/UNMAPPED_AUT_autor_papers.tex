% =============================================================================
% APPENDIX AUT: LIT-DAVID: David Autor Research Integration
% =============================================================================
% Category: LIT
% Language: English
...
% Status: Draft
%
% This appendix integrates research papers by David Autor into the EBF framework.
%
% =============================================================================

\chapter{LIT-DAVID: David Autor Research Integration}
\label{app:aut}

\begin{abstract}
This appendix integrates the research contributions of David Autor into the
...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=Quick Reference: David Autor Research]

\textbf{Appendix:} AUT (LIT)

\textbf{Researcher:} David Autor
...
\begin{itemize}[nosep]
    \item Integrate David Autor's research into EBF with parameter extraction
\end{itemize}
...
\textbf{How does lit-david: david autor research integration integrate with and contribute to the
...
\begin{table}[htbp]
\centering
\caption{Key Symbols in Appendix UNMAPPED_AUT}
\begin{tabular}{lll}
\toprule
