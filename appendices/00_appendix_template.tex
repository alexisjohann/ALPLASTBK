...
%    ├─────────────────────────────────────────────────────────────────────┤
%    │  4.1  Summary Box                                                   │
%    │  4.2  Glossary of Symbols (+ link to Appendix UNMAPPED_GLS)           ← MUST   │
...
%
%    MANDATORY LINKS:
%    - Every appendix MUST reference Appendix UNMAPPED_GLS (Central Glossary)
%    - Every appendix MUST reference bcm2_master_references.bib
%    - Symbols must be consistent with Appendix UNMAPPED_GLS definitions
%
% #############################################################################
...
% - [Appendix UNMAPPED_FND]: [What it provides]
...
%
% CRITICAL: All symbol definitions MUST be consistent with Appendix UNMAPPED_GLS (Glossary)
...
% All standard EBF symbols are defined in Appendix UNMAPPED_GLS (Central Glossary).
% 
% If you introduce a NEW symbol:
%   1. Define it here
%   2. Ensure it is added to Appendix UNMAPPED_GLS in the next update
%
% If you use a STANDARD symbol with a specialized meaning:
%   1. Define the specialization here
%   2. Reference the general definition in Appendix UNMAPPED_GLS
% -----------------------------------------------------------------------------
...
% Mark symbols as:
%   \checkmark = Standard symbol defined in Appendix UNMAPPED_GLS (reference only)
...
[Appendix UNMAPPED_FND] ([Topic]), 
[Appendix UNMAPPED_CIA] ([Topic]).
