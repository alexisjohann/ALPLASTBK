...
% - Appendix UNMAPPED_EST (CORE-WHERE): Parameter estimation for calibration
% - Appendix LLM1 (METHOD-LLMMC): LLM Monte Carlo methods
%
% DEPENDENTS (what REQUIRES this appendix):
% - Appendix UNMAPPED_VVV.2: Product roadmap builds on scenario analysis
% - Appendix UNMAPPED_VVV.3: Partnership strategy depends on platform scenarios
%
% =============================================================================
...
\textbf{Cross-References:} Appendix CTW (CORE-WHEN), Appendix UNMAPPED_EST (CORE-WHERE),
Appendix LLM1 (METHOD-LLMMC), Appendix UNMAPPED_VVV.2 (Product Roadmap)
\end{tcolorbox}
...
\begin{tcolorbox}[colback=yellow!5!white,colframe=yellow!75!black,title=Axiom UNMAPPED_VVV2-1: Fundamental Principle]
\textbf{Axiom UNMAPPED_VVV2-1 (Core Assumption):}
...
\begin{tcolorbox}[colback=yellow!5!white,colframe=yellow!75!black,title=Axiom UNMAPPED_VVV2-2: Complementarity]
\textbf{Axiom UNMAPPED_VVV2-2 (Complementarity):}
...
\begin{tcolorbox}[colback=green!10!white, colframe=green!75!black,
    title=\textbf{Appendix UNMAPPED_VVV.1: Summary}]
...
\begin{table}[htbp]
\centering
\caption{Symbols Introduced in Appendix UNMAPPED_VVV.1}
...
Appendix UNMAPPED_VVV.2 (Product Roadmap).
