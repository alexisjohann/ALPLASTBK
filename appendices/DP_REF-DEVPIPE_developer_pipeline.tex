...
concrete implementation workflows. While Appendix FM shows where proofs are,
...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=\textbf{Appendix DP: REF-DEVPIPE}]
...
\begin{itemize}[nosep]
    \item Mathematical proofs $\rightarrow$ Appendix FM (REF-FORMALMAP)
    \item Theory catalog $\rightarrow$ Appendix MS (REF-MODELSPACE)
...
\textbf{Theorem DP-1 (Computability):}
...
\textbf{Theorem DP-2 (Validation Convergence):}
...
\textbf{Theorem DP-3 (Pipeline Consistency):}
...
\textbf{Navigation Hub:} For complete parameterization methodology including decision trees and parameter-type routing, see \textbf{Appendix PM (REF-PARAMETH)}.
...
\begin{itemize}[nosep]
    \item \textbf{Source:} Appendix BBB (CORE-WHERE) parameter repository
...
\begin{itemize}[nosep]
    ...
    \item \textbf{Reference:} Appendix CAL (METHOD-LLMMC)
\end{itemize}
...
> β = 0.7 (Laibson 1997)
> Papers: laibson1997golden, odonoghue1999doing
\end{verbatim}
...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=\textbf{Appendix DP Summary}]
