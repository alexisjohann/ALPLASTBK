...
\begin{tcolorbox}[colback=yellow!5!white,colframe=yellow!75!black,title=Axiom UNMAPPED_EVL-1: Fundamental Principle]
\textbf{Axiom UNMAPPED_EVL-1 (Core Assumption):}
...
\begin{tcolorbox}[colback=yellow!5!white,colframe=yellow!75!black,title=Axiom UNMAPPED_EVL-2: Complementarity]
\textbf{Axiom UNMAPPED_EVL-2 (Complementarity):}
...
\begin{itemize}
  \item Fits: Appendix UNMAPPED_CTM (Temporal Context) --- already included
...
\hrule
\vspace{0.5em}
\noindent\textit{Cross-references: Appendix UNMAPPED_SUN (Falsifiable Predictions), 
Appendix UNMAPPED_CAM (Metatheory), Appendix UNMAPPED_EPS (Epistemics of Deviation---diagnostic 
...
\begin{table}[htbp]
\centering
\caption{Key Symbols in Appendix UNMAPPED_EVL}
\begin{tabular}{lll}
\toprule
