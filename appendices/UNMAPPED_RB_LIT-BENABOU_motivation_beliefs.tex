...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=Quick Reference: Appendix UNMAPPED_RB]
...
\begin{itemize}[nosep]
    ...
    \item REF-GLOSSARY $\rightarrow$ Appendix G
    \item LIT-TIROLE $\rightarrow$ Appendix UNMAPPED_JT
\end{itemize}
...
\begin{itemize}[nosep]
    \item 4 Table(s)
    \item 12 Equation(s)
    \item 10 Axiom(s) (UNMAPPED_RB-1 to UNMAPPED_RB-10)
...
\label{ax:rb-1}
\textbf{UNMAPPED_RB-1:} Self-confidence has instrumental value---higher $\hat{\theta}$ increases effort and performance:
\begin{equation}
...
\textbf{EBF Integration:} Axiom UNMAPPED_RB-1 connects directly to CORE-AWARE (AU)---awareness is not just about information but about \textit{willingness} to process information that threatens self-image. It also connects to CORE-READY (AV)---self-confidence affects the perceived threshold for action.
...
\label{ax:rb-2}
\textbf{UNMAPPED_RB-2:} Extrinsic incentives affect effort through two channels:
\begin{equation}
...
\textbf{EBF Integration:} Axiom UNMAPPED_RB-2 is central to EBF's intervention design. It connects to CORE-HOW (B) through the complementarity structure---intrinsic and extrinsic motivation can be complements or substitutes depending on what the incentive signals.
...
\label{ax:rb-3}
\textbf{UNMAPPED_RB-3:} Agents invest in beliefs that:
\begin{enumerate}
...
\textbf{EBF Integration:} Axiom UNMAPPED_RB-3 explains why information campaigns often fail to change behavior---new information may threaten identity investments. It connects to CORE-STAGE (AW)---identity transformation is a critical part of the behavioral change journey.

\subsection{Inequality, Stratification, and Growth}
\label{subsec:rb-inequality}

Bénabou's inequality research \citep{benabou1996inequality, benabou1996heterogeneity} shows how local complementarities create persistent stratification:
...
\label{ax:rb-4}
\textbf{UNMAPPED_RB-4:} When human capital production exhibits local complementarities ($\partial^2 f / \partial h_i \partial \bar{h}_N > 0$), stratified equilibria emerge:
\begin{enumerate}
...
\textbf{EBF Integration:} Axiom UNMAPPED_RB-4 connects to CORE-WHO (AAA) through the welfare hierarchy---community-level welfare affects individual outcomes. It explains why individual-level interventions may fail when systemic stratification persists.

\subsection{The POUM Hypothesis}
\label{subsec:rb-poum}

Bénabou and Ok's POUM model \citep{benabou2001social} explains why poor voters may oppose redistribution:
...
\label{ax:rb-5}
\textbf{UNMAPPED_RB-5:} Under concave utility and sufficient income mobility, agents below the mean may rationally oppose redistribution if they expect their future income to exceed the (future) mean:
\begin{equation}
...
\textbf{EBF Integration:} Axiom UNMAPPED_RB-5 connects motivated beliefs (UNMAPPED_RB-3) to political preferences. Beliefs about social mobility may be systematically biased upward to maintain self-image and hope.

\subsection{Groupthink and Collective Delusions}
\label{subsec:rb-groupthink}

Bénabou's groupthink model \citep{benabou2013groupthink} explains organizational failures:
...
\label{ax:rb-6}
\textbf{UNMAPPED_RB-6:} Organizations can develop ``mutually assured delusion'' when:
\begin{enumerate}
...
\textbf{EBF Integration:} Axiom UNMAPPED_RB-6 extends individual motivated beliefs (UNMAPPED_RB-3) to organizations. It connects to CORE-WHO (AAA)---organizational-level pathologies emerge from individual incentives.

\subsection{Moral Narratives and Imperatives}
\label{subsec:rb-narratives}

Bénabou, Falk, and Tirole's narratives model \citep{benabou2018narratives} analyzes how moral justifications and rules spread through society:
...
\label{ax:rb-7}
\textbf{UNMAPPED_RB-7:} Moral justifications (narratives) and categorical rules (imperatives) serve distinct functions:
...
\textbf{EBF Integration:} Axiom UNMAPPED_RB-7 connects to:
\begin{itemize}
...
Bénabou, Falk, and Henkel \citep{benabou2024ends} challenge the assumption of stable moral ``types'' (Kantian vs. Utilitarian). Using four novel \textbf{Ends-versus-Means (EVM)} games, they show:

\begin{axiom}[Context-Dependent Moral Reasoning]
\label{ax:rb-11}
\textbf{UNMAPPED_RB-11:} Moral reasoning weight $\theta$ is context-dependent, not a stable trait:
\begin{equation}
...
\textbf{EBF Integration:} UNMAPPED_RB-11 provides a \textbf{critical counterexample} to the general pattern of cross-context complementarity:
\begin{itemize}
...
Bénabou and Henkel's comprehensive handbook chapter \citep{benabou2025identity} provides the \textbf{unified framework} for belief-based identity economics, synthesizing 20+ years of research:
...
\label{ax:rb-8}
\textbf{UNMAPPED_RB-8:} Identity utility depends on self-perceived type:
\begin{equation}
...
\label{ax:rb-9}
\textbf{UNMAPPED_RB-9:} Agents may strategically avoid information when ego utility exceeds instrumental value:
\begin{equation}
...
\label{ax:rb-10}
\textbf{UNMAPPED_RB-10:} Help-seeking is deterred by fear of rejection when rejection reveals low valuation:
\begin{equation}
...
\textbf{Key Results} from Bénabou, Jaroszewicz \& Loewenstein (2022) \citep{benabou2022hurts}:
\begin{itemize}
...
\textbf{EBF Integration:} The unified framework from UNMAPPED_RB-8, UNMAPPED_RB-9, and UNMAPPED_RB-10 connects to:
\begin{itemize}
...
\begin{itemize}
    ...
    \item $\lambda_R$: Rejection sensitivity (UNMAPPED_RB-10) [1.5, 3.0]
    \item $\alpha$: Rejection scaling factor (UNMAPPED_RB-10) [0, 1]
    \item $w^*$: Asking threshold (UNMAPPED_RB-10) (endogenous)
    \item $\tilde{g}$: Offering threshold (UNMAPPED_RB-10) (endogenous)
\end{itemize}
...
\begin{tabular}{llcc}
\toprule
\textbf{Study} & \textbf{Finding} & \textbf{UNMAPPED_RB-2 Support} & \textbf{Tier} \\
\midrule
...
\begin{tabular}{llcc}
\toprule
\textbf{Study} & \textbf{Finding} & \textbf{UNMAPPED_RB-4 Support} & \textbf{Tier} \\
\midrule
...
\begin{tabular}{llcc}
\toprule
\textbf{Study} & \textbf{Finding} & \textbf{UNMAPPED_RB-5 Support} & \textbf{Tier} \\
\midrule
...
\textbf{Bénabou-Tirole Analysis (UNMAPPED_RB-2):}
\begin{equation}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{1988: Search, Price Setting, and Inflation}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Roland Bénabou (1988). ``Search, Price Setting, and Inflation.'' \textit{Review of Economic Studies}, 55.

\paragraph{10C Integration.}
\begin{itemize}[nosep]
  \item \textbf{Domain}: [To be specified]
  \item \textbf{use\_for}: LIT-BENABOU
\end{itemize}


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{1991: Education, Income Distribution, and Growth: The Local Connec...}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Roland Bénabou (1991). ``Education, Income Distribution, and Growth: The Local Connection.'' \textit{NBER Working Paper}.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{1992: Inflation and Efficiency in Search Markets}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Roland Bénabou (1992). ``Inflation and Efficiency in Search Markets.'' \textit{Review of Economic Studies}, 59.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{1993: Workings of a City: Location, Education, and Production}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Roland Bénabou (1993). ``Workings of a City: Location, Education, and Production.'' \textit{Quarterly Journal of Economics}, 108.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{1994: Human Capital, Inequality, and Growth: A Local Perspective}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Roland Bénabou (1994). ``Human Capital, Inequality, and Growth: A Local Perspective.'' \textit{European Economic Review}, 38.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{1996: Equity and Efficiency in Human Capital Investment: The Local...}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Roland Bénabou (1996). ``Equity and Efficiency in Human Capital Investment: The Local Connection.'' \textit{Review of Economic Studies}, 63.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2000: Unequal Societies: Income Distribution and the Social Contra...}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Roland Bénabou (2000). ``Unequal Societies: Income Distribution and the Social Contract.'' \textit{American Economic Review}, 90.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2001: Status, Redistribution, and Economic Growth}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Roland Bénabou (2001). ``Status, Redistribution, and Economic Growth.'' \textit{Working Paper}.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2002: Tax and Education Policy in a Heterogeneous-Agent Economy: W...}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Roland Bénabou (2002). ``Tax and Education Policy in a Heterogeneous-Agent Economy: What Levels of Redistribution Maximize Growth and Efficiency?.'' \textit{Econometrica}, 70.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2003: Human Capital, Technical Change, and the Welfare State}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Roland Bénabou (2003). ``Human Capital, Technical Change, and the Welfare State.'' \textit{Journal of the European Economic Association}, 1.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2005: Inequality, Technology, and the Social Contract}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Roland Bénabou (2005). ``Inequality, Technology, and the Social Contract.'' \textit{Handbook of Economic Growth}, 1.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2008: Ideology}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Roland Bénabou (2008). ``Ideology.'' \textit{Journal of the European Economic Association}, 6.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2015: Mutually Assured Destruction: Self-Serving Biases and Group ...}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Roland Bénabou (2015). ``Mutually Assured Destruction: Self-Serving Biases and Group Polarization.'' \textit{Working Paper}.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2019: Beliefs, Policies, and Well-Being}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Roland Bénabou (2019). ``Beliefs, Policies, and Well-Being.'' \textit{Working Paper}.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2020: Eliciting Moral Preferences}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Roland Bénabou and Armin Falk and Jean Tirole (2020). ``Eliciting Moral Preferences.'' \textit{Working Paper}.

\paragraph{10C Integration.}
\begin{itemize}[nosep]
  \item \textbf{Domain}: [To be specified]
  \item \textbf{use\_for}: LIT-BENABOU, LIT-O
\end{itemize}


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2022: Making Sense of Moral Consistency and Market Behavior}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Roland Bénabou (2022). ``Making Sense of Moral Consistency and Market Behavior.'' \textit{Working Paper}.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{1993: Search with Learning from Prices: Does Increased Inflationar...}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Roland Bénabou and Robert Gertner (1993). ``Search with Learning from Prices: Does Increased Inflationary Uncertainty Lead to Higher Markups?.'' \textit{Review of Economic Studies}, 60.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{1992: Using Privileged Information to Manipulate Markets: Insiders...}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Roland Bénabou and Guy Laroque (1992). ``Using Privileged Information to Manipulate Markets: Insiders, Gurus, and Credibility.'' \textit{Quarterly Journal of Economics}, 107.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{1998: Income Distribution, Tax Policy, and the Case for a Proporti...}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Roland Bénabou and Efe Ok (1998). ``Income Distribution, Tax Policy, and the Case for a Proportional Rate Structure.'' \textit{NBER Working Paper}.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2002: Dynamic Inconsistency and Self-Control: A Planner-Doer Inter...}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Roland Bénabou and Marek Pycia (2002). ``Dynamic Inconsistency and Self-Control: A Planner-Doer Interpretation.'' \textit{Economics Letters}, 77.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2022: Forbidden Fruits: The Political Economy of Science, Religion...}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Roland Bénabou and Davide Ticchi and Andrea Vindigni (2022). ``Forbidden Fruits: The Political Economy of Science, Religion, and Growth.'' \textit{Review of Economic Studies}, 89.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2016: Bonus Culture: Competitive Pay, Screening, and Multitasking}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Roland Bénabou and Jean Tirole (2016). ``Bonus Culture: Competitive Pay, Screening, and Multitasking.'' \textit{Journal of Political Economy}, 124.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2009: Over My Dead Body: Bargaining and the Price of Dignity}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Roland Bénabou and Jean Tirole (2009). ``Over My Dead Body: Bargaining and the Price of Dignity.'' \textit{American Economic Review Papers and Proceedings}, 99.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2010: Individual and Corporate Social Responsibility}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Roland Bénabou and Jean Tirole (2010). ``Individual and Corporate Social Responsibility.'' \textit{Economica}, 77.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2011: Laws and Norms}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Roland Bénabou and Jean Tirole (2011). ``Laws and Norms.'' \textit{NBER Working Paper}.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2016: Mindful Economics: The Production, Consumption, and Value of...}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Roland Bénabou and Jean Tirole (2016). ``Mindful Economics: The Production, Consumption, and Value of Beliefs.'' \textit{Journal of Economic Perspectives}, 30.
...
\begin{enumerate}
    \item \textbf{UNMAPPED_RB-1 (Self-Confidence):} Beliefs about ability affect motivation; rational agents engage in self-deception
    \item \textbf{UNMAPPED_RB-2 (Crowding):} Incentives backfire when they signal negative information about task or trust
    \item \textbf{UNMAPPED_RB-3 (Identity):} Beliefs are assets that provide utility and enable commitment; taboos protect sacred values
    \item \textbf{UNMAPPED_RB-4 (Stratification):} Local complementarities create persistent inequality through sorting
    \item \textbf{UNMAPPED_RB-5 (POUM):} Mobility beliefs explain support for inequality even among the poor
    \item \textbf{UNMAPPED_RB-6 (Groupthink):} Organizations develop collective delusions through conformity cascades
\end{enumerate}
...
See Appendix G (REF-GLOSSARY) for term definitions and Appendix UNMAPPED_JT (LIT-TIROLE) for the Bénabou-Tirole collaboration.
