...
\begin{itemize}[nosep]
    \item CORE-WHAT: Utility Dimensions $\rightarrow$ Appendix UNMAPPED_C
    \item CORE-WHEN: Context $\rightarrow$ Appendix UNMAPPED_V
    \item CORE-WHERE: Parameters $\rightarrow$ Appendix UNMAPPED_BBB
...
%
% DEPENDENCIES:
% - Appendix UNMAPPED_C (CORE-WHAT: Utility Dimensions): Measures of welfare
% - Appendix UNMAPPED_V (CORE-WHEN: Context): Role of cultural and institutional context
% - Appendix UNMAPPED_BBB (CORE-WHERE: Parameters): Empirical estimates from Alesina studies
%
% DEPENDENTS:
...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=Quick Reference: Appendix UNMAPPED_BD]
...
where $\text{History}_j$ includes slavery history, feudal institutions, colonial legacy (Appendix UNMAPPED_V: Context Dimensions).
...
\item \hyperref[app:context-dimension]{Appendix UNMAPPED_V (CORE-WHEN)}: How context $\Psi$ operates (institutional details)
\item \hyperref[app:hierarchy]{Appendix UNMAPPED_HI (CORE-HIERARCHY)}: Stratification in preference formation
\end{itemize}
