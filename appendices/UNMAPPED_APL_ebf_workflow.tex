...
% The 8th CORE is STAGE (Behavioral Change Journey, Appendix UNMAPPED_STA).
%
% =============================================================================
...
%
% DEPENDS ON:
%   - Appendix UNMAPPED_WHO (WHO): Welfare hierarchy for stakeholder identification
%   - Appendix UNMAPPED_HOW (HOW): Complementarity structure
%   - Appendix UNMAPPED_WAT (WHAT): Utility dimensions
%   - Appendix CTW (WHEN): Context dimensions
%   - Appendix UNMAPPED_EST (WHERE): Parameter estimation
%   - Appendix UNMAPPED_AWA (AWARE): Awareness modeling
%   - Appendix UNMAPPED_REA (READY): Willingness modeling
%   - Appendix UNMAPPED_GLS (Glossary): Symbol definitions
%
% REQUIRED BY:
...
% =============================================================================
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=Quick Reference: Appendix UNMAPPED_APL]
...
\textbf{Detailed in:} Appendix UNMAPPED_MSC, Section ``The EBF Research Workflow''
...
\begin{itemize}
    ...
    \item[$\square$] Glossary terms consistent with Appendix UNMAPPED_GLS
\end{itemize}
...
See Appendix UNMAPPED_GLS (Central Glossary) for complete definitions. Key terms for
this appendix:
...
Appendix UNMAPPED_MSC (Scientific instantiation),
