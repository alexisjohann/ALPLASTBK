...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=Quick Reference: Appendix UNMAPPED_OT]
...
\textit{Added 2026-02-02: Supporting UNMAPPED_CAT-21 Political Psychology theories (MS-PP-001 to MS-PP-005)}

\begin{tcolorbox}[colback=yellow!5!white,colframe=yellow!75!black,title=Key Paper: DÖW Rechtsextremismus-Barometer (2024)]
\textbf{Citation:} \citet{doew2024rechtsextremismus}. ``Rechtsextremismus-Barometer Österreich 2024.'' Dokumentationsarchiv des österreichischen Widerstandes, Vienna.
...
\textbf{Case:} UNMAPPED_CAS-890 (Rechtsextremismus-Segment Österreich 2024)
\end{tcolorbox}

\begin{tcolorbox}[colback=gray!10!white,colframe=gray!75!black,title=Related Papers in This Cluster]
\begin{itemize}[nosep]
    \item \citet{kleppestoe2024genetic}: Genetic basis of RWA/SDO (30-50\% heritable)
    \item \citet{herold2025replacement}: Cross-European Great Replacement beliefs
    \item \citet{ifes2022antisemitismus}: Austrian antisemitism survey (31\% prevalence)
    \item \citet{weisskircher2025normalised}: FPÖ normalization trajectory
\end{itemize}
\end{tcolorbox}
...
% Supporting Unified NTM-Context Model (Appendix UNMAPPED_PBB)
% ============================================================================
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2024: Risk aversion and favourite--longshot bias in a competitive ...}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Whelan, Karl (2024). ``Risk aversion and favourite--longshot bias in a competitive fixed-odds betting market.'' \textit{Economica}, 91, 234--256.

\paragraph{Key Parameters.}
\texttt{overconfidence, probability_misperception}

\paragraph{10C Integration.}
\begin{itemize}[nosep]
  \item \textbf{Domain}: [To be specified]
  \item \textbf{use\_for}: LIT-OTHER, DOMAIN-PREDICTION, parameter
\end{itemize}


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2009: Is there an optimistic bias on betting markets?}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Page, Lionel (2009). ``Is there an optimistic bias on betting markets?.'' \textit{Economics Letters}, 102, 70--72.

\paragraph{Key Parameters.}
\texttt{home_bias, optimism_bias}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2023: What drives biased odds in sports betting markets: Bettors' ...}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Zhang, Zili and Cheng, Dennis and Zhang, Zhimin (2023). ``What drives biased odds in sports betting markets: Bettors' irrationality and the role of bookmakers.'' \textit{European Financial Management}, 29, 1197--1227.

\paragraph{10C Integration.}
\begin{itemize}[nosep]
  \item \textbf{Domain}: [To be specified]
  \item \textbf{use\_for}: LIT-OTHER, DOMAIN-PREDICTION
\end{itemize}


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2024: Do Sports Bettors Need Consumer Protection? Evidence from a ...}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Brown, Matthew (2024). ``Do Sports Bettors Need Consumer Protection? Evidence from a Field Experiment.'' \textit{Journal}.

\paragraph{10C Integration.}
\begin{itemize}[nosep]
  \item \textbf{Domain}: [To be specified]
  \item \textbf{use\_for}: LIT-OTHER, DOMAIN-PREDICTION, empirical
\end{itemize}


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{1966: A Theory of Psychological Reactance}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Brehm, Jack W. (1966). \textit{A Theory of Psychological Reactance}. Academic Press.

\paragraph{Core Finding.}
Foundational theory of psychological reactance - when freedom is threatened, motivation to restore it increases

\paragraph{10C Integration.}
\begin{itemize}[nosep]
  \item \textbf{Domain}: [To be specified]
  \item \textbf{use\_for}: CORE-MASTER, LIT-OTHER, reactance-theory
\end{itemize}


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{1992: In Search of How People Change: Applications to Addictive Be...}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Prochaska, James O. and DiClemente, Carlo C. and Norcross, John C. (1992). ``In Search of How People Change: Applications to Addictive Behaviors.'' \textit{American Psychologist}, 47, 1102--1114.
...
\begin{itemize}[nosep]
  \item \textbf{Domain}: [To be specified]
  \item \textbf{use\_for}: CORE-MASTER, LIT-OTHER, stages-of-change, CORE-READY, CORE-STAGE
\end{itemize}


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2011: Stages of Change}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Norcross, John C. and Krebs, Paul M. and Prochaska, James O. (2011). ``Stages of Change.'' \textit{Journal of Clinical Psychology}, 67, 143--154.

\paragraph{Core Finding.}
Review of stages of change model with clinical applications
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2015: Inside the Nudge Unit: How Small Changes Can Make a Big Diff...}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Halpern, David (2015). \textit{Inside the Nudge Unit: How Small Changes Can Make a Big Difference}. WH Allen.

\paragraph{Core Finding.}
UK Behavioral Insights Team - EAST framework (Easy, Attractive, Social, Timely)

\paragraph{10C Integration.}
\begin{itemize}[nosep]
  \item \textbf{Domain}: [To be specified]
  \item \textbf{use\_for}: CORE-MASTER, LIT-OTHER, behavioral-insights, policy, CORE-EIT
\end{itemize}


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2014: THINK: A Practical Guide to Behavioral Science for Policy Ma...}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Service, Owain and Hallsworth, Michael and Halpern, David and others (2014). \textit{THINK: A Practical Guide to Behavioral Science for Policy Makers}. Behavioral Insights Team.

\paragraph{Core Finding.}
Practical guide from UK Behavioral Insights Team for policy implementation

\paragraph{10C Integration.}
\begin{itemize}[nosep]
  \item \textbf{Domain}: [To be specified]
  \item \textbf{use\_for}: CORE-MASTER, LIT-OTHER, policy-design
\end{itemize}


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2012: Beyond Nudges: Tools of a Choice Architecture}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Johnson, Eric J. and Shu, Suzanne B. and Dellaert, Benedict G.C. and others (2012). ``Beyond Nudges: Tools of a Choice Architecture.'' \textit{Marketing Letters}, 23, 487--504.

\paragraph{Core Finding.}
Taxonomy of choice architecture tools beyond defaults

\paragraph{10C Integration.}
\begin{itemize}[nosep]
  \item \textbf{Domain}: [To be specified]
  \item \textbf{use\_for}: CORE-MASTER, LIT-OTHER, choice-architecture, intervention-taxonomy
\end{itemize}


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2000: The New Institutional Economics: Taking Stock, Looking Ahead}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Williamson, Oliver E. (2000). \textit{The New Institutional Economics: Taking Stock, Looking Ahead}. Publisher.

\paragraph{Core Finding.}
Overview of new institutional economics - transaction costs, governance

\paragraph{10C Integration.}
\begin{itemize}[nosep]
  \item \textbf{Domain}: [To be specified]
  \item \textbf{use\_for}: CORE-MASTER, LIT-OTHER, institutional-economics, multi-level
\end{itemize}


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2026: {Recommendations for Further Reading}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Taylor, Timothy (2026). ``{Recommendations for Further Reading}.'' \textit{Journal of Economic Perspectives}, 40, 241--248.

\paragraph{Core Finding.}
JEP Winter 2026 symposium paper. Full text available in data/paper-texts/PAP-taylor2026recommendations.md.

\paragraph{10C Integration.}
\begin{itemize}[nosep]
  \item \textbf{Domain}: [To be specified]
  \item \textbf{use\_for}: LIT-O, LIT-OTHER
\end{itemize}
