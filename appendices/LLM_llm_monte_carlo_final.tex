...
\hrule
\vspace{0.5em}
\noindent\textit{Cross-references: Chapter 10 (FEPSDE welfare framework), Appendix CTW ($\Psi$-dimensions validation), Appendix EPS (Epistemics of Deviation), Appendix THL1 (Evaluation Protocol)}
...
\begin{table}[htbp]
\centering
\caption{Key Symbols in Appendix LLM}
\begin{tabular}{lll}
\toprule
