...
% - Appendix UNMAPPED_HOW (CORE-HOW): Complementarity structure $C$
% - Appendix CTW (CORE-WHEN): Context dimensions $\Psi$
% - Appendix UNMAPPED_WAT (CORE-WHAT): Utility dimensions (FEPSDE)
% - Appendix UNMAPPED_CAM (Metatheory): Framework philosophy
%
% DEPENDENTS (what REQUIRES this appendix):
% - Appendix THL1 (Evaluation Protocol): Uses predictions as test cases
% - Appendix UNMAPPED_EPS (Epistemics of Deviation): Uses failed predictions for learning
...
\item For learning from failures: See Appendix UNMAPPED_EPS (Epistemics of Deviation)
\end{itemize}
...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=Quick Reference: Appendix UNMAPPED_SUN]
...
\textbf{Cross-References:} Appendix THL1 (Evaluation Protocol), Appendix UNMAPPED_CAM (Metatheory), Appendix UNMAPPED_EPS (Epistemics of Deviation), Appendix UNMAPPED_FRM (Philosophy of Science Foundation---Fehr Compatibility)
\end{tcolorbox}
...
\begin{itemize}[nosep]
    ...
    \item Metatheory $\rightarrow$ Appendix UNMAPPED_CAM
...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=\textbf{Connection to Appendix UNMAPPED_FRM: The Exclusion Principle}]
This appendix implements the \textbf{Exclusion Principle} established in Appendix UNMAPPED_FRM
...
\begin{tcolorbox}[colback=yellow!5!white, colframe=yellow!75!black,
    title=Integration: Appendix UNMAPPED_SUN $\leftrightarrow$ Appendix THL1]
...
\item Appendix UNMAPPED_EPS: Protocol for learning from failed predictions
\end{itemize}
\end{tcolorbox}

\subsection{Connection to Epistemics of Deviation (Appendix UNMAPPED_EPS)}

When predictions fail, Appendix UNMAPPED_EPS provides the diagnostic protocol for systematic learning from those failures. This creates a feedback loop: failed predictions become inputs for framework refinement.
...
\begin{tcolorbox}[colback=green!10!white, colframe=green!75!black,
    title=\textbf{Appendix UNMAPPED_SUN: Summary}]
...
\textbf{Integration:} This appendix connects to Appendix THL1 (testing methodology), Appendix UNMAPPED_CAM (metatheory), and Appendix UNMAPPED_EPS (learning from failures).
...
\begin{table}[htbp]
\centering
\caption{Symbols in Appendix UNMAPPED_SUN}
\label{tab:S-symbols}
...
Appendix UNMAPPED_EPS (Epistemics of Deviation---when predictions fail, Appendix UNMAPPED_EPS provides the diagnostic protocol for systematic learning from those failures),
