...
%
% Cross-Reference Map:
%   - Appendix UNMAPPED_HOW (CORE-HOW): Basic γ definition
%   - Appendix UNMAPPED_LET (LET): Level emergence from γ
%   - Appendix CTW (MEP): Portfolio optimization with Γ matrix
%   - Appendix UNMAPPED_MEQ (MEQ): Equilibria dependent on γ structure
%   - Appendix CAL1 (EIH): Efficiency with ∏(1+γ)
%   - Appendix UNMAPPED_WAT (CORE-WHAT): Utility dimension complementarities
%   - Appendix TKT (TOOLKIT): Intervention complementarities
% =============================================================================
...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=Axiom UNMAPPED_GTC-1: The Source Axiom]
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Theorem UNMAPPED_GTC-2: Transmission Equations]
...
\begin{theorem}[Sign Consistency (UNMAPPED_GTC-3)]
\label{thm:gtc-sign}
...
\begin{theorem}[Legitimate Inconsistency (UNMAPPED_GTC-4)]
...
\begin{tcolorbox}[colback=green!5!white, colframe=green!75!black,
    title=Theorem UNMAPPED_GTC-5: Complementarity Propagation]
...
\begin{theorem}[Structural-Operative Bridge (UNMAPPED_GTC-6)]
...
\begin{theorem}[Tensor Properties (UNMAPPED_GTC-7)]
...
\begin{theorem}[Aggregation (UNMAPPED_GTC-8)]
...
\textbf{The Source Axiom (UNMAPPED_GTC-1):}
...
\textbf{Sign Consistency (UNMAPPED_GTC-3):}
Without deviation mechanisms, signs are preserved across the hierarchy.

\textbf{Legitimate Inconsistency (UNMAPPED_GTC-4):}
...
\textbf{The Bridge Equation (UNMAPPED_GTC-6):}
\begin{equation}
...
\begin{itemize}[nosep]
    \item \textbf{Appendix UNMAPPED_HOW (CORE-HOW):} Original $\gamma$ definition
    \item \textbf{Appendix UNMAPPED_WAT (CORE-WHAT):} Utility dimension complementarities
    \item \textbf{Appendix UNMAPPED_NC (FORMAL-NC):} \textbf{Critical}---Non-concavity from $\gamma > 0$; $K$ vs $Q$ distinction (Ch.7)
    \item \textbf{Appendix CAL1 (FORMAL-EIH):} Uses $\prod(1+\gamma)$
    \item \textbf{Appendix UNMAPPED_LET (FORMAL-LET):} Emergence premium from $\bar{\gamma}$
    \item \textbf{Appendix CTW (FORMAL-MEP):} Portfolio optimization with $\Gamma$
    \item \textbf{Appendix UNMAPPED_MEQ (FORMAL-MEQ):} Equilibrium structure from $\Gamma$
    \item \textbf{Appendix TKT (METHOD-TOOLKIT):} Intervention complementarities
