...
% Appendix PAP1 and the practical examples in Chapter 14 with fast, actionable
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Appendix TKT: Header Block]
...
\textbf{Reading Guide:}
\begin{itemize}[nosep]
\item For theory: Read Appendix PAP1 (formal axioms) first
...
This appendix translates the formal theory of Appendix PAP1 and the practical operationalization of Chapter 14 into \textbf{actionable decision heuristics}. It is designed for use \textit{during active project work}, when practitioners need rapid guidance on key decisions: How many clusters? Which method? Is leverage sufficient? What went wrong?
...
\begin{itemize}[nosep]
    ...
    \item Theory: Why These Heuristics?
    \item Results: Six Operational Heuristics
    \item Heuristic 1: Cluster Count Selection --- How Many Segments?
    \item Heuristic 2: Heterogeneity Diagnosis --- What's the Population's Structure?
\end{itemize}
...
This appendix answers this question by providing 6 decision heuristics---rules of thumb, diagnostic trees, and reference tables---that operationalize the formal framework of Appendix PAP1 for real-world use.
...
See \textbf{Appendix UNMAPPED_GLS: Glossary of Terms} for comprehensive notation and concepts. Key terms used in this appendix:
...
These heuristics rest on five critical foundations from Appendix PAP1:

\begin{enumerate}
\item \textbf{Axiom 1 (Heterogeneity is universal):} Any population of sufficient size ($N > 100$) contains meaningful preference heterogeneity (Appendix PAP1, §2.1)

\item \textbf{Axiom 4 (Behavioral homogeneity within clusters):} Valid clusters exhibit within-cluster behavioral homogeneity and can be identified by different intervention responses (Appendix PAP1, §2.4)

\item \textbf{Axiom 8-9 (Leverage matching):} Segment-specific interventions achieve higher expected effects when targeting each segment's leverage profile (Appendix PAP1, §3)

\item \textbf{Axiom 12 (Diagnostic refinement):} Diagnostic procedures using AvgLeverage as the key discriminator enable practitioners to distinguish intervention-matching failures from segmentation failures (Appendix PAP1, §4.3)

\item \textbf{Axiom 13 (Cumulative science):} Systematic documentation of segmentation decisions and refined diagnoses builds cumulative knowledge across projects (Appendix PAP1, §4.4)
\end{enumerate}
...
For ongoing research, practitioners should document results systematically in the FFF (Framework Falsification \& Feedback) registry (see Appendix UNMAPPED_GLS).
...
\begin{itemize}[nosep]
\item \textbf{Axioms 1-9:} Appendix PAP1 (Formal Segmentation Genesis)
\item \textbf{Clustering Methods:} Chapter 14, Section Practical Identification Methods
\item \textbf{Leverage Matching:} Appendix PAP1, Axioms 8-9
\item \textbf{Diagnostic Framework:} Appendix PAP1, Axiom 12; Chapter 14, Section Axioms 10-13
\end{itemize}
...
\item Appendix PAP1: All axioms (theoretical grounding)
\item Appendix UNMAPPED_GLS: Glossary (notation and terminology)
\end{itemize}
