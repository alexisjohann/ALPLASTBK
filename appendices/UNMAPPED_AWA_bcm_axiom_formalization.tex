...
%
% =============================================================================
% CROSS-REFERENCE STRUCTURE: Appendix UNMAPPED_AWA ↔ Chapter 11
% =============================================================================
%
...
%   Chapter 11 → Appendix UNMAPPED_AWA: "See Appendix UNMAPPED_AWA, Section X"
%   Appendix UNMAPPED_AWA → Chapter 11: "See Chapter 11, Section 11.Y"
%
% CROSS-REFERENCE MAP:
% ┌────────────────────────────────────────────────────────────────────────────┐
...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=\textbf{Appendix UNMAPPED_AWA: CORE-AWARE}]
...
\textbf{Dependencies:} & Appendix UNMAPPED_WAT (CORE-WHAT: Utility dimensions) \\
                       & Appendix CTW (CORE-WHEN: Context $\Psi$) \\
                       & Appendix UNMAPPED_EST (CORE-WHERE: Calibration) \\
\textbf{Feeds into:}   & Appendix UNMAPPED_REA (CORE-READY: $A(\cdot) \to WAX$) \\
...
\begin{itemize}[nosep]
    \item Appendix UNMAPPED_REA (CORE-READY): Willingness formalization (WAX) depends on AWX outputs
    \item Appendix UNMAPPED_KTH (Kahneman-Tversky): Cognitive foundations for attention/salience
    \item \textbf{XVIII (LIT-FEHR-METHOD):} Exclusion Principle --- $\gamma = 0$ as null hypothesis
\end{itemize}
\textbf{Referenziert von:}
\begin{itemize}[nosep]
    \item Appendix UNMAPPED_REA: $W(\cdot) = f(A(\cdot))$ transformation
...
\begin{itemize}[nosep]
    \item CORE-WHAT: Utility dimensions $\rightarrow$ Appendix UNMAPPED_WAT
    \item CORE-WHEN: Context $\Psi$ $\rightarrow$ Appendix CTW
    \item CORE-WHERE: Calibration $\rightarrow$ Appendix UNMAPPED_EST
    \item CORE-READY: $A(\cdot $\rightarrow$ Appendix UNMAPPED_REA
...
\textbf{Sources} & \citet{kahneman2003maps}; \citet{rangel2008framework}; \citet{fehr2011neuro} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Sources} & \citet{fehr1999theory}; \citet{fehr2004social}; \citet{akerlof2000identity} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Sources} & \citet{fehr2003nature}; \citet{gaechter2002altruistic} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Dependencies} & None (foundational axiom) \\
\textbf{Sources} & \citet{kahneman1979prospectprospect}; \citet{tversky1981framing} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Sources} & \citet{tversky1981framing}; \citet{thaler1980towardtoward} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Sources} & \citet{bordalo2012salience}; \citet{bordalo2013salience} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Parameters} & None (structural equation) \\
\textbf{Dependencies} & AWX-A1 \\
\textbf{Sources} & \citet{kahneman1991loss}; \citet{tversky1992advances} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Sources} & \citet{kahneman2003maps}; \citet{loewenstein2001risk} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Sources} & \citet{bargh1996automaticity}; \citet{kahneman2003maps} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Sources} & \citet{tversky1981framing}; \citet{kahneman1990endowment} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Sources} & \citet{bordalo2012salience}; \citet{koszegi2006model} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Sources} & \citet{simon1955behavioral}; \citet{kahneman2003maps}; \citet{sims2003implications} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Sources} & \citet{bordalo2012salience}; \citet{bordalo2013salience}; \citet{bargh1996automaticity} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Sources} & \citet{laibson2003projection}; \citet{loewenstein2001risk} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Sources} & \citet{kahneman2003maps}; \citet{sims2003implications} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Sources} & \citet{tversky1974judgment}; \citet{kahneman2003maps} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Dependencies} & AWX-A9 \\
\textbf{Sources} & \citet{tversky1973availability}; \citet{kahneman1979prospectprospect} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Sources} & \citet{fehr2004social}; \citet{cialdini2004social} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Sources} & \citet{cialdini2004social}; \citet{gaechter2002altruistic} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Dependencies} & AWX-A7 \\
\textbf{Sources} & \citet{acemoglu2012whynations}; \citet{north1990institutionsinstitutions} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Dependencies} & AWX-A22 \\
\textbf{Sources} & \citet{north1990institutionsinstitutions}; \citet{ostrom1990governing} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Sources} & \citet{akerlof2000identity}; \citet{akerlof2010identity} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Sources} & \citet{baumeister1998ego}; \citet{kahneman2003maps} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Parameters} & None (structural equation) \\
\textbf{Dependencies} & AWX-A1 \\
\textbf{Sources} & \citet{kahneman1979prospectprospect}; \citet{thaler1980towardtoward} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Parameters} & None (structural equation) \\
\textbf{Dependencies} & AWX-A1 \\
\textbf{Sources} & \citet{fehr1999theory}; \citet{fehr2004social} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Sources} & \citet{fehr1999theory}; \citet{akerlof2000identity}; \citet{henrich2001search} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Sources} & \citet{loewenstein2001risk}; \citet{kahneman2003maps} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Sources} & \citet{akerlof2000identity}; \citet{elster1998emotions} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Sources} & \citet{fehr2004social}; \citet{ostrom1990governing} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Sources} & \citet{fehr1999theory}; \citet{charness2002understanding} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Sources} & \citet{akerlof2000identity}; \citet{benabou2011identity} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Sources} & \citet{akerlof2000identity}; \citet{tajfel1979integrative} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Sources} & \citet{fehr1999theory}; \citet{kahneman2003maps} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Dependencies} & AWX-A34 \\
\textbf{Sources} & \citet{kahneman1979prospectprospect}; \citet{fehr1999theory} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Sources} & \citet{simon1955behavioral}; \citet{gigerenzer2002bounded} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Sources} & \citet{tversky1981framing}; \citet{kahneman1979prospectprospect} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Sources} & \citet{fehr2004social}; \citet{bohnet2004trust} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Sources} & \citet{north1990institutionsinstitutions}; \citet{acemoglu2005institutions} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Sources} & \citet{sunstein2014nudge}; \citet{sunstein2014nudge}; \citet{benartzi2004save} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Sources} & \citet{kahneman2003maps}; \citet{tversky1981framing} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Sources} & \citet{kahneman2003maps}; \citet{csikszentmihalyi1987validity} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Sources} & \citet{prochaska1992stages}; \citet{kotter1995leading} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Sources} & \citet{cialdini2004social}; \citet{bicchieri2005grammar}; \citet{akerlof2000identity} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Sources} & \citet{fehr1999theory}; \citet{henrich2001search}; \citet{heckman2006effects} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Sources} & \citet{fischbacher2001people}; \citet{kurzban2005experiments}; \citet{fehr1999theory} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Sources} & \citet{henrich2010weirdest}; \citet{hofstede2001culture}; \citet{henrich2001search} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Sources} & \citet{mani2013poverty}; \citet{mullainathan2013scarcity}; \citet{haushofer2014psychology} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Sources} & \citet{thaler1999mental}; \citet{dolan2012influencing}; \citet{milkman2014holding} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Sources} & \citet{benabou2011identity}; \citet{akerlof2000identity}; \citet{sherman2000accepting} \\
\bottomrule
\end{tabular}
\end{table}
...
\small
\centering
\caption{System-Level Biases (UNMAPPED_COR-01 to UNMAPPED_COR-07)}
\label{tab:cor-system}
\begin{tabular}{p{1.2cm}p{2.5cm}p{4cm}p{5cm}}
\toprule
\textbf{ID} & \textbf{Bias} & \textbf{Derivation} & \textbf{Formal Statement} \\
\midrule
UNMAPPED_COR-01 & Present Bias & A4 $\land$ A35 $\land$ A58 & $A(t=0) = 1 \land A(t>0) = A_0 e^{-\lambda t} \Rightarrow U_{eff}(t=0) \gg U_{eff}(t>0)$ \\
UNMAPPED_COR-02 & Hot-Cold Empathy Gap & A4 $\land$ A35 $\land$ A56 & $A_{hot} = 1 \land A_{cold} \approx 0 \Rightarrow \text{Prediction}_{cold}(U_{hot}) \neq U_{hot}$ \\
UNMAPPED_COR-03 & Affect Heuristic & A4 $\land$ A15 $\land$ A18 & $\text{Emo} > \theta \Rightarrow A_{emo} = 1 \land A_{cog} < 1$ \\
UNMAPPED_COR-04 & Hyperbolic Discounting & A4 $\land$ A58 $\land$ A35 & $\frac{\partial^2 A}{\partial t^2} > 0$ near $t=0$ (convex decay) \\
UNMAPPED_COR-05 & Temptation/Akrasia & A4 $\land$ A35 $\land$ A37 & $A_{INU}^{instant} = 1 \land A_{KNU}^{instant} = 0 \Rightarrow \text{Choose}(INU)$ \\
UNMAPPED_COR-06 & Projection Bias & A56 $\land$ A57 & $A(t) \neq A(t') \land \text{Predict}(A(t')) = A(t)$ \\
UNMAPPED_COR-07 & Immediacy Effect & A4 $\land$ A35 & $\Delta t \to 0 \Rightarrow A \to 1$ for physiological triggers \\
\bottomrule
\end{tabular}
\end{table}
...
\small
\centering
\caption{Self-Community Biases (UNMAPPED_COR-08 to UNMAPPED_COR-15)}
\label{tab:cor-self-comm}
\begin{tabular}{p{1.2cm}p{2.8cm}p{3.8cm}p{5cm}}
\toprule
\textbf{ID} & \textbf{Bias} & \textbf{Derivation} & \textbf{Formal Statement} \\
\midrule
UNMAPPED_COR-08 & Egocentric Bias & A1a $\land$ A34 & $A^{self} > A^{comm}$ by default \\
UNMAPPED_COR-09 & Bystander Effect & A1b $\land$ A76 & $A^{comm}_{ind} = \frac{A^{comm}_{total}}{n} \to 0$ as $n \to \infty$ \\
UNMAPPED_COR-10 & Diffusion of Responsibility & A1b $\land$ A33 $\land$ A76 & $A^{self}_{KNU} \propto \frac{1}{n}$ \\
UNMAPPED_COR-11 & False Consensus & A1b $\land$ A69 & $A^{comm}_{IDN} \approx 0 \Rightarrow \text{Project}(A^{self}_{IDN})$ \\
UNMAPPED_COR-12 & Out-Group Homogeneity & A1b $\land$ A33 & $A^{comm}_{IDN}(\text{out}) \ll A^{comm}_{IDN}(\text{in})$ \\
UNMAPPED_COR-13 & Spotlight Effect & A1a $\land$ A85 & $A^{self}_{IDN}$ high $\Rightarrow$ assume others have high $A$ about self \\
UNMAPPED_COR-14 & Interpersonal Empathy Gap & A1b $\land$ A37 & $A^{comm}$ requires deliberate effort (never instant) \\
UNMAPPED_COR-15 & Curse of Knowledge & A1a $\land$ A1b & $A^{self}_{cog} = 1 \land A^{comm}_{cog} \approx 0 \Rightarrow$ assume shared \\
\bottomrule
\end{tabular}
\end{table}
...
\small
\centering
\caption{Utility-Type Biases (UNMAPPED_COR-16 to UNMAPPED_COR-23)}
\label{tab:cor-utility}
\begin{tabular}{p{1.2cm}p{2.8cm}p{3.8cm}p{5cm}}
\toprule
\textbf{ID} & \textbf{Bias} & \textbf{Derivation} & \textbf{Formal Statement} \\
\midrule
UNMAPPED_COR-16 & Tragedy of Commons & A35 $\land$ A37 & $A_{INU}^{instant} = 1 \land A_{KNU}^{instant} = 0 \Rightarrow \text{Overuse}$ \\
UNMAPPED_COR-17 & Free Rider Problem & A34 $\land$ A37 & $A_{INU} > A_{KNU} \Rightarrow \text{Contribute} = 0$ \\
UNMAPPED_COR-18 & Social Dilemmas & A34 $\land$ A37 $\land$ A42 & $A_{INU}$ crowds out $A_{KNU}$ \\
UNMAPPED_COR-19 & NIMBY & A35 $\land$ A37 $\land$ A1a & $A^{self}_{INU}$ instant; $A^{comm}_{KNU}$ not \\
UNMAPPED_COR-20 & Identity-Protective Cognition & A36 $\land$ A84 $\land$ A85 & $A_{IDN}$ instant $\land$ $B < 1$ for threats \\
UNMAPPED_COR-21 & Motivated Reasoning & A81 $\land$ A84 $\land$ A89 & $U_{psych}(\hat{\theta}) > 0 \Rightarrow$ asymmetric processing \\
UNMAPPED_COR-22 & System Justification & A36 $\land$ A85 $\land$ A42 & $A_{IDN}$ blocks $A_{KNU}$ \\
UNMAPPED_COR-23 & In-Group Favoritism & A36 $\land$ A33 $\land$ A40 & $A_{IDN}(\text{in}) \Rightarrow A_{KNU}(\text{in}) > A_{KNU}(\text{out})$ \\
\bottomrule
\end{tabular}
\end{table}

\paragraph{Critical Insight.} UNMAPPED_COR-16 to UNMAPPED_COR-19 derive from the single axiom A37: $A_{KNU}^{instant} = 0$ always. This explains why collective action problems are so persistent.
...
\small
\centering
\caption{Belief-Based Biases (UNMAPPED_COR-24 to UNMAPPED_COR-33)}
\label{tab:cor-belief}
\begin{tabular}{p{1.2cm}p{2.8cm}p{3.8cm}p{5cm}}
\toprule
\textbf{ID} & \textbf{Bias} & \textbf{Derivation} & \textbf{Formal Statement} \\
\midrule
UNMAPPED_COR-24 & Confirmation Bias & A84 $\land$ A89 & $B(\text{consistent}) = 1 \land B(\text{inconsistent}) < 1 \Rightarrow$ selective updating \\
UNMAPPED_COR-25 & Denial & A66 $\land$ A84 & $\text{Threat} > \theta \Rightarrow B \to 0$ \\
UNMAPPED_COR-26 & Cognitive Dissonance & A67 $\land$ A85 & $A_{cog} \neq A_{emo}$ when $|U'_{IDN}|$ high \\
UNMAPPED_COR-27 & Rationalization & A82 $\land$ A87 & Post-hoc belief adjustment to $\hat{\theta}^* = \theta + \frac{\alpha}{2c}$ \\
UNMAPPED_COR-28 & Self-Serving Bias & A82 $\land$ A85 & $\hat{\theta}^*_{self} > \theta$ for positive attributes \\
UNMAPPED_COR-29 & Belief Perseverance & A89 & $\frac{\partial \hat{\theta}_{t+1}}{\partial \hat{\theta}_t} > 0$ creates path dependence \\
UNMAPPED_COR-30 & Overconfidence & A82 $\land$ A86 & $\alpha_{ego} > 0 \Rightarrow \hat{\theta}^*_{ability} > \theta_{ability}$ \\
UNMAPPED_COR-31 & Optimism Bias & A82 $\land$ A86 & $\alpha_{anticipatory} > 0 \Rightarrow \hat{\theta}^*_{future} > \theta_{future}$ \\
UNMAPPED_COR-32 & Wishful Thinking & A81 $\land$ A82 & $U_{psych}(\hat{\theta}) > 0 \Rightarrow$ choose $\hat{\theta} > \theta$ \\
UNMAPPED_COR-33 & Illusion of Control & A82 $\land$ A85 & $\hat{\theta}^*_{control} > \theta_{control}$ when $U_{IDN}(control)$ high \\
\bottomrule
\end{tabular}
\end{table}
...
\small
\centering
\caption{Cognitive Biases (UNMAPPED_COR-34 to UNMAPPED_COR-41)}
\label{tab:cor-cognitive}
\begin{tabular}{p{1.2cm}p{2.8cm}p{3.8cm}p{5cm}}
\toprule
\textbf{ID} & \textbf{Bias} & \textbf{Derivation} & \textbf{Formal Statement} \\
\midrule
UNMAPPED_COR-34 & Availability Heuristic & A14 & $A \propto \text{Availability} \Rightarrow$ vivid $>$ base rate \\
UNMAPPED_COR-35 & Salience Bias & A9 & $A = f(\text{Salience}) \Rightarrow$ salient $>$ important \\
UNMAPPED_COR-36 & Anchoring & A9 $\land$ A27 & First information primes $A$; insufficient adjustment \\
UNMAPPED_COR-37 & Framing Effects & A47 $\land$ A47a & Frame determines which $A$ activates \\
UNMAPPED_COR-38 & Base Rate Neglect & A14 $\land$ A9 & $A(\text{vivid case}) \gg A(\text{statistics})$ \\
UNMAPPED_COR-39 & Conjunction Fallacy & A14 & Detailed scenarios more available $\Rightarrow$ higher $A$ \\
UNMAPPED_COR-40 & Hindsight Bias & A14 $\land$ A87 & Outcome-consistent info selectively remembered \\
UNMAPPED_COR-41 & Representativeness & A14 $\land$ A9 & $A(\text{typical}) > A(\text{probable})$ \\
\bottomrule
\end{tabular}
\end{table}
...
\small
\centering
\caption{Emotional Biases (UNMAPPED_COR-42 to UNMAPPED_COR-47)}
\label{tab:cor-emotional}
\begin{tabular}{p{1.2cm}p{2.8cm}p{3.8cm}p{5cm}}
\toprule
\textbf{ID} & \textbf{Bias} & \textbf{Derivation} & \textbf{Formal Statement} \\
\midrule
UNMAPPED_COR-42 & Negativity Bias & A16 $\land$ A15 & $|A_{fear}| > |A_{hope}|$ for equivalent magnitudes \\
UNMAPPED_COR-43 & Loss Aversion & A16 $\land$ A8 & $A_{Pain} > A_{Gain} \Rightarrow \lambda > 1$ in Prospect Theory \\
UNMAPPED_COR-44 & Mood-Congruent Recall & A15 $\land$ A14 & Current $\text{Emo}$ activates congruent memories \\
UNMAPPED_COR-45 & Risk Aversion (Gains) & A16 & $A_{fear}$ dominates in gain domain \\
UNMAPPED_COR-46 & Risk Seeking (Losses) & A17 & $A_{hope}$ of avoiding loss dominates \\
UNMAPPED_COR-47 & Reactive Devaluation & A15 $\land$ A85 & Negative source $\Rightarrow$ $A_{content}$ reduced \\
\bottomrule
\end{tabular}
\end{table}

\paragraph{Key Derivation.} UNMAPPED_COR-43 (Loss Aversion) derives from A16: Fear amplifies awareness more than hope. This provides a micro-foundation for Prospect Theory's $\lambda \approx 2$.
...
\small
\centering
\caption{Social Biases (UNMAPPED_COR-48 to UNMAPPED_COR-53)}
\label{tab:cor-social}
\begin{tabular}{p{1.2cm}p{2.8cm}p{3.8cm}p{5cm}}
\toprule
\textbf{ID} & \textbf{Bias} & \textbf{Derivation} & \textbf{Formal Statement} \\
\midrule
UNMAPPED_COR-48 & Conformity Bias & A19 $\land$ A70 & $A \propto \text{Norm}_{pressure} \land A_{coll} \gg A_{ind} \Rightarrow A_{ind} = 0$ \\
UNMAPPED_COR-49 & Bandwagon Effect & A20 $\land$ A21 $\land$ A78 & $A \propto \text{Network} \Rightarrow$ cascade \\
UNMAPPED_COR-50 & Authority Bias & A22 & $A \propto \text{Institutional}_{legitimacy}$ \\
UNMAPPED_COR-51 & Social Proof & A20 $\land$ A78 & Others' behavior $\Rightarrow$ increased $A$ \\
UNMAPPED_COR-52 & Herd Behavior & A21 $\land$ A78 & Network amplifies $A$ cascades \\
UNMAPPED_COR-53 & Groupthink & A70 $\land$ A68 & $A_{coll} \gg A_{ind} \land \text{Norm conflict} \Rightarrow A_{dissent} = 0$ \\
\bottomrule
\end{tabular}
\end{table}
...
\small
\centering
\caption{Temporal Biases (UNMAPPED_COR-54 to UNMAPPED_COR-59)}
\label{tab:cor-temporal}
\begin{tabular}{p{1.2cm}p{2.8cm}p{3.8cm}p{5cm}}
\toprule
\textbf{ID} & \textbf{Bias} & \textbf{Derivation} & \textbf{Formal Statement} \\
\midrule
UNMAPPED_COR-54 & Recency Bias & A58 & $A(t) = A_0 e^{-\lambda t} \Rightarrow$ recent $>$ distant \\
UNMAPPED_COR-55 & Primacy Effect & A27 $\land$ A59 & First info creates reference for subsequent $A$ \\
UNMAPPED_COR-56 & Peak-End Rule & A63 $\land$ A58 & Memory = $f(A_{peak}, A_{end})$ \\
UNMAPPED_COR-57 & Status Quo Bias & A10 $\land$ A60 & Habit requires no $A$; change requires $A > 0$ \\
UNMAPPED_COR-58 & Mere Exposure Effect & A59 & Familiarity $\Rightarrow$ increased $A$ through reactivation \\
UNMAPPED_COR-59 & Normalcy Bias & A60 & Habituation: $\text{Var}(\text{Trigger}) \to 0 \Rightarrow A \to 0$ \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
System-Level & UNMAPPED_COR-01 to UNMAPPED_COR-07 & 7 & A4, A35, A58 \\
Self-Community & UNMAPPED_COR-08 to UNMAPPED_COR-15 & 8 & A1a, A1b, A34, A37 \\
Utility-Type & UNMAPPED_COR-16 to UNMAPPED_COR-23 & 8 & A34, A35, A36, A37 \\
Belief-Based & UNMAPPED_COR-24 to UNMAPPED_COR-33 & 10 & A81--A90 \\
Cognitive & UNMAPPED_COR-34 to UNMAPPED_COR-41 & 8 & A9, A14, A27, A47 \\
Emotional & UNMAPPED_COR-42 to UNMAPPED_COR-47 & 6 & A15, A16, A17 \\
Social & UNMAPPED_COR-48 to UNMAPPED_COR-53 & 6 & A19--A21, A70, A78 \\
Temporal & UNMAPPED_COR-54 to UNMAPPED_COR-59 & 6 & A58--A60, A63 \\
\midrule
...
\begin{enumerate}
    \item \textbf{Axiom A37 is pivotal}: The single axiom ``KNU is never instant'' generates UNMAPPED_COR-05, UNMAPPED_COR-14, UNMAPPED_COR-16 to UNMAPPED_COR-19---explaining why collective action problems are so pervasive.
...
\begin{itemize}
    \item \textbf{Dunning-Kruger Effect}: UNMAPPED_COR-30 (Overconfidence) $\land$ A51 (Epistemic Uncertainty) $\land$ A74 (Education)
    \item \textbf{Planning Fallacy}: UNMAPPED_COR-31 (Optimism) $\land$ UNMAPPED_COR-06 (Projection Bias) $\land$ A46 (Complexity)
    \item \textbf{Sunk Cost Fallacy}: UNMAPPED_COR-28 (Self-Serving) $\land$ A85 (Identity Stakes) $\land$ UNMAPPED_COR-43 (Loss Aversion)
\end{itemize}
...
\textbf{Active Corollaries} & UNMAPPED_COR-20 (Identity-Protective Cognition), UNMAPPED_COR-57 (Status Quo Bias), UNMAPPED_COR-43 (Loss Aversion) \\
...
\textbf{Active Corollaries} & UNMAPPED_COR-01 (Present Bias), UNMAPPED_COR-05 (Temptation), UNMAPPED_COR-59 (Normalcy Bias), UNMAPPED_COR-24 (Confirmation Bias) \\
...
\textbf{Active Corollaries} & UNMAPPED_COR-01 (Present Bias), UNMAPPED_COR-04 (Hyperbolic Discounting), UNMAPPED_COR-06 (Projection Bias) \\
...
\textbf{Active Corollaries} & UNMAPPED_COR-16 (Tragedy of Commons), UNMAPPED_COR-17 (Free Rider), UNMAPPED_COR-09 (Bystander Effect), UNMAPPED_COR-10 (Diffusion of Responsibility) \\
...
\textbf{Active Corollaries} & UNMAPPED_COR-22 (System Justification), UNMAPPED_COR-20 (Identity-Protective), UNMAPPED_COR-01 (Present Bias) \\
...
\textbf{Active Corollaries} & UNMAPPED_COR-20 (Identity-Protective), UNMAPPED_COR-24 (Confirmation Bias), UNMAPPED_COR-53 (Groupthink), UNMAPPED_COR-29 (Belief Perseverance) \\
...
\textbf{Active Corollaries} & UNMAPPED_COR-57 (Status Quo Bias), UNMAPPED_COR-59 (Normalcy Bias), UNMAPPED_COR-43 (Loss Aversion) \\
...
\textbf{Active Corollaries} & UNMAPPED_COR-53 (Groupthink), UNMAPPED_COR-48 (Conformity), UNMAPPED_COR-57 (Status Quo Bias), UNMAPPED_COR-20 (Identity-Protective) \\
...
\textbf{Active Corollaries} & UNMAPPED_COR-16 (Tragedy of Commons), UNMAPPED_COR-01 (Present Bias), UNMAPPED_COR-35 (Salience Bias) \\
...
\midrule
CASE-01 & Labor Transitions & A36, A85, A37 & UNMAPPED_COR-20, UNMAPPED_COR-57 \\
CASE-02 & Health/Smoking & A4, A35, A60 & UNMAPPED_COR-01, UNMAPPED_COR-05, UNMAPPED_COR-59 \\
CASE-03 & Financial/Saving & A58, A1b & UNMAPPED_COR-01, UNMAPPED_COR-04 \\
CASE-04 & Climate Action & A37, A1b, A51 & UNMAPPED_COR-16, UNMAPPED_COR-17 \\
CASE-05 & Education & A73, A74, A75 & UNMAPPED_COR-22, UNMAPPED_COR-20 \\
CASE-06 & Polarization & A84, A85, A88, A89 & UNMAPPED_COR-20, UNMAPPED_COR-24, UNMAPPED_COR-29 \\
CASE-07 & Technology & A10, A50, A54 & UNMAPPED_COR-57, UNMAPPED_COR-59 \\
CASE-08 & Org. Change & A70, A78, A80 & UNMAPPED_COR-53, UNMAPPED_COR-48 \\
CASE-09 & Sustainable Consumption & A2, A5, A37 & UNMAPPED_COR-16, UNMAPPED_COR-35 \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Critical Implication} & Low $\Psi_E$ makes present bias (UNMAPPED_COR-01) and undersaving (CASE-03) structurally worse \\
...
\textbf{Critical Implication} & Low $\Psi_M$ strengthens status quo bias (UNMAPPED_COR-57)---alternatives not ``seen'' \\
...
\begin{itemize}
    ...
    \item UNMAPPED_COR-24 (Confirmation Bias)
\end{itemize}
...
\begin{itemize}
    \item Why present bias (UNMAPPED_COR-01) is stronger in developing contexts
...
\begin{itemize}
    ...
    \item UNMAPPED_COR-16 (Tragedy of Commons)---informal norms can substitute for formal rules
...
\begin{table}[htbp]
\centering
\caption{Summary of Key Results in Appendix UNMAPPED_AWA}
...
See Appendix UNMAPPED_EXP (Paradigm 8: Beliefs) and Appendix UNMAPPED_MSC (Section 11) for full treatment.
...
\section{References for Appendix UNMAPPED_AWA}
...
\textbf{Required by:}
\begin{itemize}[nosep]
    \item Appendix UNMAPPED_REA (CORE-READY): $WAX = f(A(\cdot))$ transformation
...
$\rightarrow$ Appendix UNMAPPED_REA (willingness) $\rightarrow$ Chapter 12 (integration)
