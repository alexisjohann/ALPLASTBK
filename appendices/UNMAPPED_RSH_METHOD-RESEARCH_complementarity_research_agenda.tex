...
% HEADER BLOCK
% ----------------------------------------------------------------------------
\begin{tcolorbox}[colback=purple!5!white,colframe=purple!75!black,title=\textbf{Appendix UNMAPPED_RSH: METHOD-RESEARCH}]
...
\begin{itemize}[noitemsep]
    \item Appendix UNMAPPED_GTC (GTC): Established theory $\to$ This appendix: Extensions
    \item Appendix UNMAPPED_CMP (METHOD-COMP): Known methods $\to$ This appendix: New methods needed
\end{itemize}
\end{tcolorbox}
...
\begin{itemize}[noitemsep]
    ...
    \item Appendix UNMAPPED_CMP (METHOD-COMP): Measurement Methodology
...
\begin{itemize}[noitemsep]
    ...
    \item Appendix UNMAPPED_MEQ (MEQ): Equilibrium dynamics
...
The General Theory of Complementarity (GTC, Appendix UNMAPPED_GTC) and the methodological toolkit (METHOD-COMP, Appendix UNMAPPED_CMP) establish a solid foundation. Yet significant questions remain \textbf{unanswered}---questions that, if solved, would substantially advance behavioral economics, intervention science, and decision theory.
...
\midrule
RQ1 & Extends Appendix UNMAPPED_GTC (GTC): 6 $\gamma$ types $\to$ $k$-order $\gamma$ \\
...
\begin{itemize}[noitemsep]
    \item Appendix UNMAPPED_GTC (GTC): Established complementarity theory
    \item Appendix UNMAPPED_CMP (METHOD-COMP): 128 methodological papers
