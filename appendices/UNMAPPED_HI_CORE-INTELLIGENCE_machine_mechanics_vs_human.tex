...
% - Appendix UNMAPPED_BX: CORE-BEATRIX (LLM architecture)
% - Appendix G: Glossary
%
...
\textbf{Reading Guide:}
\begin{itemize}[nosep]
\item For technical LLM details: Read Appendix UNMAPPED_BX first
...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=Quick Reference: Appendix UNMAPPED_HI]
...
\textbf{Cross-References:} Appendix UNMAPPED_BX (BEATRIX), AAA (WHO), C (WHAT), G (Glossary)
\end{tcolorbox}
...
\begin{itemize}[nosep]
    ...
    \item The Mechanics Thesis and its axioms (UNMAPPED_HI-1 to UNMAPPED_HI-5)
...
\begin{itemize}[nosep]
    \item Mechanics Thesis axioms (UNMAPPED_HI-1 to UNMAPPED_HI-5)
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom UNMAPPED_HI-1: Mechanizability Criterion]
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom UNMAPPED_HI-2: Demonstration Deflates]
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom UNMAPPED_HI-3: Appearance Is Not Reality]
...
\textbf{Technical Basis:} LLMs perform pattern matching in embedding space (see Appendix UNMAPPED_BX). They do not ``understand''---they compute similarity functions.

\textbf{Analogy:} A photograph of a person is not a person. A simulation of intelligence is not intelligence.
\end{tcolorbox}

\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom UNMAPPED_HI-4: The Homunculus Trap]
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom UNMAPPED_HI-5: The Residual Exists]
...
\textbf{Step 1: Apply Axiom UNMAPPED_HI-1 (Mechanizability Criterion)}
...
\textbf{Step 2: Apply Axiom UNMAPPED_HI-2 (Demonstration Deflates)}
...
\textbf{Step 3: Apply Axiom UNMAPPED_HI-3 (Appearance $\neq$ Reality)}
...
\begin{tcolorbox}[colback=green!5!white, colframe=green!75!black,
    title=\textbf{Theorem UNMAPPED_HI-6: Falsifiability}]
...
\begin{enumerate}
    ...
    \item These are not computable by Turing machines (Axiom UNMAPPED_HI-1, UNMAPPED_HI-3).
...
\begin{tcolorbox}[colback=green!10!white, colframe=green!75!black,
    title=\textbf{Appendix UNMAPPED_HI: Summary}]
...
\begin{itemize}[nosep]
    \item Five axioms (UNMAPPED_HI-1 to UNMAPPED_HI-5) formalizing the thesis
...
\begin{table}[htbp]
\centering
\caption{Symbols Introduced in Appendix UNMAPPED_HI}
\renewcommand{\arraystretch}{1.3}
...
\begin{itemize}[nosep]
    \item \citet{nagel1974whatisit} --- What Is It Like to Be a Bat? (subjective experience)
    \item \citet{jackson1982epiphenomenal} --- Mary's Room (knowledge argument)
    \item \citet{chalmers1995facing} --- The Hard Problem of Consciousness
    \item \citet{chalmers1996conscious} --- The Conscious Mind (comprehensive)
    \item \citet{levine1983materialism} --- The Explanatory Gap
\end{itemize}

\textbf{Chinese Room and Understanding:}
\begin{itemize}[nosep]
    \item \citet{searle1980minds} --- Minds, Brains, and Programs (Chinese Room)
    \item \citet{searle1992rediscovery} --- Biological Naturalism
    \item \citet{searle1990consciousness} --- Against Functionalism
\end{itemize}

\textbf{Symbol Grounding and Meaning:}
\begin{itemize}[nosep]
    \item \citet{harnad1990symbol} --- The Symbol Grounding Problem
    \item \citet{barsalou1999perceptual} --- Perceptual Symbol Systems
\end{itemize}

\textbf{Embodied Cognition:}
\begin{itemize}[nosep]
    \item \citet{varela1991embodied} --- The Embodied Mind (Enactivism)
    \item \citet{dreyfus1972computers} --- What Computers Can't Do
    \item \citet{dreyfus1992computers} --- What Computers Still Can't Do
    \item \citet{brooks1991intelligence} --- Intelligence Without Representation
\end{itemize}

\textbf{Intentionality and Tacit Knowledge:}
\begin{itemize}[nosep]
    \item \citet{dennett1987intentional} --- Derived vs. Original Intentionality
    \item \citet{brentano1874psychology} --- Intentionality (foundational)
    \item \citet{polanyi1966tacittacit} --- The Tacit Dimension
    \item \citet{collins2010tacit} --- Tacit and Explicit Knowledge
\end{itemize}

\textbf{Gödelian Arguments:}
\begin{itemize}[nosep]
    \item \citet{lucas1961minds} --- Minds, Machines and Gödel
    \item \citet{penrose1989emperor} --- The Emperor's New Mind
    \item \citet{penrose1994shadows} --- Shadows of the Mind
\end{itemize}

\textbf{Moral Agency:}
\begin{itemize}[nosep]
    \item \citet{floridi2004morality} --- On the Morality of Artificial Agents
    \item \citet{johnson2006computer} --- Moral Entities but Not Moral Agents
\end{itemize}

\textbf{LLM-Specific Critiques:}
\begin{itemize}[nosep]
    \item \citet{bender2021dangers} --- Stochastic Parrots
    \item \citet{mitchell2023debate} --- The Debate Over Understanding
    \item \citet{marcus2020next} --- AI Limitations
    \item \citet{lake2017building} --- Human vs. Machine Learning
\end{itemize}

\textbf{Frame Problem:}
\begin{itemize}[nosep]
    \item \citet{mccarthy1981some} --- The Frame Problem (original)
    \item \citet{fodor1987modules} --- Frame Problem Implications
\end{itemize}
...
\begin{itemize}[nosep]
    \item \citet{putnam1967psychological} --- Functionalism (multiple realizability)
    \item \citet{fodor1975language} --- Language of Thought
    \item \citet{pylyshyn1984computation} --- Computation and Cognition
\end{itemize}

\textbf{Dennett and Churchlands:}
\begin{itemize}[nosep]
    \item \citet{dennett1991consciousness} --- Multiple Drafts Theory
    \item \citet{dennett1988quining} --- Quining Qualia (eliminativism)
    \item \citet{churchland1981eliminative} --- Eliminative Materialism
    \item \citet{churchland1986neurophilosophy} --- Neurophilosophy
\end{itemize}

\textbf{Scientific Theories of Consciousness:}
\begin{itemize}[nosep]
    \item \citet{tononi2004information} --- Integrated Information Theory (IIT)
    \item \citet{tononi2016integrated} --- IIT 3.0
    \item \citet{baars1988cognitive} --- Global Workspace Theory
    \item \citet{dehaene2011experimental} --- Global Neuronal Workspace
\end{itemize}

\textbf{Emergent AI Capabilities:}
\begin{itemize}[nosep]
    \item \citet{wei2022emergent} --- Emergent Abilities of LLMs
    \item \citet{bubeck2023sparks} --- Sparks of AGI (GPT-4)
\end{itemize}

\textbf{Other Perspectives:}
\begin{itemize}[nosep]
    \item \citet{turing1950computing} --- Computing Machinery and Intelligence
    \item \citet{griffin1992animal} --- Animal Minds (continuity argument)
    \item \citet{clark2015surfing} --- Predictive Processing
    \item \citet{hohwy2013predictive} --- The Predictive Mind
    \item \citet{clark1998extended} --- Extended Mind
    \item \citet{hassabis2017neuroscience} --- Neuroscience-Inspired AI
\end{itemize}
