...
%
% Cross-references: Appendix TKT, KKK, LLL, MMM
%
% =============================================================================

\newpage
\section*{Appendix UNMAPPED_NNN: METHOD-MULTI-LEVEL}
\label{app:method-multi-level}
\addcontentsline{toc}{section}{Appendix UNMAPPED_NNN: METHOD-MULTI-LEVEL}
...
\subsubsection*{3.2 Multi-Domain Spillover Matrix (from Appendix UNMAPPED_MMM)}

\begin{quote}
Use Appendix UNMAPPED_MMM Section 2 to compute spillover matrix across domains (Health, Pension, Environment, Labor)
...
\begin{itemize}[nosep]
\item Appendix UNMAPPED_MMM: Cross-domain spillovers (adapt for cross-level)
\item Appendix UNMAPPED_LLL: Domain templates (adapt for multi-level)
\end{itemize}
...
\begin{table}[htbp]
\centering
\caption{Key Symbols in Appendix UNMAPPED_NNN}
\begin{tabular}{lll}
\toprule
...
\vspace{2cm}
\begin{center}
{\large \textbf{End of Appendix UNMAPPED_NNN: METHOD-MULTI-LEVEL}} \\
\vspace{0.5cm}
