...
%
% This appendix addresses the structural question underlying Appendix UNMAPPED_DX:
...
% - BUILDS ON: Appendix UNMAPPED_DX (Political Economy of Austrian Media), Appendix UNMAPPED_V (CONTEXT-MASTER)
% - INTEGRATES WITH: Appendix UNMAPPED_FEH (Fehr's regulatory models), Appendix UNMAPPED_SUN (Sunstein policy)
%
% =============================================================================
...
\item \textbf{For formal media economics:} See Appendix UNMAPPED_DX (Section 3A) for Ψ_media evolution timeline
\item \textbf{For Fehr's regulatory critique:} See Appendix UNMAPPED_FEH (market design principles)
\end{itemize}
...
\begin{itemize}[nosep]
    \item Political Economy of Austrian Media $\rightarrow$ Appendix UNMAPPED_DX
    \item CONTEXT-MASTER $\rightarrow$ Appendix UNMAPPED_V
    \item Fehr's regulatory models $\rightarrow$ Appendix UNMAPPED_FEH
    \item Sunstein policy $\rightarrow$ Appendix UNMAPPED_SUN
    \item Section 3A $\rightarrow$ Appendix UNMAPPED_DX
\end{itemize}
...
\textbf{UNMAPPED_BG-1 (CORE QUESTION):} How did Austria's media market structure (concentration parameter) become
so extreme compared to similar democracies, and what were the avoidable policy decision points?

\textbf{UNMAPPED_BG-2 (THEORETICAL CLAIM):} Media concentration in Austria is not structural necessity but result
...
For detailed definitions, see \textbf{Appendix UNMAPPED_GLS (Glossary of Symbols and Terms)}:
...
For exhaustive citations, see Master Bibliography: \textbf{Appendix UNMAPPED_BBB (CORE-WHERE)}.
...
\begin{itemize}[nosep]
\item \textbf{Appendix UNMAPPED_BH (CONTEXT-SPÖ_PARADOX):} Explains SPÖ's political role in enabling/perpetuating concentration
\item \textbf{Appendix UNMAPPED_DX (CONTEXT-POLITICAL-ECONOMY):} Uses BG as foundation; explains 2025-2029 reform scenarios
\item \textbf{Appendix UNMAPPED_V (CONTEXT-MASTER):} Describes Ψ_media as one of 8 context dimensions
\item \textbf{Appendix UNMAPPED_FEH (LIT-FEHR):} Fehr's regulatory economics critique of Austrian system
\item \textbf{Appendix UNMAPPED_SUN (LIT-SUNSTEIN):} Sunstein's choice architecture as alternative to regulation
\item \textbf{Chapter 14 (Democratic Resilience):} Application of BG/DX/BH framework to policy design
\item \textbf{Appendix UNMAPPED_GLS (Glossary):} Key terms: Ψ_media, KEF-Modell, Matthew Effect, Critical Juncture
\end{itemize}

\textbf{To Cite This Appendix:}

\textit{Appendix UNMAPPED_BG (CONTEXT-GENESIS): Why Austrian Media Concentration Became Possible.}
...
\begin{table}[htbp]
\centering
\caption{Key Symbols in Appendix UNMAPPED_BG}
\begin{tabular}{lll}
\toprule
