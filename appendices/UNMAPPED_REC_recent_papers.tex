...
% - Appendix UNMAPPED_HOW (CORE-HOW): Complementarity framework ($\gamma$)
% - Appendix CTW (CORE-WHEN): Context framework ($\Psi$)
% - Appendix UNMAPPED_WAT (CORE-WHAT): Welfare dimensions (FEPSDE)
% - Appendix UNMAPPED_NOB (LIT-NOBEL): Retrospective Nobel integration
%
...
\item For retrospective analysis: See Appendix UNMAPPED_NOB (LIT-NOBEL)
...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=Quick Reference: Appendix UNMAPPED_REC]
...
(Appendix UNMAPPED_NOB), these papers were published \emph{after} the framework was
...
\textbf{Cross-References:} Appendix UNMAPPED_NOB (LIT-NOBEL), Appendix UNMAPPED_HOW (CORE-HOW),
Appendix CTW (CORE-WHEN), Appendix UNMAPPED_WAT (CORE-WHAT)
\end{tcolorbox}
...
\begin{itemize}[nosep]
    ...
    \item LIT-NOBEL $\rightarrow$ Appendix UNMAPPED_NOB
    \item LIT-NOBEL $\rightarrow$ Appendix UNMAPPED_NOB
\end{itemize}
...
but future research as well. While retrospective integration (Appendix UNMAPPED_NOB)
...
which equilibrium ($C^*$) is selected. Links directly to Appendix UNMAPPED_CIA
...
Links to FEPSDE dimension structure in Appendix UNMAPPED_WAT.
\end{tcolorbox}
...
\begin{tcolorbox}[colback=green!10!white, colframe=green!75!black,
    title=\textbf{Appendix UNMAPPED_REC: Summary}]
...
\textbf{Integration:} This appendix connects to Appendix UNMAPPED_NOB (LIT-NOBEL) as
...
\begin{table}[htbp]
\centering
\caption{Symbols Introduced in Appendix UNMAPPED_REC}
\label{tab:J-symbols}
\renewcommand{\arraystretch}{1.3}
...
Appendix UNMAPPED_NOB (LIT-NOBEL: Retrospective Integration),
Appendix UNMAPPED_HOW (CORE-HOW: Complementarity),
Appendix CTW (CORE-WHEN: Context),
Appendix UNMAPPED_WAT (CORE-WHAT: Welfare Dimensions).
