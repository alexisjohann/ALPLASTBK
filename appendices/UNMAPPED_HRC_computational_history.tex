...
\begin{itemize}
  ...
  \item Context dependence: \citet{north1990institutions}
\end{itemize}
...
\begin{tcolorbox}[colback=yellow!5!white,colframe=yellow!75!black,title=Axiom UNMAPPED_HRC-1: Fundamental Principle]
\textbf{Axiom UNMAPPED_HRC-1 (Core Assumption):}
...
\begin{tcolorbox}[colback=yellow!5!white,colframe=yellow!75!black,title=Axiom UNMAPPED_HRC-2: Complementarity]
\textbf{Axiom UNMAPPED_HRC-2 (Complementarity):}
...
\begin{table}[htbp]
\centering
\caption{Key Symbols in Appendix UNMAPPED_HRC}
\begin{tabular}{lll}
\toprule
