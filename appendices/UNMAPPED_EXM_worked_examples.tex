...
\begin{itemize}[nosep]
    \item Appendix UNMAPPED_WHO (CORE-WHO): Aggregation levels $L \in \{1,...,6\}$
    \item Appendix UNMAPPED_HOW (CORE-HOW): Complementarity structure $C$
    \item Appendix CTW (CORE-WHEN): Context dimensions $\Psi$
    \item Appendix UNMAPPED_PRF (FORMAL-PROOF): $C^*$, $K$, $Q$ definitions
\end{itemize}
...
\begin{tcolorbox}[colback=yellow!5!white,colframe=yellow!75!black,title=Axiom UNMAPPED_EXM-1: Fundamental Principle]
\textbf{Axiom UNMAPPED_EXM-1 (Core Assumption):}
...
\begin{tcolorbox}[colback=yellow!5!white,colframe=yellow!75!black,title=Axiom UNMAPPED_EXM-2: Complementarity]
\textbf{Axiom UNMAPPED_EXM-2 (Complementarity):}
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=\textbf{Summary: Appendix UNMAPPED_EXM Key Points}]
...
\begin{tcolorbox}[colback=red!5!white, colframe=red!75!black,
    title=\textbf{Critical Foundations for Appendix UNMAPPED_EXM}]

This appendix's worked examples depend on:

\begin{enumerate}
    \item \textbf{Appendix UNMAPPED_WHO (CORE-WHO):} Definition of aggregation levels $L$
    \item \textbf{Appendix UNMAPPED_HOW (CORE-HOW):} Complementarity structure creating $K$
    \item \textbf{Appendix UNMAPPED_PRF (FORMAL-PROOF):} Formal definitions of $K$, $Q$, $C^*$
...
\begin{itemize}[nosep]
    ...
    \item Appendix UNMAPPED_PRF (Formal Proofs)
...
\begin{table}[htbp]
\centering
\caption{Key Symbols in Appendix UNMAPPED_EXM}
\begin{tabular}{lll}
\toprule
