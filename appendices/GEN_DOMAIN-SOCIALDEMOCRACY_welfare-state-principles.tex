...
% - BUILDS ON: Appendix UNMAPPED_BG (CONTEXT-GENESIS), Appendix UNMAPPED_DX (CONTEXT-POLITICAL-ECONOMY)
% - INTEGRATES WITH: Appendix UNMAPPED_V (CONTEXT-MASTER), Appendix UNMAPPED_FEH (Fehr's regulatory models)
%
% =============================================================================
...
\item \textbf{For formal policy theory:} See Appendix UNMAPPED_FEH (Fehr's regulatory critique)
\end{itemize}
...
\begin{itemize}[nosep]
    \item CONTEXT-GENESIS $\rightarrow$ Appendix UNMAPPED_BG
    \item CONTEXT-POLITICAL-ECONOMY $\rightarrow$ Appendix UNMAPPED_DX
    \item CONTEXT-MASTER $\rightarrow$ Appendix UNMAPPED_V
    \item Fehr's regulatory models $\rightarrow$ Appendix UNMAPPED_FEH
    \item Fehr's regulatory critique $\rightarrow$ Appendix UNMAPPED_FEH
\end{itemize}
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Principle GEN-1: Health Universality]
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Principle GEN-2: Housing as Right]
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Principle GEN-3: Education Universality]
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Principle GEN-4: Dignity in Work]
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Principle GEN-5: Pension Guarantee]
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Principle GEN-6: Collective Insurance]
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Principle GEN-7: Progressive Redistribution]
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Principle GEN-8: Regulatory Framework]
...
\textbf{Austrian Implementation (Example):} Austria's Kartellamt exists but has weak media enforcement (Appendix UNMAPPED_BG). Krone 40\% market share never challenged. Regulation implemented in finance, manufacturing; ignored in media.
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Principle GEN-9: Active Equity Programs]
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Principle GEN-10: Codetermination}
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom GEN-1: Policy Coherence Definition]
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom GEN-2: Principle-to-Context Mapping]
...
The ten principles map directly to EBF's context parameter $\Psi$ (Appendix UNMAPPED_V):
...
\textbf{Integration:} This appendix connects to Appendix UNMAPPED_V (CONTEXT-MASTER) by showing how normative principles shape $\Psi$ parameters. It provides foundation for Appendices BG (CONTEXT-GENESIS), BH (CONTEXT-SPÖ_PARADOX), and DX (CONTEXT-POLITICAL-ECONOMY).
...
\begin{table}[htbp]
\centering
\caption{Symbols Introduced in Appendix GEN}
...
\begin{itemize}[nosep]
\item \textbf{Appendix UNMAPPED_BG (CONTEXT-GENESIS):} Explains how Principle 8 abandonment enabled media concentration
\item \textbf{Appendix UNMAPPED_BH (CONTEXT-SPÖ_PARADOX):} Shows how policy incoherence paralyzed SPÖ decision-making
\item \textbf{Appendix UNMAPPED_DX (CONTEXT-POLITICAL-ECONOMY):} Uses BF as foundation for Babler reform scenarios
\item \textbf{Appendix UNMAPPED_V (CONTEXT-MASTER):} Shows how principles shape Ψ context dimensions
\item \textbf{Appendix UNMAPPED_FEH (LIT-FEHR):} Fehr's regulatory economics critique
\item \textbf{Appendix UNMAPPED_SUN (LIT-SUNSTEIN):} Sunstein's choice architecture as policy tool
\item \textbf{Chapter 14 (Democratic Resilience):} Applies BF framework to policy design
\item \textbf{Appendix UNMAPPED_GLS (Glossary):} Key terms: Policy coherence, normative principle, selective implementation
\end{itemize}

\textbf{To Cite This Appendix:}

\textit{Appendix GEN (DOMAIN-SOCIALDEMOCRACY): The Ten Normative Principles of Social Democracy.}
