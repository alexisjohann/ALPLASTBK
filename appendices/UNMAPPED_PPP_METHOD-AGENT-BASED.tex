...
% - Added 6 theorems: UNMAPPED_PPP-1 (Mean Field), UNMAPPED_PPP-2 (Error Bound), UNMAPPED_PPP-3 (Emergence),
%   UNMAPPED_PPP-4 (Time Complexity), UNMAPPED_PPP-5 (Space Complexity), UNMAPPED_PPP-6 (Variance)
...
The ABM must reproduce the theoretical predictions from Chapter 24 and Appendix UNMAPPED_OOO.
...
\begin{tcolorbox}[colback=green!5!white, colframe=green!75!black, title=Theorem UNMAPPED_PPP-1: Mean Field Convergence]
\textbf{Theorem UNMAPPED_PPP-1 (Mean Field Convergence).}
...
\begin{tcolorbox}[colback=green!5!white, colframe=green!75!black, title=Theorem UNMAPPED_PPP-2: Finite-Sample Error]
\textbf{Theorem UNMAPPED_PPP-2 (Finite-Sample Error Bound).}
...
\begin{tcolorbox}[colback=green!5!white, colframe=green!75!black, title=Theorem UNMAPPED_PPP-3: Emergence Validity]
\textbf{Theorem UNMAPPED_PPP-3 (Emergence Validity).}
...
\textit{Proof.}
Conditions (1)-(2) ensure Theorem UNMAPPED_PPP-1 holds. Condition (3) ensures Theorem UNMAPPED_PPP-2
...
\begin{tcolorbox}[colback=yellow!5!white, colframe=yellow!75!black, title=Theorem UNMAPPED_PPP-4: Computational Complexity]
\textbf{Theorem UNMAPPED_PPP-4 (Time Complexity).}
...
\begin{tcolorbox}[colback=yellow!5!white, colframe=yellow!75!black, title=Theorem UNMAPPED_PPP-5: Space Complexity]
\textbf{Theorem UNMAPPED_PPP-5 (Space Complexity).}
...
\begin{tcolorbox}[colback=green!5!white, colframe=green!75!black, title=Theorem UNMAPPED_PPP-6: Variance Propagation]
\textbf{Theorem UNMAPPED_PPP-6 (Population Variance).}
...
# Domain parameters (from Appendix UNMAPPED_RRR)
...
\item \textbf{McKean (1967)}: McKean-Vlasov equations---foundational work showing
      ...
      Underlies our Theorem UNMAPPED_PPP-1 \citep{mckean1967propagation}.
...
Mean Field Theory & McKean 1967 & UNMAPPED_PPP-1 convergence proof \\
...
Key references for Appendix UNMAPPED_PPP:
...
\begin{table}[htbp]
\centering
\caption{Key Symbols in Appendix UNMAPPED_PPP}
\begin{tabular}{lll}
\toprule
