...
\citep{PAP-heckman2024causality}
...
See also: Full-text archive at \texttt{data/paper-texts/PAP-heckman2026skills.md}
...
\begin{table}[htbp]
\centering
\caption{Key Symbols in Appendix HEC}
\begin{tabular}{lll}
\toprule
