...
% - Appendix AW (CORE-STAGE): Behavioral change dynamics
...
\item For integration: See Appendix L (LIT-KAHNEMAN) on dual systems
\end{itemize}
...
\textbf{Cross-References:} Appendix L (LIT-KAHNEMAN), AU (CORE-AWARE), V (CORE-WHEN), BBB (CORE-WHERE)
\end{tcolorbox}
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom LO-1: Visceral Override]
...
\textbf{Source:} \citet{PAP-loewenstein1996out}, \citet{loewenstein2005visceral}
\end{tcolorbox}

\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom LO-2: Hot-Cold Empathy Gap]
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom LO-3: Curiosity as Information Gap]
...
\textbf{Source:} \citet{loewenstein1999curiosity}
\end{tcolorbox}

\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom LO-4: Anticipatory Utility]
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom LO-5: Risk as Feelings]
...
\textbf{Source:} \citet{PAP-loewenstein2000emotions}, \citet{loewenstein2001temptation}
\end{tcolorbox}

\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom LO-6: Projection Bias]
...
\midrule
LO-1 & Visceral states override cognition & $\alpha \to 0$ at high V & 1 \\
LO-2 & Hot-cold empathy gap exists & 30-50\% underprediction & 1 \\
LO-3 & Curiosity peaks at intermediate K & Inverted U-shape & 1 \\
LO-4 & Anticipation adds utility & $U_{ant} > 0$ & 1 \\
LO-5 & Emotions dominate risk perception & $\omega_E > \omega_C$ & 1 \\
LO-6 & Projection bias is systematic & $\beta \approx 0.3-0.5$ & 1 \\
LO-7 & Self-serving bias in bargaining & 15-20\% gap & 1 \\
LO-8 & Pain memory is reconstructive & Peak-end rule & 1 \\
\bottomrule
\end{tabular}
\end{table}
...
Loewenstein's foundational paper ``Out of Control'' \citep{PAP-loewenstein1996out} establishes that visceral factors---hunger, thirst, sexual arousal, pain, emotions---systematically influence behavior in ways that standard utility theory cannot capture.
...
Loewenstein's curiosity theory \citep{loewenstein1999curiosity} posits that curiosity arises from awareness of an information gap:
...
Loewenstein and colleagues \citep{PAP-loewenstein2000emotions} argue that risk perception has two components:
...
\begin{tcolorbox}[colback=green!10!white, colframe=green!75!black,
    title=\textbf{Appendix LO: Summary}]
...
\begin{table}[htbp]
\centering
\caption{Symbols Introduced in Appendix LO}
...
loewenstein1992out & 1992 & Visceral Influences & 1 \\
...
loewenstein1999curiosity & 1999 & Curiosity & 1 \\
...
ariely2004anchoring & 2004 & (with Ariely) & 1 \\
camerer2004neuroeconomics & 2004 & (with Camerer) & 1 \\
loewenstein2005visceral & 2005 & Visceral Influences & 1 \\
loewenstein2006hot & 2006 & Hot-Cold Gap & 1 \\
ariely2007expensive & 2007 & (with Ariely) & 1 \\
...
\begin{itemize}[nosep]
    \item \textbf{Visceral Influences:} \citet{PAP-loewenstein1996out}, \citet{loewenstein2005visceral}
    \item \textbf{Hot-Cold Gap:} \citet{loewenstein2006hot}, \citet{loewenstein2000projecting}
    \item \textbf{Curiosity:} \citet{loewenstein1999curiosity}
    \item \textbf{Anticipatory Utility:} \citet{loewenstein1987emotions}
    \item \textbf{Risk as Feelings:} \citet{PAP-loewenstein2000emotions}
