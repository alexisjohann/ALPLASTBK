...
% - Appendix UNMAPPED_DER (FORMAL-DERIVE): Mathematical foundations
% - Appendix UNMAPPED_PRF (FORMAL-PROOF): C* derivations and proofs
% - Appendix UNMAPPED_CAM (REF-META): Metatheoretical foundations
% - Appendix UNMAPPED_EST (CORE-WHERE): Parameter estimation framework
%
% DEPENDENTS (what REQUIRES this appendix):
% - All CORE appendices: Methodological grounding
% - Appendix LLM1 (METHOD-LLMMC): Estimation methodology
% - Appendix THL1 (METHOD-EVAL): Validation framework
%
% =============================================================================
...
\item For formal C* theory: See Appendix UNMAPPED_PRF (FORMAL-PROOF)
\item For estimation methods: See Appendix LLM1 (METHOD-LLMMC)
\end{itemize}
...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=Quick Reference: Appendix UNMAPPED_MCD]

\textbf{Appendix:} MCD (METHOD)
...
\textbf{Cross-References:} Appendix UNMAPPED_DER (FORMAL-DERIVE), Appendix UNMAPPED_PRF (FORMAL-PROOF),
Appendix UNMAPPED_CAM (REF-META), Appendix UNMAPPED_EST (CORE-WHERE), Appendix LLM1 (METHOD-LLMMC)
\end{tcolorbox}
...
\begin{itemize}[nosep]
    \item How does EBF establish methodological foundations that satisfy
...
\begin{itemize}[nosep]
    ...
    \item Part 2: Learning Theory and Expectation Formation
    \item Part 3: Dynamic Adjustment to $C^*$
    \item Part 4: Heterogeneity and Aggregation
    \item Part 5: Identification and Model Comparison
\end{itemize}

\textbf{Out-of-Scope (delegiert an andere Appendices):}
\begin{itemize}[nosep]
    \item FORMAL-DERIVE $\rightarrow$ Appendix UNMAPPED_DER
    \item FORMAL-PROOF $\rightarrow$ Appendix UNMAPPED_PRF
    \item REF-META $\rightarrow$ Appendix UNMAPPED_CAM
...
See Appendix UNMAPPED_PRF, Section D.1 for complete proof.
\end{proof}
...
See Appendix UNMAPPED_PRF, Section D.2 for complete conditions.
\end{proof}
...
\begin{proof}
Standard linearization argument. See Appendix UNMAPPED_PRF, Section D.3.
\end{proof}
...
See Appendix UNMAPPED_PRF, Section D.4.
\end{proof}
...
Appendix UNMAPPED_EST for the complete hierarchy.
...
\item Train on $UNMAPPED_FEH-1$ folds, predict on held-out fold
...
The 10C framework completes the path from utility to action. METHOD-CONSTRUCT
...
\begin{tcolorbox}[colback=green!10!white, colframe=green!75!black,
    title=\textbf{Appendix UNMAPPED_PAP2: Summary}]
...
\begin{table}[htbp]
\centering
\caption{Symbols Introduced in Appendix UNMAPPED_PAP2}
...
with behavioral learning theories \citep{camerer2004neuroeconomicscognitive}.
...
\begin{table}[htbp]
\centering
\caption{Research Roadmap for Appendix UNMAPPED_PAP2}
...
\begin{itemize}[nosep]
    ...
    \citet{camerer2004neuroeconomicscognitive}
...
\bibitem{PAP-camerer2004neuroeconomicscognitive} Camerer, C.F., Ho, T.H., \& Chong, J.K. (2004).
...
Appendix UNMAPPED_DER (FORMAL-DERIVE: Mathematical Foundations),
Appendix UNMAPPED_PRF (FORMAL-PROOF: Theorem Demonstrations),
Appendix UNMAPPED_CAM (REF-META: Metatheory),
Appendix UNMAPPED_EST (CORE-WHERE: Parameter Estimation),
Appendix LLM1 (METHOD-LLMMC: LLM Monte Carlo).
