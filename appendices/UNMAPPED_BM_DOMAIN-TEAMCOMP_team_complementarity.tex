...
We extend the EBF complementarity framework (Appendix UNMAPPED_B) to team settings:
...
\begin{itemize}
    \item \textbf{Core Theory:} Appendix UNMAPPED_B (CORE-HOW: Complementarity)
    \item \textbf{Context Framework:} Appendix UNMAPPED_V (CORE-WHEN: Context)
    \item \textbf{Identity:} Appendix UNMAPPED_AAA (CORE-WHO: Welfare Hierarchy)
    \item \textbf{Parameters:} Appendix UNMAPPED_BBB (CORE-WHERE: Parameter Repository)
...
\begin{table}[htbp]
\centering
\caption{Key Symbols in Appendix UNMAPPED_BM}
\begin{tabular}{lll}
\toprule
