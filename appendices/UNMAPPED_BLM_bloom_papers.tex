% =============================================================================
% APPENDIX BLM: LIT-BLOOM: Bloom Research Integration
% =============================================================================
% Category: LIT
% Language: English
...
% Status: Draft
%
% This appendix integrates research papers by Bloom into the EBF framework.
%
% =============================================================================

\chapter{LIT-BLOOM: Bloom Research Integration}
\label{app:blm}

\begin{abstract}
This appendix integrates the research contributions of Bloom into the
...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=Quick Reference: Bloom Research]

\textbf{Appendix:} BLM (LIT)

\textbf{Researcher:} Bloom
...
\begin{itemize}[nosep]
    \item Integrate Bloom's research into EBF with parameter extraction
\end{itemize}
...
\textbf{How does lit-bloom: bloom research integration integrate with and contribute to the
...
\begin{table}[htbp]
\centering
\caption{Key Symbols in Appendix UNMAPPED_BLM}
\begin{tabular}{lll}
\toprule
