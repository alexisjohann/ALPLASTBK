...
% - Appendix UNMAPPED_B (CORE-HOW): Complementarity structure gamma
% - Appendix UNMAPPED_MIL: Milgrom-Roberts supermodularity theory
% - Appendix VII (FORMAL-GTC): General Theory of Complementarity
%
% DEPENDENTS (what REQUIRES this appendix):
% - Appendix UNMAPPED_IE (CORE-EIT): Emergent Intervention Theory (K vs Q in emergence)
...
\begin{itemize}[nosep]
    ...
    \item Milgrom-Roberts $\rightarrow$ Appendix UNMAPPED_MIL
\end{itemize}
...
\item For formal supermodularity: See Appendix UNMAPPED_MIL (Milgrom-Roberts)
\item For emergence implications: See Appendix UNMAPPED_IE (CORE-EIT)
\end{itemize}
...
\textbf{Axiom UNMAPPED_NC-1 (Complementarity):}
...
\textbf{Axiom UNMAPPED_NC-2 (Own-Concavity):}
...
\textbf{Axiom UNMAPPED_NC-3 (Coherence Definition):}
...
\textbf{Axiom UNMAPPED_NC-4 (Quality Definition):}
...
The non-concavity framework connects directly to the 10C Emergence Classification (Appendix UNMAPPED_IE):
...
These are \textbf{quantitative questions} that require calibration from data---not derivation from principles. This connects to the WHERE dimension (Appendix UNMAPPED_BBB): parameters must be estimated, not assumed.
...
For complete symbol definitions, see \textbf{Appendix UNMAPPED_GLS} (Central Glossary).
...
\hline
$\gamma$ & Complementarity parameter & Appendix UNMAPPED_B (CORE-HOW) \\
...
$C^*$ & Equilibrium configuration & Appendix UNMAPPED_B \\
$\Psi$ & Context & Appendix UNMAPPED_V (CORE-WHEN) \\
\hline
\end{tabular}
\end{center}
