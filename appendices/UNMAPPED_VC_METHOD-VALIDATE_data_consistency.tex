...
% Date: January 2026
% Language: English
% Dependencies: Appendix UNMAPPED_BBB (CORE-WHERE), Appendix UNMAPPED_V (CORE-WHEN),
%               Appendix UNMAPPED_FRM (METHOD-FORMULA)
% =============================================================================
...
\begin{enumerate}[label=\textbf{OS\arabic*}:, leftmargin=2cm]
    ...
    \item \textbf{Statistische Validierung} --- Empirische Ergebnisse $\to$ Appendix UNMAPPED_LLM (METHOD-LLMMC)
...
\begin{itemize}
    \item \textbf{Appendix UNMAPPED_BBB} (CORE-WHERE): Parameter sources and validation
    \item \textbf{Appendix UNMAPPED_V} (CORE-WHEN): Context dimensions ($\Psi$)
    \item \textbf{Appendix UNMAPPED_FRM} (METHOD-FORMULA): Exclusion Principle (EXC-1 to EXC-6)
    \item \textbf{Appendix UNMAPPED_LLM} (METHOD-LLMMC): Parameter estimation
