...
\item Institutional stability reduces economic uncertainty effects \citep{PAP-north1990institutions}
...
\item $\lambda_{LA} \approx 2.25$ = loss aversion coefficient \citep{PAP-kahneman1979prospect}
...
\item \citet{thaler1980endowment}: WTA/WTP gap demonstrates loss aversion in ownership
...
\begin{itemize}[nosep]
\item \textbf{Decay dynamics:} \citet{PAP-kahneman1979prospect}, \citet{laibson1997golden}, \citet{frederick2002time}
\item \textbf{Context effects:} \citet{PAP-thaler2008nudge}, \citet{cialdini2004social}
...
\begin{itemize}[nosep]
\item \citet{gneezy2011limits}: Financial incentives can backfire ($\gamma \approx -0.2$ to $-0.4$)
...
\begin{itemize}[nosep]
    \item \citet{PAP-kahneman1979prospect}: Prospect theory, reference dependence, loss aversion
...
\begin{itemize}[nosep]
    \item \citet{PAP-dellavigna2009psychology}: Psychology and economics integration
    ...
    \item \citet{PAP-thaler2008nudge}: Nudge, choice architecture applications
\end{itemize}
