...
%
% DETAILED AXIOM SYSTEM: See Appendix UNMAPPED_AWA for the complete 80-axiom system.
%
% =============================================================================
...
\textbf{Detailed Treatment:} See Appendix UNMAPPED_AWA for the complete 80-axiom system.
...
in Appendix UNMAPPED_AWA. This appendix provides the core theoretical framework.
...
Moral behavior depends critically on awareness of moral implications. Bénabou, Falk, and Tirole \citep{benabou2018narratives} show that \textbf{narratives} systematically manipulate this awareness:
...
\textbf{Source:} \citet{benabou2018narratives}, Propositions 1-3.
\end{tcolorbox}
...
\textbf{Cross-Reference:} See LIT-BENABOU (RB), Axiom UNMAPPED_RB-7 for the complete formalization.
...
Cognitive Load Theory (Sweller) maps directly to AWARE: $A(\Psi_{\text{load}}) = A_{\max} \times \exp(-k \times \Psi_{\text{load}})$. See Appendix UNMAPPED_CP for the full CPS-10C mapping.
\end{tcolorbox}

\section{Summary}

\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Appendix UNMAPPED_AU Summary: CORE-AWARE]
...
\textbf{Detailed Treatment:} See Appendix UNMAPPED_AWA for complete 80-axiom system.
...
Appendix UNMAPPED_AWA (detailed axioms), V (CORE-WHEN), AV (CORE-READY), CAL (METHOD-LLMMC), RB (LIT-BENABOU: Moral Narratives), FAL (LIT-FALK), JT (LIT-TIROLE).
