...
% - Appendix ACE (LIT-KAHNEMAN): Contrast with heuristics-and-biases
% - Appendix UNMAPPED_V (CORE-WHEN): Context framework (ecological structure)
...
\item For contrast: Compare with Appendix ACE (LIT-KAHNEMAN)
...
\textbf{Cross-References:} Appendix ACE (LIT-KAHNEMAN), V (CORE-WHEN), AU (CORE-AWARE), BBB (CORE-WHERE)
\end{tcolorbox}
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom UNMAPPED_GI-1: Less-is-More Effect]
...
\textbf{Source:} \citet{gigerenzer1999simple}, \citet{gigerenzer2009homo}
\end{tcolorbox}

\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom UNMAPPED_GI-2: Ecological Rationality]
...
\textbf{Source:} \citet{gigerenzer2001bounded}, \citet{goldstein2002recognition}
\end{tcolorbox}

\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom UNMAPPED_GI-3: Recognition Heuristic]
...
\textbf{Source:} \citet{goldstein2002recognition}
\end{tcolorbox}

\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom UNMAPPED_GI-4: Take-the-Best]
...
\textbf{Source:} \citet{gigerenzer1996fast}, \citet{brandstatter2006priority}
\end{tcolorbox}

\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom UNMAPPED_GI-5: Natural Frequency Superiority]
...
\textbf{Source:} \citet{gigerenzer1995improve}, \citet{gigerenzer2012helping}
\end{tcolorbox}

\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom UNMAPPED_GI-6: Adaptive Toolbox]
...
\textbf{Source:} \citet{gigerenzer2001bounded}, \citet{gigerenzer2008rationality}
\end{tcolorbox}
...
\midrule
UNMAPPED_GI-1 & Take-the-best matches regression & Equal accuracy & 2 \\
UNMAPPED_GI-2 & Recognition heuristic is valid & $r > 0.6$ with criterion & 2 \\
UNMAPPED_GI-3 & Frequency formats improve reasoning & +40\% accuracy & 1 \\
UNMAPPED_GI-4 & Less-is-more in prediction & Simpler $>$ complex & 2 \\
UNMAPPED_GI-5 & Ecological match predicts success & Strong correlation & 2 \\
UNMAPPED_GI-6 & Heuristics beat optimization OOS & Cross-validation & 2 \\
UNMAPPED_GI-7 & Gut feelings can be accurate & Domain-dependent & 5 \\
UNMAPPED_GI-8 & Biases disappear with frequencies & 65\% $\to$ 90\% & 1 \\
\bottomrule
\end{tabular}
\end{table}
...
Gigerenzer's foundational work \citep{gigerenzer1999simple} establishes that simple heuristics are not merely ``good enough'' approximations---they can \textit{outperform} optimization:
...
The recognition heuristic \citep{goldstein2002recognition} is the simplest:
\begin{quote}
...
Take-the-best \citep{gigerenzer1996fast} is a lexicographic heuristic:
...
\begin{tcolorbox}[colback=green!10!white, colframe=green!75!black,
    title=\textbf{Appendix UNMAPPED_GI: Summary}]
...
\begin{table}[htbp]
\centering
\caption{Symbols Introduced in Appendix UNMAPPED_GI}
...
\begin{itemize}[nosep]
    \item \textbf{Fast-and-Frugal Heuristics:} \citet{gigerenzer1996fast}, \citet{gigerenzer1999simple}
    \item \textbf{Recognition Heuristic:} \citet{goldstein2002recognition}
    \item \textbf{Ecological Rationality:} \citet{gigerenzer2001bounded}
    \item \textbf{Natural Frequencies:} \citet{gigerenzer1995improve}, \citet{gigerenzer2012helping}
    \item \textbf{KT Debate:} \citet{gigerenzer1996narrow}
\end{itemize}
