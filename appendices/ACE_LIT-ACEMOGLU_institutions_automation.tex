...
\chapter*{Appendix ACE: Daron Acemoglu Research Integration}
\addcontentsline{toc}{chapter}{Appendix ACE: LIT-ACEMOGLU - Institutions, Automation \& Political Economy}
\label{app:acemoglu}
...
\begin{itemize}
    ...
    \item Appendix UNMAPPED_V (CORE-WHEN): Context as fundamental driver
...
\begin{itemize}
    ...
    \item Appendix UNMAPPED_RO (LIT-ROTH): Institutional design
\end{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2002: Technical Change, Inequality, and the Labor Market}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Acemoglu, Daron (2002). ``Technical Change, Inequality, and the Labor Market.'' \textit{Journal of Economic Literature}, 40, 7--72.

\paragraph{10C Integration.}
\begin{itemize}[nosep]
  \item \textbf{Domain}: [To be specified]
  \item \textbf{use\_for}: LIT-ACEMOGLU
\end{itemize}


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2001: The Colonial Origins of Comparative Development: An Empirica...}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Acemoglu, Daron and Johnson, Simon and Robinson, James A (2001). ``The Colonial Origins of Comparative Development: An Empirical Investigation.'' \textit{American Economic Review}, 91, 1369--1401.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2005: The Rise of Europe: Atlantic Trade, Institutional Change, an...}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Acemoglu, Daron and Johnson, Simon and Robinson, James A (2005). ``The Rise of Europe: Atlantic Trade, Institutional Change, and Economic Growth.'' \textit{American Economic Review}, 95, 546--579.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2019: Democracy Does Cause Growth}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Acemoglu, Daron and Naidu, Suresh and Restrepo, Pascual and Robinson, James A (2019). ``Democracy Does Cause Growth.'' \textit{Journal of Political Economy}, 127, 47--100.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2020: Robots and Jobs: Evidence from US Labor Markets}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Acemoglu, Daron and Restrepo, Pascual (2020). ``Robots and Jobs: Evidence from US Labor Markets.'' \textit{Journal of Political Economy}, 128, 2188--2244.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2018: Artificial Intelligence, Automation, and Work}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Acemoglu, Daron and Restrepo, Pascual (2018). ``Artificial Intelligence, Automation, and Work.'' \textit{NBER Working Paper}.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2011: Skills, Tasks and Technologies: Implications for Employment ...}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Acemoglu, Daron and Autor, David (2011). ``Skills, Tasks and Technologies: Implications for Employment and Earnings.'' \textit{Journal}, 4B, 1043--1171.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2006: Distance to Frontier, Selection, and Economic Growth}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Acemoglu, Daron and Aghion, Philippe and Zilibotti, Fabrizio (2006). ``Distance to Frontier, Selection, and Economic Growth.'' \textit{Journal of the European Economic Association}, 4.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2007: Disease and Development: The Effect of Life Expectancy on Ec...}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Acemoglu, Daron and Johnson, Simon (2007). ``Disease and Development: The Effect of Life Expectancy on Economic Growth.'' \textit{Journal of Political Economy}, 115.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2008: Persistence of Power, Elites, and Institutions}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Acemoglu, Daron and Robinson, James A. (2008). ``Persistence of Power, Elites, and Institutions.'' \textit{American Economic Review}, 98.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2012: Why Nations Fail: The Origins of Power, Prosperity, and Pove...}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Acemoglu, Daron and Robinson, James A. (2012). \textit{Why Nations Fail: The Origins of Power, Prosperity, and Poverty}. Publisher.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2015: State Capacity and Economic Development: A Network Approach}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Acemoglu, Daron and Garcia-Jimeno, Camilo and Robinson, James A. (2015). ``State Capacity and Economic Development: A Network Approach.'' \textit{American Economic Review}, 105.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2016: Networks, Shocks, and Systemic Risk}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Acemoglu, Daron and Ozdaglar, Asuman and Tahbaz-Salehi, Alireza (2016). ``Networks, Shocks, and Systemic Risk.'' \textit{Handbook of Network Economics}.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2018: The Race between Man and Machine: Implications of Technology...}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Acemoglu, Daron and Restrepo, Pascual (2018). ``The Race between Man and Machine: Implications of Technology for Growth, Factor Shares, and Employment.'' \textit{American Economic Review}, 108.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2020: AI and the Future of Work}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Acemoglu, Daron (2020). ``AI and the Future of Work.'' \textit{Working Paper}.
