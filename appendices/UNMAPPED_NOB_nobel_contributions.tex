...
\paragraph{Contribution.}
Gary Becker \citep{becker1976economic} extended economic analysis to crime, family, discrimination,
and human capital.
...
\paragraph{Contribution.}
Robert Lucas \citep{lucas1976econometric} developed rational expectations macroeconomics and
...
Paul Romer \citep{romer1990endogenous}: Endogenous growth through ideas.
...
\begin{table}[htbp]
\centering
\caption{Key Symbols in Appendix UNMAPPED_NOB}
\begin{tabular}{lll}
\toprule
