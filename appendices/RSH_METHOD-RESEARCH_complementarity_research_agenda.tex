...
\begin{abstract}
This appendix presents the key concepts and formalizations for Complementarity Research Agenda: Open Questions and Future Directions.
...
\begin{itemize}[nosep]
    \item Formalize and document the key concepts of Complementarity Research Agenda: Open Questions and Future Directions
\end{itemize}
...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=Quick Reference: Complementarity Research Agenda: Open Questions and Future Directions]

\textbf{Appendix:} RSH (METHOD)
...
\textbf{How does complementarity research agenda: open questions and future directions integrate with and contribute to the
...
% HEADER BLOCK
% ----------------------------------------------------------------------------
\begin{tcolorbox}[colback=purple!5!white,colframe=purple!75!black,title=\textbf{Appendix RSH: METHOD-RESEARCH}]
...
\begin{itemize}[noitemsep]
    \item Appendix GTC (GTC): Established theory $\to$ This appendix: Extensions
    \item Appendix CMP (METHOD-COMP): Known methods $\to$ This appendix: New methods needed
\end{itemize}
\end{tcolorbox}
...
\textbf{Builds Upon:}
\begin{itemize}[noitemsep]
    \item Appendix GTC (GTC): General Theory of Complementarity
    \item Appendix CMP (METHOD-COMP): Measurement Methodology
    \item Appendix HOW: Complementarity Fundamentals
\end{itemize}

\textbf{Connects To:}
\begin{itemize}[noitemsep]
    \item Appendix CTW (MEP): Portfolio optimization extensions
    \item Appendix MEQ (MEQ): Equilibrium dynamics
    \item Appendix LLM1: LLM Monte Carlo (potential tool)
\end{itemize}
...
The General Theory of Complementarity (GTC, Appendix GTC) and the methodological toolkit (METHOD-COMP, Appendix CMP) establish a solid foundation. Yet significant questions remain \textbf{unanswered}---questions that, if solved, would substantially advance behavioral economics, intervention science, and decision theory.
...
\midrule
RQ1 & Extends Appendix GTC (GTC): 6 $\gamma$ types $\to$ $k$-order $\gamma$ \\
...
\begin{itemize}[noitemsep]
    \item Appendix GTC (GTC): Established complementarity theory
    \item Appendix CMP (METHOD-COMP): 128 methodological papers
