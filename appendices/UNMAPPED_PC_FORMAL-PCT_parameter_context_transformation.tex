...
%          ↓                ↓                ↓
%   ┌─────────────┐  ┌─────────────┐  ┌─────────────┐
%   │  Appendix UNMAPPED_V │  │ Appendix UNMAPPED_PC │  │Appendix UNMAPPED_BBB │
...
%          ↓                ↓                ↓
%   ┌─────────────┐  ┌─────────────┐  ┌─────────────┐
%   │ Appendix UNMAPPED_LLM │  │  Paper-YAML │  │Appendix UNMAPPED_CAL │
...
\textbf{Out-of-Scope:}
\begin{itemize}
    \item Specific parameter estimates (see Appendix UNMAPPED_BBB)
    \item Context dimension definitions (see Appendix UNMAPPED_V)
    \item LLMMC methodology (see Appendix UNMAPPED_LLM)
\end{itemize}
...
For comprehensive symbol definitions, see Appendix UNMAPPED_GLS (Central Glossary).
...
\begin{itemize}
    \item Appendix UNMAPPED_V (CORE-WHEN): Context dimensions $\Psi$
    \item Appendix UNMAPPED_BBB (CORE-WHERE): Parameter values and sources
    \item Appendix UNMAPPED_LLM (METHOD-LLMMC): Prior generation methodology
    \item Appendix UNMAPPED_CAL (METHOD-CAL): Calibration and validation
    \item Appendix UNMAPPED_GLS: Central Glossary
\end{itemize}
