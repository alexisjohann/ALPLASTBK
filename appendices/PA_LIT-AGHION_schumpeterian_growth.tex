...
\chapter*{Appendix PA: Philippe Aghion Research Integration}
\addcontentsline{toc}{chapter}{Appendix PA: LIT-AGHION - Schumpeterian Growth \& Creative Destruction}
\label{app:aghion}
...
\begin{axiom}[PA-1: Creative Destruction]
\label{ax:pa1}
...
\begin{axiom}[PA-2: Escape Competition Effect]
\label{ax:pa2}
...
\begin{axiom}[PA-3: Schumpeterian Effect]
\label{ax:pa3}
...
\begin{axiom}[PA-4: Missing Growth]
\label{ax:pa4}
...
\begin{axiom}[PA-5: Trust-Regulation Complementarity]
\label{ax:pa5}
...
\begin{axiom}[PA-6: Directed Technical Change]
\label{ax:pa6}
