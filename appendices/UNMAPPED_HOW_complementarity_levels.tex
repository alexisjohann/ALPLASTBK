...
\textbf{Dependencies:} & Appendix UNMAPPED_WHO (Aggregation Levels) \\
 & Appendix UNMAPPED_WAT (FEPSDE Utility Structure) \\
...
\begin{itemize}[nosep]
    ...
    \item For empirical values: See Appendix UNMAPPED_EST (Parameter Calibration)
\end{itemize}
...
\textbf{New in 2026:} See also \textbf{Appendix UNMAPPED_HIE (CORE-HIERARCHY)}---Decision Hierarchy \& Strategic Coherence. HI formalizes how the $\Gamma$ complementarity matrix creates stratification into L0-L1-L2-L3 decision levels via Theorem T1 (Universal L2 Complexity Formula). HI Axiom A1 grounds the Complementarity Principle in Milgrom \& Roberts (1995).

\textbf{Critical Link:} \textbf{Appendix UNMAPPED_NC (FORMAL-NC)}---Non-Concavity, Fit, and Coherence. NC formalizes \textit{why} $\gamma > 0$ creates multiple stable configurations (peaks) and establishes the $K$ (coherence) vs.\ $Q$ (quality) distinction central to Chapter 7.
...
\textbf{The Exclusion Principle} (see Appendix UNMAPPED_FRM: LIT-FEHR-METHOD):
...
\textbf{Cross-Reference:} Appendix UNMAPPED_FRM provides the full philosophy of science
...
\citep{roberts2004}. See Appendix UNMAPPED_FND for detailed coverage.
...
\vspace{1cm}
\begin{tcolorbox}[colback=gray!10, colframe=gray!50, title=Appendix UNMAPPED_HOW Structure]
...
\begin{itemize}
    \item For formal supermodularity theory: See Appendix UNMAPPED_FND (Milgrom-Roberts)
    \item For FEPSDE dimensions: See Appendix UNMAPPED_WAT (CORE-WHAT)
    \item For aggregation levels: See Appendix UNMAPPED_WHO (CORE-WHO)
...
Following \citet{koszegi2006model}, the reference point $r$ is not fixed but 
depends on context:
\begin{equation}
r = r(\Psi, \mathbb{E}[x])
\end{equation}
...
Following \citet{loewenstein2000emotions}, visceral states (hunger, pain, arousal) 
...
between context and utility. From Appendix UNMAPPED_WAT, awareness determines which utility 
...
\citet{loewenstein1996out} identifies visceral factors---hunger, pain, arousal, 
...
\begin{enumerate}
    ...
    This formalizes the ``bandwidth tax'' of \citet{mullainathan2013scarcity}.
...
\citet{becker1988theory} model habit formation as intertemporal complementarity 
...
\citet{becker1973theory} established that complementarity in production drives 
...
context assessment (Appendix UNMAPPED_WAT) improves allocation efficiency.
...
\citet{becker1973theory} established the foundational connection between complementarity 
...
treated comprehensively in \textbf{Appendix UNMAPPED_EST: The Epistemics of Parameter 
...
\textbf{Key parameters estimated in Appendix UNMAPPED_EST:}
\begin{center}
\begin{tabular}{lcl}
\toprule
...
See Appendix UNMAPPED_EST for the complete methodological framework and current parameter 
values.
...
\begin{itemize}[nosep]
    \item Aggregation Levels $\rightarrow$ Appendix UNMAPPED_WHO
    \item FEPSDE Utility Structure $\rightarrow$ Appendix UNMAPPED_WAT
    \item 8Ψ Context Dimensions $\rightarrow$ Appendix CTW
    \item Parameter Calibration $\rightarrow$ Appendix UNMAPPED_EST
    \item CORE-HIERARCHY $\rightarrow$ Appendix UNMAPPED_HIE
\end{itemize}
...
\begin{tcolorbox}[colback=green!10!white, colframe=green!75!black, 
    title=\textbf{Appendix UNMAPPED_HOW: Complete Summary}]
...
\begin{enumerate}[nosep]
    ...
    \item The three-tier epistemic system (Appendix UNMAPPED_EST) explicitly distinguishes 
...
\begin{enumerate}[nosep]
    ...
    related to cognitive bounds. See Appendix UNMAPPED_AWA (Awareness).
...
Appendix UNMAPPED_MSC Section 11.
...
\bottomrule
\end{tabular}
\caption{Notation guide for Appendix UNMAPPED_HOW}
\label{tab:notation}
\end{table}
...
%==============================================================================
% GLOSSARY OF SYMBOLS (Required - links to Appendix UNMAPPED_GLS)
%==============================================================================
...
framework, see \textbf{Appendix UNMAPPED_GLS} (\textit{Glossary and Notation}).
...
\textbf{Note:} \checkmark = Defined in Appendix UNMAPPED_GLS; NEW = Introduced in this appendix 
...
\toprule
\textbf{Appendix} & \textbf{CORE Question} & \textbf{Connection to Appendix UNMAPPED_HOW} \\
\midrule
