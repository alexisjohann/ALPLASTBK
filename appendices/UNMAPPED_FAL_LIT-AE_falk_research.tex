...
Primary integration in LIT-BENABOU (Appendix UNMAPPED_RB), Axiom UNMAPPED_RB-7. See also LIT-TIROLE (Appendix UNMAPPED_JT).
...
\begin{table}[htbp]
\centering
\caption{Key Symbols in Appendix UNMAPPED_FAL}
\begin{tabular}{lll}
\toprule
