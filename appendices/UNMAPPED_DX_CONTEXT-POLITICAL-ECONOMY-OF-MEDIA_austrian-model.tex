...
\begin{itemize}[nosep]
    ...
    \item DOMAIN-AUSTRIA-VOTERS $\rightarrow$ Appendix UNMAPPED_BS
    \item DOMAIN-AUSTRIA-SPO $\rightarrow$ Appendix UNMAPPED_BT
\end{itemize}
...
%
% DEPENDENCIES:
% - Appendix UNMAPPED_C (CORE-WHAT): Utility dimensions (E, X, F, S)
% - Appendix UNMAPPED_B (CORE-HOW): Complementarity structures (γ_{E×X})
% - Appendix UNMAPPED_V (CORE-WHEN): Temporal context (Ψ_t)
% - Appendix UNMAPPED_BS (DOMAIN-AUSTRIA-VOTERS): FPÖ rise model
% - Appendix UNMAPPED_BT (DOMAIN-AUSTRIA-SPO): SPÖ decline model
% - Appendix GEN (DOMAIN-SOCIALDEMOCRACY): Party strategy
%
% DEPENDENTS:
...
\item For comprehensive historical-comparative analysis of why Austrian media concentration became possible
  (regulatory, business model, digital, algorithmic factors), see \textbf{Appendix UNMAPPED_BG (CONTEXT-GENESIS)}.
\item For analysis of the Austrian Social Democrats' (SPÖ) political role in enabling/perpetuating concentration (1950-2025),
  see \textbf{Appendix UNMAPPED_BH (CONTEXT-SPÖ_PARADOX)}.
\end{itemize}
...
See Appendix UNMAPPED_BBB (CORE-WHERE) for complete parameter repository.}
