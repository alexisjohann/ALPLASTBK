...
%   - Appendix UNMAPPED_PAP (EQUILIBRIA): Tipping points and stability
%   - Appendix UNMAPPED_HIE (HIERARCHY): Decision level structure
%   - Appendix CAL1 (EIH): Intervention efficiency
%   - Appendix UNMAPPED_LET (LET): Level emergence
...
\begin{tcolorbox}[colback=red!5!white, colframe=red!75!black,
    title=Theorem UNMAPPED_MEQ-1: Existence of Multiple Equilibria]

\textbf{Multiple Equilibria Theorem (UNMAPPED_MEQ-1):}
...
\subsection{Proof of UNMAPPED_MEQ-1}
...
\begin{theorem}[Equilibrium Landscape Structure (UNMAPPED_MEQ-2)]
...
\begin{theorem}[Optimal Transition Path (UNMAPPED_MEQ-3)]
...
\begin{tcolorbox}[colback=yellow!5!white,colframe=yellow!75!black,title=Axiom UNMAPPED_MEQ-1: Fundamental Principle]
\textbf{Axiom UNMAPPED_MEQ-1 (Core Assumption):}
...
\begin{tcolorbox}[colback=yellow!5!white,colframe=yellow!75!black,title=Axiom UNMAPPED_MEQ-2: Complementarity]
\textbf{Axiom UNMAPPED_MEQ-2 (Complementarity):}
...
\subsection{Connection to Appendix UNMAPPED_PAP (Equilibria)}

Appendix UNMAPPED_PAP formalizes tipping points and stability. MEQ operationalizes these
...
\subsection{Connection to Appendix UNMAPPED_HIE (Hierarchy)}
...
\textbf{Theorem UNMAPPED_MEQ-1 (Multiple Equilibria):}
...
\begin{itemize}[nosep]
    \item \textbf{Appendix UNMAPPED_NC (FORMAL-NC):} \textbf{Critical}---Non-concavity foundation; $\gamma > 0 \Rightarrow$ multiple equilibria (Ch.7)
    \item \textbf{Appendix CTW (FORMAL-MEP):} Portfolio optimization foundation
    \item \textbf{Appendix UNMAPPED_PAP (FORMAL-EQUILIBRIA):} Stability and tipping points
    \item \textbf{Appendix CAL1 (FORMAL-EIH):} Intervention efficiency conditions
    \item \textbf{Appendix UNMAPPED_LET (FORMAL-LET):} Level emergence mechanics
    \item \textbf{Appendix UNMAPPED_HIE (CORE-HIERARCHY):} Decision level structure
    \item \textbf{Appendix TKT (METHOD-TOOLKIT):} Intervention design toolkit
    \item \textbf{Appendix UNMAPPED_STA (CORE-STAGE):} BCJ phase dynamics
...
See Appendix UNMAPPED_GLS (REF-GLOSSARY) for complete terminology.
