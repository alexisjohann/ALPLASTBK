...
\item For systemic understanding: Read Appendix UNMAPPED_BG first (media concentration emergence)
\item For political implications: Read Appendix UNMAPPED_DX (reform scenarios 2025-2029)
\end{itemize}
...
This section systematically challenges the five core hypotheses underlying this appendix and Appendix UNMAPPED_BG.
...
\hline
Canada & 2024 & Bill UNMAPPED_C-18 (Online News Act) & Google News changed algorithm; news outlet revenue increased 8\% \\
\hline
\end{tabular}
\end{table}
...
For comprehensive definitions, see \textbf{Appendix UNMAPPED_GLS (Central Glossary)}:
...
\textbf{See Master Bibliography (Appendix UNMAPPED_BBB) for complete citations.}
...
\begin{itemize}[nosep]
\item **Appendix UNMAPPED_BG (CONTEXT-GENESIS):** Provides structural context for SPÖ's decisions
\item **Appendix UNMAPPED_DX (CONTEXT-POLITICAL-ECONOMY):** Shows consequences of SPÖ inaction (Babler's 2025 reform)
\item **Appendix UNMAPPED_V (CONTEXT-MASTER):** Ψ_media as context parameter (affected by SPÖ political choices)
\item **Chapter 14 (Democratic Resilience):** Policy implications of party coordination failure
\end{itemize}

\textbf{Citation:}
\textit{Appendix UNMAPPED_BH (CONTEXT-SPÖ_PARADOX): The Social Democrats' Ambivalent Role in Austrian Media Concentration (1950-2025).}
...
\begin{table}[htbp]
\centering
\caption{Key Symbols in Appendix UNMAPPED_BH}
\begin{tabular}{lll}
\toprule
