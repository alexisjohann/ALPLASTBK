...
\title{Appendix UNMAPPED_EST: Methodological Foundations of Parameter Estimation\\
...
\textbf{Dependencies:} & Appendix UNMAPPED_HOW (\ref{app:complementarity-how}) (Complementarity Theory) \\
 & Appendix LLM1 (\ref{app:llm-monte-carlo}) (LLM Monte Carlo) \\
 & Appendix UNMAPPED_OPS (\ref{app:operationalization}) (Empirical Operationalization) \\
...
\begin{tcolorbox}[colback=red!5!white, colframe=red!75!black, 
    title=\textbf{Appendix UNMAPPED_EST: The Epistemics of Numbers}]
...
\begin{itemize}[nosep]
    ...
    \item \textbf{Complete methodology navigation $\rightarrow$ Appendix UNMAPPED_PM (REF-PARAMETH)}
\end{itemize}
...
\begin{itemize}[nosep]
    \item \ref{app:complementarity-how} $\rightarrow$ Appendix UNMAPPED_HOW
    \item \ref{app:operationalization} $\rightarrow$ Appendix UNMAPPED_OPS
...
\midrule
Utility-Utility Complementarity & $\Gamma = [\gamma_{dd'}]$ & 15 & Appendix UNMAPPED_HOW (\ref{app:complementarity-how}), Teil II \\
Context-Context Complementarity & $\Lambda = [\lambda_{kl}]$ & 28 & Appendix UNMAPPED_HOW (\ref{app:complementarity-how}), Teil IV \\
Context Modulation & $\delta_{dd'k}$ & 120 & Appendix UNMAPPED_HOW (\ref{app:complementarity-how}), Teil III \\
Base Utility Weights & $w_d$ & 6 & Appendix UNMAPPED_WAT (\ref{app:fepsde-matrix}) \\
Reference Points & $r_d$ & 6 & Appendix UNMAPPED_WAT (\ref{app:fepsde-matrix}) \\
Discount Factor & $\delta$ & 1 & Chapter 3 \\
Tipping Thresholds & $\Psi^*_k$ & 8 & Appendix UNMAPPED_HOW (\ref{app:complementarity-how}), Teil VI \\
Coherence Threshold & $K^*$ & 1 & Appendix UNMAPPED_HOW (\ref{app:complementarity-how}), Teil I \\
\midrule
...
\textbf{Reference:} Appendix UNMAPPED_OPS (\ref{app:operationalization}) (Operationalization), Chapter 4
\end{tcolorbox}
...
\textbf{Reference:} Appendix UNMAPPED_AWA (\ref{app:axiom-formalization}) (Axiom Formalization)
\end{tcolorbox}
...
\bottomrule
\end{tabular}
\caption{Axioms defined in Appendix UNMAPPED_EST}
...
\hrule
\vspace{0.5em}
\noindent\textit{Cross-references: Appendix UNMAPPED_HOW (\ref{app:complementarity-how}) (Complementarity Theory), 
Appendix LLM1 (\ref{app:llm-monte-carlo}) (LLM Monte Carlo), Appendix UNMAPPED_OPS (\ref{app:operationalization}) (Operationalization), 
Appendix UNMAPPED_AWA (\ref{app:axiom-formalization}) (Axiom Formalization), Chapter 4 (Calibration)}
...
\bottomrule
\caption{Complete notation for Appendix UNMAPPED_EST}
...
\begin{equation}
I^2 = \frac{Q - (UNMAPPED_FEH-1)}{Q} < 0.5 \quad \text{(Low heterogeneity)}
\end{equation}
...
\bottomrule
\caption{Complete axiom index for Appendix UNMAPPED_EST}
...
Appendix UNMAPPED_EST serves as the \textbf{methodological hub} of the EBF framework, 
...
\midrule
\endfirsthead
Appendix UNMAPPED_HOW (\ref{app:complementarity-how}) & Complementarity theory, $\gamma$ definitions & Defines \textit{what} parameters mean \\
Appendix CTW (\ref{app:psi-dimensions}) & 8$\Psi$-dimension definitions & Context vector for $\delta$-modulation \\
Appendix UNMAPPED_WAT (\ref{app:fepsde-matrix}) & FEPSDE utility structure & Defines dimensions $d \in \mathcal{D}$ \\
Appendix UNMAPPED_AWA (\ref{app:axiom-formalization}) & Axiom formalization & Tier 3 axiomatic constraints \\
Appendix LLM1 (\ref{app:llm-monte-carlo}) & LLM-MC protocol details & Method B implementation \\
Appendix UNMAPPED_OPS (\ref{app:operationalization}) & Empirical data sources & Tier 1 calibration inputs \\
Chapter 4 & Application cases & Validation benchmarks \\
\bottomrule
\caption{Upstream dependencies for Appendix UNMAPPED_EST}
\end{longtable}
...
\midrule
\endfirsthead
Appendix UNMAPPED_HOW (\ref{app:complementarity-how}) & Calibrated $\Gamma$, $\Lambda$, $\delta$ & Quantified complementarity for analysis \\
Appendix UNMAPPED_WHO (\ref{app:aggregation-levels}) & Level-specific parameters & Parameters by aggregation level \\
Appendix UNMAPPED_WAT (\ref{app:fepsde-matrix}) & Calibrated weights $w_d$ & FEPSDE utility specification \\
...
\bottomrule
\caption{Downstream outputs from Appendix UNMAPPED_EST}
\end{longtable}
...
\begin{enumerate}
    ...
    \item \textbf{Complementarity Analysis:} Apply Appendix UNMAPPED_HOW (\ref{app:complementarity-how}) theory to identify leverage points
...
\midrule
Theory of complementarity & Appendix UNMAPPED_HOW (\ref{app:complementarity-how}) & Teil I-II \\
...
FEPSDE definitions & Appendix UNMAPPED_WAT (\ref{app:fepsde-matrix}) & Teil I \\
...
Social, Digital, Ecological. Defined in Appendix UNMAPPED_WAT (\ref{app:fepsde-matrix}).
...
source tiers, and epistemic status. Central reference in Appendix UNMAPPED_EST.
...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black, 
    title=\textbf{Appendix UNMAPPED_EST Summary: The Epistemics of Numbers}]
...
The following elements from Appendix UNMAPPED_EST are \textbf{foundational} for the 
