...
\item For proofs: See Appendix UNMAPPED_PRF (FORMAL-PROOF)
\end{itemize}
...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=Quick Reference: Appendix UNMAPPED_CIA]
...
\textbf{Cross-References:} Appendix UNMAPPED_HOW (CORE-HOW), Appendix CTW (CORE-WHEN),
Appendix HAI1 (DOMAIN-MACRO), Appendix UNMAPPED_ACE (LIT-THALER)
\end{tcolorbox}
...
\begin{tcolorbox}[colback=green!10!white, colframe=green!75!black,
    title=\textbf{Appendix UNMAPPED_CIA: Summary}]
...
\textbf{Integration:} This appendix connects to Appendix UNMAPPED_HOW (CORE-HOW) via
...
\begin{table}[htbp]
\centering
\caption{Symbols Introduced in Appendix UNMAPPED_CIA}
\label{tab:Y-symbols}
\renewcommand{\arraystretch}{1.3}
...
Appendix UNMAPPED_ACE (LIT-THALER: Behavioral Economics).
