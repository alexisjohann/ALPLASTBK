...
\textbf{In-Scope:}
\begin{itemize}[nosep]
    \item Appendix UNMAPPED_EST: The Epistemics of Parameter Estimation
    \item Theory
    \item Results
\end{itemize}
...
\begin{itemize}[nosep]
    \item CORE-HOW: $\Gamma$ structure $\rightarrow$ Appendix UNMAPPED_HOW
    \item CORE-WHEN: $\Psi$ dimensions $\rightarrow$ Appendix CTW
    \item Empirical Operationalization $\rightarrow$ Appendix UNMAPPED_OPS
    \item Central Glossary and Notation $\rightarrow$ Appendix UNMAPPED_GLS
    \item METHOD-EVIDENCE $\rightarrow$ Appendix XX
\end{itemize}
...
\section{Appendix UNMAPPED_EST: The Epistemics of Parameter Estimation}
...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=\textbf{Appendix UNMAPPED_EST: CORE-WHERE}]

\begin{tabular}{@{}ll@{}}
\textbf{Appendix:} & BBB (Parameter Estimation Methodology) \\
\textbf{Category:} & CORE (5th of 10C Framework) \\
\textbf{Scope:} & Complete epistemological framework for EBF parameters \\
\textbf{Version:} & 2.0 \\
\textbf{Last Updated:} & January 2026 \\
\textbf{Dependencies:} & Appendix UNMAPPED_HOW (CORE-HOW: $\Gamma$ structure) \\
                       & Appendix CTW (CORE-WHEN: $\Psi$ dimensions) \\
                       & Appendix LLM1 (METHOD-LLMMC: Synthetic estimation) \\
...
\begin{itemize}[nosep]
    ...
    \item For LLM estimation: See Appendix LLM1 (METHOD-LLMMC)
\end{itemize}
...
connecting Appendix LLM1 (LLM Monte Carlo), Appendix UNMAPPED_OPS (Empirical Operationalization),
...
\midrule
\textbf{Tier 1} & Hard Empirical & Direct measurement, RCTs, natural experiments & Highest & Appendix UNMAPPED_OPS \\
\textbf{Tier 2} & Meta-Analytical & Systematic review, Bayesian synthesis & High & Chapter 4 \\
\textbf{Tier 3} & Synthetic Priors & LLM Monte Carlo, expert elicitation & Moderate & Appendix LLM1 \\
\bottomrule
\end{tabular}
...
\begin{enumerate}
    \item Generated via LLM Monte Carlo simulation (see Appendix LLM1)
...
See Appendix LLM1 for full details. Summary:
...
See Appendix LLM1 for complete technical details.
...
\subsubsection{Axiom Index for Appendix UNMAPPED_EST}
...
\bottomrule
\end{tabular}
\caption{Axiom index for Appendix UNMAPPED_EST}
...
\begin{table}[htbp]
\centering
\caption{Summary of Key Results in Appendix UNMAPPED_EST}
...
\begin{itemize}[nosep]
    \item 1000 LLM draws using Appendix LLM1 protocol
...
\midrule
$\gamma_{dd'}$ & Utility-utility complementarity & Appendix UNMAPPED_HOW \\
$\lambda_{kl}$ & Context-context interaction & Appendix CTW \\
...
\textbf{See also:} Appendix UNMAPPED_GLS (Central Glossary and Notation) for complete symbol definitions; Appendix XX (METHOD-EVIDENCE) for evidence tier classification criteria.
...
The Level-$k$ distribution provides the following constraints for Appendix UNMAPPED_AWA parameters:
...
\begin{itemize}[nosep]
    \item \textbf{Appendix UNMAPPED_AWA:} Uses Level-$k$ $\leftrightarrow$ $A(\cdot)$ mapping for AWX axioms
    \item \textbf{Appendix UNMAPPED_EXP:} Beauty Contest experiments in Paradigm 8 (Beliefs)
    \item \textbf{Appendix UNMAPPED_MSC:} Full treatment of Mauersberger \& Nagel (2018), Section 11
\end{itemize}
...
\subsection{References for Appendix UNMAPPED_EST}
...
\textbf{Depends on:}
\begin{itemize}[nosep]
    \item Appendix UNMAPPED_HOW (CORE-HOW): $\Gamma$ complementarity structure
    \item Appendix UNMAPPED_WAT (CORE-WHAT): FEPSDE dimensions for $\gamma_{dd'}$
    \item Appendix CTW (CORE-WHEN): $\Psi$ dimensions for context modulation
    \item Appendix LLM1 (METHOD-LLMMC): Tier 3 estimation methodology
\end{itemize}
...
\begin{itemize}[nosep]
    ...
    \item Appendix UNMAPPED_SUN (PREDICT): Parameters for falsifiable predictions
    \item Appendix UNMAPPED_VC (METHOD-VALIDATE): Parameter consistency validation (DCV-3, DCV-4)
\end{itemize}

\textbf{Reading Path:}
$\rightarrow$ Chapter 4 (overview) $\rightarrow$ This Appendix (methodology)
$\rightarrow$ Appendix LLM1 (LLM-MC details) $\rightarrow$ Appendix UNMAPPED_OPS (data sources)
