...
\chapter*{Appendix FI: Urs Fischbacher Research Integration}
\addcontentsline{toc}{chapter}{Appendix FI: LIT-FISCHBACHER - Conditional Cooperation \& Experimental Methods}
...
\begin{itemize}
    ...
    \item Appendix B (CORE-HOW): Complementarity in social interaction
\end{itemize}
...
\begin{itemize}
    ...
    \item Appendix AU (CORE-AWARE): Awareness in cooperation decisions
\end{itemize}
...
\begin{itemize}
    ...
    \item Appendix SU (LIT-SUTTER): Team decision making
\end{itemize}
\end{tcolorbox}
...
% ============================================================================
\begin{abstract}
This appendix integrates Urs Fischbacher's research on conditional cooperation, experimental methodology, and social norms into the Evidence-Based Framework. Fischbacher's work establishes that cooperation types are heterogeneous and measurable: approximately 50\% are conditional cooperators, 30\% free-riders, and 14\% unconditional cooperators. His creation of z-Tree revolutionized experimental economics methodology. We formalize six core axioms (FI-1 to FI-6) connecting cooperation dynamics to EBF. Key parameters include conditional cooperation slope ($\beta_{CC} \approx 0.5$), cooperation decay rate, and partial lying prevalence. Co-author with Ernst Fehr on foundational social preferences papers.
\end{abstract}
...
\subsection{Axiom FI-1: Cooperation Type Heterogeneity}

\begin{tcolorbox}[colback=blue!5!white,colframe=blue!75!black,title=Axiom FI-1: Cooperation Type Heterogeneity]
...
\subsection{Axiom FI-2: Conditional Cooperation Function}

\begin{tcolorbox}[colback=blue!5!white,colframe=blue!75!black,title=Axiom FI-2: Conditional Cooperation Function]
...
\subsection{Axiom FI-3: Belief-Driven Dynamics}

\begin{tcolorbox}[colback=blue!5!white,colframe=blue!75!black,title=Axiom FI-3: Belief-Driven Cooperation Decay]
...
\subsection{Axiom FI-4: Third-Party Punishment}

\begin{tcolorbox}[colback=blue!5!white,colframe=blue!75!black,title=Axiom FI-4: Third-Party Punishment]
...
\subsection{Axiom FI-5: Partial Dishonesty}

\begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=Axiom FI-5: Partial Dishonesty]
...
\subsection{Axiom FI-6: Strategy Method Validity}

\begin{tcolorbox}[colback=green!5!white,colframe=green!75!black,title=Axiom FI-6: Strategy Method Validity]
