...
% Category: METHOD
% Version: 2.2 (January 2026) - Theoretical foundation refactored to CORE-EIT (Appendix UNMAPPED_IE)
% Status: Final
% Language: English
%
% SEPARATION OF CONCERNS (v2.2):
% - Appendix UNMAPPED_IE (CORE-EIT): Theoretical foundation (Axioms EIT-1 to EIT-5, Emergence Modes)
% - This appendix (HHH): Operational tools (20-Field Schema, A1-A8, LLMMC protocols)
%
% NOTE: Axioms EIT-1 to EIT-5 and Emergence Mode theory are now canonical in Appendix UNMAPPED_IE.
...
Emergence Modes E-Full/E-Partial/E-None, Data Sufficiency) is now canonical in Appendix UNMAPPED_IE.
...
\item For portfolio design: See Chapter 20 (incl.\ Sec.\ 20-hierarchical for Strategic/Tactical/Operative optimization with C1--C6 constraints) and Appendix UNMAPPED_PAP (FORMAL-EQUILIBRIA)
\end{itemize}
...
\begin{itemize}[nosep]
    \item CORE-EIT $\rightarrow$ Appendix UNMAPPED_IE
...
\end{equation}
where each $I_d \in [0,1]$ indicates intensity on that 10C dimension. See Appendix UNMAPPED_IE (CORE-EIT), Axiom EIT-3.
\end{tcolorbox}
...
Following Appendix UNMAPPED_FRM, the continuous space framework \textit{preserves} the Exclusion Principle:
...
\begin{tcolorbox}[colback=red!5!white, colframe=red!75!black,
    title=\textbf{Foundation: Theory in Appendix UNMAPPED_IE (CORE-EIT)}]

The following emergence functions are the theoretical foundation for determining which components of $\vec{I}$ should be high-intensity. Three axioms have been fully formalized in Appendix UNMAPPED_IE:
...
\midrule
EIT-6 & $I_{\text{AWARE}}$ & Appendix UNMAPPED_IE, Sec. \ref{sec:ie-axiom-6} \\
EIT-7 & $I_{\text{READY}}$ & Appendix UNMAPPED_IE, Sec. \ref{sec:ie-axiom-7} \\
EIT-8 & $I_{\text{WHEN}}$ & Appendix UNMAPPED_IE, Sec. \ref{sec:ie-axiom-8} \\
EIT-9 & $I_{\text{WHO}}$ & Appendix UNMAPPED_IE, Sec. \ref{sec:ie-axiom-9} \\
EIT-10 & $I_{\text{WHAT}}$ & Appendix UNMAPPED_IE, Sec. \ref{sec:ie-axiom-10} \\
EIT-11 & $I_{\text{HOW}}$ & Appendix UNMAPPED_IE, Sec. \ref{sec:ie-axiom-11} \\
EIT-12 & $I_{\text{WHERE}}$ & Appendix UNMAPPED_IE, Sec. \ref{sec:ie-axiom-12} \\
EIT-13 & $I_{\text{HIERARCHY}}$ & Appendix UNMAPPED_IE, Sec. \ref{sec:ie-axiom-13} \\
\bottomrule
\end{tabular}
\end{center}
...
%------------------------------------------------------------------------------
\subsection{Quick Reference: Master Matrix (Appendix UNMAPPED_IE)}
%------------------------------------------------------------------------------

\textbf{For practitioners seeking a one-page overview of all 8 emergence functions,} see \textbf{Appendix UNMAPPED_IE (CORE-EIT), Table: ``Master Matrix: 8 Emergence Functions (EIT-6 through EIT-13)''}
...
\item Jump directly to the detailed axiom section in Appendix UNMAPPED_IE
\end{enumerate}

%------------------------------------------------------------------------------
\subsection{Axioms EIT-6, EIT-7, EIT-8: Fully Formalized in Appendix UNMAPPED_IE}
%------------------------------------------------------------------------------

\textbf{These three axioms are canonical in Appendix UNMAPPED_IE and govern the intensity of awareness-raising, willingness-building, and context-based interventions:}
...
\item \textbf{EIT-6 (Awareness-Targeting):} $I_{\text{AWARE}} = f_{\text{AWARE}}(A_0)$
  ...
  \item See Appendix UNMAPPED_IE, Axiom EIT-6, for full formalization and validation
  \end{itemize}
...
\item \textbf{EIT-7 (Willingness-Targeting):} $I_{\text{READY}} = f_{\text{READY}}(W_0, A_0)$
  ...
  \item See Appendix UNMAPPED_IE, Axiom EIT-7, for full formalization and validation
  \end{itemize}
...
\item \textbf{EIT-8 (Context-Targeting):} $I_{\text{WHEN}} = f_{\text{WHEN}}(\Psi, W_0)$
  ...
  \item See Appendix UNMAPPED_IE, Axiom EIT-8, for full formalization and validation
  \end{itemize}
\end{itemize}
...
\textbf{Axiom EIT-9 (from Appendix UNMAPPED_IE):} The intensity of welfare-level interventions emerges from the mismatch between current welfare level $L$ and goal level $L_{\text{goal}}$:
...
\textbf{See:} Appendix UNMAPPED_IE (CORE-EIT), Subsection ``Axiom EIT-9: I_WHO Emergence from Welfare Level Targeting''
...
\textbf{Axiom EIT-10 (from Appendix UNMAPPED_IE):} Dimension-targeting intensity emerges from mismatch between current and goal utility dimensions, modulated by complementarity structure:
...
\textbf{See:} Appendix UNMAPPED_IE (CORE-EIT), Subsection ``Axiom EIT-10: I_WHAT Emergence from Utility Dimension Targeting''
...
\textbf{Axiom EIT-11 (from Appendix UNMAPPED_IE):} Complementarity-reshaping intensity emerges from current and goal complementarity structure, modulated by feasibility:
...
\textbf{See:} Appendix UNMAPPED_IE (CORE-EIT), Subsection ``Axiom EIT-11: I_HOW Emergence from Complementarity Reshaping''
...
\textbf{Axiom EIT-12 (from Appendix UNMAPPED_IE):} Parameter-gathering intensity emerges from data availability, decision-value of better data, and collection cost:
...
\textbf{See:} Appendix UNMAPPED_IE (CORE-EIT), Subsection ``Axiom EIT-12: I_WHERE Emergence from Data Investment Intensity''
...
\textbf{Axiom EIT-13 (from Appendix UNMAPPED_IE):} Hierarchy-shifting intensity emerges from scope-distance between current and goal decision levels, modulated by urgency and resources:
...
\textbf{See:} Appendix UNMAPPED_IE (CORE-EIT), Subsection ``Axiom EIT-13: I_HIERARCHY Emergence from Temporal Scope Intensity''
...
\begin{tcolorbox}[colback=green!10!white, colframe=green!75!black,
    title=\textbf{Appendix TKT: Summary (v2.0 --- Emergent Intervention Theory)}]
...
Consult the Master Matrix in Appendix UNMAPPED_IE to find:
\begin{itemize}[nosep]
...
\textbf{Data sources:} See Appendix UNMAPPED_BBB (WHERE — Parameters) for typical parameter values by domain.

\subsection{Step 5: Calculate Component Intensity}

Use the formal axiom definition from Appendix UNMAPPED_IE to calculate each component's intensity:
...
\textbf{Appendix UNMAPPED_DP (REF-DEVPIPE: Developer Pipeline --- Stage 4: Intervention Design)}.
