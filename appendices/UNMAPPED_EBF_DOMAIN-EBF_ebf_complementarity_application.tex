...
%   - Appendix UNMAPPED_DFN (DOMAIN-FOUND): Domain foundations
%   - Appendix UNMAPPED_HOW (CORE-HOW): Interaction structure
...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=Quick Reference: Appendix UNMAPPED_EBF]

\textbf{Appendix:} EBF (DOMAIN)
...
\begin{itemize}[nosep]
    \item Formalize and document the key concepts of EBF Complementarity Application
\end{itemize}
...
\textbf{How does ebf complementarity application integrate with and contribute to the
...
From CORE-WHAT (Appendix UNMAPPED_WAT), utility decomposes into six dimensions:
\begin{itemize}[noitemsep]
...
Following the EBF Intervention Toolkit (Appendix TKT), we classify interventions:
...
From CORE-STAGE (Appendix UNMAPPED_STA), the BCJ has five phases:
\begin{enumerate}[noitemsep]
...
From CORE-WHEN (Appendix CTW), context $\Psi$ modulates all parameters:
\begin{equation}
...
LLM Monte Carlo (Appendix LLM1) & Medium & Gap-filling \\
\bottomrule
\end{tabular}
\end{table}
...
\label{sec:ebf-axioms}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\begin{tcolorbox}[colback=yellow!5!white,colframe=yellow!75!black,title=Axiom UNMAPPED_EBF-1: Fundamental Principle]
\textbf{Axiom UNMAPPED_EBF-1 (Core Assumption):}
...
\begin{tcolorbox}[colback=yellow!5!white,colframe=yellow!75!black,title=Axiom UNMAPPED_EBF-2: Complementarity]
\textbf{Axiom UNMAPPED_EBF-2 (Complementarity):}
...
\begin{table}[h]
\centering
\caption{Complementarity Integration with 10C}
...
\begin{itemize}[noitemsep]
    ...
    \item Integrated with 10C CORE framework
