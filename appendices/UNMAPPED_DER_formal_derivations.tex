...
\begin{itemize}[nosep]
    ...
    \item complementarity details $\rightarrow$ Appendix UNMAPPED_HOW
    \item proofs $\rightarrow$ Appendix UNMAPPED_PRF
\end{itemize}
...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=\textbf{Appendix UNMAPPED_DER: FORMAL-LIMITS}]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% SECTION 7: TIME ALLOCATION THEORY (UNMAPPED_CAT-17)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\citet{becker1965theory} extends classical consumer theory by treating time as a scarce resource.
...
\citet{goodman2026timeintensive} extend Becker's framework to digital platforms.
...
\begin{table}[htbp]
\centering
\caption{Summary of Formal Results in Appendix UNMAPPED_DER}
\label{tab:A-results}
\renewcommand{\arraystretch}{1.2}
...
\subsection{References for Appendix UNMAPPED_DER}
...
$\rightarrow$ Appendix UNMAPPED_HOW (complementarity details) $\rightarrow$ Appendix UNMAPPED_PRF (proofs)
