...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=\textbf{Appendix UNMAPPED_PAP3: LIT-PARADIGMS}]
...
\textbf{Dependencies:} & Appendix UNMAPPED_PRF (FORMAL-CSTAR) \\
                       & Appendix UNMAPPED_CAM (REF-META) \\
...
\begin{itemize}[nosep]
    ...
    \item \citet{thaler1980toward}: Mental Accounting
    \item \citet{camerer2003behavioral}: Behavioral Game Theory
\end{itemize}
...
\textbf{Key Works:}
\begin{itemize}[nosep]
    \item \citet{north1990institutions}: Institutions as rules of the game
...
\begin{itemize}[nosep]
    ...
    \item \citet{merton1968social}: Social Theory and Social Structure
\end{itemize}
...
\begin{itemize}[nosep]
    ...
    \item \citet{becker1976economic}: The Economic Approach to Human Behavior
\end{itemize}
...
Appendix UNMAPPED_PRF proves that $C^*$ is an ESS for complementarity beliefs.
...
\paragraph{Connection to Appendix UNMAPPED_PRF (FORMAL-CSTAR).}
AY provides the intellectual context for why $C^*$ is derived as a fixed point
rather than assumed. Appendix UNMAPPED_PRF provides the formal mathematics that AY surveys
across paradigms.

\paragraph{Connection to Appendix UNMAPPED_CAM (REF-META).}
AY's taxonomy of reference point types (exogenous, endogenous, optimization,
normative) builds on the metatheoretical foundations in Appendix UNMAPPED_CAM.
...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=\textbf{Appendix UNMAPPED_PAP3 Summary: LIT-PARADIGMS}]
...
\textbf{Appendix UNMAPPED_GLS} (\textit{REF-GLOSSARY}).
...
\begin{table}[htbp]
\centering
\caption{Symbols in Appendix UNMAPPED_PAP3}
...
\begin{table}[htbp]
\centering
\caption{Research Roadmap for Appendix UNMAPPED_PAP3}
...
\subsection{References for Appendix UNMAPPED_PAP3}
...
\begin{itemize}[nosep]
    ...
    \item \citet{north1990institutions}: Institutions, Institutional Change
\end{itemize}
...
\textbf{Appendix UNMAPPED_GLS} (REF-GLOSSARY).
\end{tcolorbox}
...
\textbf{Depends on:}
\begin{itemize}[nosep]
    \item Appendix UNMAPPED_PRF (FORMAL-CSTAR): $C^*$ derivation
    \item Appendix UNMAPPED_GLS (REF-GLOSSARY): Symbol definitions
    \item Appendix UNMAPPED_CAM (REF-META): Metatheoretical foundations
\end{itemize}
...
$\rightarrow$ Appendix UNMAPPED_PRF (formal $C^*$) $\rightarrow$ Chapter 6 (application)
