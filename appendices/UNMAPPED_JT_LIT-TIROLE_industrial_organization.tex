...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=Quick Reference: Appendix UNMAPPED_JT]
...
% ============================================================================
\begin{abstract}
This appendix integrates Jean Tirole's foundational contributions to economics into the EBF framework. Tirole (Nobel Prize 2014) revolutionized our understanding of market power, regulation, platform economics, and the interaction between intrinsic and extrinsic motivation. His work with Roland Bénabou on behavioral industrial organization provides crucial bridges between traditional IO and behavioral economics. The EBF framework incorporates Tirole's insights through six axioms (UNMAPPED_JT-1 to UNMAPPED_JT-6) that formalize two-sided market dynamics, regulatory design under asymmetric information, motivation crowding, and corporate governance. Key contributions include the theory of two-sided markets ($\pi = (p_1 - c_1)D_1 + (p_2 - c_2)D_2$ with $D_i(p_1, p_2)$), the Laffont-Tirole regulatory framework, and the Bénabou-Tirole model of intrinsic motivation crowding.
\end{abstract}
...
\begin{itemize}[nosep]
    ...
    \item REF-GLOSSARY $\rightarrow$ Appendix G
    \item DOMAIN-IO $\rightarrow$ Appendix UNMAPPED_IOO
\end{itemize}
...
Tirole's work with Rochet \citep{rochet2003platform, rochet2006two} revolutionized our understanding of platforms:
...
\label{ax:jt-1}
\textbf{UNMAPPED_JT-1:} In two-sided markets, optimal pricing does not equate price to marginal cost on each side. Instead, platforms subsidize the side with stronger cross-side externalities:
\begin{equation}
...
\textbf{EBF Integration:} Axiom UNMAPPED_JT-1 connects to CORE-HOW (B) through complementarity---user value depends on other-side participation. It connects to CORE-WHO (AAA) through multi-stakeholder welfare: platform, side 1 users, side 2 users, and society.
...
The Laffont-Tirole framework \citep{laffont1993theory} addresses regulation when firms have private information:
...
\label{ax:jt-2}
\textbf{UNMAPPED_JT-2:} Optimal regulation trades off allocative efficiency against information rents:
\begin{equation}
...
\textbf{EBF Integration:} Axiom UNMAPPED_JT-2 connects to CORE-AWARE (AU) through information asymmetries and to CORE-WHEN (V) through context-dependent regulatory design. The key insight: one-size-fits-all regulation is suboptimal when firms differ in unobservable characteristics.

\subsection{Regulatory Capture}
\label{subsec:jt-capture}

Tirole's work on regulatory capture \citep{laffont1991politics} formalizes how interest groups influence regulation:
...
\label{ax:jt-3}
\textbf{UNMAPPED_JT-3:} Regulatory capture is more likely when:
\begin{enumerate}
...
\textbf{EBF Integration:} Axiom UNMAPPED_JT-3 connects to CORE-WHO (AAA) through the multi-level welfare problem: regulator welfare vs. public welfare vs. firm welfare.

\subsection{Intrinsic and Extrinsic Motivation}
\label{subsec:jt-motivation}

The Bénabou-Tirole framework \citep{benabou2003intrinsic, benabou2006incentives} integrates behavioral insights into incentive theory:
...
\label{ax:jt-4}
\textbf{UNMAPPED_JT-4:} Extrinsic incentives can crowd out intrinsic motivation when they signal the principal's beliefs about the agent:
\begin{equation}
...
The Bénabou-Tirole work on identity \citep{benabou2011identity, benabou2016mindful} shows how beliefs serve as assets:
...
\label{ax:jt-5}
\textbf{UNMAPPED_JT-5:} Agents may distort beliefs when beliefs provide anticipatory utility or motivation benefits:
\begin{equation}
...
\textbf{EBF Integration:} Axiom UNMAPPED_JT-5 connects to CORE-AWARE (AU) through the gap between objective information and subjective awareness. It explains why information alone often fails to change behavior---beliefs are maintained because they serve psychological functions.

\subsection{Corporate Governance and Stakeholders}
\label{subsec:jt-governance}

Tirole's work on corporate governance \citep{tirole2001corporate} extends beyond shareholder value:
...
\label{ax:jt-6}
\textbf{UNMAPPED_JT-6:} Optimal corporate governance balances stakeholder interests based on:
\begin{enumerate}
...
\textbf{EBF Integration:} Axiom UNMAPPED_JT-6 connects directly to CORE-WHO (AAA) through the welfare hierarchy---firm-level welfare aggregates employee, shareholder, customer, and community welfare.
...
\begin{tabular}{llcc}
\toprule
\textbf{Platform} & \textbf{Finding} & \textbf{UNMAPPED_JT-1 Support} & \textbf{Evidence Tier} \\
\midrule
...
\begin{tabular}{llcc}
\toprule
\textbf{Study} & \textbf{Finding} & \textbf{UNMAPPED_JT-4 Support} & \textbf{Evidence Tier} \\
\midrule
...
\begin{tabular}{llcc}
\toprule
\textbf{Case} & \textbf{Finding} & \textbf{UNMAPPED_JT-2/3 Support} & \textbf{Evidence Tier} \\
\midrule
...
\textbf{Tirole Two-Sided Pricing (UNMAPPED_JT-1):}
\begin{enumerate}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{1982: On the Possibility of Speculation under Rational Expectation...}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Jean Tirole (1982). ``On the Possibility of Speculation under Rational Expectations.'' \textit{Econometrica}, 50.

\paragraph{10C Integration.}
\begin{itemize}[nosep]
  \item \textbf{Domain}: [To be specified]
  \item \textbf{use\_for}: LIT-TIROLE
\end{itemize}


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{1985: Asset Bubbles and Overlapping Generations}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Jean Tirole (1985). ``Asset Bubbles and Overlapping Generations.'' \textit{Econometrica}, 53.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{1999: Incomplete Contracts: Where Do We Stand?}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Jean Tirole (1999). ``Incomplete Contracts: Where Do We Stand?.'' \textit{Econometrica}, 67.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2010: The Contribution of Economics to Climate Policy}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Jean Tirole (2010). ``The Contribution of Economics to Climate Policy.'' \textit{TSE Working Papers}.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2011: Illiquidity and All Its Friends}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Jean Tirole (2011). ``Illiquidity and All Its Friends.'' \textit{Journal of Economic Literature}, 49.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2012: Overcoming Adverse Selection: How Public Intervention Can Re...}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Jean Tirole (2012). ``Overcoming Adverse Selection: How Public Intervention Can Restore Market Functioning.'' \textit{American Economic Review}, 102.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2017: Economics for the Common Good}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Jean Tirole (2017). \textit{Economics for the Common Good}. Publisher.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2021: Digital Dystopia}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Jean Tirole (2021). ``Digital Dystopia.'' \textit{American Economic Review}, 111.
...
\begin{enumerate}
    \item \textbf{UNMAPPED_JT-1 (Two-Sided Markets):} Platform pricing subsidizes the side with stronger cross-side externalities
    \item \textbf{UNMAPPED_JT-2 (Regulation):} Optimal regulation trades off efficiency against information rents
    \item \textbf{UNMAPPED_JT-3 (Capture):} Concentrated interests and information asymmetries enable capture
    \item \textbf{UNMAPPED_JT-4 (Crowding):} Extrinsic incentives can crowd out intrinsic motivation via signaling
    \item \textbf{UNMAPPED_JT-5 (Beliefs):} Agents maintain motivated beliefs that serve psychological functions
    \item \textbf{UNMAPPED_JT-6 (Governance):} Multi-stakeholder governance allocates control based on contractibility
\end{enumerate}
...
See Appendix G (REF-GLOSSARY) for term definitions and Appendix UNMAPPED_IOO (DOMAIN-IO) for industrial organization applications.
