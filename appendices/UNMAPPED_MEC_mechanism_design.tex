...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=Quick Reference: Appendix UNMAPPED_MEC]
\textbf{Appendix:} MEC (FORMAL)
...
in the FORMAL domain. It synthesizes literature relevant to the Evidence-Based
...
\begin{itemize}[nosep]
    \item Synthesize key research findings for FORMAL integration
\end{itemize}
...
\begin{table}[htbp]
\centering
\caption{Key Symbols in Appendix UNMAPPED_MEC}
\begin{tabular}{lll}
\toprule
