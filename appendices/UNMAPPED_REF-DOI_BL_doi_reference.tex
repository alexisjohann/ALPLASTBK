...
\begin{itemize}[noitemsep]
    ...
    \item Appendix UNMAPPED_BBB (CORE-WHERE) -- Parameter sources from literature
    \item Appendix UNMAPPED_MS (REF-MODELSPACE) -- Theory catalog with paper references
\end{itemize}
...
\begin{itemize}[noitemsep]
    ...
    \item Appendix UNMAPPED_BBB (CORE-WHERE) for parameter source references
    \item Appendix UNMAPPED_MS (REF-MODELSPACE) for theory-paper linkages
\end{itemize}
