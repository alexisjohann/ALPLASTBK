...
%
% DEPENDENCIES:
% - Appendix UNMAPPED_AU (CORE-AWARE): Awareness framework
...
\item For cross-cultural validation: See Appendix UNMAPPED_BJ
\end{itemize}
...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=Quick Reference: Appendix UNMAPPED_ENK]
...
\begin{itemize}[nosep]
    ...
    \item Cross-cultural validation details $\rightarrow$ Appendix UNMAPPED_BJ (DOMAINVAL)
...
Enke's research on ancestral kinship \citep{enke2017ancestral, enke2022preferences}
...
\begin{tcolorbox}[colback=green!10!white, colframe=green!75!black,
    title=\textbf{Appendix UNMAPPED_ENK: Summary}]
...
\begin{table}[htbp]
\centering
\caption{Symbols in Appendix UNMAPPED_ENK}
...
Appendix UNMAPPED_BJ (METHOD-DOMAINVAL).
