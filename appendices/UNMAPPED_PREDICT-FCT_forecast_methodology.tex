...
\begin{itemize}
    ...
    \item Appendix UNMAPPED_BBB (CORE-WHERE): Parameter sources
    \item Appendix UNMAPPED_LLM (METHOD-LLMMC): LLM Monte Carlo estimation
    \item Appendix UNMAPPED_MS (REF-MODELSPACE): Theory catalog
\end{itemize}
...
\begin{itemize}
    ...
    \item Parameter estimation (see Appendix UNMAPPED_LLM: METHOD-LLMMC)
...
\begin{enumerate}
    ...
    \item \textbf{EBF Context Framework} (Appendix UNMAPPED_V): $\Psi$-dimensions affect forecast parameters
\end{enumerate}
