...
\subsection{WHO (Appendix UNMAPPED_WHO): Levels and Segment Distributions}
...
\subsection{WHAT (Appendix UNMAPPED_WAT): Utility Dimensions Drive Clustering}
...
\subsection{HOW (Appendix UNMAPPED_HOW): Complementarities Shape Preference Prototypes}
...
\subsection{WHERE (Appendix UNMAPPED_EST): Parameters Estimated Per Cluster}
...
\subsection{AWARE (Appendix UNMAPPED_AWA): Awareness Creates Cluster Visibility}
...
\subsection{READY (Appendix UNMAPPED_REA): Willingness Operates Within and Across Clusters}
...
\subsection{STAGE (Appendix UNMAPPED_STA): Behavioral Change Journey Differs By Cluster}
...
Appendix TKT Axiom HHH-A5 (Segment Specificity) formalizes what BA establishes empirically:
...
\textbf{Cross-Reference:} See Appendix TKT Section 4 (Axiom HHH-A5) for formal specification.
...
\cite{nosek2018registered, collaboration2015estimating}
...
\cite{camerer2018evaluatingevaluating, collaboration2015estimating, nosek2015promoting}
...
\begin{itemize}[nosep]
\item \textbf{Appendix UNMAPPED_STA} (CORE-STAGE): BCJ dynamics differ by cluster
\item \textbf{Appendix UNMAPPED_REA} (CORE-READY): Willingness thresholds differ by cluster
\item \textbf{Appendix UNMAPPED_AWA} (CORE-AWARE): Awareness distributions shape clustering
\item \textbf{Appendix UNMAPPED_WAT} (CORE-WHAT): Utility dimensions define clustering space
\item \textbf{Appendix CTW} (CORE-WHEN): Context modulates cluster structure
\item \textbf{Appendix TKT} (REF-SEGMENTATION-HEURISTICS): Quick decision guides for practitioners
...
\item \textbf{Appendix TKT}: For theoretical foundations of diagnostic heuristics
