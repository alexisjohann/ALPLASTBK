...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=\textbf{Appendix MS: REF-MODELSPACE}]
...
\begin{itemize}[nosep]
    \item Formal mathematical proofs $\rightarrow$ Appendix DER (FORMAL-LIMITS)
    \item Model design workflow $\rightarrow$ Appendix DSN (METHOD-DESIGN)
    \item Custom model storage $\rightarrow$ Appendix REG (METHOD-REGISTRY)
...
\hline
\texttt{id: MS-RD-001} & \texttt{@article\{kahneman1979prospect,} \\
\texttt{name: Prospect Theory} & \texttt{  theory\_support = \{MS-RD-001, MS-RD-002\},} \\
\texttt{bib\_keys: [kahneman1979prospect]} & \texttt{  ...\}} \\
\hline
\end{tabular}
\end{center}
...
\begin{itemize}[nosep]
    ...
    \item \texttt{python scripts/theory\_papers.py --paper kahneman1979prospect} \\
...
\begin{tcolorbox}[colback=green!5!white, colframe=green!75!black,
    title=\textbf{Axiom MS-0: The Organizing Metatheory Principle}]
...
\begin{enumerate}
    \item \textbf{Practitioner Perspective:} Use 10C dimensions directly to
          ...
          \begin{itemize}[nosep]
              \item Workflow: Appendix DSN (METHOD-DESIGN)
              \item Storage: Appendix REG (METHOD-REGISTRY)
          \end{itemize}
    ...
    \item \textbf{Scientist Perspective:} Understand how established theories
          ...
          \begin{itemize}[nosep]
              ...
              \item Proofs: Appendix DER (FORMAL-LIMITS)
          \end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{8 categories} have formal proofs in Appendix DER
...
\begin{enumerate}
    ...
    \item \textbf{Formal Proofs:} See Appendix DER for mathematical derivations.
\end{enumerate}

\subsection{For Hybrid Users (Practitioner + Scientist)}

\begin{enumerate}
    \item \textbf{Design model} using 10C (Appendix DSN).
...
\begin{enumerate}
    \item \textbf{Formal Proofs:} Categories 9-13 (Behavioral Finance, Nudge,
          ...
          Appendix DER. Future work should extend the limiting case proofs.
