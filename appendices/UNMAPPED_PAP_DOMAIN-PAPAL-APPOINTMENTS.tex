...
\title{\textbf{Appendix UNMAPPED_PAP: DOMAIN-PAPAL-APPOINTMENTS} \\ Cardinal Appointments as Structural Determinants of Papal Succession \\ Integration with PSF 2.0 Complementarity Parameters}
...
\begin{tcolorbox}[colback=yellow!5!white,colframe=yellow!75!black,title=Axiom UNMAPPED_PAP-1: Fundamental Principle]
\textbf{Axiom UNMAPPED_PAP-1 (Core Assumption):}
...
\begin{tcolorbox}[colback=yellow!5!white,colframe=yellow!75!black,title=Axiom UNMAPPED_PAP-2: Complementarity]
\textbf{Axiom UNMAPPED_PAP-2 (Complementarity):}
...
See Appendix UNMAPPED_GLS (Central Glossary) for full symbol definitions. \href{https://github.com/FehrAdvice-Partners-AG/complementarity-context-framework/appendices/G_glossary.tex}{Link to Appendix UNMAPPED_GLS}.
...
\begin{itemize}
\item Appendix UNMAPPED_PAP3: DOMAIN-PAPAL-SUCCESSION (PSF 2.0 framework)
\item Appendix UNMAPPED_PAP2: DOMAIN-PAPAL-HISTORICAL (validation across 7 conclaves)
\item Appendix PAP1: DOMAIN-PAPAL-EXTENDED (pre-1958 validation)
\end{itemize}
...
$\Rightarrow$ Appendix UNMAPPED_PAP3 (PSF 2.0 Main Model) | Appendix UNMAPPED_PAP2 (Historical Validation) | Appendix PAP1 (Extended History) \\
...
\begin{table}[htbp]
\centering
\caption{Key Symbols in Appendix UNMAPPED_PAP}
\begin{tabular}{lll}
\toprule
