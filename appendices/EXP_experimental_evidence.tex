...
\begin{itemize}[nosep]
    ...
    \item Fehr literature $\rightarrow$ Appendix FEH
    \item calibration $\rightarrow$ Appendix EST
\end{itemize}
...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=\textbf{Appendix EXP: LIT-EVIDENCE}]
...
\citet{guth1982} (original); \citet{camerer2003} (meta-analysis);
...
\paragraph{Gneezy (2005) Deception Game \citep{gneezy2005}.}
...
\paragraph{Fischbacher-Föllmi-Heusi (2013) Die Roll \citep{fischbacher2013}.}
...
\paragraph{Meta-Analytic Findings \citep{abeler2019}.}
...
\paragraph{Key Citations.}
\citet{gneezy2005} (deception game); \citet{fischbacher2013} (die roll);
\citet{abeler2019} (meta-analysis); \citet{kajackas2009} (replication);
\citet{mazar2008} (self-concept maintenance).
...
\paragraph{Double Auction Experiments \citep{smith1962}.}
...
\paragraph{Induced Value Theory \citep{smith1976}.}
...
outcomes under different institutions \citep{smith1982institutions}:
\begin{center}
\small
\begin{tabular}{@{}lcc@{}}
\toprule
...
\paragraph{Constructivist vs.\ Ecological Rationality \citep{smith2003nobel}.}
...
\paragraph{Key Citations.}
\citet{smith1962} (double auction); \citet{smith1976} (induced value);
\citet{smith1982institutions} (institutions); \citet{smith1988bubbles} (bubbles);
\citet{smith2003nobel} (ecological rationality); \citet{plottsmith2008} (handbook).
...
\paragraph{Kidney Exchange \citep{roth2004kidney,roth2007efficient}.}
...
\citet{roth2007repugnance} (repugnance); \citet{roth2015gets} (popular account).
...
\paragraph{Van Huyck, Battalio, Beil Experiments \citep{vanhuyck1990,vanhuyck1991}.}
...
\paragraph{Schelling Focal Points \citep{schelling1960}.}
...
\paragraph{Key Citations.}
\citet{schelling1960} (focal points); \citet{vanhuyck1990,vanhuyck1991} (minimum effort);
\citet{cooper1992communication} (communication); \citet{mehta1994focal} (focal point experiments);
\citet{camerer2003} (behavioral game theory synthesis).
...
\paragraph{Reinforcement Learning \citep{rotherev1995,erevandorth1998}.}
...
\paragraph{Experience-Weighted Attraction \citep{camererho1999}.}
...
\paragraph{Key Citations.}
\citet{rotherev1995} (learning in extensive-form games); \citet{erevandorth1998}
(predicting behavior); \citet{camererho1999} (EWA); \citet{fudenberglevine1998}
(theory); \citet{camerer2003} (behavioral game theory synthesis).
...
The central theoretical result \citep{fudenbergmaskin1986}:
\begin{equation}
...
\paragraph{Axelrod's Tournaments \citep{axelrod1984}.}
...
\paragraph{Dal B\'{o} \& Fr\'{e}chette Experiments \citep{dalbo2011,dalbofrechette2018}.}
...
\paragraph{Key Citations.}
\citet{axelrod1984} (tournaments); \citet{fudenbergmaskin1986} (folk theorem);
\citet{dalbo2011,dalbofrechette2018} (experimental tests); \citet{camera2009}
...
\paragraph{Cognitive Hierarchy \citep{PAP-camerer2004cognitive}.}
...
\paragraph{Belief Elicitation \citep{costagomes2006}.}
...
\paragraph{Intentions and Belief-Dependent Preferences \citep{falkfehr2006}.}
...
\paragraph{Higher-Order Beliefs and Common Knowledge \citep{rubinstein1989}.}
...
\begin{itemize}[nosep]
    ...
    \item \textbf{Email game \citep{rubinstein1989}:} Shows common knowledge matters---even
    ...
    \item \textbf{Experimental finding:} Subjects struggle with higher-order reasoning;
          typically stop at 2nd order \citep{PAP-camerer2004cognitive}
\end{itemize}
\begin{equation}
...
\paragraph{Bayesian Updating in Strategic Settings \citep{nyarko1999}.}
...
\begin{itemize}[nosep]
    ...
    \item \textbf{Belief learning \citep{cheungfriedman1997}:} Estimate belief dynamics directly
...
\paragraph{Global Games and Coordination under Uncertainty \citep{carlssonvanDamme1993, morrishin2003}.}
...
\paragraph{Field Evidence for Beliefs \citep{dellavigna2009, levitt2007}.}
Laboratory findings on beliefs replicate in the field:
\begin{itemize}[nosep]
    \item \textbf{Financial markets:} Investor beliefs predict bubbles \citep{shiller2000};
          overconfidence drives excess trading \citep{barber2001}
    \item \textbf{Voting:} Beliefs about others' turnout affect own turnout \citep{dellavigna2009}
    \item \textbf{Charitable giving:} Beliefs about matching/seed money affect donations \citep{list2011}
    \item \textbf{Tax compliance:} Beliefs about audit probability and peer compliance matter \citep{hallsworth2017}
    \item \textbf{Workplace:} Beliefs about coworker effort affect own effort \citep{bandiera2010}
\end{itemize}
\textbf{Effect sizes:} Field effects typically 50-80\% of lab effects, but highly robust.

\paragraph{Neuroeconomic Evidence \citep{sanfey2003, singer2009}.}
...
\begin{itemize}[nosep]
    \item \textbf{Theory of Mind (ToM):} Medial prefrontal cortex (mPFC) activates when
          reasoning about others' beliefs \citep{frith2006}
...
\paragraph{Replication and Robustness \citep{camerer2016, camerer2018}.}
Belief-related findings show strong replicability:
\begin{itemize}[nosep]
    \item \textbf{Many Labs replication:} Level-k patterns replicate across 36 labs \citep{klein2018}
...
\paragraph{Key Citations.}
\citet{nagel1995unraveling} (beauty contest); \citet{PAP-camerer2004cognitive} (cognitive hierarchy);
\citet{costagomes2006} (belief elicitation); \citet{falkfehr2006} (intentions);
\citet{crawford2013structural} (structural estimation); \citet{rubinstein1989} (common knowledge);
\citet{morrishin2003} (global games); \citet{sanfey2003} (neuroeconomics);
\citet{camerer2016} (replication).
...
about behavioral economics. \citet{camerer2018} systematically replicated
...
\textbf{Response:} Field experiments replicate lab findings. \citet{levittlist2007}
...
\subsection{References for Appendix EXP}
...
\begin{itemize}[nosep]
    ...
    \item \citet{camerer2003}: Behavioral game theory synthesis
    \item \citet{camerer2018}: Replication project
    \item \citet{engel2011}: Dictator game meta-analysis
    \item \citet{levittlist2007}: Lab-field comparison
    \item \citet{alganandcahuc2010}: Inherited trust
\end{itemize}

\textbf{Honesty:}
\begin{itemize}[nosep]
    \item \citet{gneezy2005}: Deception games (foundational)
    \item \citet{fischbacher2013}: Die-roll paradigm
    \item \citet{abeler2019}: Meta-analysis of lying experiments
    \item \citet{mazar2008}: Self-concept maintenance theory
\end{itemize}

\textbf{Market Experiments (Smith):}
\begin{itemize}[nosep]
    \item \citet{smith1962}: Double auction experiments (foundational)
    \item \citet{smith1976}: Induced value theory
    \item \citet{smith1988bubbles}: Asset bubble experiments
    \item \citet{smith2003nobel}: Ecological rationality (Nobel lecture)
    \item \citet{plottsmith2008}: Handbook of Experimental Economics
\end{itemize}
...
\begin{itemize}[nosep]
    ...
    \item \citet{roth2015gets}: Who Gets What and Why (popular account)
\end{itemize}

\textbf{Coordination:}
\begin{itemize}[nosep]
    \item \citet{schelling1960}: Strategy of Conflict (focal points)
    \item \citet{vanhuyck1990}: Minimum effort coordination game
    \item \citet{vanhuyck1991}: Strategic uncertainty in coordination
...
\textbf{Learning:}
\begin{itemize}[nosep]
    \item \citet{rotherev1995}: Learning in extensive-form games
    \item \citet{erevandorth1998}: Predicting how people play games
    \item \citet{camererho1999}: Experience-Weighted Attraction learning
    \item \citet{fudenberglevine1998}: Theory of Learning in Games
\end{itemize}

\textbf{Repeated Games:}
\begin{itemize}[nosep]
    \item \citet{axelrod1984}: Evolution of Cooperation (Tit-for-Tat)
    \item \citet{fudenbergmaskin1986}: Folk Theorem
    \item \citet{dalbo2011}: Experimental repeated games
    \item \citet{dalbofrechette2018}: Handbook chapter on repeated games
\end{itemize}

\textbf{Beliefs (Core):}
\begin{itemize}[nosep]
    \item \citet{nagel1995unraveling}: Beauty contest (Level-k thinking)
    \item \citet{PAP-camerer2004cognitive}: Cognitive hierarchy model
    \item \citet{costagomes2006}: Belief elicitation experiments
    \item \citet{falkfehr2006}: Intentions and belief-dependent preferences
    \item \citet{crawford2013structural}: Structural estimation of strategic models
\end{itemize}

\textbf{Beliefs (Higher-Order \& Global Games):}
\begin{itemize}[nosep]
    \item \citet{rubinstein1989}: Email game (common knowledge)
    \item \citet{carlssonvanDamme1993}: Global games (equilibrium selection)
    \item \citet{morrishin2003}: Global games theory and applications
    \item \citet{cheungfriedman1997}: Belief learning dynamics
\end{itemize}

\textbf{Beliefs (Field Evidence):}
\begin{itemize}[nosep]
    \item \citet{dellavigna2009}: Psychology and economics (field evidence)
    \item \citet{levitt2007}: Lab-field generalizability
    \item \citet{shiller2000}: Beliefs in financial markets
    \item \citet{hallsworth2017}: Tax compliance and beliefs
    \item \citet{bandiera2010}: Workplace beliefs and effort
\end{itemize}

\textbf{Beliefs (Neuroeconomics \& Replication):}
\begin{itemize}[nosep]
    \item \citet{sanfey2003}: Neural basis of economic decisions
    \item \citet{frith2006}: Neural basis of mentalizing
    \item \citet{camerer2016}: Replicability in experimental economics
    \item \citet{klein2018}: Many Labs replication project
\end{itemize}
...
$\rightarrow$ Appendix FEH (Fehr literature) $\rightarrow$ Appendix EST (calibration)
