...
\chapter*{Appendix UNMAPPED_RO: Alvin E. Roth Research Integration}
\addcontentsline{toc}{chapter}{Appendix UNMAPPED_RO: LIT-ROTH - Market Design \& Matching Theory}
\label{app:roth}
...
\begin{itemize}
    ...
    \item Appendix UNMAPPED_B (CORE-HOW): Complementarity in strategic interaction
...
\begin{itemize}
    ...
    \item Appendix UNMAPPED_V (CORE-WHEN): Institutional context Ψ
\end{itemize}

\textbf{Related Literature:}
\begin{itemize}
    \item Appendix UNMAPPED_CA (LIT-CAMERER): Strategic behavior in games
    \item Appendix UNMAPPED_GI (LIT-GIGERENZER): Ecological rationality of simple mechanisms
...
% ============================================================================
\begin{abstract}
This appendix integrates Alvin E. Roth's research on market design and matching theory into the Evidence-Based Framework. Roth's work demonstrates how economic theory can be applied as ``engineering'' to design institutions that improve welfare. His contributions span matching markets (labor, school choice), kidney exchange, and the concept of repugnance as a constraint on markets. We formalize six core axioms (UNMAPPED_RO-1 to UNMAPPED_RO-6) that connect market design principles to EBF's institutional context dimension ($\Psi_I$). Key insight: Markets are not natural phenomena but designed institutions where $\gamma > 0$ between mechanism properties and participant behavior determines success or failure. Nobel Prize 2012 (with Lloyd Shapley).
\end{abstract}
...
\subsection{Axiom UNMAPPED_RO-1: Stability Requirement}

\begin{tcolorbox}[colback=blue!5!white,colframe=blue!75!black,title=Axiom UNMAPPED_RO-1: Stability Requirement]
...
\subsection{Axiom UNMAPPED_RO-2: Thickness Principle}

\begin{tcolorbox}[colback=blue!5!white,colframe=blue!75!black,title=Axiom UNMAPPED_RO-2: Thickness Principle]
...
\subsection{Axiom UNMAPPED_RO-3: Congestion Management}

\begin{tcolorbox}[colback=blue!5!white,colframe=blue!75!black,title=Axiom UNMAPPED_RO-3: Congestion Management]
...
\subsection{Axiom UNMAPPED_RO-4: Safety and Strategy-Proofness}

\begin{tcolorbox}[colback=blue!5!white,colframe=blue!75!black,title=Axiom UNMAPPED_RO-4: Safety and Strategy-Proofness]
...
\subsection{Axiom UNMAPPED_RO-5: Repugnance Constraint}

\begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=Axiom UNMAPPED_RO-5: Repugnance Constraint]
...
\subsection{Axiom UNMAPPED_RO-6: Economist as Engineer}

\begin{tcolorbox}[colback=green!5!white,colframe=green!75!black,title=Axiom UNMAPPED_RO-6: Economist as Engineer]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{1999: The Redesign of the Matching Market for American Physicians:...}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Roth, Alvin E and Peranson, Elliott (1999). ``The Redesign of the Matching Market for American Physicians: Some Engineering Aspects of Economic Design.'' \textit{American Economic Review}, 89, 748--780.

\paragraph{10C Integration.}
\begin{itemize}[nosep]
  \item \textbf{Domain}: [To be specified]
  \item \textbf{use\_for}: LIT-ROTH
\end{itemize}


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2015: Who Gets What---and Why: The New Economics of Matchmaking an...}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Roth, Alvin E (2015). \textit{Who Gets What---and Why: The New Economics of Matchmaking and Market Design}. Houghton Mifflin Harcourt.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{1991: Game-Theoretic Models of Bargaining}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Roth, Alvin E. (1991). \textit{Game-Theoretic Models of Bargaining}. Cambridge University Press.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{1995: Learning in Extensive-Form Games: Experimental Data and Simp...}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Roth, Alvin E. and Erev, Ido (1995). ``Learning in Extensive-Form Games: Experimental Data and Simple Dynamic Models in the Intermediate Term.'' \textit{Games and Economic Behavior}, 8, 164--212.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{1990: Two-Sided Matching: A Study in Game-Theoretic Modeling and A...}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Roth, Alvin E. and Sotomayor, Marilda A. Oliveira (1990). \textit{Two-Sided Matching: A Study in Game-Theoretic Modeling and Analysis}. Publisher.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2005: The Effects of a Centralized Clearinghouse on Job Placement,...}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Roth, Alvin and Niederle, Muriel (2005). ``The Effects of a Centralized Clearinghouse on Job Placement, Wages, and Hiring Practices.'' \textit{NBER Working Paper}.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2008: Deferred Acceptance Algorithms: History, Theory, Practice}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Roth, Alvin E. (2008). ``Deferred Acceptance Algorithms: History, Theory, Practice.'' \textit{International Journal of Game Theory}, 36.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{1994: Jumping the Gun: Imperfections and Institutions Related to t...}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Roth, Alvin E. and Xing, Xiaolin (1994). ``Jumping the Gun: Imperfections and Institutions Related to the Timing of Market Transactions.'' \textit{American Economic Review}, 84, 992--1044.
