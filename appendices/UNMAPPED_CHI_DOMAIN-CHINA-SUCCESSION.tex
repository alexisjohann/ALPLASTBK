...
\title{\textbf{Appendix UNMAPPED_CHI: DOMAIN-CHINA-SUCCESSION} \\ A Factionalist-Consensus Model of CCP Leadership Selection \\ With Applications to 2027 and 2032 Party Congress Predictions}
...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=Quick Reference: Appendix UNMAPPED_CHI]
...
\begin{tcolorbox}[colback=yellow!5!white,colframe=yellow!75!black,title=Axiom UNMAPPED_CHI-1: Fundamental Principle]
\textbf{Axiom UNMAPPED_CHI-1 (Core Assumption):}
...
\begin{tcolorbox}[colback=yellow!5!white,colframe=yellow!75!black,title=Axiom UNMAPPED_CHI-2: Complementarity]
\textbf{Axiom UNMAPPED_CHI-2 (Complementarity):}
...
\begin{table}[htbp]
\centering
\caption{Key Symbols in Appendix UNMAPPED_CHI}
\begin{tabular}{lll}
\toprule
