...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=Quick Reference: Appendix UNMAPPED_MIL]
...
\textbf{Critical Link:} \textbf{Appendix UNMAPPED_NC (FORMAL-NC)}---Non-Concavity, Fit, and Coherence (Chapter 7).
...
\begin{table}[htbp]
\centering
\caption{Key Symbols in Appendix UNMAPPED_MIL}
\begin{tabular}{lll}
\toprule
