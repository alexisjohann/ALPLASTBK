...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=\textbf{Appendix OPS: METHOD-OPERATIONAL}]
...
\begin{table}[htbp]
\centering
\caption{Summary of Results in Appendix OPS}
\label{tab:E-results}
\renewcommand{\arraystretch}{1.2}
...
$C_{ij}$ & Complementarity between $i$ and $j$ & Appendix HOW \\
\bottomrule
\end{tabular}
\end{center}
...
\subsection{References for Appendix OPS}
...
$\rightarrow$ Appendix LLM1 (estimation) $\rightarrow$ Appendix EST (parameters)
