% =============================================================================
% APPENDIX LLM: LIT-AUTHOR: Unknown Researcher Research Integration
% =============================================================================
% Category: LIT
% Language: English
...
\hrule
\vspace{0.5em}
\noindent\textit{Cross-references: Chapter 10 (FEPSDE welfare framework), Appendix CTW ($\Psi$-dimensions validation), Appendix UNMAPPED_EPS (Epistemics of Deviation), Appendix THL1 (Evaluation Protocol)}
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Appendix UNMAPPED_LLM Summary]
...
\begin{table}[htbp]
\centering
\caption{Key Symbols in Appendix UNMAPPED_LLM}
\begin{tabular}{lll}
\toprule
