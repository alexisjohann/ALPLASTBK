...
See Appendix UNMAPPED_DFN (DOMAIN-FOUND) for complete translation.
...
\begin{tcolorbox}[colback=yellow!5!white,colframe=yellow!75!black,title=Axiom UNMAPPED_HTY-1: Fundamental Principle]
\textbf{Axiom UNMAPPED_HTY-1 (Core Assumption):}
...
\begin{tcolorbox}[colback=yellow!5!white,colframe=yellow!75!black,title=Axiom UNMAPPED_HTY-2: Complementarity]
\textbf{Axiom UNMAPPED_HTY-2 (Complementarity):}
