...
\begin{itemize}[nosep]
    \item \textbf{Case Registry:} UNMAPPED_CAS-876 (Fehr-Schmidt Inequity Aversion Model)
    ...
    \begin{itemize}[nosep]
        \item \citet{bolton2000erc}: ERC model (alternative formulation)
        \item \citet{charness2002understanding}: Extensions and tests
        \item \citet{henrich2001search}: Cross-cultural variation
    \end{itemize}
\end{itemize}
...
his empirical contributions catalogued above---see \textbf{Appendix UNMAPPED_FRM (LIT-FEHR-METHOD):
...
\begin{table}[htbp]
\centering
\caption{Key Symbols in Appendix UNMAPPED_FEH}
\begin{tabular}{lll}
\toprule
