...
\chapter*{Appendix UNMAPPED_GA: George Akerlof Research Integration}
\addcontentsline{toc}{chapter}{Appendix UNMAPPED_GA: LIT-AKERLOF - Identity Economics \& Information Asymmetry}
\label{app:akerlof}
...
\begin{axiom}[UNMAPPED_GA-1: Information Asymmetry]
\label{ax:ga1}
...
\begin{axiom}[UNMAPPED_GA-2: Identity and Prescriptions]
\label{ax:ga2}
...
\begin{axiom}[UNMAPPED_GA-3: Identity Loss]
\label{ax:ga3}
...
\begin{axiom}[UNMAPPED_GA-4: Effort-Wage Reciprocity]
\label{ax:ga4}
...
\begin{axiom}[UNMAPPED_GA-5: Near-Rationality]
\label{ax:ga5}
...
\begin{axiom}[UNMAPPED_GA-6: Confidence Multiplier]
\label{ax:ga6}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{1976: The Economics of Caste and of the Rat Race and Other Woeful ...}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Akerlof, George (1976). ``The Economics of Caste and of the Rat Race and Other Woeful Tales.'' \textit{Quarterly Journal of Economics}, 90.

\paragraph{10C Integration.}
\begin{itemize}[nosep]
  \item \textbf{Domain}: [To be specified]
  \item \textbf{use\_for}: LIT-AKERLOF
\end{itemize}


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{1980: Unemployment Spells and Unemployment Experience}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Akerlof, George and Main, Brian (1980). ``Unemployment Spells and Unemployment Experience.'' \textit{American Economic Review}, 70.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{1983: Loyalty Filters}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Akerlof, George (1983). ``Loyalty Filters.'' \textit{American Economic Review}, 73.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{1988: Fairness and Unemployment}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Akerlof, George and Yellen, Janet (1988). ``Fairness and Unemployment.'' \textit{American Economic Review}, 78.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{1985: Can Small Deviations from Rationality Make Significant Diffe...}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Akerlof, George and Yellen, Janet (1985). ``Can Small Deviations from Rationality Make Significant Differences to Economic Equilibria?.'' \textit{American Economic Review}, 75.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{1982: The Economic Consequences of Cognitive Dissonance}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Akerlof, George and Dickens, William (1982). ``The Economic Consequences of Cognitive Dissonance.'' \textit{American Economic Review}, 72.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{1993: Looting: The Economic Underworld of Bankruptcy for Profit}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Akerlof, George and Romer, Paul (1993). ``Looting: The Economic Underworld of Bankruptcy for Profit.'' \textit{Brookings Papers on Economic Activity}, 1993.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{1997: Social Distance and Social Decisions}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Akerlof, George (1997). ``Social Distance and Social Decisions.'' \textit{Econometrica}, 65.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2002: Behavioral Macroeconomics and Macroeconomic Behavior}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Akerlof, George (2002). ``Behavioral Macroeconomics and Macroeconomic Behavior.'' \textit{American Economic Review}, 92.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2002: Identity and Schooling: Some Lessons for the Economics of Ed...}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Akerlof, George and Kranton, Rachel (2002). ``Identity and Schooling: Some Lessons for the Economics of Education.'' \textit{Journal of Economic Literature}, 40.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2005: Identity and the Economics of Organizations}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Akerlof, George and Kranton, Rachel (2005). ``Identity and the Economics of Organizations.'' \textit{Journal of Economic Perspectives}, 19.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2007: The Missing Motivation in Macroeconomics}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Akerlof, George (2007). ``The Missing Motivation in Macroeconomics.'' \textit{American Economic Review}, 97.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2016: Bread and Bullets}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Akerlof, George and Snower, Dennis (2016). ``Bread and Bullets.'' \textit{Journal of Economic Behavior and Organization}, 126.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2020: Sins of Omission and the Practice of Economics}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Akerlof, George (2020). ``Sins of Omission and the Practice of Economics.'' \textit{Journal of Economic Literature}, 58.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2016: Exploitation}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Akerlof, George and Shiller, Robert (2016). ``Exploitation.'' \textit{Working Paper}.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{2018: Persistence of False Paradigms in Low-Power Sciences}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\paragraph{Citation.}
Akerlof, George and Michaillat, Pascal (2018). ``Persistence of False Paradigms in Low-Power Sciences.'' \textit{Proceedings of the National Academy of Sciences}, 115.
