...
\section*{Appendix UNMAPPED_SW: Scientific Writing Structure Model (SWSM)}
\label{app:sw}
\addcontentsline{toc}{section}{Appendix UNMAPPED_SW: Scientific Writing Structure Model}
...
\begin{itemize}
    ...
    \item Appendix UNMAPPED_LLM: LLM Monte Carlo Theory (LLMMC for $\theta$ estimation)
    \item Appendix UNMAPPED_DTE: Document Type Theory (8D $\rightarrow$ $\theta$ mapping)
\end{itemize}
...
\begin{itemize}
    ...
    \item Appendix UNMAPPED_DTE: Document Type Theory (8D Algorithm)
    \item Appendix UNMAPPED_MS: Model Space (Scientific Theory Catalog)
    \item Appendix UNMAPPED_LLM: LLM Monte Carlo Theory (LLMMC θ estimation)
\end{itemize}
\end{tcolorbox}
...
SWSM integrates with the EBF's \textbf{LLM Monte Carlo} methodology (see Appendix UNMAPPED_LLM: METHOD-LLMMC).
...
\textit{Cross-reference:} Appendix UNMAPPED_LLM (METHOD-LLMMC) provides the full LLMMC methodology.
