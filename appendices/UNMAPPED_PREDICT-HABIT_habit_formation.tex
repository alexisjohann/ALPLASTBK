...
% - Appendix UNMAPPED_AW (CORE-STAGE): Behavioral Change Journey phases
% - Appendix UNMAPPED_AU (CORE-AWARE): Awareness function and belief updating
% - Appendix UNMAPPED_BBB (CORE-WHERE): Parameter values from empirical literature
%
% DEPENDENTS (what REQUIRES this appendix):
% - Appendix TKT (METHOD-TOOLKIT): Intervention design specifications
...
\item For parameter values: See Appendix UNMAPPED_BBB (CORE-WHERE)
\end{itemize}
...
\bibitem{nelson1970information} Nelson, P. (1970).
...
Appendix UNMAPPED_AW (CORE-STAGE),
