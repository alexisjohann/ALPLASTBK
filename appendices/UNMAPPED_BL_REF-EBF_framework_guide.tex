...
\begin{itemize}[nosep]
    ...
    \item Context dimensions in detail $\rightarrow$ Appendix UNMAPPED_V (CORE-WHEN)
    \item Utility theory $\rightarrow$ Appendix UNMAPPED_C (CORE-WHAT)
...
For details, see \textbf{Appendix UNMAPPED_V (CORE-WHEN)}.
...
\item \textbf{Hallsworth et al. (2017):} ``The Behavioralist as Tax Collector''
      ...
      \citep{hallsworth2017behavioralist}.
\end{itemize}
...
\item \textbf{Gächter \& Klinowski (2022):} ``Individual-Level Loss Aversion''
      --- heterogeneity in loss aversion parameters \citep{gaechter2022lossaversion}.
...
\item \textbf{Hussam et al. (2022):} ``Rational Habit Formation: Experimental
      ...
      behavioral persistence \citep{hussam2022rational}.
\item \textbf{Jones, Molitor \& Reif (2025):} ``How Do Habits Form?'' ---
      habit formation dynamics from field experiments \citep{jones2025habits}.
\end{itemize}
...
\begin{tcolorbox}[colback=green!10!white, colframe=green!75!black,
    title=\textbf{Appendix UNMAPPED_BL: Summary}]
...
\item Appendix UNMAPPED_V (CORE-WHEN) --- Context dimensions in detail
\item Appendix UNMAPPED_AAA (CORE-WHO) --- The Welfare Hierarchy
\item Appendix UNMAPPED_C (CORE-WHAT) --- Utility theory
\item Appendix UNMAPPED_B (CORE-HOW) --- Complementarity
\item Appendix UNMAPPED_BBB (CORE-WHERE) --- Parameter repository
\item Appendix TKT (METHOD-TOOLKIT) --- Intervention design
\end{itemize}
