...
% integration with the Lead Management System (Appendix UNMAPPED_BN).
%
% =============================================================================
...
% - Appendix UNMAPPED_BN (REF-LEAD): Lead Management System (Lead-to-Customer Conversion)
...
\begin{itemize}[nosep]
\item Appendix UNMAPPED_BN (REF-LEAD): Lead Management System $\leftrightarrow$ Lead-to-Customer Conversion
\item Appendix BK (METHOD-CALC): Revenue Calculations $\leftrightarrow$ CLV Formulas
\end{itemize}

\textbf{Reading Guide:}
\begin{itemize}[nosep]
\item For lead acquisition: Read Appendix UNMAPPED_BN first
...
The system integrates with the Lead Management System (Appendix UNMAPPED_BN) to provide
...
\textbf{Cross-References:} Appendix UNMAPPED_BN (Lead Management), Appendix BK (Calculations)
\end{tcolorbox}
...
\begin{itemize}[nosep]
    \item Lead-Akquise und Lead-Qualifizierung $\rightarrow$ Appendix UNMAPPED_BN (REF-LEAD)
    \item Interventions-Design für Kunden $\rightarrow$ Appendix TKT (METHOD-TOOLKIT)
...
While the Lead Management System (Appendix UNMAPPED_BN) handles customer acquisition,
...
\begin{tcolorbox}[colback=yellow!5!white, colframe=yellow!75!black,
    title=Integration: Appendix BP $\leftrightarrow$ Appendix UNMAPPED_BN (Lead Management)]
...
\textbf{Next Steps:} See Appendix UNMAPPED_BN for lead management, Appendix TKT for
...
Appendix UNMAPPED_BN (Lead Management),
