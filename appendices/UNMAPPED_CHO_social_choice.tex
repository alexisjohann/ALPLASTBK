...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!75!black,
    title=Quick Reference: Appendix UNMAPPED_CHO]
\textbf{Appendix:} CHO (LIT)
...
As in mechanism design (Appendix FAL1):
...
\textbf{Key Finding.}
Foundation of strategic voting theory. [Also in Appendix FAL1]
...
\begin{table}[htbp]
\centering
\caption{Key Symbols in Appendix UNMAPPED_CHO}
\begin{tabular}{lll}
\toprule
