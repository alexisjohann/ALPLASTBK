...
% - Appendix UNMAPPED_BBB (CORE-WHERE): Parameter references
...
\textbf{Cross-References:} Appendix G (Glossary), Appendix UNMAPPED_BBB (CORE-WHERE)
\end{tcolorbox}
...
\begin{itemize}[nosep]
    ...
    \item Axiom system (UNMAPPED_SK-1 to UNMAPPED_SK-9)
...
│  CAS-{NNN}                      Case        UNMAPPED_CAS-001                     │
│  CON-{YYYY}-{NNN}               Concept     CON-2026-001                │
│  FRM-{NNN}                      Formula     UNMAPPED_FRM-001                     │
│  PAP-{BibKey}                   Paper       PAP-kahneman1979prospectprospect    │
│                                                                         │
...
│  ──────────────────────────────────────────────────────                 │
│  INO-L-{YYYY-MM-DD}-{CAT}-{NNN} Learning     INO-ACE-2026-01-27-DOC-001   │
│                                                                         │
└─────────────────────────────────────────────────────────────────────────┘
\end{verbatim}
...
Case & CAS & CAS-\{NNN\} & UNMAPPED_CAS-001 & 3-digit sequence \\
Concept & CON & CON-\{YYYY\}-\{NNN\} & CON-2026-001 & Year of creation \\
Formula & FRM & FRM-\{NNN\} & UNMAPPED_FRM-001 & 3-digit sequence \\
Paper & PAP & PAP-\{BibKey\} & PAP-kahneman1979prospectprospect & Prevents hallucination \\
\midrule
...
Learning & INO-L & INO-L-\{DATE\}-\{CAT\}-\{NNN\} & INO-ACE-2026-01-27-DOC-001 & Date: YYYY-MM-DD, CAT: category \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom UNMAPPED_SK-1: Uniqueness]
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom UNMAPPED_SK-2: Immutability]
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom UNMAPPED_SK-3: Prefix Determinism]
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom UNMAPPED_SK-4: Hierarchical Embedding]
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom UNMAPPED_SK-5: Separator Consistency]
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom UNMAPPED_SK-6: Version Externality]
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom UNMAPPED_SK-7: Reference Validity]
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom UNMAPPED_SK-8: Historical Exception]
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom UNMAPPED_SK-9: Paper Exception]
...
\textbf{Examples:}
\begin{itemize}[nosep]
\item PAP-kahneman1979prospectprospect $\rightarrow$ PAP-kahneman1979prospectprospect
\item fehr1999theory $\rightarrow$ PAP-fehr1999theory
\item thaler2008nudge $\rightarrow$ PAP-sunstein2014nudge
\end{itemize}
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Axiom UNMAPPED_SK-10: Learning Database Keys]
...
\textbf{Examples:}
\begin{itemize}[nosep]
\item INO-ACE-2026-01-27-DOC-001 (Versionsnummern-Konsistenz)
\item INO-ACE-2026-01-27-PROC-001 (Ernst Fehr Feedback-Muster)
\item INO-ACE-2026-01-27-MEET-001 (Meeting-Transkript-Analyse)
\end{itemize}
...
\begin{itemize}
    ...
    \item 10 formal axioms guaranteeing consistency (UNMAPPED_SK-1 to UNMAPPED_SK-10)
...
Case & CASE-001 & UNMAPPED_CAS-001 & 3-char prefix \\
Concept & CONC-2026-001 & CON-2026-001 & 3-char prefix \\
Project & PRJ-001 & CUS-XXX-PRJ-001 & Add customer context \\
Theory & MS-RD-001 & MS-RD-001 & No change (UNMAPPED_SK-8) \\
Customer & (none) & CUS-ALPLA & \textbf{NEW} \\
Formula & (none) & UNMAPPED_FRM-001 & \textbf{NEW} \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{enumerate}[nosep]
    ...
    \begin{itemize}[nosep]
        \item LaTeX files: \verb|\citep{key}| $\rightarrow$ \verb|\citep{key}|
...
\begin{tcolorbox}[colback=gray!5!white, colframe=gray!75!black,
    title=Appendix UNMAPPED_BN Summary: Superkey Specification]
...
\item Historical exception: Theories retain MS- prefix (UNMAPPED_SK-8)
\item Paper exception: PAP- prefix prevents LLM hallucination (UNMAPPED_SK-9)
\item Learning exception: INO-L- prefix with date-category format (UNMAPPED_SK-10)
\end{itemize}
...
\begin{table}[htbp]
\centering
\caption{Symbols Introduced in Appendix UNMAPPED_BN}
...
Appendix UNMAPPED_VC (METHOD-VALIDATE).
