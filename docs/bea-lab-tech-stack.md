...
> **⚠️ DEPRECATED — Konsolidiert in SSOT**
>
> Dieses Dokument ist inhaltlich korrekt, aber wurde in die zentrale SSOT konsolidiert.
>
> **SSOT:** `data/beatrix/architecture.yaml`
>
> Änderungen NUR in der SSOT vornehmen. Dieses Dokument wird nicht mehr aktualisiert.
