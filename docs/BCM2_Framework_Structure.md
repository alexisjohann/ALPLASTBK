...
> **SSOT for BCM definition:** `data/knowledge/canonical/bcm.yaml`
> **Glossary reference:** `appendices/UNMAPPED_GLS_glossary.tex:631`

## Overview

The Behavioral Change Model 2.0 (BCM) is the core of the Evidence-Based Framework (EBF) by FehrAdvice & Partners AG. It provides a comprehensive theoretical and practical framework for understanding and facilitating behavioral change. It integrates insights from behavioral economics, psychology, and decision science into a unified, actionable model.

### The Core Formula

```
P(Behavioral Change) = Willingness × Ability × Context
```

### The 8 Context Dimensions (Ψ)

Every situation is characterized by 8 dimensions that modulate behavior:

| Symbol | Dimension | Question |
|--------|-----------|----------|
| Ψ_I | Institutional | What rules, laws, defaults apply? |
| Ψ_S | Social | Who is present? What social norms apply? |
| Ψ_C | Cognitive | Tired? Stressed? Attentive? Motivated? |
| Ψ_K | Cultural | What values, traditions, religion? |
| Ψ_E | Economic | How much budget, time, energy available? |
| Ψ_T | Temporal | When? Time pressure? Life phase? |
| Ψ_M | Material | What technology, infrastructure, objects? |
| Ψ_F | Physical | Where physically? Home, office, public? |

### The BCM2 Context Database

The BCM is operationalized through the **BCM2 Context Database** — a curated collection of 404+ context factors:

| Level | Database | Factors | Description |
|-------|----------|---------|-------------|
| MACRO | `BCM2_04_KON` | 404 | Country-specific context vectors (CH/AT/DE) |
| INDIVIDUAL | `BCM2_05_IND` | 48 | Age, gender, education, personality |
| META | `BCM2_06_META` | 42 | Framing, defaults, timing, channels |

The 5 MACRO axes (404 factors for Switzerland):

| Axis | Code | Factors | Sources |
|------|------|---------|---------|
| Demographic | DEM | 60 | BFS, SECO, BSV |
| Economic | ECO | 54 | SECO, SNB, BFS, KOF |
| Institutional-Political | POL | 59 | Bundeskanzlei, World Bank |
| Technological-Ecological | TEC | 65 | BFS, BFE, BAFU |
| Socio-Cultural | SOC | 166 | BFS, ESS, WVS, gfs.bern, Sotomo |

**Data location:** `data/dr-datareq/sources/context/`
...
- **Canonical BCM Definition (SSOT):** `data/knowledge/canonical/bcm.yaml`
- **Glossary Entry:** `appendices/UNMAPPED_GLS_glossary.tex:631`
- **Context Vector Architecture:** `docs/frameworks/context-vector-architecture.md`
- **Context Database:** `data/dr-datareq/sources/context/`
- **10C Framework (SSOT):** `docs/frameworks/core-framework-definition.yaml`
