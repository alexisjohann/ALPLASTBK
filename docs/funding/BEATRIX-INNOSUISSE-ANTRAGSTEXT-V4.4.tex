...
%% Version 4.4 - Finalisierte Version mit allen Korrekturen
%% Datum: 27. Januar 2026
%% Update: Abstract ergänzt (Massnahmenvorschläge), Literaturverzeichnis alphabetisch
%% =============================================================================
...
{\large Version 4.4 -- Erweitertes Abstract, aktualisierte Zitationen}\\[2cm]
...
\midrule
BEATRIX & Behavioral Economics AI Technology for Research and Implementation eXcellence. Ein evidenzbasiertes Entscheidungsunterstützungssystem, das 50 Jahre verhaltensökonomische Forschung (Kahneman, Thaler, Fehr) systematisch für die Managementpraxis aufbereitet. BEATRIX erfasst Wechselwirkungen, die in der Realität stattfinden (psychologische, finanzielle, kulturelle Effekte) -- und schlägt auf dieser Basis geeignete Massnahmen vor. \\
\midrule
...
\midrule
EBF-Framework & Evidence-Based Framework for Economic and Social Behavior. Das theoretische Fundament von BEATRIX: 21 Kapitel, 56 Appendices, 414 formale Axiome. Integriert die Forschung von Kahneman, Thaler, Fehr und anderen in ein einheitliches System mit dem 9C-CORE. \\
\midrule
...
\midrule
Komplementarität ($\gamma$) & Wechselwirkung zwischen Massnahmen. Verstärkend: Transparenz + Feedback wirken zusammen stärker. Neutralisierend: Individualboni + Teamziele heben sich auf. Blockierend: Kontrolle verhindert Vertrauenskultur. Im EBF als $\gamma$-Matrix quantifiziert (Kapitel 5). \\
\midrule
...
\midrule
9C-CORE & Die neun Kernfragen des EBF-Frameworks: WHO (wer hat Nutzen?), WHAT (was ist Nutzen?), HOW (wie interagieren Faktoren?), WHEN (wann zählt Kontext?), WHERE (woher die Zahlen?), AWARE (wie bewusst?), READY (handlungsbereit?), STAGE (wo in der Journey?), HIERARCHY (wie stratifizieren Entscheidungen?). \\
\bottomrule
\end{longtable}
...
{\small Dokument erstellt: 27. Januar 2026}\\
{\small Version: 4.4 -- Finalisierte Version mit allen Korrekturen}\\
