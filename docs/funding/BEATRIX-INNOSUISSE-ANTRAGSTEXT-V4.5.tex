...
%% Version 4.5 - Letzte Meile: BCM/EBF/BEATRIX-Definitionen, Fehr-Konsistenz
%% Datum: 12. Februar 2026
%% Update: BCM/EBF/BEATRIX-Begriffe präzisiert, Fehr-Korrektur durchgängig, Zahlen aktualisiert
%% =============================================================================
...
{\large Version 4.5 -- BCM/EBF/BEATRIX-Definitionen, Fehr-Konsistenz}\\[2cm]
...
FehrAdvice \& Partners verfügt über eine wissenschaftlich fundierte, über Jahre validierte methodische Kernkompetenz in der Analyse von Verhaltensentscheidungen. Diese Expertise wird durch BEATRIX nicht ersetzt, sondern formalisiert, strukturiert und teilautomatisiert. BEATRIX überführt damit bisher personengebundene verhaltensökonomische Expertise in eine systematisch anwendbare Entscheidungslogik, die über unterschiedliche Kontexte hinweg konsistent eingesetzt werden kann.

BEATRIX ist ein evidenzbasiertes Entscheidungsunterstützungssystem, das mehrere Jahrzehnte verhaltensökonomische Forschung für die Managementpraxis zugänglich macht. Die Innovation besteht aus drei Elementen: (1) systematische Kontextmodellierung, (2) die Erfassung von Wechselwirkungen, die in der Realität stattfinden (psychologische, finanzielle, kulturelle Effekte) -- und darauf basierender Massnahmenvorschlag, sowie (3) eine transparente, nachvollziehbare Entscheidungslogik. Die Kombination verhaltensökonomischer Methodik mit digitalen Technologien und maschinellem Lernen ermöglicht es erstmals, mehrere relevante Faktoren simultan zu berücksichtigen und deren Interdependenzen systematisch in Entscheidungsprozesse zu integrieren.
...
BEATRIX geht über Standardberatung hinaus, indem es Verhaltensentscheidungen nicht primär erfahrungsbasiert beurteilt, sondern Kontext, Wechselwirkungen und Entscheidungslogik systematisch modelliert und nachvollziehbar macht.

\subsection{Die drei Säulen der Innovation}

\subsubsection{Säule 1: Kontext ernst nehmen}

Menschen verhalten sich nicht isoliert vom Kontext (Fehr \& Gächter, 2002a). Ein finanzieller Anreiz wirkt anders bei einem Berufseinsteiger als bei einer Führungskraft kurz vor der Pensionierung (Gneezy et al., 2011). \textbf{BEATRIX berücksichtigt acht Kontext-Dimensionen systematisch} -- formalisiert im EBF-Framework als $\Psi$-Vektor (vgl. Kapitel 9):
...
\textbf{Warum ist das neu?} Bisherige Ansätze behandeln Kontext als Störfaktor. Wir machen ihn zum zentralen Ordnungsprinzip (Thaler \& Sunstein, 2008).

\subsubsection{Säule 2: Wechselwirkungen in der Realität erfassen -- und Massnahmen vorschlagen}

BEATRIX geht über die blosse Analyse von Massnahmen hinaus: \textbf{Das System erfasst Wechselwirkungen, die in der Realität selbst stattfinden} -- und schlägt auf dieser Basis geeignete Massnahmen vor. Diese realen Wechselwirkungen sind extrem schwierig zu erfassen und umfassen drei Ebenen:

\begin{table}[h]
\centering
\begin{tabular}{@{}L{4cm}L{9cm}@{}}
\toprule
\textbf{Wechselwirkungs-Ebene} & \textbf{Was BEATRIX erfasst} \\
\midrule
...
\textbf{Warum ist das neu?} Traditionelle Beratung betrachtet Massnahmen isoliert. BEATRIX modelliert die komplexen Wechselwirkungen, die in der Realität zwischen psychologischen, finanziellen und kulturellen Faktoren stattfinden -- und \textbf{schlägt auf dieser Basis passende Massnahmen vor}.
...
BEATRIX ist ein evidenzbasiertes Entscheidungsunterstützungssystem für alle Entscheidungsträger:innen in Organisationen und Unternehmen, die grundlegende Entscheidungen treffen müssen, die von vielen gleichzeitig miteinander verflochtenen Faktoren geprägt sind (also von komplexen Entscheidungen). Das umfasst beispielsweise:
...
\begin{itemize}
    ...
    \item[$\checkmark$] Erfassung von Wechselwirkungen, die in der Realität stattfinden
    \item[$\checkmark$] Benutzeroberfläche für Berater
    \item[$\checkmark$] Bibliothek mit über 50 dokumentierten Anwendungsfällen
    \item[$\checkmark$] Integration von über 2'300 wissenschaftlichen Studien
\end{itemize}
...
Forscht zur Zusammenarbeit zwischen Menschen und intelligenten Systemen -- zentral für die Willingness-Komponente des EBF-Frameworks (Kapitel 12) (Krakowski et al., 2025). Seine Frage:
...
\midrule
a) Innovation & BEATRIX erfasst Wechselwirkungen, die in der Realität stattfinden (psychologisch, finanziell, kulturell) -- und schlägt darauf basierend Massnahmen vor. Systematisch und nachvollziehbar. \\
...
\midrule
BCM & Behavioral Change Model. Das Entscheidungs- und Beratungsmodell, das FehrAdvice \& Partners über mehr als drei Jahrzehnte in enger Verbindung mit der Forschung von Prof. Ernst Fehr entwickelt hat. Das BCM wurde von Berater:innen in der täglichen Praxis eingesetzt -- als Rahmenwerk, gestützt auf Erfahrung und wissenschaftliche Evidenz. Siehe auch: EBF-Framework, BEATRIX. \\
\midrule
BEATRIX & Behavioral Economics AI Technology for Research and Implementation eXcellence. Verwendet digitale Technologien und maschinelles Lernen -- Agenten, APIs, Datenbanken und weitere digitale Werkzeuge -- um das EBF-Framework (und damit auch das BCM) für Berater:innen operativ einsetzbar zu machen. BEATRIX ist kein KI-Tool, sondern eine technologiegestützte Infrastruktur. Sie erfasst Wechselwirkungen, die in der Realität stattfinden (psychologische, finanzielle, kulturelle Effekte) -- und schlägt auf dieser Basis geeignete Massnahmen vor. \\
\midrule
...
\midrule
EBF-Framework & Evidence-Based Framework for Economic and Social Behavior. Die vollständige wissenschaftliche Formalisierung und Systematisierung des Wissens, das hinter dem BCM steht -- und weit darüber hinaus. Das EBF umfasst 25 Kapitel, über 200 Appendices und über 2'300 wissenschaftliche Studien. Es integriert die Forschung von Kahneman, Thaler, Fehr und anderen in ein einheitliches System mit dem 10C-CORE. BEATRIX macht das EBF operativ einsetzbar. \\
\midrule
Evidenzbasiert & Auf wissenschaftlichen Belegen beruhend, nicht auf Intuition oder Erfahrung allein. Bedeutet: Aussagen sind durch Studien, Experimente oder systematische Beobachtungen gestützt. Das EBF-Framework integriert über 2'300 wissenschaftliche Studien. \\
\midrule
...
\midrule
FEPSDE & Die sechs Dimensionen von Wohlbefinden im EBF-Framework: Financial, Experiential, Procedural, Social, Distributive, Episodic. Jede Intervention wirkt auf eine oder mehrere dieser Dimensionen. \\
\midrule
...
\midrule
Intervention & Gezielte Massnahme zur Beeinflussung von Verhalten. Im EBF-Framework in acht Grundtypen klassifiziert: Awareness, Feedback, Kontextgestaltung, Timing, Identität, Soziale Normen, Finanzielle Anreize, Selbstverpflichtung. \\
\midrule
...
\midrule
Komplementarität ($\gamma$) & Wechselwirkung zwischen Faktoren, die in der Realität stattfinden. Verstärkend: Transparenz + Feedbackkultur wirken zusammen stärker. Neutralisierend: Individualboni + Teamziele heben sich auf. Blockierend: Kontrolle verhindert Vertrauenskultur. BEATRIX erfasst diese realen Wechselwirkungen und schlägt darauf basierend Massnahmen vor. Im EBF als $\gamma$-Matrix quantifiziert (Kapitel 5). \\
\midrule
...
\midrule
Willingness (WAX) & Handlungsbereitschaft einer Person. Im EBF-Framework (Kapitel 12) mit 99 Axiomen formalisiert. Hängt ab von: Awareness (weiss ich, was ich tun soll?), Motivation (will ich es?), und wahrgenommenen Barrieren (kann ich es?). Erklärt, warum Wissen allein selten zu Verhaltensänderung führt. \\
\midrule
10C-CORE & Die zehn Kernfragen des EBF-Frameworks: WHO (wer hat Nutzen?), WHAT (was ist Nutzen?), HOW (wie interagieren Faktoren?), WHEN (wann zählt Kontext?), WHERE (woher die Zahlen?), AWARE (wie bewusst?), READY (handlungsbereit?), STAGE (wo in der Journey?), HIERARCHY (wie stratifizieren Entscheidungen?), EIT (wie emergieren Interventionen?). \\
\bottomrule
\end{longtable}
...
{\small Dokument erstellt: 12. Februar 2026}\\
{\small Version: 4.5 -- BCM/EBF/BEATRIX-Definitionen, Fehr-Konsistenz}\\
