...
%% Version 4.2 - Mit Glossar (40) und erweitertem Literaturverzeichnis (36 Tier 1/2)
%% Datum: 27. Januar 2026
%% Update: Säule 2 erweitert gemäss E. Fehr Feedback (Wechselwirkungen in der Realität)
%% =============================================================================
...
{\large Version 4.2 -- Mit Glossar (40) und erweitertem Literaturverzeichnis (36 Tier 1/2)}\\[2cm]
...
Unternehmen und öffentliche Verwaltungen verfügen über exzellente Datensysteme für harte Faktoren (Finanzen, Logistik, Produktion), doch für die systematische Analyse von Verhaltenstreibern fehlen wissenschaftlich fundierte Werkzeuge. Die Folge: Etwa 70\% aller Change-Projekte erreichen ihre Ziele nicht, weil menschliche Faktoren unterschätzt werden (Kotter, 1996; McKinsey, 2015).

BEATRIX ist ein evidenzbasiertes Entscheidungsunterstützungssystem, das 50 Jahre verhaltensökonomische Forschung für die Managementpraxis zugänglich macht. Die Innovation besteht aus drei Elementen: (1) Systematische Kontextmodellierung, (2) Erfassung von Wechselwirkungen, die in der Realität stattfinden (psychologische, finanzielle, kulturelle Effekte) -- und darauf basierender Massnahmenvorschlag, und (3) transparente, nachvollziehbare Entscheidungslogik.
...
BEATRIX adressiert einen Markt von CHF 5--10 Milliarden im DACH-Raum (Organisations- und Verhaltensberatung). Pilotprojekte zeigen vielversprechende Resultate. Das Projekt stärkt die Schweizer Position als Standort für evidenzbasierte Management-Innovationen -- entwickelt in Zürich, für Schweizer KMU und darüber hinaus.

\textbf{Wortanzahl: 212}
...
Menschen verhalten sich nicht isoliert vom Kontext. Ein finanzieller Anreiz wirkt anders bei einem Berufseinsteiger als bei einer Führungskraft kurz vor der Pensionierung (Fehr \& Gächter, 2002a; Gneezy et al., 2011). \textbf{BEATRIX berücksichtigt acht Kontext-Dimensionen systematisch} -- formalisiert im EBF-Framework als $\Psi$-Vektor (vgl. Kapitel 9):
...
Forscht zur Zusammenarbeit zwischen Menschen und intelligenten Systemen -- zentral für die Willingness-Komponente des EBF-Frameworks (Kapitel 12) (Luger et al., 2022). Seine Frage:
...
\vspace{0.3cm}
Luger, J., Raisch, S., \& Schimmer, M. (2022). Dynamic balancing of exploration and exploitation: The contingent benefits of ambidexterity. \textit{Organization Science}, 33(3), 911--932.
...
{\small Version: 4.2 -- Mit Glossar (40 Begriffe) und Literaturverzeichnis (36 Quellen)}\\
