...
%% Version 5.0 - Scharfe 3-Ebenen-Abgrenzung EBF / BCM / BEATRIX
%% Datum: 12. Februar 2026
%% Basis: V4.7 (12. Februar 2026)
%% Änderung: Durchgehende terminologische Konsistenz:
%%   BCM  = Beratungsmodell (30 Jahre Praxis, kam ZUERST)
%%   EBF  = Wissenschaftliche Formalisierung (enthält BCM, geht weit darüber hinaus)
...
{\large Version 5.0 -- Scharfe Abgrenzung EBF / BCM / BEATRIX}\\[2cm]
...
FehrAdvice \& Partners verfügt über eine wissenschaftlich fundierte, über mehr als drei Jahrzehnte in enger Verbindung mit der Forschung von Prof. Ernst Fehr entwickelte methodische Kernkompetenz in der Analyse von Verhaltensentscheidungen. Diese Expertise ist als \textbf{BCM} (Behavioral Change Model) bekannt -- das Entscheidungs- und Beratungsmodell, das alle FehrAdvice-Berater:innen in der täglichen Praxis einsetzen: als mentales Rahmenwerk, gestützt auf Erfahrung, Intuition und wissenschaftliche Evidenz. Das BCM war mächtig, aber begrenzt durch die kognitive Kapazität der einzelnen Berater:in. Das \textbf{EBF} (Evidence-Based Framework) ist die vollständige wissenschaftliche Formalisierung und Systematisierung des Wissens, das hinter dem BCM steht -- und geht weit darüber hinaus. \textbf{BEATRIX} verwendet digitale Technologien und maschinelles Lernen, um das EBF (und damit auch das BCM) für Berater:innen operativ einsetzbar zu machen.

BEATRIX ist eine technologiegestützte Infrastruktur -- Agenten, APIs, Datenbanken und weitere digitale Werkzeuge --, die das EBF für Berater:innen operativ einsetzbar macht. BEATRIX ist kein KI-Tool im Hype-Sinn, sondern hebt die zentrale Begrenzung der bisherigen Beratungspraxis auf: die menschliche kognitive Kapazität, die es verunmöglichte, das gesamte verfügbare Wissen gleichzeitig und konsistent in Entscheidungen einfliessen zu lassen. Das EBF liefert dabei drei Kernelemente: (1) systematische Kontextmodellierung, (2) die Erfassung von Wechselwirkungen, die in der Realität stattfinden (psychologische, finanzielle, kulturelle Effekte), sowie (3) eine transparente, nachvollziehbare Entscheidungslogik. BEATRIX operationalisiert diese Elemente und schlägt auf dieser Basis geeignete Massnahmen vor. Die Kombination von formalisierter Evidenz (EBF) mit digitalen Technologien und maschinellem Lernen (BEATRIX) ermöglicht es erstmals, mehrere relevante Faktoren simultan zu berücksichtigen und deren Interdependenzen systematisch in Entscheidungsprozesse zu integrieren.
...
\vspace{0.5cm}
\noindent\textbf{Begriffliche Einordnung: BCM, EBF und BEATRIX.} Drei Begriffe durchziehen diesen Antrag:

\begin{table}[h]
\centering
\begin{tabular}{@{}L{2.2cm}L{3.8cm}L{3.5cm}L{3.5cm}@{}}
\toprule
& \textbf{BCM} & \textbf{EBF} & \textbf{BEATRIX} \\
\midrule
\textbf{Voller Name} & Behavioral Change Model & Evidence-Based Framework & Behavioral Economics AI Technology \\
\textbf{Was ist es?} & Beratungsmodell & Wissenschaftliche Formalisierung & Technologiegestützte Infrastruktur \\
\textbf{Was tut es?} & Rahmenwerk für Berater:innen & Formalisiert und erweitert das BCM & Macht das EBF operativ nutzbar \\
\textbf{Existiert seit} & 1990er (kumulativ) & 2018 (formalisiert) & 2022 (Prototyp) \\
\textbf{Begrenzt durch} & Kognitive Kapazität & -- & -- \\
\textbf{Validiert durch} & 30 Jahre Praxis & Axiomatik + Empirie & Innovation Cheque \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{itemize}[nosep]
    ...
    \item \textbf{EBF} (Evidence-Based Framework for Economic and Social Behavior): Die vollständige wissenschaftliche Formalisierung und Systematisierung des Wissens, das hinter dem BCM steht -- und weit darüber hinaus. Über 2'000 Studien, 153 Theorien, 852 dokumentierte Fälle, formale Axiome. Das EBF \emph{enthält} das BCM, erweitert es aber massiv um theoretische Grundlagen (10C-Framework), empirische Evidenz und methodische Werkzeuge.
    \item \textbf{BEATRIX} (Behavioral Economics AI Technology for Research and Implementation eXcellence): Verwendet digitale Technologien und maschinelles Lernen, um das EBF (und damit auch das BCM) für Berater:innen operativ einsetzbar zu machen. BEATRIX ersetzt nicht die Beratungskompetenz, sondern hebt deren zentrale Begrenzung auf: die menschliche kognitive Kapazität. Der Innovation Cheque validiert BEATRIX.
\end{itemize}

\noindent\textit{Zusammenhang: BCM $\subset$ EBF $\leftarrow$ BEATRIX. Das BCM ist, was Berater:innen bisher im Kopf hatten. Das EBF ist alles, was dahintersteht -- formalisiert und erweitert. BEATRIX macht das EBF für Berater:innen nutzbar.}
...
BEATRIX geht über Standardberatung hinaus, indem es auf Basis des EBF Verhaltensentscheidungen nicht erfahrungsbasiert beurteilt, sondern Kontext ($\Psi$), Wechselwirkungen ($\gamma$) und Entscheidungslogik systematisch modelliert und nachvollziehbar macht.

\subsection{Die drei Säulen der Innovation}

\subsubsection{Säule 1: Kontext ernst nehmen}

Menschen verhalten sich nicht isoliert vom Kontext (Fehr \& Gächter, 2002a). Ein finanzieller Anreiz wirkt anders bei einem Berufseinsteiger als bei einer Führungskraft kurz vor der Pensionierung (Gneezy et al., 2011). \textbf{BEATRIX nutzt das EBF, um acht Kontext-Dimensionen systematisch zu berücksichtigen} -- formalisiert als $\Psi$-Vektor (vgl. Kapitel 9):
...
\textbf{Warum ist das neu?} Bisherige Ansätze behandeln Kontext als Störfaktor. Das EBF macht ihn zum zentralen Ordnungsprinzip -- BEATRIX setzt dies operativ um (Thaler \& Sunstein, 2008).

\subsubsection{Säule 2: Wechselwirkungen in der Realität erfassen -- und Massnahmen vorschlagen}

BEATRIX analysiert nicht Massnahmen isoliert, sondern die Realität dahinter: \textbf{Das EBF erfasst Wechselwirkungen, die in der Realität selbst stattfinden} (psychologisch, finanziell, kulturell) -- und BEATRIX schlägt auf dieser Basis geeignete Massnahmen vor. Diese realen Wechselwirkungen sind extrem schwierig zu erfassen und umfassen drei Ebenen:

\begin{table}[h]
\centering
\begin{tabular}{@{}L{4cm}L{9cm}@{}}
\toprule
\textbf{Wechselwirkungs-Ebene} & \textbf{Was das EBF modelliert} \\
\midrule
...
\textbf{Warum ist das neu?} Traditionelle Beratung betrachtet Massnahmen isoliert. Das EBF modelliert die komplexen Wechselwirkungen, die in der Realität zwischen psychologischen, finanziellen und kulturellen Faktoren stattfinden -- BEATRIX \textbf{schlägt auf dieser Basis passende Massnahmen vor}.
...
\begin{itemize}
    \item \textbf{Kein Wahrsager:} Das EBF modelliert Verhaltensparameter auf Populationsebene -- BEATRIX sagt nicht vorher, was eine einzelne Person tun wird
...
\begin{itemize}
    \item[$\checkmark$] Systematische Erfassung der acht Kontext-Dimensionen (EBF-Logik, durch BEATRIX umgesetzt)
    \item[$\checkmark$] Erfassung von Wechselwirkungen, die in der Realität stattfinden, und darauf basierende Massnahmenvorschläge (EBF modelliert, BEATRIX operationalisiert)
    \item[$\checkmark$] Benutzeroberfläche für Berater (BEATRIX)
    \item[$\checkmark$] Bibliothek mit über 50 dokumentierten Anwendungsfällen (EBF-Evidenzbasis)
    \item[$\checkmark$] Zugang zur im EBF systematisierten Evidenzbasis von über 1'500 wissenschaftlichen Studien
\end{itemize}
...
Forscht zur Zusammenarbeit zwischen Menschen und intelligenten Systemen -- zentral für die Willingness-Komponente des EBF (Kapitel 12) (Krakowski et al., 2025). Seine Frage:
...
\midrule
a) Innovation & Das EBF modelliert Wechselwirkungen, die in der Realität stattfinden (psychologisch, finanziell, kulturell); BEATRIX macht diese Modellierung skalierbar und schlägt darauf basierend Massnahmen vor. \\
...
\textit{``Dieses Projekt entwickelt weder eine neue Wissensbasis (das EBF existiert) noch ein neues Modell (das BCM existiert). Es validiert die technologiegestützte Infrastruktur BEATRIX, die das EBF (und damit auch das BCM) für die Managementpraxis operativ nutzbar macht. Die Transformation der Beratungspraxis ist das eigentliche Produkt.''}
}}
\end{center}
...
\midrule
BEATRIX & Behavioral Economics AI Technology for Research and Implementation eXcellence. Eine technologiegestützte Infrastruktur -- Agenten, APIs, Datenbanken und weitere digitale Werkzeuge --, die das EBF (und damit auch das BCM) für Berater:innen operativ einsetzbar macht. BEATRIX hebt die zentrale Begrenzung der bisherigen Beratungspraxis auf: die menschliche kognitive Kapazität. BEATRIX ersetzt nicht die Beratungskompetenz, sondern macht das im EBF formalisierte Wissen skalierbar, konsistent und nachvollziehbar. Der Innovation Cheque validiert BEATRIX. \\
\midrule
...
\midrule
BCM & Behavioral Change Model. Das Entscheidungs- und Beratungsmodell, das FehrAdvice \& Partners über mehr als drei Jahrzehnte in enger Verbindung mit der Forschung von Prof. Ernst Fehr entwickelt hat. Das BCM war das mentale Rahmenwerk aller Berater:innen -- mächtig, aber begrenzt durch die kognitive Kapazität der einzelnen Berater:in. Das BCM ist im EBF enthalten (BCM $\subset$ EBF) und wird durch BEATRIX operativ nutzbar gemacht. \\
\midrule
...
\midrule
EBF & Evidence-Based Framework for Economic and Social Behavior. Die vollständige wissenschaftliche Formalisierung und Systematisierung des Wissens, das hinter dem BCM steht -- und weit darüber hinaus. Über 2'000 Studien, 153 Theorien, 852 dokumentierte Fälle, systematisiert in 21 Kapiteln, 56 Appendices und 414 formalen Axiomen. Das EBF formalisiert, wie Kontext ($\Psi$), Wechselwirkungen ($\gamma$) und der Veränderungsprozess (Utility $\rightarrow$ Awareness $\rightarrow$ Willingness $\rightarrow$ Journey) zusammenwirken. Kernidee: $\theta = f(\Psi)$, d.\,h. Verhaltensparameter sind kontextabhängige Funktionen. Das EBF \emph{enthält} das BCM (BCM $\subset$ EBF). BEATRIX operationalisiert das EBF. \\
\midrule
Evidenzbasiert & Auf wissenschaftlichen Belegen beruhend, nicht auf Intuition oder Erfahrung allein. Bedeutet: Aussagen sind durch Studien, Experimente oder systematische Beobachtungen gestützt. Das EBF systematisiert über 2'000 wissenschaftliche Studien; BEATRIX macht diese Evidenz anwendbar. \\
\midrule
...
\midrule
FEPSDE & Die sechs Dimensionen von Wohlbefinden im EBF: Financial, Experiential, Procedural, Social, Distributive, Episodic. Jede Intervention wirkt auf eine oder mehrere dieser Dimensionen. \\
\midrule
...
\midrule
Intervention & Gezielte Massnahme zur Beeinflussung von Verhalten. Im EBF in acht Grundtypen klassifiziert: Awareness, Feedback, Kontextgestaltung, Timing, Identität, Soziale Normen, Finanzielle Anreize, Selbstverpflichtung. \\
\midrule
...
\midrule
Willingness (WAX) & Handlungsbereitschaft einer Person. Im EBF (Kapitel 12) mit 99 Axiomen formalisiert. Hängt ab von: Awareness (weiss ich, was ich tun soll?), Motivation (will ich es?), und wahrgenommenen Barrieren (kann ich es?). Erklärt, warum Wissen allein selten zu Verhaltensänderung führt. \\
\midrule
10C-CORE & Die zehn Kernfragen, die im EBF definiert und formalisiert sind: WHO (wer hat Nutzen?), WHAT (was ist Nutzen?), HOW (wie interagieren Faktoren?), WHEN (wann zählt Kontext?), WHERE (woher die Zahlen?), AWARE (wie bewusst?), READY (handlungsbereit?), STAGE (wo in der Journey?), HIERARCHY (wie stratifizieren Entscheidungen?), EIT (wie emergieren Interventionen?). BEATRIX beantwortet diese Fragen operativ. \\
\bottomrule
\end{longtable}
...
{\small Version: 5.0 -- Scharfe Abgrenzung EBF / BCM / BEATRIX}\\
