...
- Connection to Appendix UNMAPPED_PAP (equilibrium diagnostics)
...
**Structure:**
- **Part I (Foundation):** W11-W13 willingness axioms + connection to Appendix UNMAPPED_PAP
...
### Appendix UNMAPPED_PAP (FORMAL-INTERVENTION-EQUILIBRIA)
...
### Appendix UNMAPPED_REA (Willingness)
...
### Appendix UNMAPPED_STA (BCJ - Behavioral Change Journey)
...
### Appendix UNMAPPED_HOW (Complementarity)
