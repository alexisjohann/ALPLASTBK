...
└── Commits:
    ├── 9a11eec: Initial PSF 2.0 + Appendix UNMAPPED_PAP
...
#### **Appendix UNMAPPED_PAP: Cardinal Appointments as Structural Determinants**
```
...
**Key Insight**: Appendix UNMAPPED_PAP explains **HOW** appointments create the universal dimensions, not just **THAT** they do.
...
│   └── @misc{prevost2026psf}
│       └── Documents: Appendix UNMAPPED_PAP & gamma matrix
...
│   │   ├── Appendix UNMAPPED_PAP (Cardinal Appointments)
│   │   ├── Appendix UNMAPPED_PAP3 (Main Model)
│   │   ├── Appendix UNMAPPED_PAP2 (Historical Validation)
│   │   └── Appendix PAP1 (Pre-1958 Extension)
│   │
...
│   ├── Appendix UNMAPPED_PAP: Cardinal Appointments Theory
│   ├── GENERALIZATION-CHINESE-SUCCESSION.md
...
│   ├── core-framework-definition.yaml [← EBF 10C]
...
- [x] Appendix UNMAPPED_PAP provides theoretical foundation (cardinal appointments)
