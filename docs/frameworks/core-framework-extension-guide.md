...
> Wie man das 10C CORE Framework auf 10C, 10C, etc. erweitert

---

## Übersicht

Das EBF CORE Framework ist durch ein **Single Source of Truth (SSOT)** System erweiterbar. Diese Anleitung beschreibt den Prozess, um ein neues CORE (z.B. 10C) hinzuzufügen.
...
framework:
  ...
  version: "10C"    # ← von 10C auf 10C ändern
  count: 10         # ← von 8 auf 9 ändern
```
...
| Datei | Was ändern |
|-------|------------|
| `README.md` | 10C → 10C, CORE-Tabelle erweitern |
| `CLAUDE.md` | 10C → 10C, 10C CORE Tabelle erweitern |
...
Alle `chapters/ch*_README.md` Dateien, die "10C" oder die CORE-Tabelle referenzieren.
...
```markdown
### YYYY-MM-DD: 10C Framework Extension

**Kontext:** Erweiterung von 10C auf 10C mit CORE-[CODE]
...
```bash
# Alle 10C → 10C ersetzen
sed -i 's/10C CORE/10C CORE/g' README.md CLAUDE.md ...
...
✅ Keine Probleme gefunden! Das 10C Framework ist konsistent.
```
